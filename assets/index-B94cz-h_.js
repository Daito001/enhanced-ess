...
Vielen Dank!`}};function fe(e,t){const a=te[e];return a?{...a,...t??{}}:null}function ft(e,t){const a=Be(e.text,t);return{betreff:Be(e.betreff,t),text:a}}function Be(e,t){return e.replace(/\{(\w+)\}/g,(a,n)=>t[n]!=null?String(t[n]):`{${n}}`)}function mt(e,t){const a=t.datum?new Date(t.datum):null;return{name:"",personalnr:"",kostenstelle:"",datum:a?lt(a).split(", ")[1]:"",wochentag:sn[t.wochentag]??t.wochentag??"",zeitwirtschaft_anrede:e.zeitwirtschaftAnrede||"Frau Kanarya",zeitwirtschaft_email:e.zeitwirtschaftEmail||"Zeitwirtschaft.Aichtal@putzmeister.com",ist:t.ist!=null?t.ist.toFixed(2).replace(".",","):"",soll:t.soll!=null?t.soll.toFixed(2).replace(".",","):"",abgezogen:t.abgezogen!=null?Math.round(t.abgezogen*60):"",gestempelt:t.gestempelt!=null?Math.round(t.gestempelt*60):"",verlust:t.verlustMinuten??""}}function pt(e,t,a){const n=ft(t,a),s=e.zeitwirtschaftEmail||"Zeitwirtschaft.Aichtal@putzmeister.com",i=new URLSearchParams;return i.set("subject",n.betreff),i.set("body",n.text),`mailto:${s}?${i.toString().replace(/\+/g,"%20")}`}E.register(Pt,Tt,Et,Lt,Ft,Kt,Wt,Bt,Ot,Ct,Vt,It,_t,jt);function k(e){return getComputedStyle(document.documentElement).getPropertyValue(e).trim()}function O(){return{fg:k("--fg"),fgMuted:k("--fg-muted"),fgSubtle:k("--fg-subtle"),border:k("--border"),surface:k("--surface"),accent:k("--accent"),success:k("--success"),warn:k("--warn"),danger:k("--danger"),info:k("--info"),palette:[k("--chart-1"),k("--chart-2"),k("--chart-3"),k("--chart-4"),k("--chart-5"),k("--chart-6"),k("--chart-7")]}}function $(e){return{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{labels:{color:e.fgMuted,font:{size:12}}},tooltip:{backgroundColor:e.surface,titleColor:e.fg,bodyColor:e.fg,borderColor:e.border,borderWidth:1,padding:10,displayColors:!0}},scales:{x:{ticks:{color:e.fgMuted,font:{size:11}},grid:{color:e.border,drawBorder:!1}},y:{ticks:{color:e.fgMuted,font:{size:11}},grid:{color:e.border,drawBorder:!1}}}}}function rn(e,t){const a=O();if(C(e),!(t!=null&&t.length))return;const n=t.map(i=>z(x(i.datum),"dd.MM.")),s=t.map(i=>i.saldo);return s.map(i=>i>=0?a.success:a.danger),new E(e,{type:"line",data:{labels:n,datasets:[{label:"Tages-Saldo",data:s,borderColor:a.accent,backgroundColor:i=>{const r=i.chart,{ctx:l,chartArea:c,scales:o}=r;return c?mn(l,c,o.y,a):V(a.accent,.14)},segment:{borderColor:i=>{const r=i.p0.parsed.y,l=i.p1.parsed.y,c=(r+l)/2;return c>=.02?a.success:c<=-.02?a.danger:a.fgMuted}},tension:.25,pointRadius:2,pointHoverRadius:6,pointHitRadius:20,pointBackgroundColor:s.map(i=>i>=.02?a.success:i<=-.02?a.danger:a.fgMuted),pointBorderColor:a.surface,pointBorderWidth:1,fill:!0,borderWidth:2}]},options:{...$(a),interaction:{mode:"index",intersect:!1,axis:"x"},hover:{mode:"index",intersect:!1,axis:"x"},plugins:{...$(a).plugins,legend:{display:!1},tooltip:{enabled:!1,mode:"index",intersect:!1,axis:"x",position:"nearest",external:ln(t)}},scales:{...$(a).scales,y:{...$(a).scales.y,ticks:{...$(a).scales.y.ticks,callback:i=>`${i>=0?"+":""}${i.toFixed(1).replace(".",",")}h`}}}}})}function ln(e){return function(t){var G;const{chart:a,tooltip:n}=t;let s=a.$saldoTooltipEl;if(!s){s=document.createElement("div"),s.className="saldo-tooltip",document.body.appendChild(s),a.$saldoTooltipEl=s;const H=a.destroy.bind(a);a.destroy=function(){s.parentNode&&s.parentNode.removeChild(s),H()}}if(n.opacity===0||!((G=n.dataPoints)!=null&&G.length)){s.style.opacity="0";return}const i=n.dataPoints[0].dataIndex,r=e[i];if(!r){s.style.opacity="0";return}const l=r.saldo>.05?"pos":r.saldo<-.05?"neg":"flat",c=(r.diff??0)>.05?"pos":(r.diff??0)<-.05?"neg":"flat",o=(r.saldo>0?"+":"")+r.saldo.toFixed(2).replace(".",",")+"h",d=r.diff!=null?(r.diff>0?"+":"")+r.diff.toFixed(2).replace(".",",")+"h":null;let u=`<div class="saldo-tooltip-title">${Oe(z(x(r.datum),"EE, dd.MM.yyyy",{locale:ne}))}</div>`;u+=`<div class="saldo-tooltip-row"><span class="saldo-tooltip-label">Saldo</span><span class="saldo-tooltip-value ${l}">${o}</span></div>`,d&&(u+=`<div class="saldo-tooltip-row"><span class="saldo-tooltip-label">Tages-Diff</span><span class="saldo-tooltip-value ${c}">${d}</span></div>`);const g=[];r.tagestyp&&g.push(`Typ: ${Oe(r.tagestyp)}`),r.umbuchung&&g.push(`Umbuchung: ${r.umbuchung>=0?"+":""}${r.umbuchung.toFixed(2).replace(".",",")}h`),g.length&&(u+=`<div class="saldo-tooltip-meta">${g.map(H=>`<span>${H}</span>`).join("")}</div>`),s.innerHTML=u;const f=a.canvas.getBoundingClientRect(),p=f.left+n.caretX,y=f.top+n.caretY;s.style.opacity="0",s.style.left="0px",s.style.top="0px";const v=s.offsetWidth,D=s.offsetHeight,Z=18;let j=p+Z;j+v>window.innerWidth-8&&(j=p-Z-v);let L=y-D/2;L<8&&(L=8),L+D>window.innerHeight-8&&(L=window.innerHeight-D-8),s.style.left=j+"px",s.style.top=L+"px",s.style.opacity="1"}}function Oe(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function on(e,t){const a=O();if(C(e),!(t!=null&&t.length))return;const n=t.map(i=>i.monatKey),s=t.map(i=>{var r;return((r=i.glz)==null?void 0:r.saldoGesamt)??0});return new E(e,{type:"line",data:{labels:n,datasets:[{label:"GLZ-Saldo (Monatsende)",data:s,borderColor:a.accent,backgroundColor:V(a.accent,.18),tension:.35,fill:!0,pointRadius:4}]},options:$(a)})}function Se(e,t){const a=O();if(C(e),!(t!=null&&t.length))return;const n=t.map(r=>z(x(r.datum),"dd.MM.")),s=t.map(r=>r.ist??0),i=t.map(r=>pn(r.tagestyp,a));return new E(e,{type:"bar",data:{labels:n,datasets:[{label:"Ist-Stunden",data:s,backgroundColor:i,borderRadius:4,borderSkipped:!1}]},options:{...$(a),plugins:{...$(a).plugins,legend:{display:!1},tooltip:{...$(a).plugins.tooltip,callbacks:{label:r=>{const l=t[r.dataIndex];return`${l.tagestyp??"—"}: ${(l.ist??0).toFixed(2).replace(".",",")}h`}}}},scales:{...$(a).scales,y:{...$(a).scales.y,suggestedMin:0,suggestedMax:10}}}})}function cn(e,t){const a=O();if(C(e),!(t!=null&&t.length))return;const n=t.filter(o=>{var d;return((d=o.zeitSpannen)==null?void 0:d.length)&&o.zeitSpannen.some(h=>h.von&&h.bis)}).map(o=>{const d=o.zeitSpannen.filter(g=>g.von&&g.bis).map(g=>({von:K(g.von),bis:K(g.bis),vonStr:g.von,bisStr:g.bis})).filter(g=>g.von!=null&&g.bis!=null);if(d.length===0)return null;const h=Math.min(...d.map(g=>g.von)),u=Math.max(...d.map(g=>g.bis));return{...o,_spans:d,_minVon:h,_maxBis:u}}).filter(Boolean);if(!n.length)return;const s=o=>o.ist==null?a.fgMuted:o.ist>=7?a.success:a.danger,i={label:"Tages-Rahmen",data:n.map(o=>[o._minVon,o._maxBis]),backgroundColor:n.map(s),borderColor:n.map(s),borderWidth:0,borderRadius:4,borderSkipped:!1,barPercentage:.75,categoryPercentage:.95},r=Math.max(0,Math.floor(Math.min(...n.map(o=>o._minVon))/60)*60-60),l=Math.min(24*60,Math.ceil(Math.max(...n.map(o=>o._maxBis))/60)*60+60),c=o=>`${String(Math.floor(o/60)).padStart(2,"0")}:${String(o%60).padStart(2,"0")}`;return new E(e,{type:"bar",data:{labels:n.map(o=>z(x(o.datum),"dd.MM.")),datasets:[i]},options:{...$(a),interaction:{mode:"index",intersect:!1,axis:"x"},plugins:{legend:{display:!1},tooltip:{enabled:!0,backgroundColor:a.surface,borderColor:a.accent,borderWidth:2,padding:14,titleColor:a.fg,titleFont:{size:14,weight:"600"},titleMarginBottom:8,bodyColor:a.fg,bodyFont:{size:13},bodySpacing:4,displayColors:!1,caretPadding:10,cornerRadius:8,callbacks:{title:o=>{const d=n[o[0].dataIndex];return z(x(d.datum),"EE, dd.MM.yyyy",{locale:ne})},label:()=>"",beforeBody:o=>{const d=n[o[0].dataIndex],h=d.ist!=null?N(d.ist):"—",u=d.soll!=null?N(d.soll):"—",g=d.pause!=null?Math.round(d.pause*60)+" min":"—",p=[`Tages-Rahmen: ${`${c(d._minVon)} – ${c(d._maxBis)}`}`];return d._spans.length>1&&(p.push(""),d._spans.forEach((y,v)=>{p.push(`  Block ${v+1}: ${y.vonStr} – ${y.bisStr}`)})),[...p,"",`Arbeitszeit (netto): ${h}`,`Soll: ${u}`,`Pause (abgezogen): ${g}`]}}}},scales:{x:{ticks:{color:a.fgMuted,font:{size:10},maxRotation:60,minRotation:60,autoSkip:!0,maxTicksLimit:40},grid:{display:!1}},y:{min:r,max:l,ticks:{color:a.fgMuted,stepSize:60,callback:o=>c(o)},grid:{color:a.border}}}}})}function dn(e,t){const a=O();C(e);const n={};for(const r of t){if(r.tagestyp!=="Stempelzeit"||!r.zeitSpannen||r.zeitSpannen.length<2)continue;const l=ut(r.zeitSpannen);if(l<=0)continue;const c=Math.round(l*60),o=Math.floor(c/15)*15;n[o]=(n[o]??0)+1}const s=Object.keys(n).map(Number).sort((r,l)=>r-l),i=s.map(r=>n[r]);return new E(e,{type:"bar",data:{labels:s.map(r=>`${r}–${r+14} min`),datasets:[{label:"Häufigkeit",data:i,backgroundColor:a.palette[1],borderRadius:4}]},options:{...$(a),plugins:{...$(a).plugins,legend:{display:!1},tooltip:{...$(a).plugins.tooltip,callbacks:{title:r=>`Pause-Länge (gestempelt): ${r[0].label}`,label:r=>`${r.parsed.y} Tag(e)`}}}}})}function un(e,t){const a=O();C(e);const n=["MO","DI","MI","DO","FR"],s={},i={};for(const l of n)s[l]=0,i[l]=0;for(const l of t)n.includes(l.wochentag)&&(l.ist==null||l.ist===0||(s[l.wochentag]+=l.ist,i[l.wochentag]+=1));const r=n.map(l=>i[l]>0?s[l]/i[l]:0);return new E(e,{type:"bar",data:{labels:["Montag","Dienstag","Mittwoch","Donnerstag","Freitag"],datasets:[{label:"Ø Ist-Stunden",data:r,backgroundColor:a.palette[2],borderRadius:4}]},options:{...$(a),plugins:{...$(a).plugins,legend:{display:!1}}}})}function gn(e,t){const a=O();C(e);const n={};for(const r of t)!r.tagestyp||r.tagestyp==="Wochenende"||(n[r.tagestyp]=(n[r.tagestyp]??0)+1);const s=Object.keys(n),i=Object.values(n);return new E(e,{type:"doughnut",data:{labels:s,datasets:[{data:i,backgroundColor:s.map((r,l)=>a.palette[l%a.palette.length]),borderColor:a.surface,borderWidth:2}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"right",labels:{color:a.fgMuted,font:{size:12}}},tooltip:$(a).plugins.tooltip}}})}function hn(e,t){const a=O();C(e);const n={};for(const l of t){const c=l.wocheKey;n[c]??(n[c]={ist:0,soll:0}),n[c].ist+=l.ist??0,n[c].soll+=l.soll??0}const s=Object.keys(n).sort(),i=s.map(l=>n[l].ist),r=s.map(l=>n[l].soll);return new E(e,{type:"bar",data:{labels:s.map(l=>"KW "+l.split("-")[1]),datasets:[{label:"Ist",data:i,backgroundColor:a.palette[0],borderRadius:4},{label:"Soll",data:r,backgroundColor:a.palette[3],borderRadius:4}]},options:$(a)})}function fn(e,t){const a=O();C(e);const n=t.slice().sort((r,l)=>r.datum.localeCompare(l.datum));let s=0;const i=n.map(r=>(s+=r.diff??0,{x:r.datum,y:s}));return new E(e,{type:"line",data:{labels:i.map(r=>r.x),datasets:[{label:"Kumulative Differenz (+/- Soll)",data:i.map(r=>r.y),borderColor:a.palette[5],backgroundColor:V(a.palette[5],.15),fill:!0,tension:.2,pointRadius:0}]},options:{...$(a),scales:{x:{display:!1,grid:{display:!1}},y:{...$(a).scales.y}}}})}function C(e){const t=E.getChart(e);t&&t.destroy()}function V(e,t){const a=e.replace("#","").trim();if(a.length!==6&&a.length!==3)return e;const n=a.length===3?a.split("").map(l=>l+l).join(""):a,s=parseInt(n.slice(0,2),16),i=parseInt(n.slice(2,4),16),r=parseInt(n.slice(4,6),16);return`rgba(${s}, ${i}, ${r}, ${t})`}function mn(e,t,a,n){const{top:s,bottom:i}=t,r=e.createLinearGradient(0,s,0,i),l=a.min,c=a.max,o=c-l;if(o<=0)return V(n.success,.14);let d=(c-0)/o;return d=Math.max(0,Math.min(1,d)),r.addColorStop(0,V(n.success,.28)),r.addColorStop(Math.max(0,d-.001),V(n.success,.06)),r.addColorStop(Math.min(1,d+.001),V(n.danger,.06)),r.addColorStop(1,V(n.danger,.28)),r}function pn(e,t){const a=String(e??"").toLowerCase();return a.includes("stempel")?t.palette[0]:a.includes("berufs")?t.palette[1]:a.includes("urlaub")?t.palette[2]:a.includes("feiertag")?t.fgSubtle:a.includes("dienst")?t.palette[3]:a.includes("krank")?t.palette[4]:t.palette[5]}let vn=0;function ze(e,{type:t="info",duration:a=3500}={}){const n=document.getElementById("toast-root");if(!n)return;const s=document.createElement("div");s.className=`toast ${t}`,s.textContent=e,s.dataset.id=++vn,n.appendChild(s),setTimeout(()=>{s.style.opacity="0",s.style.transform="translateY(-8px)",s.style.transition="opacity 220ms, transform 220ms",setTimeout(()=>s.remove(),250)},a)}function oe(e){return ze(e,{type:"error",duration:6e3})}function M(e){return ze(e,{type:"success"})}const Ce=[{key:7,label:"1 Woche"},{key:14,label:"2 Wochen"},{key:30,label:"1 Monat"},{key:90,label:"3 Monate"},{key:"alles",label:"Alles"}];async function Ve({root:e}){var L,G,H,De;const[t,a,n,s,i,r,l]=await Promise.all([_(),ae(),B(),ma(),ra("dashboardZeitraum",14),ke(),nt()]),c=Object.fromEntries(r.map(b=>[b.key,b]));if(n.length===0){e.innerHTML=Mn();return}const o=!((G=(L=t.berufsschulMuster)==null?void 0:L.wochentageWoechentlich)!=null&&G.length||(De=(H=t.berufsschulMuster)==null?void 0:H.wochentage14Taegig)!=null&&De.length),d=en(n,a),h=d.length;let u=i;typeof u=="number"&&u>h&&(u="alles");const g=new Set(s.map(b=>b.key)),f=l!=null&&l.stichtagAuswertung?new Date(l.stichtagAuswertung):new Date,p=Me(n,t,f,g),y=ht(a,g),v=[...p,...y],D=an(d),Z=D>.05?"positive":D<-.05?"negative":"";e.innerHTML=`
      ...
      <div style="flex: 1; min-width: 400px; display: flex; flex-direction: column;">
        <div class="card-split" style="margin-bottom: 12px; align-items: center;">
          ...
          <div class="segmented" id="zeitraum-picker">
            ${Ce.map(b=>{const S=typeof b.key=="number"&&b.key>h;return`<button type="button" data-key="${b.key}" class="${u===b.key?"active":""}" ${S?'disabled style="opacity:0.4"':""}>${b.label}</button>`}).join("")}
          </div>
        </div>
    ...
    <div class="grid cols-2" style="margin-bottom: 32px;">
      <div class="card">
        ...
        <p style="color: var(--fg-muted); font-size: 13px; margin-bottom: 16px;">
          Lade deinen Zeitnachweis (PDF aus ESS) hoch. Die Daten werden ausschließlich lokal in deinem Browser analysiert und gespeichert — nichts verlässt dein Gerät.
        </p>
        <div class="upload-zone" id="upload-zone">
          <div class="upload-zone-icon">📄</div>
          <h3>PDF hierher ziehen oder klicken</h3>
          <p>Akzeptiert: .pdf aus ESS</p>
        </div>
  ...
  `;const n=e.querySelector("#upload-zone"),s=e.querySelector("#file-input");n.addEventListener("click",()=>s.click()),n.addEventListener("dragover",i=>{i.preventDefault(),n.classList.add("drag")}),n.addEventListener("dragleave",()=>n.classList.remove("drag")),n.addEventListener("drop",async i=>{var l;i.preventDefault(),n.classList.remove("drag");const r=(l=i.dataTransfer.files)==null?void 0:l[0];r&&await Ze(r,e,a)}),s.addEventListener("change",async i=>{var l;const r=(l=i.target.files)==null?void 0:l[0];r&&await Ze(r,e,a)}),e.querySelector("#btn-export").addEventListener("click",In),e.querySelector("#btn-import").addEventListener("click",()=>e.querySelector("#import-input").click()),e.querySelector("#import-input").addEventListener("change",_n),e.querySelector("#btn-clear-parsed").addEventListener("click",Vn),e.querySelector("#btn-reset").addEventListener("click",jn)}async function Vn(){confirm("PDF-abgeleitete Daten (Tage, Monate, Uploads) werden gelöscht. Profil und Mail-Vorlagen bleiben erhalten. Fortfahren?")&&(await it(),M("Daten gelöscht. Profil bleibt."),setTimeout(()=>location.reload(),600))}function vt(e){return`
    <table class="table">
      <thead>
        <tr>
      ...
      <div class="alert-body">
        ...
        <div class="alert severity-error">
          ...
          <div class="alert-body">
            ...
            <p style="margin: 8px 0; font-size: 13px;">
              <strong>Lösung:</strong> Lade dein PDF direkt aus ESS herunter
...
Fortfahren?`)){s.style.pointerEvents="",s.style.opacity="",n.innerHTML=`
    ...
    `,M(`PDF verarbeitet: ${d.tage.length} Tage.`);const v=await st();t.querySelector("#uploads-list").innerHTML=vt(v)}catch(o){console.error(o),n.innerHTML=`
      <div class="alert severity-error">
        <div class="alert-icon">!</div>
        <div class="alert-body">
    ...
    `,oe("PDF konnte nicht gelesen werden.")}finally{s.style.pointerEvents="",s.style.opacity=""}}async function In(){try{const e=await ga(),t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),a=URL.createObjectURL(t),n=document.createElement("a"),s=new Date().toISOString().slice(0,10);n.href=a,n.download=`zeitnachweis-backup-${s}.json`,n.click(),URL.revokeObjectURL(a),M("Backup heruntergeladen.")}catch(e){oe(`Export fehlgeschlagen: ${e.message}`)}}async function _n(e){var a;const t=(a=e.target.files)==null?void 0:a[0];if(t)try{const n=await t.text(),s=JSON.parse(n);if(!confirm("Existierende Daten werden überschrieben. Fortfahren?"))return;await ha(s),M("Backup erfolgreich importiert. Seite wird neu geladen…"),setTimeout(()=>location.reload(),800)}catch(n){oe(`Import fehlgeschlagen: ${n.message}`)}}async function jn(){confirm("ALLE Daten endgültig löschen? Das lässt sich nicht rückgängig machen.")&&confirm("Wirklich alle Daten löschen? Letzte Warnung.")&&(await ua(),M("Alle Daten gelöscht."),setTimeout(()=>location.reload(),600))}function Rn(e){if(!e)return"—";const t=new Date(e);return t.toLocaleDateString("de-DE",{year:"numeric",month:"2-digit",day:"2-digit"})+" "+t.toLocaleTimeString("de-DE",{hour:"2-digit",minute:"2-digit"})}const He={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag"};async function Zn({root:e}){var s,i,r,l,c;const t=await _(),a=t.berufsschulMuster??{},n=(((s=a.wochentageWoechentlich)==null?void 0:s.length)??0)>0||(((i=a.wochentage14Taegig)==null?void 0:i.length)??0)>0;e.innerHTML=`
  ...
  `}async function Nn({params:e,root:t}){const a=e.yyyymm,[n,s,i]=await Promise.all([B(),ae(),_()]),r=s.find(o=>o.monatKey===a),l=n.filter(o=>o.monatKey===a).sort((o,d)=>o.datum.localeCompare(d.datum));if(!l.length){t.innerHTML=`<h1 class="view-title">Monat ${ye(a)}</h1><p class="view-subtitle">Keine Daten für diesen Monat.</p><a href="#/monat" class="btn">← Alle Monate</a>`;return}const c=Me(n,i,new Date).filter(o=>o.datum.startsWith(a));t.innerHTML=`
  ...
  `}async function Qn({params:e,root:t}){const a=await B(),n=e.yyyykw,s=a.filter(c=>c.wocheKey===n).sort((c,o)=>c.datum.localeCompare(o.datum));if(!s.length){t.innerHTML=`<h1 class="view-title">KW ${de(n)}</h1><p>Keine Daten.</p><a href="#/woche" class="btn">← Alle Wochen</a>`;return}const i=s.reduce((c,o)=>c+(o.ist??0),0),r=s.reduce((c,o)=>c+(o.soll??0),0),l=i-r;t.innerHTML=`
    <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 8px;">
  ...
  `}function ns(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function Q(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}async function ss({root:e}){const[t,a]=await Promise.all([B(),ae()]);if(!t.length){e.innerHTML='<h1 class="view-title">Analytics</h1><p class="view-subtitle">Keine Daten.</p><a href="#/daten" class="btn primary">Zum Upload</a>';return}e.innerHTML=`
...
`);navigator.clipboard.writeText(r).then(()=>M(`${i.length} Zeilen kopiert.`))});function s(){const i=n.value,l=(i?t.filter(c=>c.monatKey===i):t).filter(c=>c.ist!=null&&c.ist>0&&c.tagestyp!=="Wochenende");e.querySelector("#liste").innerHTML=rs(l),e.querySelectorAll(".copy-val").forEach(c=>{c.addEventListener("click",async()=>{const o=c.getAttribute("data-val");await navigator.clipboard.writeText(o),c.classList.add("ok");const d=c.textContent;c.textContent="✓ kopiert",setTimeout(()=>{c.classList.remove("ok"),c.textContent=d},1200)})})}s()}function rs(e){return e.length?`
    <table class="table">
      <thead>
        <tr>
          <th>Datum</th>
...
${T(i.text)}
  ...
  `}function hs(e){e.querySelectorAll(".btn-save-vorlage").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-key"),n=t.closest(".vorlagen-item"),s=n.querySelector(".v-betreff").value,i=n.querySelector(".v-text").value;await le(a,{betreff:s,text:i}),M("Vorlage gespeichert.")})}),e.querySelectorAll(".btn-reset-vorlage").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-key"),n=te[a];n&&confirm(`Vorlage "${n.titel}" auf Default zurücksetzen?`)&&(await le(a,{betreff:n.betreff,text:n.text}),M("Zurückgesetzt."),setTimeout(()=>location.reload(),400))})})}function fs(e){e.querySelectorAll(".btn-copy-mail").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-subject"),n=t.getAttribute("data-body"),s=`Betreff: ${a}

${n}`;await navigator.clipboard.writeText(s),M("Mail-Text kopiert.")})})}function T(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function we(e){return T(e)}async function ms({root:e}){const t=Qe(),[a,n]=await Promise.all([_(),ke()]),s=Object.fromEntries(n.map(i=>[i.key,i]));e.innerHTML=`
  ...
  `,e.querySelectorAll("[data-theme]").forEach(i=>{i.addEventListener("click",()=>{const r=i.getAttribute("data-theme");$e(r),e.querySelectorAll("[data-theme]").forEach(l=>l.classList.toggle("active",l===i)),M(`Theme: ${i.textContent.trim()}`)})}),e.querySelector("#pause-sel").addEventListener("change",async i=>{const r={...a,pausenRegel:i.target.value};await re(r),M("Pausen-Regel gespeichert.")}),e.querySelectorAll(".btn-save-vorlage").forEach(i=>{i.addEventListener("click",async()=>{const r=i.getAttribute("data-key"),l=i.closest(".vorlagen-item"),c=l.querySelector(".v-betreff").value,o=l.querySelector(".v-text").value;await le(r,{betreff:c,text:o}),M("Vorlage gespeichert.")})}),e.querySelectorAll(".btn-reset-vorlage").forEach(i=>{i.addEventListener("click",async()=>{const r=i.getAttribute("data-key"),l=te[r];l&&confirm(`Vorlage "${l.titel}" auf Default zurücksetzen?`)&&(await le(r,{betreff:l.betreff,text:l.text}),M("Zurückgesetzt."),setTimeout(()=>location.reload(),400))})})}function ps(e){return`
    <div class="vorlagen-item" data-key="${e.key}" style="border: 1px solid var(--border); border-radius: var(--radius-md); padding: 16px; margin-bottom: 16px;">
      <div class="card-split" style="margin-bottom: 12px;">
        <div>
  ...
  `}function ie(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function vs(e){return ie(e)}async function qe(){var t;Ht();const e=document.getElementById("content");(t=document.getElementById("theme-toggle"))==null||t.addEventListener("click",()=>Nt()),Gt(()=>{Xt()}),await ia()&&setTimeout(()=>{ze('Parser wurde aktualisiert. Bitte lade deinen Zeitnachweis unter "Daten" neu hoch.',{type:"info",duration:12e3})},500),await sa(),await na(),A("/",Ve),A("/dashboard",Ve),A("/analytics",ss),A("/monat",Hn),A("/monat/:yyyymm",Nn),A("/woche",Xn),A("/woche/:yyyykw",Qn),A("/tag/:datum",as),A("/berichtsheft",is),A("/mails",ds),A("/profil",Zn),A("/daten",Cn),A("/einstellungen",ms),Ut(e),location.hash||Jt("/")}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",qe):qe();
