import{D as ct}from"./dexie-BODkcwel.js";import{b as ce,a as N,c as q,d as dt,f as x,e as X,i as Ve,p as ut,g as gt,h as ht,j as M,k as _e,l as mt,s as ft,m as pt}from"./datefns-Dq49jaKA.js";import{C as E,L as vt,B as bt,D as yt,S as wt,a as $t,b as Mt,P as zt,A as xt,c as St,d as kt,T as Dt,p as At,e as Pt,i as Tt}from"./chartjs-CRgZvhTJ.js";import{_ as Et,a as Lt}from"./pdfjs-BDGsuRSB.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=a(s);fetch(s.href,i)}})();const ie="theme";function Kt(){const e=localStorage.getItem(ie)??"auto";me(e)}function me(e){e==="auto"?document.documentElement.removeAttribute("data-theme"):document.documentElement.setAttribute("data-theme",e),localStorage.setItem(ie,e),Ct(e)}function Ft(){const e=localStorage.getItem(ie)??"auto",t=e==="auto"?"light":e==="light"?"dark":"auto";return me(t),je(t),t}const de=new Set;function Wt(e){return de.add(e),()=>de.delete(e)}function je(e){for(const t of de)try{t(e)}catch(a){console.error(a)}}var Re;if(typeof window<"u"&&window.matchMedia){const e=window.matchMedia("(prefers-color-scheme: dark)");(Re=e.addEventListener)==null||Re.call(e,"change",()=>{Ze()==="auto"&&je("auto")})}function Ct(e){const t=document.getElementById("theme-toggle");if(!t)return;const a=t.querySelector(".theme-label"),n=t.querySelector(".theme-icon-dark"),s=t.querySelector(".theme-icon-light");a&&(e==="auto"?(a.textContent="Auto",n&&(n.style.display="inline"),s&&(s.style.display="inline")):e==="light"?(a.textContent="Hell",n&&(n.style.display="none"),s&&(s.style.display="inline")):(a.textContent="Dunkel",n&&(n.style.display="inline"),s&&(s.style.display="none")))}function Ze(){return localStorage.getItem(ie)??"auto"}const He=[];let Ge=null;function D(e,t){const a=e.split("/").filter(Boolean),n=[],s=new RegExp("^/?"+a.map(i=>i.startsWith(":")?(n.push(i.slice(1)),"([^/]+)"):Vt(i)).join("/")+"/?$");He.push({pattern:e,regex:s,paramNames:n,render:t})}function Ot(e){e.startsWith("#")||(e="#"+e),window.location.hash===e?L():window.location.hash=e}function It(e,{onNavigate:t}={}){window.addEventListener("hashchange",L),L.rootEl=e,L.onNavigate=t,L()}async function L(){var n;const e=L.rootEl,t=window.location.hash.slice(1)||"/",a=t.startsWith("/")?t:`/${t}`;for(const s of He){const i=s.regex.exec(a);if(i){const r={};s.paramNames.forEach((l,o)=>r[l]=decodeURIComponent(i[o+1])),Ge=a,(n=L.onNavigate)==null||n.call(L,a),Bt(a);try{e.classList.remove("view-enter"),await s.render({params:r,path:a,root:e}),e.classList.add("view-enter")}catch(l){console.error("Route render error:",l),e.innerHTML=`<div class="empty-state">
  ...
  `,e.querySelector("#profil-form").addEventListener("submit",async o=>{var f,g,u,h;o.preventDefault();const c=new FormData(o.target),d={...t,name:((f=c.get("name"))==null?void 0:f.trim())||"",personalnummer:((g=c.get("personalnummer"))==null?void 0:g.trim())||"",geburtsdatum:c.get("geburtsdatum")?new Date(c.get("geburtsdatum")).toISOString():null,pausenRegel:c.get("pausenRegel")||"auto",zeitwirtschaftEmail:((u=c.get("zeitwirtschaftEmail"))==null?void 0:u.trim())||"Zeitwirtschaft.Aichtal@putzmeister.com",zeitwirtschaftAnrede:((h=c.get("zeitwirtschaftAnrede"))==null?void 0:h.trim())||"Frau Kanarya"};await fe(d),S("Profil gespeichert.")})}function ae(e){return String(e??"").replace(/"/g,"&quot;")}async function Sn({root:e}){var s;const t=await ee(),a=await W(),n={};for(const i of a)n[s=i.monatKey]??(n[s]=[]),n[i.monatKey].push(i);if(t.length===0){e.innerHTML=En("Noch keine Monatsdaten. Lade zuerst ein PDF unter Daten hoch.");return}e.innerHTML=`
...
Ich bitte Sie um Prüfung und Korrektur auf {soll}h.`},stempelzeit_fehlt:{key:"stempelzeit_fehlt",titel:"Stempelzeit fehlt",beschreibung:"Wenn ein regulärer Arbeitstag ohne Stempelung geblieben ist.",betreff:"Bitte um Zeitkorrektur im ESS  - Fehlender Arbeitstag {datum}",text:`Guten Tag {zeitwirtschaft_anrede},
...
Ich bitte Sie um Prüfung und Nachtrag der Stempeldaten.`},pausen_abzug:{key:"pausen_abzug",titel:"Falscher Pausen-Abzug",beschreibung:"Wenn mehr Pause abgezogen wurde als tatsächlich gestempelt.",betreff:"Bitte um Zeitkorrektur im ESS  - Pausen-Abzug {datum}",text:`Guten Tag {zeitwirtschaft_anrede},
...
Ich bitte Sie um Prüfung und Korrektur auf {gestempelt} Minuten Pause.`}};function rt(e,t){const a=we[e];return a?{...a,...t??{}}:null}function lt(e,t){const a=Ie(e.text,t);return{betreff:Ie(e.betreff,t),text:a}}function Ie(e,t){return e.replace(/\{(\w+)\}/g,(a,n)=>t[n]!=null?String(t[n]):`{${n}}`)}function Hn(e,t){const a=t.datum?new Date(t.datum):null,n=a?Ue(a).split(", ")[1]:"";return{name:e.name||"Ihr Mitarbeiter",personalnr:e.personalnummer||"—",kostenstelle:e.kostenstelle||"—",datum:n,wochentag:Zn[t.wochentag]??t.wochentag??"",zeitwirtschaft_anrede:e.zeitwirtschaftAnrede||"Frau Kanarya",zeitwirtschaft_email:e.zeitwirtschaftEmail||"Zeitwirtschaft.Aichtal@putzmeister.com",ist:t.ist!=null?t.ist.toFixed(2).replace(".",","):"",soll:t.soll!=null?t.soll.toFixed(2).replace(".",","):"",abgezogen:t.abgezogen!=null?Math.round(t.abgezogen*60):"",gestempelt:t.gestempelt!=null?Math.round(t.gestempelt*60):"",verlust:t.verlustMinuten??""}}function Gn(e,t,a){const n=lt(t,a),s=e.zeitwirtschaftEmail||"Zeitwirtschaft.Aichtal@putzmeister.com",i=new URLSearchParams;return i.set("subject",n.betreff),i.set("body",n.text),`mailto:${s}?${i.toString().replace(/\+/g,"%20")}`}async function Nn({root:e}){const[t,a,n,s]=await Promise.all([W(),j(),ee(),Yt()]),i=Object.fromEntries(s.map(o=>[o.key,o])),r=pe(t,a,new Date).filter(o=>o.mailVorlageKey),l=tt(n);e.innerHTML=`
  ...
  `,Un(e),Qn(e)}function qn(e,t,a){const n=rt(e.mailVorlageKey,a[e.mailVorlageKey]);if(!n)return"";const s=Hn(t,e),i=lt(n,s),r=Gn(t,n,s);return`
...
${n}`;await navigator.clipboard.writeText(s),S("Mail-Text kopiert.")})})}function T(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function he(e){return T(e)}async function Yn({root:e}){const t=Ze(),a=await j();e.innerHTML=`
