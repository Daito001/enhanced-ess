import{D as dt}from"./dexie-BODkcwel.js";import{b as oe,a as G,c as q,d as ut,f as x,e as je,i as Ze,s as gt,g as ht,p as ft,h as mt,j as pt,k as vt,l as S,m as bt}from"./datefns-Dlft8rFK.js";import{C as E,L as yt,B as wt,D as $t,S as Mt,a as kt,b as St,P as xt,A as zt,c as Dt,d as At,T as Pt,p as Tt,e as Et,i as Lt}from"./chartjs-CRgZvhTJ.js";import{_ as Kt,a as Wt}from"./pdfjs-BDGsuRSB.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function a(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(s){if(s.ep)return;s.ep=!0;const r=a(s);fetch(s.href,r)}})();const se="theme";function Ft(){const e=localStorage.getItem(se)??"auto";he(e)}function he(e){e==="auto"?document.documentElement.removeAttribute("data-theme"):document.documentElement.setAttribute("data-theme",e),localStorage.setItem(se,e),Bt(e)}function Ot(){const e=localStorage.getItem(se)??"auto",t=e==="auto"?"light":e==="light"?"dark":"auto";return he(t),He(t),t}const ce=new Set;function Ct(e){return ce.add(e),()=>ce.delete(e)}function He(e){for(const t of ce)try{t(e)}catch(a){console.error(a)}}var Re;if(typeof window<"u"&&window.matchMedia){const e=window.matchMedia("(prefers-color-scheme: dark)");(Re=e.addEventListener)==null||Re.call(e,"change",()=>{Ne()==="auto"&&He("auto")})}function Bt(e){const t=document.getElementById("theme-toggle");if(!t)return;const a=t.querySelector(".theme-label"),n=t.querySelector(".theme-icon-dark"),s=t.querySelector(".theme-icon-light");a&&(e==="auto"?(a.textContent="Auto",n&&(n.style.display="inline"),s&&(s.style.display="inline")):e==="light"?(a.textContent="Hell",n&&(n.style.display="none"),s&&(s.style.display="inline")):(a.textContent="Dunkel",n&&(n.style.display="inline"),s&&(s.style.display="none")))}function Ne(){return localStorage.getItem(se)??"auto"}const Ge=[];let qe=null;function D(e,t){const a=e.split("/").filter(Boolean),n=[],s=new RegExp("^/?"+a.map(r=>r.startsWith(":")?(n.push(r.slice(1)),"([^/]+)"):jt(r)).join("/")+"/?$");Ge.push({pattern:e,regex:s,paramNames:n,render:t})}function It(e){e.startsWith("#")||(e="#"+e),window.location.hash===e?L():window.location.hash=e}function Vt(e,{onNavigate:t}={}){window.addEventListener("hashchange",L),L.rootEl=e,L.onNavigate=t,L()}async function L(){var n;const e=L.rootEl,t=window.location.hash.slice(1)||"/",a=t.startsWith("/")?t:`/${t}`;for(const s of Ge){const r=s.regex.exec(a);if(r){const i={};s.paramNames.forEach((l,o)=>i[l]=decodeURIComponent(r[o+1])),qe=a,(n=L.onNavigate)==null||n.call(L,a),_t(a);try{e.classList.remove("view-enter"),await s.render({params:i,path:a,root:e}),e.classList.add("view-enter")}catch(l){console.error("Route render error:",l),e.innerHTML=`<div class="empty-state">
  ...
  `,Ee(c,e,l);const $=()=>e.querySelectorAll("#zeitraum-picker button, #zeitraum-picker-2 button");$().forEach(b=>{b.addEventListener("click",async()=>{if(b.disabled)return;const M=b.getAttribute("data-key"),P=M==="alles"?"alles":parseInt(M,10);$().forEach(H=>H.classList.toggle("active",H.getAttribute("data-key")===M)),await Yt("dashboardZeitraum",P),Ee(P,e,l)})}),e.addEventListener("click",async b=>{const M=b.target.closest(".ist-copy");if(M){b.preventDefault(),b.stopPropagation();const ke=M.getAttribute("data-val");try{await navigator.clipboard.writeText(ke),M.classList.add("ok");const N=M.querySelector(".ist-wert"),le=M.querySelector(".copy-icon");if(N&&le){const ct=N.textContent;N.textContent="✓ kopiert",le.style.display="none",setTimeout(()=>{M.classList.remove("ok"),N.textContent=ct,le.style.display=""},1e3)}}catch{z(`Bitte kopieren: ${ke}`)}return}const P=b.target.closest(".btn-dismiss");if(!P)return;const H=P.getAttribute("data-datum"),$e=P.getAttribute("data-typ");if(!H||!$e)return;await ra(H,$e),z("Warnung ausgeblendet.");const Me=P.closest(".alert");Me&&(Me.style.display="none")})}function Ee(e,t,a){const n=qa(a,e),s=Ua(n);requestAnimationFrame(()=>{const o=t.querySelector("#saldo-chart");Ya(o,n)});const r=t.querySelector("#hero-bewegung");if(r){const o=s>.05?"up":s<-.05?"down":"flat",c=s>.05?"↑":s<-.05?"↓":"→";r.className=`saldo-trend ${o}`,r.innerHTML=`${c} ${Math.abs(s)<.01?"Unverändert":A(s,{signed:!0})} im Zeitraum`}const i=t.querySelector("#tage-info");if(i){const o=n.length;i.textContent=`${o} ${o===1?"Tag":"Tage"}`}const l=t.querySelector("#tage-liste");l&&(l.innerHTML=gn(n.slice().reverse()))}const dn=3,un=2.5;function gn(e){if(!e.length)return'<p class="hint">Keine Tage im Zeitraum.</p>';const t=[];let a=null;for(const n of e)(!a||a.key!==n.wocheKey)&&(a={key:n.wocheKey,tage:[]},t.push(a)),a.tage.push(n);return`<div class="tages-liste">${t.map(n=>hn(n)).join("")}</div>`}function hn(e){var c;const t=e.tage.reduce((d,h)=>d+(h.ist??0),0),a=e.tage.reduce((d,h)=>d+(h.diff??0),0),n=(c=e.tage[0])==null?void 0:c.datum,s=n?Ba(S(n)):"",r=e.key?e.key.split("-")[1]:"?",i=a>.05?"pos":a<-.05?"neg":"flat",l=(a>0?"+":"")+a.toFixed(2).replace(".",",")+"h",o=t.toFixed(2).replace(".",",")+"h";return`
    <div class="woche-group">
      ...
      <div class="woche-tage">
        ${e.tage.map(d=>fn(d)).join("")}
      </div>
    </div>
  `}function fn(e){const t=e.diff??0,a=t>0,n=a?dn:un,s=Math.min(150,Math.abs(t)/n*50),r=a?"var(--success)":t<0?"var(--danger)":"var(--fg-subtle)",i=ie(e.zeitSpannen);return`
    <a href="#/tag/${e.datum}" class="tag-row">
      <div class="tag-row-datum">
        <div class="tabular">${V(y(new Date(e.datum)))}</div>
        <div class="tag-row-wd">${vn(e.wochentag)}</div>
      </div>
      <div class="tag-row-typ">
        ${e.tagestyp?`<span class="pill ${bn(e.tagestyp)}">${V(e.tagestyp)}</span>`:'<span style="color: var(--fg-subtle); font-size: 12px;">—</span>'}
      </div>
  ...
  `}function mn(e){const t=e.schweregrad==="error"?"!":e.schweregrad==="warn"?"⚠":"i";return`
  ...
  `;const n=e.querySelector("#upload-zone"),s=e.querySelector("#file-input");n.addEventListener("click",()=>s.click()),n.addEventListener("dragover",r=>{r.preventDefault(),n.classList.add("drag")}),n.addEventListener("dragleave",()=>n.classList.remove("drag")),n.addEventListener("drop",async r=>{var l;r.preventDefault(),n.classList.remove("drag");const i=(l=r.dataTransfer.files)==null?void 0:l[0];i&&await Oe(i,e,a)}),s.addEventListener("change",async r=>{var l;const i=(l=r.target.files)==null?void 0:l[0];i&&await Oe(i,e,a)}),e.querySelector("#btn-export").addEventListener("click",Ln),e.querySelector("#btn-import").addEventListener("click",()=>e.querySelector("#import-input").click()),e.querySelector("#import-input").addEventListener("change",Kn),e.querySelector("#btn-clear-parsed").addEventListener("click",En),e.querySelector("#btn-reset").addEventListener("click",Wn)}async function En(){confirm("PDF-abgeleitete Daten (Tage, Monate, Uploads) werden gelöscht. Profil und Mail-Vorlagen bleiben erhalten. Fortfahren?")&&(await aa(),z("Daten gelöscht. Profil bleibt."),setTimeout(()=>location.reload(),600))}function st(e){return`
    <table class="table">
      <thead>
        <tr>
  ...
  `,e.querySelector("#profil-form").addEventListener("submit",async o=>{var h,u;o.preventDefault();const c=new FormData(o.target),d={...t,ueber18:c.get("ueber18")==="on",zeitwirtschaftEmail:((h=c.get("zeitwirtschaftEmail"))==null?void 0:h.trim())||"Zeitwirtschaft.Aichtal@putzmeister.com",zeitwirtschaftAnrede:((u=c.get("zeitwirtschaftAnrede"))==null?void 0:u.trim())||"Frau Kanarya"};await fe(d),z("Profil gespeichert.")})}function Be(e){return String(e??"").replace(/"/g,"&quot;")}async function Cn({root:e}){var s;const t=await Q(),a=await F(),n={};for(const r of a)n[s=r.monatKey]??(n[s]=[]),n[r.monatKey].push(r);if(t.length===0){e.innerHTML=jn("Noch keine Monatsdaten. Lade zuerst ein PDF unter Daten hoch.");return}e.innerHTML=`
  ...
  `,ve(t.querySelector("#chart-monat"),l)}function In(e){var n,s,r,i;const t=((n=e.glz)==null?void 0:n.saldoGesamt)??0;return`
      ...
      <tbody>
        ${e.map(t=>{const a=t.diff>.05?"positive":t.diff<-.05?"negative":"",n=ie(t.zeitSpannen);return`
            <tr>
              ...
              <td>${t.tagestyp?`<span class="pill ${Rn(t.tagestyp)}">${ae(t.tagestyp)}</span>`:"—"}</td>
              <td>${re(n,{size:18})}</td>
  ...
  `,ve(t.querySelector("#chart-woche"),s)}function Nn(e){return`
    <table class="table">
      <thead>
        <tr>
          <th>Datum</th>
      ...
      <tbody>
        ${e.map(t=>{const a=t.diff>.05?"positive":t.diff<-.05?"negative":"",n=ie(t.zeitSpannen);return`
            <tr>
              ...
              <td>${t.tagestyp?`<span class="pill ${Gn(t.tagestyp)}">${ne(t.tagestyp)}</span>`:"—"}</td>
              <td>${re(n,{size:18})}</td>
              <td class="num tabular">${t.ist!=null?t.ist.toFixed(2).replace(".",","):"—"}</td>
              <td class="num tabular">${t.soll!=null?t.soll.toFixed(2).replace(".",","):"—"}</td>
              <td class="num tabular ${a}">${t.diff!=null?A(t.diff,{signed:!0,suffix:""}):"—"}</td>
    ...
    <div class="grid cols-2" style="gap: 24px;">
      ...
      <div class="card">
        ...
        <div class="tag-detail">
          ...
          <div class="tag-detail-value">${n.tagestyp?`<span class="pill ${Jn(n.tagestyp)}">${Y(n.tagestyp)}</span>`:"—"}</div>
        </div>
        <div class="tag-detail">
  ...
  `}function Jn(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function Y(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}async function Un({root:e}){const[t,a]=await Promise.all([F(),Q()]);if(!t.length){e.innerHTML='<h1 class="view-title">Analytics</h1><p class="view-subtitle">Keine Daten.</p><a href="#/daten" class="btn primary">Zum Upload</a>';return}e.innerHTML=`
  ...
  `,requestAnimationFrame(()=>{Qa(e.querySelector("#c-saldo"),a),sn(e.querySelector("#c-istsoll"),t),rn(e.querySelector("#c-kumulativ"),t),en(e.querySelector("#c-startend"),t),an(e.querySelector("#c-wochentag"),t),tn(e.querySelector("#c-pausen"),t),nn(e.querySelector("#c-donut"),t);const n=t.slice(-30);ve(e.querySelector("#c-alle-tage"),n)})}async function Yn({root:e}){const t=await F();if(!t.length){e.innerHTML='<h1 class="view-title">Berichtsheft</h1><p class="view-subtitle">Keine Daten.</p><a href="#/daten" class="btn primary">Zum Upload</a>';return}const a=[...new Set(t.map(r=>r.monatKey))].sort().reverse();e.innerHTML=`
...
`);navigator.clipboard.writeText(i).then(()=>z(`${r.length} Zeilen kopiert.`))});function s(){const r=n.value,l=(r?t.filter(o=>o.monatKey===r):t).filter(o=>o.ist!=null&&o.ist>0&&o.tagestyp!=="Wochenende");e.querySelector("#liste").innerHTML=Xn(l),e.querySelectorAll(".copy-val").forEach(o=>{o.addEventListener("click",async()=>{const c=o.getAttribute("data-val");await navigator.clipboard.writeText(c),o.classList.add("ok");const d=o.textContent;o.textContent="✓ kopiert",setTimeout(()=>{o.classList.remove("ok"),o.textContent=d},1200)})})}s()}function Xn(e){return e.length?`
      ...
      <tbody>
        ${e.map(t=>{const a=I(t.ist),n=`${y(S(t.datum))}	${a}`;return`
            <tr data-copy="${Ie(n)}">
              ...
              <td>${t.tagestyp?`<span class="pill ${ts(t.tagestyp)}">${rt(t.tagestyp)}</span>`:"—"}</td>
  ...
  `:'<p style="color: var(--fg-muted);">Keine Tage in dieser Auswahl.</p>'}function Qn(e){return{MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"}[e]??e}function es(e){const[t,a]=e.split("-");return x(new Date(parseInt(t),parseInt(a)-1,1),"LLLL yyyy",{locale:ee})}function ts(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function rt(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Ie(e){return rt(e)}const as={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"},we={bs_tag_fehlt:{key:"bs_tag_fehlt",titel:"Berufsschultag fehlt",beschreibung:"Wenn ein Berufsschultag komplett nicht im Zeitnachweis eingetragen wurde.",betreff:"Bitte um Zeitkorrektur im ESS  - Fehlender Berufsschultag {datum}",text:`Guten Tag {zeitwirtschaft_anrede},
...
Vielen Dank!`}};function lt(e,t){const a=we[e];return a?{...a,...t??{}}:null}function ot(e,t){const a=Ve(e.text,t);return{betreff:Ve(e.betreff,t),text:a}}function Ve(e,t){return e.replace(/\{(\w+)\}/g,(a,n)=>t[n]!=null?String(t[n]):`{${n}}`)}function ns(e,t){const a=t.datum?new Date(t.datum):null;return{name:"",personalnr:"",kostenstelle:"",datum:a?Xe(a).split(", ")[1]:"",wochentag:as[t.wochentag]??t.wochentag??"",zeitwirtschaft_anrede:e.zeitwirtschaftAnrede||"Frau Kanarya",zeitwirtschaft_email:e.zeitwirtschaftEmail||"Zeitwirtschaft.Aichtal@putzmeister.com",ist:t.ist!=null?t.ist.toFixed(2).replace(".",","):"",soll:t.soll!=null?t.soll.toFixed(2).replace(".",","):"",abgezogen:t.abgezogen!=null?Math.round(t.abgezogen*60):"",gestempelt:t.gestempelt!=null?Math.round(t.gestempelt*60):"",verlust:t.verlustMinuten??""}}function ss(e,t,a){const n=ot(t,a),s=e.zeitwirtschaftEmail||"Zeitwirtschaft.Aichtal@putzmeister.com",r=new URLSearchParams;return r.set("subject",n.betreff),r.set("body",n.text),`mailto:${s}?${r.toString().replace(/\+/g,"%20")}`}async function is({root:e}){const[t,a,n,s]=await Promise.all([F(),R(),Q(),ia()]),r=Object.fromEntries(s.map(o=>[o.key,o])),i=pe(t,a,new Date).filter(o=>o.mailVorlageKey),l=nt(n);e.innerHTML=`
    ...
    <div class="card" style="margin-bottom: 24px;">
      ...
      ${i.length===0?'<div class="empty-state"><div class="empty-state-icon">✓</div><p>Keine akuten Warnungen — top.</p></div>':i.map(o=>rs(o,a,r)).join("")}
    ...
    <div class="card">
      ...
      <div id="vorlagen-editor">
        ${Object.keys(we).map(o=>{const c=lt(o,r[o]);return ls(c)}).join("")}
      </div>
    </div>
  `,os(e),cs(e)}function rs(e,t,a){const n=lt(e.mailVorlageKey,a[e.mailVorlageKey]);if(!n)return"";const s=ns(t,e),r=ot(n,s),i=ss(t,n,s);return`
