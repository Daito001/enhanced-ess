import{D as xt}from"./dexie-BODkcwel.js";import{b as me,a as U,c as Y,d as kt,f as z,e as Ye,i as Xe,s as $t,g as St,p as Mt,h as zt,j as Dt,k as Pt,l as $,m as At}from"./datefns-Dlft8rFK.js";import{C as E,L as Tt,B as Et,D as Lt,S as Kt,a as Ft,b as Wt,P as Bt,A as Ct,c as Ot,d as Vt,T as It,p as _t,e as jt,i as Rt}from"./chartjs-CRgZvhTJ.js";import{_ as Ht,a as Zt}from"./pdfjs-BDGsuRSB.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=a(s);fetch(s.href,i)}})();const ue="theme";function Nt(){const e=localStorage.getItem(ue)??"auto";xe(e)}function xe(e){e==="auto"?document.documentElement.removeAttribute("data-theme"):document.documentElement.setAttribute("data-theme",e),localStorage.setItem(ue,e),Jt(e)}function Gt(){const e=localStorage.getItem(ue)??"auto",t=e==="auto"?"light":e==="light"?"dark":"auto";return xe(t),Qe(t),t}const ve=new Set;function qt(e){return ve.add(e),()=>ve.delete(e)}function Qe(e){for(const t of ve)try{t(e)}catch(a){console.error(a)}}var Ue;if(typeof window<"u"&&window.matchMedia){const e=window.matchMedia("(prefers-color-scheme: dark)");(Ue=e.addEventListener)==null||Ue.call(e,"change",()=>{et()==="auto"&&Qe("auto")})}function Jt(e){const t=document.getElementById("theme-toggle");if(!t)return;const a=t.querySelector(".theme-label"),n=t.querySelector(".theme-icon-dark"),s=t.querySelector(".theme-icon-light");a&&(e==="auto"?(a.textContent="Auto",n&&(n.style.display="inline"),s&&(s.style.display="inline")):e==="light"?(a.textContent="Hell",n&&(n.style.display="none"),s&&(s.style.display="inline")):(a.textContent="Dunkel",n&&(n.style.display="inline"),s&&(s.style.display="none")))}function et(){return localStorage.getItem(ue)??"auto"}const tt=[];let at=null;function A(e,t){const a=e.split("/").filter(Boolean),n=[],s=new RegExp("^/?"+a.map(i=>i.startsWith(":")?(n.push(i.slice(1)),"([^/]+)"):ea(i)).join("/")+"/?$");tt.push({pattern:e,regex:s,paramNames:n,render:t})}function Ut(e){e.startsWith("#")||(e="#"+e),window.location.hash===e?K():window.location.hash=e}function Yt(e,{onNavigate:t}={}){window.addEventListener("hashchange",K),K.rootEl=e,K.onNavigate=t,K()}async function K(){var n;const e=K.rootEl,t=window.location.hash.slice(1)||"/",a=t.startsWith("/")?t:`/${t}`;for(const s of tt){const i=s.regex.exec(a);if(i){const r={};s.paramNames.forEach((l,o)=>r[l]=decodeURIComponent(i[o+1])),at=a,(n=K.onNavigate)==null||n.call(K,a),Xt(a);try{e.classList.remove("view-enter"),await s.render({params:r,path:a,root:e}),e.classList.add("view-enter")}catch(l){console.error("Route render error:",l),e.innerHTML=`<div class="empty-state">
          <div class="empty-state-icon">⚠</div>
          <h2>Fehler beim Anzeigen</h2>
          <p>${Ke(l.message||String(l))}</p>
        </div>`}return}}e.innerHTML=`<div class="empty-state">
    <div class="empty-state-icon">?</div>
    <h2>Seite nicht gefunden</h2>
    <p>Die Route <code>${Ke(a)}</code> existiert nicht.</p>
    <a href="#/" class="btn primary">Zum Dashboard</a>
  </div>`}function Xt(e){document.querySelectorAll("[data-route]").forEach(a=>{const n=a.getAttribute("data-route"),s=n==="/"?e==="/":e===n||e.startsWith(n+"/");a.classList.toggle("active",s)});const t=e==="/"?"dashboard":e.split("/").filter(Boolean)[0];document.body.setAttribute("data-view",t||"dashboard")}function Qt(){at!=null&&K()}function ea(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function Ke(e){return String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}const ta="modulepreload",aa=function(e){return"/zeitnachweis-app/"+e},Fe={},na=function(t,a,n){let s=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),l=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));s=Promise.allSettled(a.map(o=>{if(o=aa(o),o in Fe)return;Fe[o]=!0;const c=o.endsWith(".css"),d=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${d}`))return;const g=document.createElement("link");if(g.rel=c?"stylesheet":ta,c||(g.as="script"),g.crossOrigin="",g.href=o,l&&g.setAttribute("nonce",l),document.head.appendChild(g),c)return new Promise((u,h)=>{g.addEventListener("load",u),g.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${o}`)))})}))}function i(r){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=r,window.dispatchEvent(l),!l.defaultPrevented)throw r}return s.then(r=>{for(const l of r||[])l.status==="rejected"&&i(l.reason);return t().catch(i)})},m=new xt("zeitnachweis");m.version(1).stores({profil:"id",tage:"datum, wochentag, tagestyp, monatKey, wocheKey",monate:"monatKey",uploads:"++id, hochladeDatum, stichtagAuswertung",einstellungen:"key",mailVorlagen:"key",warnungDismissals:"key"});m.version(2).stores({profil:"id",tage:"datum, wochentag, tagestyp, monatKey, wocheKey",monate:"monatKey",uploads:"++id, hochladeDatum, stichtagAuswertung",einstellungen:"key",mailVorlagen:"key",warnungDismissals:"key"}).upgrade(async e=>{await e.table("tage").clear(),await e.table("monate").clear(),await e.table("uploads").clear(),await e.table("warnungDismissals").clear(),await e.table("einstellungen").put({key:"__migration_reset",value:!0})});m.version(3).stores({profil:"id",tage:"datum, wochentag, tagestyp, monatKey, wocheKey",monate:"monatKey",uploads:"++id, hochladeDatum, stichtagAuswertung",einstellungen:"key",mailVorlagen:"key",warnungDismissals:"key"}).upgrade(async e=>{await e.table("tage").clear(),await e.table("monate").clear(),await e.table("uploads").clear(),await e.table("warnungDismissals").clear(),await e.table("einstellungen").put({key:"__migration_reset",value:!0})});m.version(4).stores({profil:"id",tage:"datum, wochentag, tagestyp, monatKey, wocheKey",monate:"monatKey",uploads:"++id, hochladeDatum, stichtagAuswertung",einstellungen:"key",mailVorlagen:"key",warnungDismissals:"key"}).upgrade(async e=>{await e.table("mailVorlagen").clear()});m.version(5).stores({profil:"id",tage:"datum, wochentag, tagestyp, monatKey, wocheKey",monate:"monatKey",uploads:"++id, hochladeDatum, stichtagAuswertung",einstellungen:"key",mailVorlagen:"key",warnungDismissals:"key"}).upgrade(async e=>{const t=await e.table("profil").get("self");t&&(!t.zeitwirtschaftEmail||t.zeitwirtschaftEmail==="zeitwirtschaft@putzmeister.com")&&await e.table("profil").put({...t,zeitwirtschaftEmail:"Zeitwirtschaft.Aichtal@putzmeister.com"})});m.version(6).stores({profil:"id",tage:"datum, wochentag, tagestyp, monatKey, wocheKey",monate:"monatKey",uploads:"++id, hochladeDatum, stichtagAuswertung",einstellungen:"key",mailVorlagen:"key",warnungDismissals:"key"}).upgrade(async e=>{await e.table("mailVorlagen").clear()});m.version(7).stores({profil:"id",tage:"datum, wochentag, tagestyp, monatKey, wocheKey",monate:"monatKey",uploads:"++id, hochladeDatum, stichtagAuswertung",einstellungen:"key",mailVorlagen:"key",warnungDismissals:"key"}).upgrade(async e=>{const t=await e.table("profil").get("self");if(!t)return;let a=t.ueber18??!0;if(t.geburtsdatum){const s=new Date(t.geburtsdatum),i=new Date;a=i.getFullYear()-s.getFullYear()-(i<new Date(i.getFullYear(),s.getMonth(),s.getDate())?1:0)>=18}const n={id:"self",ueber18:a,sollStundenProWoche:t.sollStundenProWoche??35,sollStundenProTag:t.sollStundenProTag??7,berufsschulMuster:t.berufsschulMuster??{wochentageWoechentlich:[],wochentage14Taegig:[],referenzDatum14Taegig:null},zeitwirtschaftEmail:t.zeitwirtschaftEmail||"Zeitwirtschaft.Aichtal@putzmeister.com",zeitwirtschaftAnrede:t.zeitwirtschaftAnrede||"Frau Kanarya",pausenRegel:t.pausenRegel??"auto",erstelltAm:t.erstelltAm??new Date().toISOString(),updatedAt:new Date().toISOString()};await e.table("profil").put(n)});async function sa(){try{const{erkenneBerufsschulMuster:e}=await na(async()=>{const{erkenneBerufsschulMuster:r}=await Promise.resolve().then(()=>Ua);return{erkenneBerufsschulMuster:r}},void 0),t=await m.tage.toArray();if(!t.length)return!1;const a=e(t),n=await m.profil.get("self");if(!n)return!1;const s=n.berufsschulMuster??{};return JSON.stringify(s.wochentageWoechentlich??[])!==JSON.stringify(a.wochentageWoechentlich)||JSON.stringify(s.wochentage14Taegig??[])!==JSON.stringify(a.wochentage14Taegig)||(s.referenzDatum14Taegig??null)!==(a.referenzDatum14Taegig??null)||(s.stundenProTag??null)!==(a.stundenProTag??null)||(s.halbtags??!1)!==(a.halbtags??!1)?(await m.profil.put({...n,berufsschulMuster:a}),!0):!1}catch(e){return console.warn("[db] refreshBerufsschulMuster fehlgeschlagen:",e),!1}}async function ia(){try{const e=await m.mailVorlagen.toArray(),t=e.some(n=>n.betreff&&!n.betreff.startsWith("Bitte um Zeitkorrektur im ESS")),a=e.some(n=>n.text&&!/Vielen Dank!\s*$/.test(n.text));return t||a?(await m.mailVorlagen.clear(),!0):!1}catch(e){return console.warn("[db] ensureMailVorlagenFresh fehlgeschlagen:",e),!1}}async function ra(){const e=await m.einstellungen.get("__migration_reset");return(e==null?void 0:e.value)===!0?(await m.einstellungen.delete("__migration_reset"),!0):!1}async function _(){return await m.profil.get("self")??nt()}async function le(e){const t={...e,id:"self",updatedAt:new Date().toISOString()};return await m.profil.put(t),t}function nt(){return{id:"self",ueber18:!0,sollStundenProWoche:35,sollStundenProTag:7,berufsschulMuster:{wochentageWoechentlich:[],wochentage14Taegig:[],referenzDatum14Taegig:null,stundenProTag:null,halbtags:!1},zeitwirtschaftEmail:"Zeitwirtschaft.Aichtal@putzmeister.com",zeitwirtschaftAnrede:"Frau Kanarya",pausenRegel:"auto",erstelltAm:new Date().toISOString()}}async function la(e,t=null){const a=await m.einstellungen.get(e);return a?a.value:t}async function oa(e,t){await m.einstellungen.put({key:e,value:t})}async function B(){return await m.tage.orderBy("datum").toArray()}async function ca(e){return e.length?(await m.tage.bulkPut(e),e.length):0}async function da(e){return e.length?(await m.monate.bulkPut(e),e.length):0}async function ne(){return await m.monate.orderBy("monatKey").toArray()}async function ua(e){return await m.uploads.add({...e,hochladeDatum:new Date().toISOString()})}async function ke(){return await m.uploads.orderBy("hochladeDatum").last()}async function st(){return await m.uploads.orderBy("hochladeDatum").reverse().toArray()}async function ga(){await Promise.all([m.profil.clear(),m.tage.clear(),m.monate.clear(),m.uploads.clear(),m.einstellungen.clear(),m.mailVorlagen.clear(),m.warnungDismissals.clear()])}async function it(){await Promise.all([m.tage.clear(),m.monate.clear(),m.uploads.clear(),m.warnungDismissals.clear()])}async function ha(){const[e,t,a,n,s,i,r]=await Promise.all([m.profil.toArray(),m.tage.toArray(),m.monate.toArray(),m.uploads.toArray(),m.einstellungen.toArray(),m.mailVorlagen.toArray(),m.warnungDismissals.toArray()]);return{version:1,exportedAt:new Date().toISOString(),data:{profil:e,tage:t,monate:a,uploads:n,einstellungen:s,mailVorlagen:i,warnungDismissals:r}}}async function fa(e){if(!e||e.version!==1||!e.data)throw new Error("Ungültiges oder inkompatibles Backup-Format.");const t=e.data;await m.transaction("rw",m.profil,m.tage,m.monate,m.uploads,m.einstellungen,m.mailVorlagen,m.warnungDismissals,async()=>{var a,n,s,i,r,l,o;(a=t.profil)!=null&&a.length&&await m.profil.bulkPut(t.profil),(n=t.tage)!=null&&n.length&&await m.tage.bulkPut(t.tage),(s=t.monate)!=null&&s.length&&await m.monate.bulkPut(t.monate),(i=t.uploads)!=null&&i.length&&await m.uploads.bulkPut(t.uploads),(r=t.einstellungen)!=null&&r.length&&await m.einstellungen.bulkPut(t.einstellungen),(l=t.mailVorlagen)!=null&&l.length&&await m.mailVorlagen.bulkPut(t.mailVorlagen),(o=t.warnungDismissals)!=null&&o.length&&await m.warnungDismissals.bulkPut(t.warnungDismissals)})}async function oe(e,t){await m.mailVorlagen.put({key:e,...t})}async function $e(){return await m.mailVorlagen.toArray()}async function ma(e,t){await m.warnungDismissals.put({key:`${e}-${t}`,datum:e,typ:t,dismissedAt:new Date().toISOString()})}async function pa(){return await m.warnungDismissals.toArray()}function rt(e){if(e==null)return null;if(typeof e=="number")return e;let t=String(e).trim();if(!t)return null;let a=!1;t.endsWith("-")&&(a=!0,t=t.slice(0,-1).trim()),t=t.replace(",",".");const n=parseFloat(t);return isNaN(n)?null:a?-n:n}function N(e){if(e==null||isNaN(e))return"—";const t=e<0,a=Math.abs(e),n=Math.floor(a),s=Math.round((a-n)*60);let i=n,r=s;return r===60&&(i+=1,r=0),`${t?"-":""}${i}:${String(r).padStart(2,"0")}`}function D(e,t={}){if(e==null||isNaN(e))return"—";const{signed:a=!1,suffix:n="h"}=t,s=a&&e>0?"+":"",i=e.toFixed(2).replace(".",",");return`${s}${i}${n}`}function F(e){if(!e)return null;const t=/^(\d{1,2}):(\d{2})$/.exec(String(e).trim());return t?parseInt(t[1],10)*60+parseInt(t[2],10):null}function ge(e){if(!(e!=null&&e.length))return null;const t=e.filter(s=>s.von&&s.bis);if(!t.length)return null;let a=t[0].von,n=t[0].bis;for(const s of t)F(s.von)<F(a)&&(a=s.von),F(s.bis)>F(n)&&(n=s.bis);return{kommen:a,gehen:n}}function va(e=22){return`<svg class="kg-icon" width="${e}" height="${e}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
    <path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/>
    <polyline points="10 17 15 12 10 7"/>
    <line x1="15" y1="12" x2="3" y2="12"/>
  </svg>`}function ba(e=22){return`<svg class="kg-icon" width="${e}" height="${e}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
  ...
  `:'<span class="kg-empty">—</span>'}const We={lessThanXSeconds:{standalone:{one:"weniger als 1 Sekunde",other:"weniger als {{count}} Sekunden"},withPreposition:{one:"weniger als 1 Sekunde",other:"weniger als {{count}} Sekunden"}},xSeconds:{standalone:{one:"1 Sekunde",other:"{{count}} Sekunden"},withPreposition:{one:"1 Sekunde",other:"{{count}} Sekunden"}},halfAMinute:{standalone:"eine halbe Minute",withPreposition:"einer halben Minute"},lessThanXMinutes:{standalone:{one:"weniger als 1 Minute",other:"weniger als {{count}} Minuten"},withPreposition:{one:"weniger als 1 Minute",other:"weniger als {{count}} Minuten"}},xMinutes:{standalone:{one:"1 Minute",other:"{{count}} Minuten"},withPreposition:{one:"1 Minute",other:"{{count}} Minuten"}},aboutXHours:{standalone:{one:"etwa 1 Stunde",other:"etwa {{count}} Stunden"},withPreposition:{one:"etwa 1 Stunde",other:"etwa {{count}} Stunden"}},xHours:{standalone:{one:"1 Stunde",other:"{{count}} Stunden"},withPreposition:{one:"1 Stunde",other:"{{count}} Stunden"}},xDays:{standalone:{one:"1 Tag",other:"{{count}} Tage"},withPreposition:{one:"1 Tag",other:"{{count}} Tagen"}},aboutXWeeks:{standalone:{one:"etwa 1 Woche",other:"etwa {{count}} Wochen"},withPreposition:{one:"etwa 1 Woche",other:"etwa {{count}} Wochen"}},xWeeks:{standalone:{one:"1 Woche",other:"{{count}} Wochen"},withPreposition:{one:"1 Woche",other:"{{count}} Wochen"}},aboutXMonths:{standalone:{one:"etwa 1 Monat",other:"etwa {{count}} Monate"},withPreposition:{one:"etwa 1 Monat",other:"etwa {{count}} Monaten"}},xMonths:{standalone:{one:"1 Monat",other:"{{count}} Monate"},withPreposition:{one:"1 Monat",other:"{{count}} Monaten"}},aboutXYears:{standalone:{one:"etwa 1 Jahr",other:"etwa {{count}} Jahre"},withPreposition:{one:"etwa 1 Jahr",other:"etwa {{count}} Jahren"}},xYears:{standalone:{one:"1 Jahr",other:"{{count}} Jahre"},withPreposition:{one:"1 Jahr",other:"{{count}} Jahren"}},overXYears:{standalone:{one:"mehr als 1 Jahr",other:"mehr als {{count}} Jahre"},withPreposition:{one:"mehr als 1 Jahr",other:"mehr als {{count}} Jahren"}},almostXYears:{standalone:{one:"fast 1 Jahr",other:"fast {{count}} Jahre"},withPreposition:{one:"fast 1 Jahr",other:"fast {{count}} Jahren"}}},ya=(e,t,a)=>{let n;const s=a!=null&&a.addSuffix?We[e].withPreposition:We[e].standalone;return typeof s=="string"?n=s:t===1?n=s.one:n=s.other.replace("{{count}}",String(t)),a!=null&&a.addSuffix?a.comparison&&a.comparison>0?"in "+n:"vor "+n:n},wa={full:"EEEE, do MMMM y",long:"do MMMM y",medium:"do MMM y",short:"dd.MM.y"},xa={full:"HH:mm:ss zzzz",long:"HH:mm:ss z",medium:"HH:mm:ss",short:"HH:mm"},ka={full:"{{date}} 'um' {{time}}",long:"{{date}} 'um' {{time}}",medium:"{{date}} {{time}}",short:"{{date}} {{time}}"},$a={date:me({formats:wa,defaultWidth:"full"}),time:me({formats:xa,defaultWidth:"full"}),dateTime:me({formats:ka,defaultWidth:"full"})},Sa={lastWeek:"'letzten' eeee 'um' p",yesterday:"'gestern um' p",today:"'heute um' p",tomorrow:"'morgen um' p",nextWeek:"eeee 'um' p",other:"P"},Ma=(e,t,a,n)=>Sa[e],za={narrow:["v.Chr.","n.Chr."],abbreviated:["v.Chr.","n.Chr."],wide:["vor Christus","nach Christus"]},Da={narrow:["1","2","3","4"],abbreviated:["Q1","Q2","Q3","Q4"],wide:["1. Quartal","2. Quartal","3. Quartal","4. Quartal"]},be={narrow:["J","F","M","A","M","J","J","A","S","O","N","D"],abbreviated:["Jan","Feb","Mär","Apr","Mai","Jun","Jul","Aug","Sep","Okt","Nov","Dez"],wide:["Januar","Februar","März","April","Mai","Juni","Juli","August","September","Oktober","November","Dezember"]},Pa={narrow:be.narrow,abbreviated:["Jan.","Feb.","März","Apr.","Mai","Juni","Juli","Aug.","Sep.","Okt.","Nov.","Dez."],wide:be.wide},Aa={narrow:["S","M","D","M","D","F","S"],short:["So","Mo","Di","Mi","Do","Fr","Sa"],abbreviated:["So.","Mo.","Di.","Mi.","Do.","Fr.","Sa."],wide:["Sonntag","Montag","Dienstag","Mittwoch","Donnerstag","Freitag","Samstag"]},Ta={narrow:{am:"vm.",pm:"nm.",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachm.",evening:"Abend",night:"Nacht"},abbreviated:{am:"vorm.",pm:"nachm.",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachmittag",evening:"Abend",night:"Nacht"},wide:{am:"vormittags",pm:"nachmittags",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachmittag",evening:"Abend",night:"Nacht"}},Ea={narrow:{am:"vm.",pm:"nm.",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachm.",evening:"abends",night:"nachts"},abbreviated:{am:"vorm.",pm:"nachm.",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachmittags",evening:"abends",night:"nachts"},wide:{am:"vormittags",pm:"nachmittags",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachmittags",evening:"abends",night:"nachts"}},La=e=>Number(e)+".",Ka={ordinalNumber:La,era:U({values:za,defaultWidth:"wide"}),quarter:U({values:Da,defaultWidth:"wide",argumentCallback:e=>e-1}),month:U({values:be,formattingValues:Pa,defaultWidth:"wide"}),day:U({values:Aa,defaultWidth:"wide"}),dayPeriod:U({values:Ta,defaultWidth:"wide",formattingValues:Ea,defaultFormattingWidth:"wide"})},Fa=/^(\d+)(\.)?/i,Wa=/\d+/i,Ba={narrow:/^(v\.? ?Chr\.?|n\.? ?Chr\.?)/i,abbreviated:/^(v\.? ?Chr\.?|n\.? ?Chr\.?)/i,wide:/^(vor Christus|vor unserer Zeitrechnung|nach Christus|unserer Zeitrechnung)/i},Ca={any:[/^v/i,/^n/i]},Oa={narrow:/^[1234]/i,abbreviated:/^q[1234]/i,wide:/^[1234](\.)? Quartal/i},Va={any:[/1/i,/2/i,/3/i,/4/i]},Ia={narrow:/^[jfmasond]/i,abbreviated:/^(j[aä]n|feb|mär[z]?|apr|mai|jun[i]?|jul[i]?|aug|sep|okt|nov|dez)\.?/i,wide:/^(januar|februar|märz|april|mai|juni|juli|august|september|oktober|november|dezember)/i},_a={narrow:[/^j/i,/^f/i,/^m/i,/^a/i,/^m/i,/^j/i,/^j/i,/^a/i,/^s/i,/^o/i,/^n/i,/^d/i],any:[/^j[aä]/i,/^f/i,/^mär/i,/^ap/i,/^mai/i,/^jun/i,/^jul/i,/^au/i,/^s/i,/^o/i,/^n/i,/^d/i]},ja={narrow:/^[smdmf]/i,short:/^(so|mo|di|mi|do|fr|sa)/i,abbreviated:/^(son?|mon?|die?|mit?|don?|fre?|sam?)\.?/i,wide:/^(sonntag|montag|dienstag|mittwoch|donnerstag|freitag|samstag)/i},Ra={any:[/^so/i,/^mo/i,/^di/i,/^mi/i,/^do/i,/^f/i,/^sa/i]},Ha={narrow:/^(vm\.?|nm\.?|Mitternacht|Mittag|morgens|nachm\.?|abends|nachts)/i,abbreviated:/^(vorm\.?|nachm\.?|Mitternacht|Mittag|morgens|nachm\.?|abends|nachts)/i,wide:/^(vormittags|nachmittags|Mitternacht|Mittag|morgens|nachmittags|abends|nachts)/i},Za={any:{am:/^v/i,pm:/^n/i,midnight:/^Mitte/i,noon:/^Mitta/i,morning:/morgens/i,afternoon:/nachmittags/i,evening:/abends/i,night:/nachts/i}},Na={ordinalNumber:kt({matchPattern:Fa,parsePattern:Wa,valueCallback:e=>parseInt(e)}),era:Y({matchPatterns:Ba,defaultMatchWidth:"wide",parsePatterns:Ca,defaultParseWidth:"any"}),quarter:Y({matchPatterns:Oa,defaultMatchWidth:"wide",parsePatterns:Va,defaultParseWidth:"any",valueCallback:e=>e+1}),month:Y({matchPatterns:Ia,defaultMatchWidth:"wide",parsePatterns:_a,defaultParseWidth:"any"}),day:Y({matchPatterns:ja,defaultMatchWidth:"wide",parsePatterns:Ra,defaultParseWidth:"any"}),dayPeriod:Y({matchPatterns:Ha,defaultMatchWidth:"wide",parsePatterns:Za,defaultParseWidth:"any"})},se={code:"de",formatDistance:ya,formatLong:$a,formatRelative:Ma,localize:Ka,match:Na,options:{weekStartsOn:1,firstWeekContainsDate:4}};function te(e){if(!e)return null;const t=e.trim();return Mt(t,"dd.MM.yyyy",new Date)}function w(e){return z(e,"dd.MM.yyyy")}function lt(e){return z(e,"EE, dd.MM.yyyy",{locale:se})}function ot(e){const t=$t(e,{weekStartsOn:1}),a=St(e,{weekStartsOn:1});return`${z(t,"dd.MM.")} – ${z(a,"dd.MM.yyyy")}`}function Ga(e){return`${zt(e)}-${String(Dt(e)).padStart(2,"0")}`}function ct(e){return z(e,"yyyy-MM")}function qa(e){return z(e,"yyyy-MM-dd")}function Ja(e,t){if(!e||!t)return 0;e>t&&([e,t]=[t,e]);let a=0,n=new Date(e);for(;n<t;)n=Ye(n,1),Xe(n)||a++;return a}function W(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function dt(e){var d;const t=e.filter(g=>g.tagestyp==="Berufsschule");if(t.length<2)return{wochentageWoechentlich:[],wochentage14Taegig:[],referenzDatum14Taegig:null,stundenProTag:null,halbtags:!1};const a={};for(const g of t)a[d=g.wochentag]??(a[d]=[]),a[g.wochentag].push(g);const n=[],s=[];let i=null;for(const[g,u]of Object.entries(a)){if(u.sort((p,y)=>p.datum.localeCompare(y.datum)),u.length<2)continue;const h=[];for(let p=1;p<u.length;p++)h.push(Pt($(u[p].datum),$(u[p-1].datum)));const f=Be(h);f<=10?n.push(g):f<=18&&(s.push(g),(!i||$(u[0].datum)<$(i))&&(i=u[0].datum))}const r=t.map(g=>g.ist).filter(g=>g!=null&&g>0),l=Be(r),o=l!=null?Math.round(l*4)/4:null,c=o!=null&&o<5;return{wochentageWoechentlich:n,wochentage14Taegig:s,referenzDatum14Taegig:i,stundenProTag:o,halbtags:c}}function Be(e){if(!e.length)return null;const t=e.slice().sort((n,s)=>n-s),a=Math.floor(t.length/2);return t.length%2?t[a]:(t[a-1]+t[a])/2}function Se(e,t){var s,i;if(!t)return!1;const n=["SO","MO","DI","MI","DO","FR","SA"][e.getDay()];if((s=t.wochentageWoechentlich)!=null&&s.includes(n))return!0;if((i=t.wochentage14Taegig)!=null&&i.includes(n)&&t.referenzDatum14Taegig){const r=$(t.referenzDatum14Taegig),l=At(e,r,{weekStartsOn:1});if(l>=0&&l%2===0)return!0}return!1}function ut(e,t=null){return(e==null?void 0:e.stundenProTag)!=null&&e.stundenProTag>0?e.stundenProTag:t}const Ua=Object.freeze(Object.defineProperty({__proto__:null,erkenneBerufsschulMuster:dt,erwarteteBerufsschulStunden:ut,istBerufsschulTagLautMuster:Se},Symbol.toStringTag,{value:"Module"}));function Ya(e){return e?"arbzg":"jarbschg"}function Xa(e,t){return e==null?0:t==="jarbschg"?e>6?1:e>4.5?.5:0:e>9?.75:e>6?.5:0}function gt(e){if(!e||e.length<2)return 0;const t=e.filter(n=>n.von&&n.bis).map(n=>({von:F(n.von),bis:F(n.bis)})).filter(n=>n.von!=null&&n.bis!=null).sort((n,s)=>n.von-s.von);let a=0;for(let n=1;n<t.length;n++){const s=t[n].von-t[n-1].bis;(s>0&&s>=15||s>0)&&(a+=s)}return a/60}function ht(e,t){const a=e.zeitSpannen??[];if(!a.length||a.every(f=>!f.von))return{keinAnspruch:!0};const n=gt(a),s=e.pause??0,i=Qa(a),r=i-s,l=t.pausenRegel&&t.pausenRegel!=="auto"?t.pausenRegel==="jarbschg"?"jarbschg":"arbzg":Ya(!!t.ueber18),o=Xa(r,l),c=Math.max(n,o),d=s-c,g=Math.max(0,o-n);let u="ok",h=null;if(d>.05)u="fehler_zeitwirtschaft",h=`${Math.round(d*60)} min Pause wurden zusätzlich zur gesetzlichen Pflicht und zur gestempelten Pause abgezogen. Das sieht nach einem Zeitwirtschafts-Fehler aus.`;else if(g>.05&&s>n+.02){u="aufstockung_legal";const f=Math.round(g*60);h=`Du hast ${Math.round(n*60)} min Pause gestempelt, aber bei ${r.toFixed(2).replace(".",",")}h Arbeitszeit schreibt das Gesetz (${l.toUpperCase()}) ${Math.round(o*60)} min vor. Die fehlenden ${f} min wurden automatisch als Pause gewertet. Das ist gesetzeskonform — nächstes Mal einfach länger Pause machen.`}return{arbeitszeitMitPause:i,arbeitszeitOhnePause:r,gestempeltePause:n,abgezogenePause:s,gesetzlichePflicht:o,gesetz:l,legalerAbzug:c,unrechtmaessigerVerlustMin:Math.round(Math.max(0,d)*60),aufstockungMin:Math.round(Math.max(0,g)*60),typ:u,warnung:h}}function Qa(e){let t=0;for(const a of e){if(!a.von||!a.bis)continue;const n=F(a.von),s=F(a.bis);n!=null&&s!=null&&s>n&&(t+=s-n)}return t/60}const X={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"};function Me(e,t,a,n=new Set){var d,g;const s=[],i=a??new Date,r=new Map(e.map(u=>[u.datum,u]));if(!e.length)return s;const l=$(e[0].datum),o=i;for(let u=new Date(l);u<=o;u=Ye(u,1)){if(Xe(u))continue;const h=z(u,"yyyy-MM-dd"),f=r.get(h),p=Ja(u,o);if(!f||!f.tagestyp&&!f.ist&&(((d=f.zeitSpannen)==null?void 0:d.length)??0)===0){if(Se(u,t.berufsschulMuster)){const v=p>=4?"error":p>=2?"warn":"info";Q(s,n,{datum:h,wochentag:(f==null?void 0:f.wochentag)??ie(u),typ:"bs_tag_fehlt",schweregrad:v,titel:`Berufsschultag nicht eingetragen: ${w(u)}`,beschreibung:`Laut deinem Profil hast du am ${X[ie(u)]}, ${w(u)} Berufsschule. Im Zeitnachweis fehlt der Tag bisher${p>=4?" — bitte bei der Zeitwirtschaft nachhaken":""}.`,alter:p,mailVorlageKey:v==="error"?"bs_tag_fehlt":null})}else{const v=p>=4?"error":p>=2?"warn":"info";Q(s,n,{datum:h,wochentag:ie(u),typ:"stempelzeit_fehlt",schweregrad:v,titel:`Keine Stempelzeit am ${w(u)}`,beschreibung:`Am ${X[ie(u)]}, ${w(u)} wurde keine Stempelzeit erfasst. Falls du an diesem Tag im Haus warst, sollte die Zeitwirtschaft das nachtragen${p>=4?" — es ist inzwischen ≥4 Werktage her":""}.`,alter:p,mailVorlageKey:v==="error"?"stempelzeit_fehlt":null})}continue}if(f.tagestyp==="Berufsschule"&&f.ist!=null){const v=ut(t.berufsschulMuster,f.soll);v!=null&&f.ist<v-.5&&Q(s,n,{datum:h,wochentag:f.wochentag,typ:"bs_stunden_falsch",schweregrad:"error",titel:`Berufsschultag mit zu wenig Stunden: ${w(u)}`,beschreibung:`Am ${X[f.wochentag]}, ${w(u)} sind nur ${f.ist.toFixed(2).replace(".",",")}h gebucht statt der für dich üblichen ${v.toFixed(2).replace(".",",")}h. Die Zeitwirtschaft hat den Berufsschultag möglicherweise nur halb erfasst.`,ist:f.ist,soll:v,mailVorlageKey:"bs_stunden_falsch"})}if(f.tagestyp==="Stempelzeit"&&((g=f.zeitSpannen)==null?void 0:g.length)>1&&h>="2026-04-01"){const v=ht(f,t);(v==null?void 0:v.typ)==="fehler_zeitwirtschaft"&&v.unrechtmaessigerVerlustMin>=5?Q(s,n,{datum:h,wochentag:f.wochentag,typ:"pausen_abzug",schweregrad:v.unrechtmaessigerVerlustMin>=15?"error":"warn",titel:`Pausen-Abzug fehlerhaft (${w(u)})`,beschreibung:`Am ${X[f.wochentag]}, ${w(u)} wurden ${Math.round(v.abgezogenePause*60)} min Pause abgezogen. Gestempelt: ${Math.round(v.gestempeltePause*60)} min, gesetzlich nötig (${v.gesetz.toUpperCase()}): ${Math.round(v.gesetzlichePflicht*60)} min. Differenz von ${v.unrechtmaessigerVerlustMin} min ist unerklärlich.`,verlustMinuten:v.unrechtmaessigerVerlustMin,abgezogen:v.abgezogenePause,gestempelt:v.gestempeltePause,mailVorlageKey:"pausen_abzug"}):(v==null?void 0:v.typ)==="aufstockung_legal"&&v.aufstockungMin>=10&&Q(s,n,{datum:h,wochentag:f.wochentag,typ:"pausen_aufstockung",schweregrad:"info",titel:`Zu wenig Pause gestempelt (${w(u)}) — ${v.aufstockungMin} min automatisch aufgestockt`,beschreibung:`Am ${X[f.wochentag]}, ${w(u)} hast du nur ${Math.round(v.gestempeltePause*60)} min Pause gemacht. Gesetz (${v.gesetz.toUpperCase()}) schreibt ${Math.round(v.gesetzlichePflicht*60)} min vor. Fehlende ${v.aufstockungMin} min wurden als Pause gewertet — das ist legal, aber du verlierst dadurch Arbeitszeit. Tipp: mach beim nächsten Mal etwas länger Mittag.`})}}const c={error:0,warn:1,info:2};return s.sort((u,h)=>{const f=c[u.schweregrad]-c[h.schweregrad];return f!==0?f:h.datum.localeCompare(u.datum)}),s}function ft(e,t=new Set){var n,s,i,r;const a=[];for(const l of e){const o=((n=l.glz)==null?void 0:n.saldoVorperiode)??0,c=((s=l.glz)==null?void 0:s.saldoAktuellePeriode)??0,d=((i=l.glz)==null?void 0:i.umgebuchteStunden)??0,g=(r=l.glz)==null?void 0:r.saldoGesamt;if(g==null)continue;const u=o+c+d,h=Math.abs(g-u);if(h>.03){const f=`${l.monatKey}-saldo_plausi`;t.has(f)||a.push({datum:`${l.monatKey}-01`,wochentag:"",typ:"saldo_plausi",schweregrad:"warn",titel:`Saldo-Differenz im Monat ${l.monatKey}`,beschreibung:`Rechnung: Vorperiode ${o.toFixed(2)} + aktuelle Periode ${c.toFixed(2)} + umgebucht ${d.toFixed(2)} = ${u.toFixed(2)}, aber dein Saldo wird mit ${g.toFixed(2)} angezeigt. Abweichung: ${h.toFixed(2)}h.`,soll:u,ist:g})}}return a}function Q(e,t,a){const n=`${a.datum}-${a.typ}`;t.has(n)||(a.id=n,e.push(a))}function ie(e){return["SO","MO","DI","MI","DO","FR","SA"][e.getDay()]}function en(e,t){var o,c,d;const a=[...e].sort((g,u)=>g.datum.localeCompare(u.datum));if(!a.length)return[];const n=new Map(t.map(g=>[g.monatKey,g])),s={};for(const g of a)s[o=g.monatKey]??(s[o]=[]),s[g.monatKey].push(g);const i=Object.keys(s).sort(),r=[];let l=null;for(const g of i){const u=n.get(g);let h;((c=u==null?void 0:u.glz)==null?void 0:c.saldoVorperiode)!=null?h=u.glz.saldoVorperiode:l!=null?h=l:h=0;const f=s[g];for(const p of f)p.diff!=null&&(h+=p.diff),r.push({datum:p.datum,wochentag:p.wochentag,saldo:Math.round(h*100)/100,diff:p.diff,ist:p.ist,soll:p.soll,tagestyp:p.tagestyp,monatKey:p.monatKey,wocheKey:p.wocheKey,zeitSpannen:p.zeitSpannen});if(((d=u==null?void 0:u.glz)==null?void 0:d.saldoGesamt)!=null){const p=u.glz.saldoGesamt-h;if(Math.abs(p)>.02&&r.length>0){const y=r.length-1;r[y].umbuchung=p,r[y].saldo=Math.round((r[y].saldo+p)*100)/100,h=r[y].saldo}l=u.glz.saldoGesamt}else l=h}return r}function tn(e,t){if(!e.length)return[];if(t==="alles")return e;const a=Math.min(t,e.length);return e.slice(-a)}function an(e){return e.length?e[e.length-1].saldo:0}function nn(e){if(!e.length)return 0;const t=e[0].saldo-(e[0].diff??0),a=e[e.length-1].saldo;return Math.round((a-t)*100)/100}const sn={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"},ae={bs_tag_fehlt:{key:"bs_tag_fehlt",titel:"Berufsschultag fehlt",beschreibung:"Wenn ein Berufsschultag komplett nicht im Zeitnachweis eingetragen wurde.",betreff:"Bitte um Zeitkorrektur im ESS  - Fehlender Berufsschultag {datum}",text:`Guten Tag {zeitwirtschaft_anrede},
...
Vielen Dank!`}};function fe(e,t){const a=ae[e];return a?{...a,...t??{}}:null}function mt(e,t){const a=Ce(e.text,t);return{betreff:Ce(e.betreff,t),text:a}}function Ce(e,t){return e.replace(/\{(\w+)\}/g,(a,n)=>t[n]!=null?String(t[n]):`{${n}}`)}function pt(e,t){const a=t.datum?new Date(t.datum):null;return{name:"",personalnr:"",kostenstelle:"",datum:a?lt(a).split(", ")[1]:"",wochentag:sn[t.wochentag]??t.wochentag??"",zeitwirtschaft_anrede:e.zeitwirtschaftAnrede||"Frau Kanarya",zeitwirtschaft_email:e.zeitwirtschaftEmail||"Zeitwirtschaft.Aichtal@putzmeister.com",ist:t.ist!=null?t.ist.toFixed(2).replace(".",","):"",soll:t.soll!=null?t.soll.toFixed(2).replace(".",","):"",abgezogen:t.abgezogen!=null?Math.round(t.abgezogen*60):"",gestempelt:t.gestempelt!=null?Math.round(t.gestempelt*60):"",verlust:t.verlustMinuten??""}}function vt(e,t,a){const n=mt(t,a),s=e.zeitwirtschaftEmail||"Zeitwirtschaft.Aichtal@putzmeister.com",i=new URLSearchParams;return i.set("subject",n.betreff),i.set("body",n.text),`mailto:${s}?${i.toString().replace(/\+/g,"%20")}`}E.register(Tt,Et,Lt,Kt,Ft,Wt,Bt,Ct,Ot,Vt,It,_t,jt,Rt);function k(e){return getComputedStyle(document.documentElement).getPropertyValue(e).trim()}function C(){return{fg:k("--fg"),fgMuted:k("--fg-muted"),fgSubtle:k("--fg-subtle"),border:k("--border"),surface:k("--surface"),accent:k("--accent"),success:k("--success"),warn:k("--warn"),danger:k("--danger"),info:k("--info"),palette:[k("--chart-1"),k("--chart-2"),k("--chart-3"),k("--chart-4"),k("--chart-5"),k("--chart-6"),k("--chart-7")]}}function x(e){return{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{labels:{color:e.fgMuted,font:{size:12}}},tooltip:{backgroundColor:e.surface,titleColor:e.fg,bodyColor:e.fg,borderColor:e.border,borderWidth:1,padding:10,displayColors:!0}},scales:{x:{ticks:{color:e.fgMuted,font:{size:11}},grid:{color:e.border,drawBorder:!1}},y:{ticks:{color:e.fgMuted,font:{size:11}},grid:{color:e.border,drawBorder:!1}}}}}function rn(e,t){const a=C();if(O(e),!(t!=null&&t.length))return;const n=t.map(i=>z($(i.datum),"dd.MM.")),s=t.map(i=>i.saldo);return s.map(i=>i>=0?a.success:a.danger),new E(e,{type:"line",data:{labels:n,datasets:[{label:"Tages-Saldo",data:s,borderColor:a.accent,backgroundColor:i=>{const r=i.chart,{ctx:l,chartArea:o,scales:c}=r;return o?mn(l,o,c.y,a):V(a.accent,.14)},segment:{borderColor:i=>{const r=i.p0.parsed.y,l=i.p1.parsed.y,o=(r+l)/2;return o>=.02?a.success:o<=-.02?a.danger:a.fgMuted}},tension:.25,pointRadius:2,pointHoverRadius:6,pointHitRadius:20,pointBackgroundColor:s.map(i=>i>=.02?a.success:i<=-.02?a.danger:a.fgMuted),pointBorderColor:a.surface,pointBorderWidth:1,fill:!0,borderWidth:2}]},options:{...x(a),interaction:{mode:"index",intersect:!1,axis:"x"},hover:{mode:"index",intersect:!1,axis:"x"},plugins:{...x(a).plugins,legend:{display:!1},tooltip:{enabled:!1,mode:"index",intersect:!1,axis:"x",position:"nearest",external:ln(t)}},scales:{...x(a).scales,y:{...x(a).scales.y,ticks:{...x(a).scales.y.ticks,callback:i=>`${i>=0?"+":""}${i.toFixed(1).replace(".",",")}h`}}}}})}function ln(e){return function(t){var q;const{chart:a,tooltip:n}=t;let s=a.$saldoTooltipEl;if(!s){s=document.createElement("div"),s.className="saldo-tooltip",document.body.appendChild(s),a.$saldoTooltipEl=s;const Z=a.destroy.bind(a);a.destroy=function(){s.parentNode&&s.parentNode.removeChild(s),Z()}}if(n.opacity===0||!((q=n.dataPoints)!=null&&q.length)){s.style.opacity="0";return}const i=n.dataPoints[0].dataIndex,r=e[i];if(!r){s.style.opacity="0";return}const l=r.saldo>.05?"pos":r.saldo<-.05?"neg":"flat",o=(r.diff??0)>.05?"pos":(r.diff??0)<-.05?"neg":"flat",c=(r.saldo>0?"+":"")+r.saldo.toFixed(2).replace(".",",")+"h",d=r.diff!=null?(r.diff>0?"+":"")+r.diff.toFixed(2).replace(".",",")+"h":null;let u=`<div class="saldo-tooltip-title">${Oe(z($(r.datum),"EE, dd.MM.yyyy",{locale:se}))}</div>`;u+=`<div class="saldo-tooltip-row"><span class="saldo-tooltip-label">Saldo</span><span class="saldo-tooltip-value ${l}">${c}</span></div>`,d&&(u+=`<div class="saldo-tooltip-row"><span class="saldo-tooltip-label">Tages-Diff</span><span class="saldo-tooltip-value ${o}">${d}</span></div>`);const h=[];r.tagestyp&&h.push(`Typ: ${Oe(r.tagestyp)}`),r.umbuchung&&h.push(`Umbuchung: ${r.umbuchung>=0?"+":""}${r.umbuchung.toFixed(2).replace(".",",")}h`),h.length&&(u+=`<div class="saldo-tooltip-meta">${h.map(Z=>`<span>${Z}</span>`).join("")}</div>`),s.innerHTML=u;const f=a.canvas.getBoundingClientRect(),p=f.left+n.caretX,y=f.top+n.caretY;s.style.opacity="0",s.style.left="0px",s.style.top="0px";const v=s.offsetWidth,P=s.offsetHeight,H=18;let j=p+H;j+v>window.innerWidth-8&&(j=p-H-v);let L=y-P/2;L<8&&(L=8),L+P>window.innerHeight-8&&(L=window.innerHeight-P-8),s.style.left=j+"px",s.style.top=L+"px",s.style.opacity="1"}}function Oe(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function on(e,t){const a=C();if(O(e),!(t!=null&&t.length))return;const n=t.map(i=>i.monatKey),s=t.map(i=>{var r;return((r=i.glz)==null?void 0:r.saldoGesamt)??0});return new E(e,{type:"line",data:{labels:n,datasets:[{label:"GLZ-Saldo (Monatsende)",data:s,borderColor:a.accent,backgroundColor:V(a.accent,.18),tension:.35,fill:!0,pointRadius:4}]},options:x(a)})}function ze(e,t){const a=C();if(O(e),!(t!=null&&t.length))return;const n=t.map(r=>z($(r.datum),"dd.MM.")),s=t.map(r=>r.ist??0),i=t.map(r=>pn(r.tagestyp,a));return new E(e,{type:"bar",data:{labels:n,datasets:[{label:"Ist-Stunden",data:s,backgroundColor:i,borderRadius:4,borderSkipped:!1}]},options:{...x(a),plugins:{...x(a).plugins,legend:{display:!1},tooltip:{...x(a).plugins.tooltip,callbacks:{label:r=>{const l=t[r.dataIndex];return`${l.tagestyp??"—"}: ${(l.ist??0).toFixed(2).replace(".",",")}h`}}}},scales:{...x(a).scales,y:{...x(a).scales.y,suggestedMin:0,suggestedMax:10}}}})}function cn(e,t){const a=C();if(O(e),!(t!=null&&t.length))return;const n=t.filter(c=>{var d;return((d=c.zeitSpannen)==null?void 0:d.length)&&c.zeitSpannen.some(g=>g.von&&g.bis)}).map(c=>{const d=c.zeitSpannen.filter(h=>h.von&&h.bis).map(h=>({von:F(h.von),bis:F(h.bis),vonStr:h.von,bisStr:h.bis})).filter(h=>h.von!=null&&h.bis!=null);if(d.length===0)return null;const g=Math.min(...d.map(h=>h.von)),u=Math.max(...d.map(h=>h.bis));return{...c,_spans:d,_minVon:g,_maxBis:u}}).filter(Boolean);if(!n.length)return;const s=c=>c.ist==null?a.fgMuted:c.ist>=7?a.success:a.danger,i={label:"Tages-Rahmen",data:n.map(c=>[c._minVon,c._maxBis]),backgroundColor:n.map(s),borderColor:n.map(s),borderWidth:0,borderRadius:4,borderSkipped:!1,barPercentage:.75,categoryPercentage:.95},r=Math.max(0,Math.floor(Math.min(...n.map(c=>c._minVon))/60)*60-60),l=Math.min(24*60,Math.ceil(Math.max(...n.map(c=>c._maxBis))/60)*60+60),o=c=>`${String(Math.floor(c/60)).padStart(2,"0")}:${String(c%60).padStart(2,"0")}`;return new E(e,{type:"bar",data:{labels:n.map(c=>z($(c.datum),"dd.MM.")),datasets:[i]},options:{...x(a),interaction:{mode:"index",intersect:!1,axis:"x"},plugins:{legend:{display:!1},tooltip:{enabled:!0,backgroundColor:a.surface,borderColor:a.accent,borderWidth:2,padding:14,titleColor:a.fg,titleFont:{size:14,weight:"600"},titleMarginBottom:8,bodyColor:a.fg,bodyFont:{size:13},bodySpacing:4,displayColors:!1,caretPadding:10,cornerRadius:8,callbacks:{title:c=>{const d=n[c[0].dataIndex];return z($(d.datum),"EE, dd.MM.yyyy",{locale:se})},label:()=>"",beforeBody:c=>{const d=n[c[0].dataIndex],g=d.ist!=null?N(d.ist):"—",u=d.soll!=null?N(d.soll):"—",h=d.pause!=null?Math.round(d.pause*60)+" min":"—",p=[`Tages-Rahmen: ${`${o(d._minVon)} – ${o(d._maxBis)}`}`];return d._spans.length>1&&(p.push(""),d._spans.forEach((y,v)=>{p.push(`  Block ${v+1}: ${y.vonStr} – ${y.bisStr}`)})),[...p,"",`Arbeitszeit (netto): ${g}`,`Soll: ${u}`,`Pause (abgezogen): ${h}`]}}}},scales:{x:{ticks:{color:a.fgMuted,font:{size:10},maxRotation:60,minRotation:60,autoSkip:!0,maxTicksLimit:40},grid:{display:!1}},y:{min:r,max:l,ticks:{color:a.fgMuted,stepSize:60,callback:c=>o(c)},grid:{color:a.border}}}}})}function dn(e,t){const a=C();O(e);const n={};for(const r of t){if(r.tagestyp!=="Stempelzeit"||!r.zeitSpannen||r.zeitSpannen.length<2)continue;const l=gt(r.zeitSpannen);if(l<=0)continue;const o=Math.round(l*60),c=Math.floor(o/15)*15;n[c]=(n[c]??0)+1}const s=Object.keys(n).map(Number).sort((r,l)=>r-l),i=s.map(r=>n[r]);return new E(e,{type:"bar",data:{labels:s.map(r=>`${r}–${r+14} min`),datasets:[{label:"Häufigkeit",data:i,backgroundColor:a.palette[1],borderRadius:4}]},options:{...x(a),plugins:{...x(a).plugins,legend:{display:!1},tooltip:{...x(a).plugins.tooltip,callbacks:{title:r=>`Pause-Länge (gestempelt): ${r[0].label}`,label:r=>`${r.parsed.y} Tag(e)`}}}}})}function un(e,t){const a=C();O(e);const n=["MO","DI","MI","DO","FR"],s={},i={};for(const l of n)s[l]=0,i[l]=0;for(const l of t)n.includes(l.wochentag)&&(l.ist==null||l.ist===0||(s[l.wochentag]+=l.ist,i[l.wochentag]+=1));const r=n.map(l=>i[l]>0?s[l]/i[l]:0);return new E(e,{type:"bar",data:{labels:["Montag","Dienstag","Mittwoch","Donnerstag","Freitag"],datasets:[{label:"Ø Ist-Stunden",data:r,backgroundColor:a.palette[2],borderRadius:4}]},options:{...x(a),plugins:{...x(a).plugins,legend:{display:!1}}}})}function gn(e,t){const a=C();O(e);const n={};for(const r of t)!r.tagestyp||r.tagestyp==="Wochenende"||(n[r.tagestyp]=(n[r.tagestyp]??0)+1);const s=Object.keys(n),i=Object.values(n);return new E(e,{type:"doughnut",data:{labels:s,datasets:[{data:i,backgroundColor:s.map((r,l)=>a.palette[l%a.palette.length]),borderColor:a.surface,borderWidth:2}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"right",labels:{color:a.fgMuted,font:{size:12}}},tooltip:x(a).plugins.tooltip}}})}function hn(e,t){const a=C();O(e);const n={};for(const l of t){const o=l.wocheKey;n[o]??(n[o]={ist:0,soll:0}),n[o].ist+=l.ist??0,n[o].soll+=l.soll??0}const s=Object.keys(n).sort(),i=s.map(l=>n[l].ist),r=s.map(l=>n[l].soll);return new E(e,{type:"bar",data:{labels:s.map(l=>"KW "+l.split("-")[1]),datasets:[{label:"Ist",data:i,backgroundColor:a.palette[0],borderRadius:4},{label:"Soll",data:r,backgroundColor:a.palette[3],borderRadius:4}]},options:x(a)})}function fn(e,t){const a=C();O(e);const n=t.slice().sort((r,l)=>r.datum.localeCompare(l.datum));let s=0;const i=n.map(r=>(s+=r.diff??0,{x:r.datum,y:s}));return new E(e,{type:"line",data:{labels:i.map(r=>r.x),datasets:[{label:"Kumulative Differenz (+/- Soll)",data:i.map(r=>r.y),borderColor:a.palette[5],backgroundColor:V(a.palette[5],.15),fill:!0,tension:.2,pointRadius:0}]},options:{...x(a),scales:{x:{display:!1,grid:{display:!1}},y:{...x(a).scales.y}}}})}function O(e){const t=E.getChart(e);t&&t.destroy()}function V(e,t){const a=e.replace("#","").trim();if(a.length!==6&&a.length!==3)return e;const n=a.length===3?a.split("").map(l=>l+l).join(""):a,s=parseInt(n.slice(0,2),16),i=parseInt(n.slice(2,4),16),r=parseInt(n.slice(4,6),16);return`rgba(${s}, ${i}, ${r}, ${t})`}function mn(e,t,a,n){const{top:s,bottom:i}=t,r=e.createLinearGradient(0,s,0,i),l=a.min,o=a.max,c=o-l;if(c<=0)return V(n.success,.14);let d=(o-0)/c;return d=Math.max(0,Math.min(1,d)),r.addColorStop(0,V(n.success,.28)),r.addColorStop(Math.max(0,d-.001),V(n.success,.06)),r.addColorStop(Math.min(1,d+.001),V(n.danger,.06)),r.addColorStop(1,V(n.danger,.28)),r}function pn(e,t){const a=String(e??"").toLowerCase();return a.includes("stempel")?t.palette[0]:a.includes("berufs")?t.palette[1]:a.includes("urlaub")?t.palette[2]:a.includes("feiertag")?t.fgSubtle:a.includes("dienst")?t.palette[3]:a.includes("krank")?t.palette[4]:t.palette[5]}let vn=0;function De(e,{type:t="info",duration:a=3500}={}){const n=document.getElementById("toast-root");if(!n)return;const s=document.createElement("div");s.className=`toast ${t}`,s.textContent=e,s.dataset.id=++vn,n.appendChild(s),setTimeout(()=>{s.style.opacity="0",s.style.transform="translateY(-8px)",s.style.transition="opacity 220ms, transform 220ms",setTimeout(()=>s.remove(),250)},a)}function ce(e){return De(e,{type:"error",duration:6e3})}function S(e){return De(e,{type:"success"})}const Ve=[{key:7,label:"1 Woche"},{key:14,label:"2 Wochen"},{key:30,label:"1 Monat"},{key:90,label:"3 Monate"},{key:"alles",label:"Alles"}];async function Ie({root:e}){var L,q,Z,Pe;const[t,a,n,s,i,r,l]=await Promise.all([_(),ne(),B(),pa(),la("dashboardZeitraum",14),$e(),ke()]),o=Object.fromEntries(r.map(b=>[b.key,b]));if(n.length===0){e.innerHTML=Sn();return}const c=!((q=(L=t.berufsschulMuster)==null?void 0:L.wochentageWoechentlich)!=null&&q.length||(Pe=(Z=t.berufsschulMuster)==null?void 0:Z.wochentage14Taegig)!=null&&Pe.length),d=en(n,a),g=d.length;let u=i;typeof u=="number"&&u>g&&(u="alles");const h=new Set(s.map(b=>b.key)),f=l!=null&&l.stichtagAuswertung?new Date(l.stichtagAuswertung):new Date,p=Me(n,t,f,h),y=ft(a,h),v=[...p,...y],P=an(d),H=P>.05?"positive":P<-.05?"negative":"";e.innerHTML=`
    ...
    <div class="saldo-hero" style="margin-bottom: 32px; align-items: stretch;">
      <div class="saldo-hero-text" style="min-width: 260px;">
        ...
        <div class="saldo-value ${H}">${D(P,{signed:!0,suffix:""})}</div>
      ...
      <div style="flex: 1; min-width: 400px; display: flex; flex-direction: column;">
        <div class="card-split" style="margin-bottom: 12px; align-items: center;">
          ...
          <div class="segmented" id="zeitraum-picker">
            ${Ve.map(b=>{const M=typeof b.key=="number"&&b.key>g;return`<button type="button" data-key="${b.key}" class="${u===b.key?"active":""}" ${M?'disabled style="opacity:0.4"':""}>${b.label}</button>`}).join("")}
          </div>
        </div>
    ...
    ${v.length>0?`
      <div class="card" style="margin-bottom: 32px;">
        ...
        ${v.slice(0,8).map(b=>$n(b,t,o)).join("")}
  ...
  `,_e(u,e,d);const j=()=>e.querySelectorAll("#zeitraum-picker button, #zeitraum-picker-2 button");j().forEach(b=>{b.addEventListener("click",async()=>{if(b.disabled)return;const M=b.getAttribute("data-key"),R=M==="alles"?"alles":parseInt(M,10);j().forEach(J=>J.classList.toggle("active",J.getAttribute("data-key")===M)),await oa("dashboardZeitraum",R),_e(R,e,d)})}),e.addEventListener("click",async b=>{const M=b.target.closest(".ist-part");if(M){b.preventDefault(),b.stopPropagation();const Ee=M.getAttribute("data-val");try{await navigator.clipboard.writeText(Ee);const Le=M.textContent;M.classList.add("ok"),M.textContent="✓",setTimeout(()=>{M.classList.remove("ok"),M.textContent=Le},800)}catch{S(`Bitte kopieren: ${Ee}`)}return}const R=b.target.closest(".btn-dismiss");if(!R)return;const J=R.getAttribute("data-datum"),Ae=R.getAttribute("data-typ");if(!J||!Ae)return;await ma(J,Ae),S("Warnung ausgeblendet.");const Te=R.closest(".alert");Te&&(Te.style.display="none")})}function _e(e,t,a){const n=tn(a,e),s=nn(n);requestAnimationFrame(()=>{const o=t.querySelector("#saldo-chart");rn(o,n)});const i=t.querySelector("#hero-bewegung");if(i){const o=s>.05?"up":s<-.05?"down":"flat",c=s>.05?"↑":s<-.05?"↓":"→";i.className=`saldo-trend ${o}`,i.innerHTML=`${c} ${Math.abs(s)<.01?"Unverändert":D(s,{signed:!0})} im Zeitraum`}const r=t.querySelector("#tage-info");if(r){const o=n.length;r.textContent=`${o} ${o===1?"Tag":"Tage"}`}const l=t.querySelector("#tage-liste");l&&(l.innerHTML=wn(n.slice().reverse()))}const bn=3,yn=2.5;function wn(e){if(!e.length)return'<p class="hint">Keine Tage im Zeitraum.</p>';const t=[];let a=null;for(const n of e)(!a||a.key!==n.wocheKey)&&(a={key:n.wocheKey,tage:[]},t.push(a)),a.tage.push(n);return`<div class="tages-liste">${t.map(n=>xn(n)).join("")}</div>`}function xn(e){var c;const t=e.tage.reduce((d,g)=>d+(g.ist??0),0),a=e.tage.reduce((d,g)=>d+(g.diff??0),0),n=(c=e.tage[0])==null?void 0:c.datum,s=n?ot($(n)):"",i=e.key?e.key.split("-")[1]:"?",r=a>.05?"pos":a<-.05?"neg":"flat",l=(a>0?"+":"")+a.toFixed(2).replace(".",",")+"h",o=t.toFixed(2).replace(".",",")+"h";return`
  ...
  `}function kn(e){const t=e.diff??0,a=t>0,n=a?bn:yn,s=Math.min(150,Math.abs(t)/n*50),i=a?"var(--success)":t<0?"var(--danger)":"var(--fg-subtle)",r=ge(e.zeitSpannen);return`
  ...
  `}function $n(e,t,a){const n=e.schweregrad==="error"?"!":e.schweregrad==="warn"?"⚠":"i";let s=null;if(e.mailVorlageKey&&t){const i=fe(e.mailVorlageKey,a==null?void 0:a[e.mailVorlageKey]);if(i){const r=pt(t,e);s=vt(t,i,r)}}return`
  ...
  `}async function Ze(e,t,a){var i,r,l,o;const n=t.querySelector("#upload-status"),s=t.querySelector("#upload-zone");s.style.pointerEvents="none",s.style.opacity="0.6",n.innerHTML=`
    <div class="alert severity-info">
      ...
      <div class="alert-body">
    ...
    </div>`;try{const c=await e.arrayBuffer(),d=await An(c);if(d.tage.length===0&&!d.meta.zeitraumVon){s.style.pointerEvents="",s.style.opacity="",n.innerHTML=`
        ...
        </div>`,ce("PDF enthält keinen extrahierbaren Text.");return}const g=await ke(),u=g==null?void 0:g.personalnummer,h=d.meta.personalnummer;if(u&&h&&u!==h){const P=(g==null?void 0:g.name)||`Personalnr. ${u}`,H=d.meta.name||`Personalnr. ${h}`;if(!confirm(`Das hochgeladene PDF gehört zu einem anderen Azubi als die bisher gespeicherten Daten:
...
Fortfahren?`)){s.style.pointerEvents="",s.style.opacity="",n.innerHTML=`
          ...
          </div>`;return}await it();const L=await _();await le({...L,berufsschulMuster:{wochentageWoechentlich:[],wochentage14Taegig:[],referenzDatum14Taegig:null,stundenProTag:null,halbtags:!1}})}await ca(d.tage),await da(d.monate),await ua({dateiname:e.name,personalnummer:d.meta.personalnummer??null,name:d.meta.name??null,zeitraumVon:((r=d.meta.zeitraumVon)==null?void 0:r.toISOString())??null,zeitraumBis:((l=d.meta.zeitraumBis)==null?void 0:l.toISOString())??null,stichtagAuswertung:((o=d.meta.stichtagAuswertung)==null?void 0:o.toISOString())??null,tageCount:d.tage.length,monateCount:d.monate.length});const f=await B(),p=dt(f),y={...nt(),...a};(p.wochentageWoechentlich.length>0||p.wochentage14Taegig.length>0)&&(y.berufsschulMuster=p),await le(y),n.innerHTML=`
    ...
    `,S(`PDF verarbeitet: ${d.tage.length} Tage.`);const v=await st();t.querySelector("#uploads-list").innerHTML=bt(v)}catch(c){console.error(c),n.innerHTML=`
      <div class="alert severity-error">
        <div class="alert-icon">!</div>
        <div class="alert-body">
          <div class="alert-title">Fehler beim Parsen</div>
          <p style="margin: 4px 0; font-size: 13px;">${W(c.message||String(c))}</p>
    ...
    `,ce("PDF konnte nicht gelesen werden.")}finally{s.style.pointerEvents="",s.style.opacity=""}}async function _n(){try{const e=await ha(),t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),a=URL.createObjectURL(t),n=document.createElement("a"),s=new Date().toISOString().slice(0,10);n.href=a,n.download=`zeitnachweis-backup-${s}.json`,n.click(),URL.revokeObjectURL(a),S("Backup heruntergeladen.")}catch(e){ce(`Export fehlgeschlagen: ${e.message}`)}}async function jn(e){var a;const t=(a=e.target.files)==null?void 0:a[0];if(t)try{const n=await t.text(),s=JSON.parse(n);if(!confirm("Existierende Daten werden überschrieben. Fortfahren?"))return;await fa(s),S("Backup erfolgreich importiert. Seite wird neu geladen…"),setTimeout(()=>location.reload(),800)}catch(n){ce(`Import fehlgeschlagen: ${n.message}`)}}async function Rn(){confirm("ALLE Daten endgültig löschen? Das lässt sich nicht rückgängig machen.")&&confirm("Wirklich alle Daten löschen? Letzte Warnung.")&&(await ga(),S("Alle Daten gelöscht."),setTimeout(()=>location.reload(),600))}function Hn(e){if(!e)return"—";const t=new Date(e);return t.toLocaleDateString("de-DE",{year:"numeric",month:"2-digit",day:"2-digit"})+" "+t.toLocaleTimeString("de-DE",{hour:"2-digit",minute:"2-digit"})}const Ne={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag"};async function Zn({root:e}){var s,i,r,l,o;const t=await _(),a=t.berufsschulMuster??{},n=(((s=a.wochentageWoechentlich)==null?void 0:s.length)??0)>0||(((i=a.wochentage14Taegig)==null?void 0:i.length)??0)>0;e.innerHTML=`
      ...
      <div class="card" style="grid-column: 1 / -1;">
        ...
        ${n?`
          <div class="tag-detail">
            ...
            <div class="tag-detail-value"><strong>${((r=a.wochentageWoechentlich)==null?void 0:r.map(c=>Ne[c]).join(", "))||"—"}</strong></div>
          </div>
          <div class="tag-detail">
            <div class="tag-detail-label">Alle 2 Wochen</div>
            <div class="tag-detail-value"><strong>${((l=a.wochentage14Taegig)==null?void 0:l.map(c=>Ne[c]).join(", "))||"—"}</strong>${a.referenzDatum14Taegig?` <span class="hint">(Anker: ${w(new Date(a.referenzDatum14Taegig))})</span>`:""}</div>
          </div>
          <div class="tag-detail">
  ...
  `,e.querySelector("#profil-form").addEventListener("submit",async c=>{var u,h;c.preventDefault();const d=new FormData(c.target),g={...t,ueber18:d.get("ueber18")==="on",zeitwirtschaftEmail:((u=d.get("zeitwirtschaftEmail"))==null?void 0:u.trim())||"Zeitwirtschaft.Aichtal@putzmeister.com",zeitwirtschaftAnrede:((h=d.get("zeitwirtschaftAnrede"))==null?void 0:h.trim())||"Frau Kanarya"};await le(g),S("Profil gespeichert.")})}function Ge(e){return String(e??"").replace(/"/g,"&quot;")}async function Nn({root:e}){var s;const t=await ne(),a=await B(),n={};for(const i of a)n[s=i.monatKey]??(n[s]=[]),n[i.monatKey].push(i);if(t.length===0){e.innerHTML=Qn("Noch keine Monatsdaten. Lade zuerst ein PDF unter Daten hoch.");return}e.innerHTML=`
  ...
  `}async function Gn({params:e,root:t}){const a=e.yyyymm,[n,s,i,r]=await Promise.all([B(),ne(),_(),ke()]),l=s.find(g=>g.monatKey===a),o=n.filter(g=>g.monatKey===a).sort((g,u)=>g.datum.localeCompare(u.datum));if(!o.length){t.innerHTML=`<h1 class="view-title">Monat ${ye(a)}</h1><p class="view-subtitle">Keine Daten für diesen Monat.</p><a href="#/monat" class="btn">← Alle Monate</a>`;return}const c=r!=null&&r.stichtagAuswertung?new Date(r.stichtagAuswertung):new Date,d=Me(n,i,c).filter(g=>g.datum.startsWith(a));t.innerHTML=`
  ...
  `,ze(t.querySelector("#chart-monat"),o)}function qn(e){var n,s,i,r;const t=((n=e.glz)==null?void 0:n.saldoGesamt)??0;return`
  ...
  `}function Jn(e){var n;const t={};for(const s of e)t[n=s.wocheKey]??(t[n]={key:s.wocheKey,tage:[],ist:0,soll:0}),t[s.wocheKey].tage.push(s),t[s.wocheKey].ist+=s.ist??0,t[s.wocheKey].soll+=s.soll??0;const a=Object.keys(t).sort();return a.length?a.map(s=>{var u;const i=t[s],r=+(i.ist-i.soll).toFixed(2),l=r>.05?"positive":r<-.05?"negative":"",o=r>.05?"var(--success)":r<-.05?"var(--danger)":"var(--fg-muted)",c=(u=i.tage[0])==null?void 0:u.datum,d=c?ot($(c)):"",g=s.split("-")[1]||"?";return`
    ...
    `}).join(""):'<p style="color: var(--fg-muted);">Keine Wochen.</p>'}function Un(e){return`
    <table class="table">
      <thead>
        <tr>
          <th>Datum</th>
      ...
      <tbody>
        ${e.map(t=>{const a=t.diff>.05?"positive":t.diff<-.05?"negative":"",n=ge(t.zeitSpannen);return`
            <tr>
              ...
              <td>${t.tagestyp?`<span class="pill ${Xn(t.tagestyp)}">${G(t.tagestyp)}</span>`:"—"}</td>
              <td>${he(n,{size:18})}</td>
  ...
  `}function ye(e){const[t,a]=e.split("-"),n=new Date(parseInt(t),parseInt(a)-1,1);return z(n,"LLLL yyyy",{locale:se})}function Xn(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function Qn(e){return`<div class="empty-state"><div class="empty-state-icon">📭</div><p>${G(e)}</p><a href="#/daten" class="btn primary">Zu Daten</a></div>`}function G(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}async function es({root:e}){var s;const t=await B();if(!t.length){e.innerHTML='<h1 class="view-title">Wochen</h1><p class="view-subtitle">Noch keine Daten.</p><a href="#/daten" class="btn primary">Zum Upload</a>';return}const a={};for(const i of t)a[s=i.wocheKey]??(a[s]={key:i.wocheKey,tage:[],ist:0,soll:0}),a[i.wocheKey].tage.push(i),a[i.wocheKey].ist+=i.ist??0,a[i.wocheKey].soll+=i.soll??0;const n=Object.keys(a).sort().reverse();e.innerHTML=`
    ...
    <div>
      ${n.map(i=>{const r=a[i],l=r.ist-r.soll,o=l>.05?"positive":l<-.05?"negative":"";return`
          <a href="#/woche/${i}" class="list-item">
            <div class="tabular" style="font-size: 16px; font-weight: 600; color: var(--fg-muted);">${de(yt(i))}</div>
            <div>
  ...
  `}async function ts({params:e,root:t}){const a=await B(),n=e.yyyykw,s=a.filter(o=>o.wocheKey===n).sort((o,c)=>o.datum.localeCompare(c.datum));if(!s.length){t.innerHTML=`<h1 class="view-title">KW ${de(n)}</h1><p>Keine Daten.</p><a href="#/woche" class="btn">← Alle Wochen</a>`;return}const i=s.reduce((o,c)=>o+(c.ist??0),0),r=s.reduce((o,c)=>o+(c.soll??0),0),l=i-r;t.innerHTML=`
    <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 8px;">
      <a href="#/woche" class="btn sm">← Alle Wochen</a>
    </div>
    <h1 class="view-title">${de(yt(n))}</h1>
  ...
  `,ze(t.querySelector("#chart-woche"),s)}function as(e){return`
    <table class="table">
      <thead>
        <tr>
          <th>Datum</th>
      ...
      <tbody>
        ${e.map(t=>{const a=t.diff>.05?"positive":t.diff<-.05?"negative":"",n=ge(t.zeitSpannen);return`
            <tr>
              ...
              <td>${t.tagestyp?`<span class="pill ${ns(t.tagestyp)}">${de(t.tagestyp)}</span>`:"—"}</td>
              <td>${he(n,{size:18})}</td>
              <td class="num tabular">${t.ist!=null?t.ist.toFixed(2).replace(".",","):"—"}</td>
              <td class="num tabular">${t.soll!=null?t.soll.toFixed(2).replace(".",","):"—"}</td>
              <td class="num tabular ${a}">${t.diff!=null?D(t.diff,{signed:!0,suffix:""}):"—"}</td>
  ...
  `}function yt(e){const[t,a]=e.split("-");return`KW ${a} · ${t}`}function ns(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function de(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}async function ss({params:e,root:t}){var c,d,g;const a=e.datum,n=await m.tage.get(a),s=await _();if(!n){t.innerHTML=`<h1 class="view-title">Tag nicht gefunden</h1><p>Für ${a} liegen keine Daten vor.</p><a href="#/" class="btn">← Dashboard</a>`;return}const i=$(a),r=n.tagestyp==="Stempelzeit"?ht(n,s):null,l=Se(i,s.berufsschulMuster),o=ge(n.zeitSpannen);t.innerHTML=`
    <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 8px;">
    ...
    <div class="grid cols-2" style="gap: 24px;">
      ...
      <div class="card">
        ...
        <div class="tag-detail">
          ...
          <div class="tag-detail-value">${n.tagestyp?`<span class="pill ${is(n.tagestyp)}">${ee(n.tagestyp)}</span>`:"—"}</div>
        </div>
        <div class="tag-detail">
  ...
  `}function is(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function ee(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}async function rs({root:e}){const[t,a]=await Promise.all([B(),ne()]);if(!t.length){e.innerHTML='<h1 class="view-title">Analytics</h1><p class="view-subtitle">Keine Daten.</p><a href="#/daten" class="btn primary">Zum Upload</a>';return}e.innerHTML=`
      ...
      <div class="card-split" style="margin-bottom: 16px; align-items: center;">
        ...
        <div style="display: flex; gap: 8px; align-items: center;">
          ...
          <select id="filter-monat">
            ...
            ${a.map(i=>`<option value="${i}">${ds(i)}</option>`).join("")}
          </select>
...
`);navigator.clipboard.writeText(r).then(()=>S(`${i.length} Zeilen kopiert.`))});function s(){const i=n.value,l=(i?t.filter(o=>o.monatKey===i):t).filter(o=>o.ist!=null&&o.ist>0&&o.tagestyp!=="Wochenende");e.querySelector("#liste").innerHTML=os(l),e.querySelectorAll(".copy-val").forEach(o=>{o.addEventListener("click",async()=>{const c=o.getAttribute("data-val");await navigator.clipboard.writeText(c),o.classList.add("ok");const d=o.textContent;o.textContent="✓ kopiert",setTimeout(()=>{o.classList.remove("ok"),o.textContent=d},1200)})})}s()}function os(e){return e.length?`
    <table class="table">
      <thead>
        <tr>
          <th>Datum</th>
      ...
      <tbody>
        ${e.map(t=>{const a=N(t.ist),n=`${w($(t.datum))}	${a}`;return`
            <tr data-copy="${qe(n)}">
              ...
              <td>${cs(t.wochentag)}</td>
              <td>${t.tagestyp?`<span class="pill ${us(t.tagestyp)}">${wt(t.tagestyp)}</span>`:"—"}</td>
  ...
  `:'<p style="color: var(--fg-muted);">Keine Tage in dieser Auswahl.</p>'}function cs(e){return{MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"}[e]??e}function ds(e){const[t,a]=e.split("-");return z(new Date(parseInt(t),parseInt(a)-1,1),"LLLL yyyy",{locale:se})}function us(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function wt(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function qe(e){return wt(e)}async function gs({root:e}){const[t,a,n,s]=await Promise.all([B(),_(),ne(),$e()]),i=Object.fromEntries(s.map(o=>[o.key,o])),r=Me(t,a,new Date).filter(o=>o.mailVorlageKey),l=ft(n);e.innerHTML=`
    ...
    <div class="card" style="margin-bottom: 24px;">
      ...
      ${r.length===0?'<div class="empty-state"><div class="empty-state-icon">✓</div><p>Keine akuten Warnungen — top.</p></div>':r.map(o=>hs(o,a,i)).join("")}
    ...
    <div class="card">
      ...
      <div id="vorlagen-editor">
        ${Object.keys(ae).map(o=>{const c=fe(o,i[o]);return fs(c)}).join("")}
      </div>
    </div>
  `,ms(e),ps(e)}function hs(e,t,a){const n=fe(e.mailVorlageKey,a[e.mailVorlageKey]);if(!n)return"";const s=pt(t,e),i=mt(n,s),r=vt(t,n,s);return`
...
${T(i.text)}
  ...
  `}function ms(e){e.querySelectorAll(".btn-save-vorlage").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-key"),n=t.closest(".vorlagen-item"),s=n.querySelector(".v-betreff").value,i=n.querySelector(".v-text").value;await oe(a,{betreff:s,text:i}),S("Vorlage gespeichert.")})}),e.querySelectorAll(".btn-reset-vorlage").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-key"),n=ae[a];n&&confirm(`Vorlage "${n.titel}" auf Default zurücksetzen?`)&&(await oe(a,{betreff:n.betreff,text:n.text}),S("Zurückgesetzt."),setTimeout(()=>location.reload(),400))})})}function ps(e){e.querySelectorAll(".btn-copy-mail").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-subject"),n=t.getAttribute("data-body"),s=`Betreff: ${a}

${n}`;await navigator.clipboard.writeText(s),S("Mail-Text kopiert.")})})}function T(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function we(e){return T(e)}async function vs({root:e}){const t=et(),[a,n]=await Promise.all([_(),$e()]),s=Object.fromEntries(n.map(i=>[i.key,i]));e.innerHTML=`
    ...
    <div class="grid cols-2">
      ...
      <div class="card" style="grid-column: 1 / -1;">
        ...
        <div id="vorlagen-editor">
          ${Object.keys(ae).map(i=>{const r=fe(i,s[i]);return bs(r)}).join("")}
        </div>
      </div>
  ...
  `,e.querySelectorAll("[data-theme]").forEach(i=>{i.addEventListener("click",()=>{const r=i.getAttribute("data-theme");xe(r),e.querySelectorAll("[data-theme]").forEach(l=>l.classList.toggle("active",l===i)),S(`Theme: ${i.textContent.trim()}`)})}),e.querySelector("#pause-sel").addEventListener("change",async i=>{const r={...a,pausenRegel:i.target.value};await le(r),S("Pausen-Regel gespeichert.")}),e.querySelectorAll(".btn-save-vorlage").forEach(i=>{i.addEventListener("click",async()=>{const r=i.getAttribute("data-key"),l=i.closest(".vorlagen-item"),o=l.querySelector(".v-betreff").value,c=l.querySelector(".v-text").value;await oe(r,{betreff:o,text:c}),S("Vorlage gespeichert.")})}),e.querySelectorAll(".btn-reset-vorlage").forEach(i=>{i.addEventListener("click",async()=>{const r=i.getAttribute("data-key"),l=ae[r];l&&confirm(`Vorlage "${l.titel}" auf Default zurücksetzen?`)&&(await oe(r,{betreff:l.betreff,text:l.text}),S("Zurückgesetzt."),setTimeout(()=>location.reload(),400))})})}function bs(e){return`
    <div class="vorlagen-item" data-key="${e.key}" style="border: 1px solid var(--border); border-radius: var(--radius-md); padding: 16px; margin-bottom: 16px;">
      <div class="card-split" style="margin-bottom: 12px;">
        <div>
      ...
      <div class="form-group">
        <label>Betreff</label>
        <input type="text" class="v-betreff" value="${ys(e.betreff)}" />
      </div>
      <div class="form-group">
        <label>Nachrichtentext</label>
  ...
  `}function re(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function ys(e){return re(e)}async function Je(){var t;Nt();const e=document.getElementById("content");(t=document.getElementById("theme-toggle"))==null||t.addEventListener("click",()=>Gt()),qt(()=>{Qt()}),await ra()&&setTimeout(()=>{De('Parser wurde aktualisiert. Bitte lade deinen Zeitnachweis unter "Daten" neu hoch.',{type:"info",duration:12e3})},500),await ia(),await sa(),A("/",Ie),A("/dashboard",Ie),A("/analytics",rs),A("/monat",Nn),A("/monat/:yyyymm",Gn),A("/woche",es),A("/woche/:yyyykw",ts),A("/tag/:datum",ss),A("/berichtsheft",ls),A("/mails",gs),A("/profil",Zn),A("/daten",On),A("/einstellungen",vs),Yt(e),location.hash||Ut("/")}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Je):Je();
