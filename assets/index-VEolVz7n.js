...
import{C as Y,L as ga,B as ha,D as fa,S as ma,a as pa,b as ba,P as va,A as ya,c as wa,d as ka,T as xa,p as $a,e as Sa,i as Ma}from"./chartjs-CRgZvhTJ.js";import{b as pt,a as Be,c as We,d as Da,f as L,s as kn,e as xn,g as $n,p as za,h as Aa,i as qe,j as Ze,k as N,l as Sn,q as Pa,m as Ta,n as Ea,o as Fa}from"./datefns-C8_rfWt_.js";import{D as La}from"./dexie-UpTFNL8S.js";import{GlobalWorkerOptions as Mn,getDocument as Dn}from"./pdfjs-BnPRJEQ6.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&a(o)}).observe(document,{childList:!0,subtree:!0});function n(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(s){if(s.ep)return;s.ep=!0;const i=n(s);fetch(s.href,i)}})();function _a(){document.documentElement.setAttribute("data-theme","dark")}const Gt={lessThanXSeconds:{standalone:{one:"weniger als 1 Sekunde",other:"weniger als {{count}} Sekunden"},withPreposition:{one:"weniger als 1 Sekunde",other:"weniger als {{count}} Sekunden"}},xSeconds:{standalone:{one:"1 Sekunde",other:"{{count}} Sekunden"},withPreposition:{one:"1 Sekunde",other:"{{count}} Sekunden"}},halfAMinute:{standalone:"eine halbe Minute",withPreposition:"einer halben Minute"},lessThanXMinutes:{standalone:{one:"weniger als 1 Minute",other:"weniger als {{count}} Minuten"},withPreposition:{one:"weniger als 1 Minute",other:"weniger als {{count}} Minuten"}},xMinutes:{standalone:{one:"1 Minute",other:"{{count}} Minuten"},withPreposition:{one:"1 Minute",other:"{{count}} Minuten"}},aboutXHours:{standalone:{one:"etwa 1 Stunde",other:"etwa {{count}} Stunden"},withPreposition:{one:"etwa 1 Stunde",other:"etwa {{count}} Stunden"}},xHours:{standalone:{one:"1 Stunde",other:"{{count}} Stunden"},withPreposition:{one:"1 Stunde",other:"{{count}} Stunden"}},xDays:{standalone:{one:"1 Tag",other:"{{count}} Tage"},withPreposition:{one:"1 Tag",other:"{{count}} Tagen"}},aboutXWeeks:{standalone:{one:"etwa 1 Woche",other:"etwa {{count}} Wochen"},withPreposition:{one:"etwa 1 Woche",other:"etwa {{count}} Wochen"}},xWeeks:{standalone:{one:"1 Woche",other:"{{count}} Wochen"},withPreposition:{one:"1 Woche",other:"{{count}} Wochen"}},aboutXMonths:{standalone:{one:"etwa 1 Monat",other:"etwa {{count}} Monate"},withPreposition:{one:"etwa 1 Monat",other:"etwa {{count}} Monaten"}},xMonths:{standalone:{one:"1 Monat",other:"{{count}} Monate"},withPreposition:{one:"1 Monat",other:"{{count}} Monaten"}},aboutXYears:{standalone:{one:"etwa 1 Jahr",other:"etwa {{count}} Jahre"},withPreposition:{one:"etwa 1 Jahr",other:"etwa {{count}} Jahren"}},xYears:{standalone:{one:"1 Jahr",other:"{{count}} Jahre"},withPreposition:{one:"1 Jahr",other:"{{count}} Jahren"}},overXYears:{standalone:{one:"mehr als 1 Jahr",other:"mehr als {{count}} Jahre"},withPreposition:{one:"mehr als 1 Jahr",other:"mehr als {{count}} Jahren"}},almostXYears:{standalone:{one:"fast 1 Jahr",other:"fast {{count}} Jahre"},withPreposition:{one:"fast 1 Jahr",other:"fast {{count}} Jahren"}}},Ca=(e,t,n)=>{let a;const s=n!=null&&n.addSuffix?Gt[e].withPreposition:Gt[e].standalone;return typeof s=="string"?a=s:t===1?a=s.one:a=s.other.replace("{{count}}",String(t)),n!=null&&n.addSuffix?n.comparison&&n.comparison>0?"in "+a:"vor "+a:a},Ba={full:"EEEE, do MMMM y",long:"do MMMM y",medium:"do MMM y",short:"dd.MM.y"},Wa={full:"HH:mm:ss zzzz",long:"HH:mm:ss z",medium:"HH:mm:ss",short:"HH:mm"},Ka={full:"{{date}} 'um' {{time}}",long:"{{date}} 'um' {{time}}",medium:"{{date}} {{time}}",short:"{{date}} {{time}}"},Na={date:pt({formats:Ba,defaultWidth:"full"}),time:pt({formats:Wa,defaultWidth:"full"}),dateTime:pt({formats:Ka,defaultWidth:"full"})},Va={lastWeek:"'letzten' eeee 'um' p",yesterday:"'gestern um' p",today:"'heute um' p",tomorrow:"'morgen um' p",nextWeek:"eeee 'um' p",other:"P"},Oa=(e,t,n,a)=>Va[e],Ia={narrow:["v.Chr.","n.Chr."],abbreviated:["v.Chr.","n.Chr."],wide:["vor Christus","nach Christus"]},Ha={narrow:["1","2","3","4"],abbreviated:["Q1","Q2","Q3","Q4"],wide:["1. Quartal","2. Quartal","3. Quartal","4. Quartal"]},$t={narrow:["J","F","M","A","M","J","J","A","S","O","N","D"],abbreviated:["Jan","Feb","Mär","Apr","Mai","Jun","Jul","Aug","Sep","Okt","Nov","Dez"],wide:["Januar","Februar","März","April","Mai","Juni","Juli","August","September","Oktober","November","Dezember"]},Ra={narrow:$t.narrow,abbreviated:["Jan.","Feb.","März","Apr.","Mai","Juni","Juli","Aug.","Sep.","Okt.","Nov.","Dez."],wide:$t.wide},ja={narrow:["S","M","D","M","D","F","S"],short:["So","Mo","Di","Mi","Do","Fr","Sa"],abbreviated:["So.","Mo.","Di.","Mi.","Do.","Fr.","Sa."],wide:["Sonntag","Montag","Dienstag","Mittwoch","Donnerstag","Freitag","Samstag"]},qa={narrow:{am:"vm.",pm:"nm.",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachm.",evening:"Abend",night:"Nacht"},abbreviated:{am:"vorm.",pm:"nachm.",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachmittag",evening:"Abend",night:"Nacht"},wide:{am:"vormittags",pm:"nachmittags",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachmittag",evening:"Abend",night:"Nacht"}},Za={narrow:{am:"vm.",pm:"nm.",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachm.",evening:"abends",night:"nachts"},abbreviated:{am:"vorm.",pm:"nachm.",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachmittags",evening:"abends",night:"nachts"},wide:{am:"vormittags",pm:"nachmittags",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachmittags",evening:"abends",night:"nachts"}},Ga=e=>Number(e)+".",Ua={ordinalNumber:Ga,era:Be({values:Ia,defaultWidth:"wide"}),quarter:Be({values:Ha,defaultWidth:"wide",argumentCallback:e=>e-1}),month:Be({values:$t,formattingValues:Ra,defaultWidth:"wide"}),day:Be({values:ja,defaultWidth:"wide"}),dayPeriod:Be({values:qa,defaultWidth:"wide",formattingValues:Za,defaultFormattingWidth:"wide"})},Ja=/^(\d+)(\.)?/i,Ya=/\d+/i,Xa={narrow:/^(v\.? ?Chr\.?|n\.? ?Chr\.?)/i,abbreviated:/^(v\.? ?Chr\.?|n\.? ?Chr\.?)/i,wide:/^(vor Christus|vor unserer Zeitrechnung|nach Christus|unserer Zeitrechnung)/i},Qa={any:[/^v/i,/^n/i]},es={narrow:/^[1234]/i,abbreviated:/^q[1234]/i,wide:/^[1234](\.)? Quartal/i},ts={any:[/1/i,/2/i,/3/i,/4/i]},ns={narrow:/^[jfmasond]/i,abbreviated:/^(j[aä]n|feb|mär[z]?|apr|mai|jun[i]?|jul[i]?|aug|sep|okt|nov|dez)\.?/i,wide:/^(januar|februar|märz|april|mai|juni|juli|august|september|oktober|november|dezember)/i},as={narrow:[/^j/i,/^f/i,/^m/i,/^a/i,/^m/i,/^j/i,/^j/i,/^a/i,/^s/i,/^o/i,/^n/i,/^d/i],any:[/^j[aä]/i,/^f/i,/^mär/i,/^ap/i,/^mai/i,/^jun/i,/^jul/i,/^au/i,/^s/i,/^o/i,/^n/i,/^d/i]},ss={narrow:/^[smdmf]/i,short:/^(so|mo|di|mi|do|fr|sa)/i,abbreviated:/^(son?|mon?|die?|mit?|don?|fre?|sam?)\.?/i,wide:/^(sonntag|montag|dienstag|mittwoch|donnerstag|freitag|samstag)/i},is={any:[/^so/i,/^mo/i,/^di/i,/^mi/i,/^do/i,/^f/i,/^sa/i]},rs={narrow:/^(vm\.?|nm\.?|Mitternacht|Mittag|morgens|nachm\.?|abends|nachts)/i,abbreviated:/^(vorm\.?|nachm\.?|Mitternacht|Mittag|morgens|nachm\.?|abends|nachts)/i,wide:/^(vormittags|nachmittags|Mitternacht|Mittag|morgens|nachmittags|abends|nachts)/i},ls={any:{am:/^v/i,pm:/^n/i,midnight:/^Mitte/i,noon:/^Mitta/i,morning:/morgens/i,afternoon:/nachmittags/i,evening:/abends/i,night:/nachts/i}},os={ordinalNumber:Da({matchPattern:Ja,parsePattern:Ya,valueCallback:e=>parseInt(e)}),era:We({matchPatterns:Xa,defaultMatchWidth:"wide",parsePatterns:Qa,defaultParseWidth:"any"}),quarter:We({matchPatterns:es,defaultMatchWidth:"wide",parsePatterns:ts,defaultParseWidth:"any",valueCallback:e=>e+1}),month:We({matchPatterns:ns,defaultMatchWidth:"wide",parsePatterns:as,defaultParseWidth:"any"}),day:We({matchPatterns:ss,defaultMatchWidth:"wide",parsePatterns:is,defaultParseWidth:"any"}),dayPeriod:We({matchPatterns:rs,defaultMatchWidth:"wide",parsePatterns:ls,defaultParseWidth:"any"})},ee={code:"de",formatDistance:Ca,formatLong:Na,formatRelative:Oa,localize:Ua,match:os,options:{weekStartsOn:1,firstWeekContainsDate:4}};function zn(e){if(e==null)return null;if(typeof e=="number")return e;let t=String(e).trim();if(!t)return null;let n=!1;t.endsWith("-")&&(n=!0,t=t.slice(0,-1).trim()),t=t.replace(",",".");const a=parseFloat(t);return isNaN(a)?null:n?-a:a}function He(e){if(e==null||isNaN(e))return"—";const t=e<0,n=Math.abs(e),a=Math.floor(n),s=Math.round((n-a)*60);let i=a,o=s;return o===60&&(i+=1,o=0),`${t?"-":""}${i}:${String(o).padStart(2,"0")}`}function ge(e,t={}){if(e==null||isNaN(e))return"—";const{signed:n=!1,suffix:a="h"}=t,s=n&&e>0?"+":"",i=e.toFixed(2).replace(".",",");return`${s}${i}${a}`}function cs(e,t={}){if(e==null||isNaN(e))return"—";const{signed:n=!1}=t;return`${n&&e>0?"+":""}${He(e)}`}function Ut(e,t="hhmm",n={}){return t==="dezimal"?ge(e,{signed:!0,suffix:"",...n}):cs(e,{signed:!0,...n})}function se(e){if(!e)return null;const t=/^(\d{1,2}):(\d{2})$/.exec(String(e).trim());return t?parseInt(t[1],10)*60+parseInt(t[2],10):null}function An(e){if(!(e!=null&&e.length))return null;const t=e.filter(s=>s.von&&s.bis);if(!t.length)return null;let n=t[0].von,a=t[0].bis;for(const s of t)se(s.von)<se(n)&&(n=s.von),se(s.bis)>se(a)&&(a=s.bis);return{kommen:n,gehen:a}}const Pn="2026-04-01";function ds(e){return e?"arbzg":"jarbschg"}function us(e,t){return e==null?0:t==="jarbschg"?e>6?1:e>4.5?.5:0:e>9?.75:e>6?.5:0}function Pt(e){if(!e||e.length<2)return 0;const t=e.filter(a=>a.von&&a.bis).map(a=>({von:se(a.von),bis:se(a.bis)})).filter(a=>a.von!=null&&a.bis!=null).sort((a,s)=>a.von-s.von);let n=0;for(let a=1;a<t.length;a++){const s=t[a].von-t[a-1].bis;(s>0&&s>=15||s>0)&&(n+=s)}return n/60}function Tn(e,t){const n=e.zeitSpannen??[];if(!n.length||n.every(m=>!m.von))return{keinAnspruch:!0};const a=Pt(n),s=e.pause??0,i=gs(n),o=i-s,d=t.pausenRegel&&t.pausenRegel!=="auto"?t.pausenRegel==="jarbschg"?"jarbschg":"arbzg":ds(!!t.ueber18),r=us(o,d);if(e.datum&&e.datum<Pn)return{arbeitszeitMitPause:i,arbeitszeitOhnePause:o,gestempeltePause:a,abgezogenePause:s,gesetzlichePflicht:r,gesetz:d,legalerAbzug:s,unrechtmaessigerVerlustMin:0,aufstockungMin:0,typ:"alt_reglement",warnung:null,altReglement:!0};const l=Math.max(a,r),c=s-l,g=Math.max(0,r-a);let h="ok",u=null;if(c>.05)h="fehler_zeitwirtschaft",u=`${Math.round(c*60)} min Pause wurden zusätzlich zur gesetzlichen Pflicht und zur gestempelten Pause abgezogen. Das sieht nach einem Zeitwirtschafts-Fehler aus.`;else if(g>.05&&s>a+.02){h="aufstockung_legal";const m=Math.round(g*60);u=`Du hast ${Math.round(a*60)} min Pause gestempelt, aber bei ${o.toFixed(2).replace(".",",")}h Arbeitszeit schreibt das Gesetz (${d.toUpperCase()}) ${Math.round(r*60)} min vor. Die fehlenden ${m} min wurden automatisch als Pause gewertet. Das ist gesetzeskonform — nächstes Mal einfach länger Pause machen.`}return{arbeitszeitMitPause:i,arbeitszeitOhnePause:o,gestempeltePause:a,abgezogenePause:s,gesetzlichePflicht:r,gesetz:d,legalerAbzug:l,unrechtmaessigerVerlustMin:Math.round(Math.max(0,c)*60),aufstockungMin:Math.round(Math.max(0,g)*60),typ:h,warnung:u,altReglement:!1}}function gs(e){let t=0;for(const n of e){if(!n.von||!n.bis)continue;const a=se(n.von),s=se(n.bis);a!=null&&s!=null&&s>a&&(t+=s-a)}return t/60}function En(e,t){var r,l,c;const n=[...e].sort((g,h)=>g.datum.localeCompare(h.datum));if(!n.length)return[];const a=new Map(t.map(g=>[g.monatKey,g])),s={};for(const g of n)s[r=g.monatKey]??(s[r]=[]),s[g.monatKey].push(g);const i=Object.keys(s).sort(),o=[];let d=null;for(const g of i){const h=a.get(g);let u;((l=h==null?void 0:h.glz)==null?void 0:l.saldoVorperiode)!=null?u=h.glz.saldoVorperiode:d!=null?u=d:u=0;const m=s[g];for(const f of m)f.diff!=null&&(u+=f.diff),o.push({datum:f.datum,wochentag:f.wochentag,saldo:Math.round(u*100)/100,diff:f.diff,ist:f.ist,soll:f.soll,tagestyp:f.tagestyp,monatKey:f.monatKey,wocheKey:f.wocheKey,zeitSpannen:f.zeitSpannen});if(((c=h==null?void 0:h.glz)==null?void 0:c.saldoGesamt)!=null){const f=h.glz.saldoGesamt-u;if(Math.abs(f)>.02&&o.length>0){const b=o.length-1;o[b].umbuchung=f,o[b].saldo=Math.round((o[b].saldo+f)*100)/100,u=o[b].saldo}d=h.glz.saldoGesamt}else d=u}return o}function hs(e,t){if(!e.length)return[];if(t==="alles")return e;const n=Math.min(t,e.length);return e.slice(-n)}function fs(e){return e.length?e[e.length-1].saldo:0}const Fn=new Set(["Urlaub","Arbeitsunfähigkeit","Feiertag","Gleitzeit","Berufsschule","Dienstreise"]),Ln=7;function lt(e){if(!e||e.tagestyp==="Wochenende"||e.wochentag==="SA"||e.wochentag==="SO")return 0;const t=e.ist??0,n=e.soll??0;return t>0?t:Fn.has(e.tagestyp)?Math.max(n,Ln):n>0?n:t}function Tt(e){if(!e||e.tagestyp==="Wochenende"||e.wochentag==="SA"||e.wochentag==="SO")return 0;const t=e.soll??0;return t>0?t:Fn.has(e.tagestyp)?Ln:t}function ms(e){if(!e.length)return 0;const t=e[0].saldo-(e[0].diff??0),n=e[e.length-1].saldo;return Math.round((n-t)*100)/100}const ps=["SO","MO","DI","MI","DO","FR","SA"],bs=["Sonntag","Montag","Dienstag","Mittwoch","Donnerstag","Freitag","Samstag"];function Te(e){if(!e)return null;const t=e.trim();return za(t,"dd.MM.yyyy",new Date)}function K(e){return L(e,"dd.MM.yyyy")}function Et(e){return L(e,"EE, dd.MM.yyyy",{locale:ee})}function vs(e){return L(e,"dd.MM.")}function ys(e){return ps[e.getDay()]}function ws(e){return bs[e.getDay()]}function ks(e){return $n(e)}function Ge(e){const t=kn(e,{weekStartsOn:1}),n=xn(e,{weekStartsOn:1});return`${L(t,"dd.MM.")} – ${L(n,"dd.MM.yyyy")}`}function _n(e){return`${Aa(e)}-${String($n(e)).padStart(2,"0")}`}function Ft(e){return L(e,"yyyy-MM")}function Cn(e){return L(e,"yyyy-MM-dd")}function xs(e,t){const n=[];let a=new Date(e);for(;a<=t;)Ze(a)||n.push(new Date(a)),a=qe(a,1);return n}function Bn(e,t){if(!e||!t)return 0;e>t&&([e,t]=[t,e]);let n=0,a=new Date(e);for(;a<t;)a=qe(a,1),Ze(a)||n++;return n}function $(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function $s(e){return $(e)}const Ss=Object.freeze(Object.defineProperty({__proto__:null,addDays:qe,dayKey:Cn,differenceInCalendarDays:Sn,endOfMonth:Ta,endOfWeek:xn,escapeAttr:$s,escapeHtml:$,formatGermanDate:K,formatGermanDateLong:Et,formatShortDate:vs,formatWocheRange:Ge,getWeekdayCode:ys,getWeekdayName:ws,isSameDay:Ea,isWeekend:Ze,isoWeek:ks,monthKey:Ft,parseGermanDate:Te,startOfMonth:Fa,startOfWeek:kn,weekKey:_n,werktageAbstand:Bn,werktageZwischen:xs},Symbol.toStringTag,{value:"Module"}));Y.register(ga,ha,fa,ma,pa,ba,va,ya,wa,ka,xa,$a,Sa,Ma);function R(e){return getComputedStyle(document.documentElement).getPropertyValue(e).trim()}function fe(){return{fg:R("--fg"),fgMuted:R("--fg-muted"),fgSubtle:R("--fg-subtle"),border:R("--border"),surface:R("--surface"),accent:R("--accent"),success:R("--success"),warn:R("--warn"),danger:R("--danger"),info:R("--info"),palette:[R("--chart-1"),R("--chart-2"),R("--chart-3"),R("--chart-4"),R("--chart-5"),R("--chart-6"),R("--chart-7")]}}function B(e){return{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{labels:{color:e.fgMuted,font:{size:12}}},tooltip:{backgroundColor:e.surface,titleColor:e.fg,bodyColor:e.fg,borderColor:e.border,borderWidth:1,padding:10,displayColors:!0}},scales:{x:{ticks:{color:e.fgMuted,font:{size:11}},grid:{color:e.border,drawBorder:!1}},y:{ticks:{color:e.fgMuted,font:{size:11}},grid:{color:e.border,drawBorder:!1}}}}}function Lt(e,t){const n=fe();if(pe(e),!(t!=null&&t.length))return;const a=t.map(i=>L(N(i.datum),"dd.MM.")),s=t.map(i=>i.saldo);return s.map(i=>i>=0?n.success:n.danger),new Y(e,{type:"line",data:{labels:a,datasets:[{label:"Tages-Saldo",data:s,borderColor:n.accent,backgroundColor:i=>{const o=i.chart,{ctx:d,chartArea:r,scales:l}=o;return r?Wn(d,r,l.y,n):de(n.accent,.14)},segment:{borderColor:i=>{const o=i.p0.parsed.y,d=i.p1.parsed.y,r=(o+d)/2;return r>=.02?n.success:r<=-.02?n.danger:n.fgMuted}},tension:.25,pointRadius:2,pointHoverRadius:6,pointHitRadius:20,pointBackgroundColor:s.map(i=>i>=.02?n.success:i<=-.02?n.danger:n.fgMuted),pointBorderColor:n.surface,pointBorderWidth:1,fill:!0,borderWidth:2}]},options:{...B(n),interaction:{mode:"index",intersect:!1,axis:"x"},hover:{mode:"index",intersect:!1,axis:"x"},onHover:(i,o,d)=>{const r=d.getElementsAtEventForMode(i,"index",{intersect:!1},!1);d.canvas.style.cursor=r.length>0?"pointer":"default"},onClick:(i,o,d)=>{const r=d.getElementsAtEventForMode(i,"index",{intersect:!1},!1);if(r.length>0){const l=r[0].index,c=t[l];c!=null&&c.datum&&(window.location.hash=`#/tag/${c.datum}`)}},plugins:{...B(n).plugins,legend:{display:!1},tooltip:{enabled:!1,mode:"index",intersect:!1,axis:"x",position:"nearest",external:Ms(t)}},scales:{...B(n).scales,y:{...B(n).scales.y,ticks:{...B(n).scales.y.ticks,callback:i=>`${i>=0?"+":""}${i.toFixed(1).replace(".",",")}h`}}}}})}function me(e){return function(t){var f,b;const{chart:n,tooltip:a}=t;let s=n.$richTooltipEl;if(!s){s=document.createElement("div"),s.className="saldo-tooltip",document.body.appendChild(s),n.$richTooltipEl=s;const p=n.destroy.bind(n);n.destroy=function(){s.parentNode&&s.parentNode.removeChild(s),p()}}if(a.opacity===0||!((f=a.dataPoints)!=null&&f.length)){s.style.opacity="0";return}const i=e({tooltip:a,chart:n});if(!i){s.style.opacity="0";return}let o=`<div class="saldo-tooltip-title">${St(i.title)}</div>`;for(const p of i.rows||[]){const w=p.klasse||"flat";o+=`<div class="saldo-tooltip-row"><span class="saldo-tooltip-label">${St(p.label)}</span><span class="saldo-tooltip-value ${w}">${p.value}</span></div>`}(b=i.meta)!=null&&b.length&&(o+=`<div class="saldo-tooltip-meta">${i.meta.map(p=>`<span>${p}</span>`).join("")}</div>`),s.innerHTML=o;const d=n.canvas.getBoundingClientRect(),r=d.left+a.caretX,l=d.top+a.caretY;s.style.opacity="0",s.style.left="0px",s.style.top="0px";const c=s.offsetWidth,g=s.offsetHeight,h=18;let u=r+h;u+c>window.innerWidth-8&&(u=r-h-c);let m=l-g/2;m<8&&(m=8),m+g>window.innerHeight-8&&(m=window.innerHeight-g-8),s.style.left=u+"px",s.style.top=m+"px",s.style.opacity="1"}}function he(e){return e==null?"flat":e>.05?"pos":e<-.05?"neg":"flat"}function xe(e){return e==null?"—":(e>0?"+":"")+e.toFixed(2).replace(".",",")+"h"}function $e(e){return e==null?"—":e.toFixed(2).replace(".",",")+"h"}function Ms(e){return me(({tooltip:t})=>{const n=t.dataPoints[0].dataIndex,a=e[n];if(!a)return null;const s=[{label:"Saldo",value:xe(a.saldo),klasse:he(a.saldo)}];a.diff!=null&&s.push({label:"Tages-Diff",value:xe(a.diff),klasse:he(a.diff)});const i=[];return a.tagestyp&&i.push(`Typ: ${St(a.tagestyp)}`),a.umbuchung&&i.push(`Umbuchung: ${a.umbuchung>=0?"+":""}${a.umbuchung.toFixed(2).replace(".",",")}h`),{title:L(N(a.datum),"EE, dd.MM.yyyy",{locale:ee}),rows:s,meta:i}})}function St(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Ds(e,t){const n=fe();if(pe(e),!(t!=null&&t.length))return;const a=t.map(d=>d.monatKey),s=a.map(d=>{const[r,l]=d.split("-"),c=new Date(parseInt(r,10),parseInt(l,10)-1,1);return L(c,"MMM yyyy",{locale:ee})}),i=t.map(d=>{var r;return((r=d.glz)==null?void 0:r.saldoGesamt)??0}),o=t.map(d=>{var r;return((r=d.glz)==null?void 0:r.saldoVorperiode)??null});return new Y(e,{type:"line",data:{labels:s,datasets:[{label:"GLZ-Saldo (Monatsende)",data:i,borderColor:n.accent,backgroundColor:d=>{const r=d.chart,{ctx:l,chartArea:c,scales:g}=r;return c?Wn(l,c,g.y,n):de(n.accent,.14)},segment:{borderColor:d=>{const r=d.p0.parsed.y,l=d.p1.parsed.y,c=(r+l)/2;return c>=.05?n.success:c<=-.05?n.danger:n.fgMuted}},pointBackgroundColor:i.map(d=>d>=.05?n.success:d<=-.05?n.danger:n.fgMuted),pointBorderColor:n.surface,pointBorderWidth:1,tension:.35,fill:!0,pointRadius:4,pointHoverRadius:7,pointHitRadius:20}]},options:{...B(n),interaction:{mode:"index",intersect:!1,axis:"x"},hover:{mode:"index",intersect:!1,axis:"x"},onHover:(d,r,l)=>{const c=l.getElementsAtEventForMode(d,"index",{intersect:!1},!1);l.canvas.style.cursor=c.length>0?"pointer":"default"},onClick:(d,r,l)=>{const c=l.getElementsAtEventForMode(d,"index",{intersect:!1},!1);if(c.length>0){const g=c[0].index,h=a[g];h&&(window.location.hash=`#/kalender/${h}`)}},plugins:{...B(n).plugins,legend:{display:!1},tooltip:{enabled:!1,external:me(({tooltip:d})=>{const r=d.dataPoints[0].dataIndex,l=i[r],c=o[r],g=[{label:"Saldo Monatsende",value:xe(l),klasse:he(l)}];if(c!=null){const h=+(l-c).toFixed(2);g.push({label:"Vorperiode",value:xe(c),klasse:he(c)}),g.push({label:"Bewegung",value:xe(h),klasse:he(h)})}return{title:s[r],rows:g}})}}}})}function zs(e,t){const n=fe();if(pe(e),!(t!=null&&t.length))return;const a=t.map(o=>L(N(o.datum),"dd.MM.")),s=t.map(o=>o.ist??0),i=t.map(o=>_s(o.tagestyp,n));return new Y(e,{type:"bar",data:{labels:a,datasets:[{label:"Ist-Stunden",data:s,backgroundColor:i,borderRadius:4,borderSkipped:!1,maxBarThickness:32,categoryPercentage:.85,barPercentage:.9}]},options:{...B(n),onHover:(o,d,r)=>{const l=r.getElementsAtEventForMode(o,"nearest",{intersect:!0},!1);r.canvas.style.cursor=l.length>0?"pointer":"default"},onClick:(o,d,r)=>{const l=r.getElementsAtEventForMode(o,"nearest",{intersect:!0},!1);if(l.length>0){const c=t[l[0].index];c!=null&&c.datum&&(window.location.hash=`#/tag/${c.datum}`)}},plugins:{...B(n).plugins,legend:{display:!1},tooltip:{enabled:!1,external:me(({tooltip:o})=>{const d=o.dataPoints[0].dataIndex,r=t[d],l=[{label:"Ist",value:$e(r.ist),klasse:"flat"}];r.soll!=null&&l.push({label:"Soll",value:$e(r.soll),klasse:"flat"}),r.diff!=null&&l.push({label:"Diff",value:xe(r.diff),klasse:he(r.diff)});const c=r.tagestyp?[`Typ: ${r.tagestyp}`]:[];return{title:L(N(r.datum),"EE, dd.MM.yyyy",{locale:ee}),rows:l,meta:c}})}},scales:{...B(n).scales,y:{...B(n).scales.y,suggestedMin:0,suggestedMax:10}}}})}function Jt(e,t){const n=fe();if(pe(e),!(t!=null&&t.length))return;const a=t.filter(l=>{var c;return((c=l.zeitSpannen)==null?void 0:c.length)&&l.zeitSpannen.some(g=>g.von&&g.bis)}).map(l=>{const c=l.zeitSpannen.filter(u=>u.von&&u.bis).map(u=>({von:se(u.von),bis:se(u.bis),vonStr:u.von,bisStr:u.bis})).filter(u=>u.von!=null&&u.bis!=null);if(c.length===0)return null;const g=Math.min(...c.map(u=>u.von)),h=Math.max(...c.map(u=>u.bis));return{...l,_spans:c,_minVon:g,_maxBis:h}}).filter(Boolean);if(!a.length)return;const s=l=>l.ist==null?n.fgMuted:l.ist>=7?n.success:n.danger,i={label:"Tages-Rahmen",data:a.map(l=>[l._minVon,l._maxBis]),backgroundColor:a.map(s),borderColor:a.map(s),borderWidth:0,borderRadius:4,borderSkipped:!1,barPercentage:.7,categoryPercentage:.9,maxBarThickness:18},o=Math.max(0,Math.floor(Math.min(...a.map(l=>l._minVon))/60)*60-60),d=Math.min(24*60,Math.ceil(Math.max(...a.map(l=>l._maxBis))/60)*60+60),r=l=>`${String(Math.floor(l/60)).padStart(2,"0")}:${String(l%60).padStart(2,"0")}`;return new Y(e,{type:"bar",data:{labels:a.map(l=>L(N(l.datum),"dd.MM.")),datasets:[i]},options:{...B(n),interaction:{mode:"index",intersect:!1,axis:"x"},onHover:(l,c,g)=>{const h=g.getElementsAtEventForMode(l,"index",{intersect:!1},!1);g.canvas.style.cursor=h.length>0?"pointer":"default"},onClick:(l,c,g)=>{const h=g.getElementsAtEventForMode(l,"index",{intersect:!1},!1);if(h.length>0){const u=a[h[0].index];u!=null&&u.datum&&(window.location.hash=`#/tag/${u.datum}`)}},plugins:{legend:{display:!1},tooltip:{enabled:!1,external:me(({tooltip:l})=>{const c=a[l.dataPoints[0].dataIndex],g=[];c.ist!=null&&g.push({label:"Ist",value:$e(c.ist),klasse:he(c.ist-7)}),c.soll!=null&&g.push({label:"Soll",value:$e(c.soll)});const h=[`Rahmen: ${r(c._minVon)} – ${r(c._maxBis)}`];return c._spans.length>1&&c._spans.forEach((u,m)=>h.push(`Block ${m+1}: ${u.vonStr} – ${u.bisStr}`)),c.pause!=null&&h.push(`Pause: ${Math.round(c.pause*60)} min`),{title:L(N(c.datum),"EE, dd.MM.yyyy",{locale:ee}),rows:g,meta:h}})}},scales:{x:{ticks:{color:n.fgMuted,font:{size:10},maxRotation:60,minRotation:60,autoSkip:!0,maxTicksLimit:40},grid:{display:!1}},y:{min:o,max:d,ticks:{color:n.fgMuted,stepSize:60,callback:l=>r(l)},grid:{color:n.border}}}}})}function As(e,t){const n=fe();pe(e);const a={};for(const o of t){if(o.tagestyp!=="Stempelzeit"||!o.zeitSpannen||o.zeitSpannen.length<2)continue;const d=Pt(o.zeitSpannen);if(d<=0)continue;const r=Math.round(d*60),l=Math.floor(r/15)*15;a[l]=(a[l]??0)+1}const s=Object.keys(a).map(Number).sort((o,d)=>o-d),i=s.map(o=>a[o]);return new Y(e,{type:"bar",data:{labels:s.map(o=>`${o}–${o+14} min`),datasets:[{label:"Häufigkeit",data:i,backgroundColor:n.palette[1],borderRadius:4}]},options:{...B(n),onHover:(o,d,r)=>{const l=r.getElementsAtEventForMode(o,"nearest",{intersect:!0},!1);r.canvas.style.cursor=l.length>0?"pointer":"default"},onClick:(o,d,r)=>{const l=r.getElementsAtEventForMode(o,"nearest",{intersect:!0},!1);if(l.length>0){const c=s[l[0].index];c!=null&&(window.location.hash=`#/kalender/pause/${c}`)}},plugins:{...B(n).plugins,legend:{display:!1},tooltip:{enabled:!1,external:me(({tooltip:o})=>{const d=o.dataPoints[0].dataIndex;return{title:"Pause-Länge "+(s[d]!=null?`${s[d]}–${s[d]+14} min`:""),rows:[{label:"Häufigkeit",value:`${i[d]} Tag${i[d]===1?"":"e"}`}]}})}}}})}function Ps(e,t){const n=fe();pe(e);const a=["MO","DI","MI","DO","FR"],s={},i={};for(const r of a)s[r]=0,i[r]=0;for(const r of t)a.includes(r.wochentag)&&(r.ist==null||r.ist===0||(s[r.wochentag]+=r.ist,i[r.wochentag]+=1));const o=a.map(r=>i[r]>0?s[r]/i[r]:0),d={id:"wochentag-datalabels",afterDatasetsDraw(r){const{ctx:l,data:c,scales:g}=r;l.save(),l.fillStyle=n.fg,l.font="600 12px system-ui",l.textAlign="center",l.textBaseline="bottom",r.getDatasetMeta(0).data.forEach((u,m)=>{const f=c.datasets[0].data[m];if(!f||f===0)return;const b=f.toFixed(2).replace(".",",")+"h";l.fillText(b,u.x,u.y-6)}),l.restore()}};return new Y(e,{type:"bar",data:{labels:["Montag","Dienstag","Mittwoch","Donnerstag","Freitag"],datasets:[{label:"Ø Ist-Stunden",data:o,backgroundColor:n.palette[2],borderRadius:4,maxBarThickness:56,categoryPercentage:.7,barPercentage:.8}]},options:{...B(n),layout:{padding:{top:24}},onHover:(r,l,c)=>{const g=c.getElementsAtEventForMode(r,"nearest",{intersect:!0},!1);c.canvas.style.cursor=g.length>0?"pointer":"default"},onClick:(r,l,c)=>{const g=c.getElementsAtEventForMode(r,"nearest",{intersect:!0},!1);if(g.length>0){const h=a[g[0].index];h&&(window.location.hash=`#/kalender/wochentag/${h}`)}},plugins:{...B(n).plugins,legend:{display:!1},tooltip:{enabled:!1,external:me(({tooltip:r})=>{const l=r.dataPoints[0].dataIndex,c=a[l];return{title:["Montag","Dienstag","Mittwoch","Donnerstag","Freitag"][l],rows:[{label:"Ø Stunden",value:$e(o[l])},{label:"Anzahl Tage",value:String(i[c]||0)}]}})}},scales:{...B(n).scales,y:{...B(n).scales.y,suggestedMax:Math.max(...o)*1.15}}},plugins:[d]})}function Ts(e,t){const n=fe();pe(e);const a={};for(const o of t)!o.tagestyp||o.tagestyp==="Wochenende"||(a[o.tagestyp]=(a[o.tagestyp]??0)+1);const s=Object.keys(a),i=Object.values(a);return new Y(e,{type:"doughnut",data:{labels:s,datasets:[{data:i,backgroundColor:s.map((o,d)=>n.palette[d%n.palette.length]),borderColor:n.surface,borderWidth:2}]},options:{responsive:!0,maintainAspectRatio:!1,onHover:(o,d,r)=>{const l=r.getElementsAtEventForMode(o,"nearest",{intersect:!0},!1);r.canvas.style.cursor=l.length>0?"pointer":"default"},onClick:(o,d,r)=>{const l=r.getElementsAtEventForMode(o,"nearest",{intersect:!0},!1);if(l.length>0){const c=s[l[0].index];c&&(window.location.hash=`#/kalender/typ/${encodeURIComponent(c)}`)}},plugins:{legend:{position:"right",labels:{color:n.fgMuted,font:{size:12}}},tooltip:{enabled:!1,external:me(({tooltip:o})=>{const d=o.dataPoints[0].dataIndex,r=i.reduce((c,g)=>c+g,0),l=r?i[d]/r*100:0;return{title:s[d],rows:[{label:"Anzahl",value:`${i[d]} Tag${i[d]===1?"":"e"}`},{label:"Anteil",value:l.toFixed(1).replace(".",",")+"%"}]}})}}}})}function Es(e,t){const n=fe();pe(e);const a={};for(const c of t){const g=c.wocheKey;a[g]??(a[g]={ist:0,soll:0,days:0,ersterTag:null,monatKey:null}),a[g].ist+=lt(c),a[g].soll+=Tt(c),a[g].days++,(!a[g].ersterTag||c.datum&&c.datum<a[g].ersterTag)&&(a[g].ersterTag=c.datum,a[g].monatKey=c.monatKey)}const s=Object.keys(a).sort();if(!s.length)return;const i=s.map(c=>+a[c].ist.toFixed(2)),o=s.map(c=>+a[c].soll.toFixed(2)),d=s.map(c=>{const g=a[c].ersterTag;return g?Ge(N(g)):""}),r=i.map((c,g)=>c>=o[g]+.1?n.success:c<=o[g]-.1?n.danger:n.fgMuted),l={id:"wochenstunden-soll-linie",afterDatasetsDraw(c){const{ctx:g,scales:h}=c;h.x;const u=h.y;g.save(),g.strokeStyle=n.fgSubtle||n.fgMuted,g.lineWidth=1,g.setLineDash([4,4]),g.beginPath(),c.getDatasetMeta(0).data.forEach((f,b)=>{const p=f.x,w=f.width/2+2,v=u.getPixelForValue(o[b]??35);g.moveTo(p-w,v),g.lineTo(p+w,v)}),g.stroke(),g.restore()}};return new Y(e,{type:"bar",data:{labels:s.map(c=>"KW "+c.split("-")[1]),datasets:[{label:"Wochenstunden",data:i,backgroundColor:r.map(c=>de(c,.55)),borderColor:r,borderWidth:1.5,borderRadius:4,maxBarThickness:32,categoryPercentage:.85,barPercentage:.9}]},options:{...B(n),onHover:(c,g,h)=>{const u=h.getElementsAtEventForMode(c,"nearest",{intersect:!0},!1);h.canvas.style.cursor=u.length>0?"pointer":"default"},onClick:(c,g,h)=>{var m;const u=h.getElementsAtEventForMode(c,"nearest",{intersect:!0},!1);if(u.length>0){const f=u[0].index,b=s[f],p=b?(m=a[b])==null?void 0:m.monatKey:null;b&&p?window.location.hash=`#/kalender/${p}/${b}`:b&&(window.location.hash="#/kalender")}},plugins:{...B(n).plugins,legend:{display:!1},tooltip:{enabled:!1,external:me(({tooltip:c})=>{const g=c.dataPoints[0].dataIndex,h=s[g],u=i[g],m=o[g],f=+(u-m).toFixed(2),b=d[g];return{title:b?"KW "+h.split("-")[1]+" · "+b:"KW "+h.split("-")[1]+" · "+h.split("-")[0],rows:[{label:"Ist",value:$e(u),klasse:"flat"},{label:"Soll",value:$e(m),klasse:"flat"},{label:"Diff",value:xe(f),klasse:he(f)}]}})}},scales:{...B(n).scales,y:{...B(n).scales.y,beginAtZero:!0,ticks:{...B(n).scales.y.ticks,callback:c=>`${c.toFixed(0)}h`}}}},plugins:[l]})}function pe(e){const t=Y.getChart(e);t&&t.destroy()}function Fs(){if(Y.instances){for(const e of Object.values(Y.instances))if(e!=null&&e.canvas&&!document.body.contains(e.canvas))try{e.destroy()}catch{}}document.querySelectorAll(".saldo-tooltip").forEach(e=>e.remove())}function de(e,t){const n=e.replace("#","").trim();if(n.length!==6&&n.length!==3)return e;const a=n.length===3?n.split("").map(d=>d+d).join(""):n,s=parseInt(a.slice(0,2),16),i=parseInt(a.slice(2,4),16),o=parseInt(a.slice(4,6),16);return`rgba(${s}, ${i}, ${o}, ${t})`}function Wn(e,t,n,a){return Ls(e,t,n,0,a)}function Ls(e,t,n,a,s){const{top:i,bottom:o}=t,d=e.createLinearGradient(0,i,0,o),r=n.min,l=n.max,c=l-r;if(c<=0)return de(s.success,.14);let g=(l-a)/c;return g=Math.max(0,Math.min(1,g)),d.addColorStop(0,de(s.success,.28)),d.addColorStop(Math.max(0,g-.001),de(s.success,.06)),d.addColorStop(Math.min(1,g+.001),de(s.danger,.06)),d.addColorStop(1,de(s.danger,.28)),d}function _s(e,t){const n=String(e??"").toLowerCase();return n.includes("stempel")?t.palette[0]:n.includes("berufs")?t.palette[1]:n.includes("urlaub")?t.palette[2]:n.includes("feiertag")?t.fgSubtle:n.includes("dienst")?t.palette[3]:n.includes("krank")?t.palette[4]:t.palette[5]}const Kn=[];function q(e,t){const n=e.split("/").filter(Boolean),a=[],s=new RegExp("^/?"+n.map(i=>i.startsWith(":")?(a.push(i.slice(1)),"([^/]+)"):Ks(i)).join("/")+"/?$");Kn.push({pattern:e,regex:s,paramNames:a,render:t})}function Cs(e){e.startsWith("#")||(e="#"+e),window.location.hash===e?oe():window.location.hash=e}function Bs(e,{onNavigate:t}={}){window.addEventListener("hashchange",oe),oe.rootEl=e,oe.onNavigate=t,oe()}async function oe(){var a;Fs();const e=oe.rootEl,t=window.location.hash.slice(1)||"/",n=t.startsWith("/")?t:`/${t}`;for(const s of Kn){const i=s.regex.exec(n);if(i){const o={};s.paramNames.forEach((d,r)=>o[d]=decodeURIComponent(i[r+1])),(a=oe.onNavigate)==null||a.call(oe,n),Ws(n);try{e.classList.remove("view-enter"),await s.render({params:o,path:n,root:e}),e.classList.add("view-enter")}catch(d){console.error("Route render error:",d),e.innerHTML=`<div class="empty-state">
  ...
  </div>`}function Ws(e){document.querySelectorAll("[data-route]").forEach(n=>{const a=n.getAttribute("data-route"),s=a==="/"?e==="/":e===a||e.startsWith(a+"/");n.classList.toggle("active",s)});const t=e==="/"?"dashboard":e.split("/").filter(Boolean)[0];document.body.setAttribute("data-view",t||"dashboard")}function Ks(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function Yt(e){return String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}const Ns="modulepreload",Vs=function(e){return"/better-ess/"+e},Xt={},Se=function(t,n,a){let s=Promise.resolve();if(n&&n.length>0){document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),d=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));s=Promise.allSettled(n.map(r=>{if(r=Vs(r),r in Xt)return;Xt[r]=!0;const l=r.endsWith(".css"),c=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${r}"]${c}`))return;const g=document.createElement("link");if(g.rel=l?"stylesheet":Ns,l||(g.as="script"),g.crossOrigin="",g.href=r,d&&g.setAttribute("nonce",d),document.head.appendChild(g),l)return new Promise((h,u)=>{g.addEventListener("load",h),g.addEventListener("error",()=>u(new Error(`Unable to preload CSS for ${r}`)))})}))}function i(o){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=o,window.dispatchEvent(d),!d.defaultPrevented)throw o}return s.then(o=>{for(const d of o||[])d.status==="rejected"&&i(d.reason);return t().catch(i)})},y=new La("zeitnachweis");y.version(1).stores({profil:"id",tage:"datum, wochentag, tagestyp, monatKey, wocheKey",monate:"monatKey",uploads:"++id, hochladeDatum, stichtagAuswertung",einstellungen:"key",mailVorlagen:"key",warnungDismissals:"key"});y.version(2).stores({profil:"id",tage:"datum, wochentag, tagestyp, monatKey, wocheKey",monate:"monatKey",uploads:"++id, hochladeDatum, stichtagAuswertung",einstellungen:"key",mailVorlagen:"key",warnungDismissals:"key"}).upgrade(async e=>{await e.table("tage").clear(),await e.table("monate").clear(),await e.table("uploads").clear(),await e.table("warnungDismissals").clear(),await e.table("einstellungen").put({key:"__migration_reset",value:!0})});y.version(3).stores({profil:"id",tage:"datum, wochentag, tagestyp, monatKey, wocheKey",monate:"monatKey",uploads:"++id, hochladeDatum, stichtagAuswertung",einstellungen:"key",mailVorlagen:"key",warnungDismissals:"key"}).upgrade(async e=>{await e.table("tage").clear(),await e.table("monate").clear(),await e.table("uploads").clear(),await e.table("warnungDismissals").clear(),await e.table("einstellungen").put({key:"__migration_reset",value:!0})});y.version(4).stores({profil:"id",tage:"datum, wochentag, tagestyp, monatKey, wocheKey",monate:"monatKey",uploads:"++id, hochladeDatum, stichtagAuswertung",einstellungen:"key",mailVorlagen:"key",warnungDismissals:"key"}).upgrade(async e=>{await e.table("mailVorlagen").clear()});y.version(5).stores({profil:"id",tage:"datum, wochentag, tagestyp, monatKey, wocheKey",monate:"monatKey",uploads:"++id, hochladeDatum, stichtagAuswertung",einstellungen:"key",mailVorlagen:"key",warnungDismissals:"key"}).upgrade(async e=>{const t=await e.table("profil").get("self");t&&(!t.zeitwirtschaftEmail||t.zeitwirtschaftEmail==="zeitwirtschaft@putzmeister.com")&&await e.table("profil").put({...t,zeitwirtschaftEmail:"Zeitwirtschaft.Aichtal@putzmeister.com"})});y.version(6).stores({profil:"id",tage:"datum, wochentag, tagestyp, monatKey, wocheKey",monate:"monatKey",uploads:"++id, hochladeDatum, stichtagAuswertung",einstellungen:"key",mailVorlagen:"key",warnungDismissals:"key"}).upgrade(async e=>{await e.table("mailVorlagen").clear()});y.version(7).stores({profil:"id",tage:"datum, wochentag, tagestyp, monatKey, wocheKey",monate:"monatKey",uploads:"++id, hochladeDatum, stichtagAuswertung",einstellungen:"key",mailVorlagen:"key",warnungDismissals:"key",fahrtgeldTemplate:"id"}).upgrade(async e=>{const t=await e.table("profil").get("self");if(!t)return;let n=t.ueber18??!0;if(t.geburtsdatum){const s=new Date(t.geburtsdatum),i=new Date;n=i.getFullYear()-s.getFullYear()-(i<new Date(i.getFullYear(),s.getMonth(),s.getDate())?1:0)>=18}const a={id:"self",ueber18:n,sollStundenProWoche:t.sollStundenProWoche??35,sollStundenProTag:t.sollStundenProTag??7,berufsschulMuster:t.berufsschulMuster??{wochentageWoechentlich:[],wochentage14Taegig:[],referenzDatum14Taegig:null},zeitwirtschaftEmail:t.zeitwirtschaftEmail||"Zeitwirtschaft.Aichtal@putzmeister.com",zeitwirtschaftAnrede:t.zeitwirtschaftAnrede||"Frau Kanarya",pausenRegel:t.pausenRegel??"auto",erstelltAm:t.erstelltAm??new Date().toISOString(),updatedAt:new Date().toISOString()};await e.table("profil").put(a)});async function Os(){try{const{erkenneBerufsschulMuster:e}=await Se(async()=>{const{erkenneBerufsschulMuster:o}=await Promise.resolve().then(()=>ni);return{erkenneBerufsschulMuster:o}},void 0),t=await y.tage.toArray();if(!t.length)return!1;const n=e(t),a=await y.profil.get("self");if(!a)return!1;const s=a.berufsschulMuster??{};return JSON.stringify(s.wochentageWoechentlich??[])!==JSON.stringify(n.wochentageWoechentlich)||JSON.stringify(s.wochentage14Taegig??[])!==JSON.stringify(n.wochentage14Taegig)||(s.referenzDatum14Taegig??null)!==(n.referenzDatum14Taegig??null)||(s.stundenProTag??null)!==(n.stundenProTag??null)||(s.halbtags??!1)!==(n.halbtags??!1)?(await y.profil.put({...a,berufsschulMuster:n}),!0):!1}catch(e){return console.warn("[db] refreshBerufsschulMuster fehlgeschlagen:",e),!1}}async function Is(){try{const{weekKey:e}=await Se(async()=>{const{weekKey:s}=await Promise.resolve().then(()=>Ss);return{weekKey:s}},void 0),{parseISO:t}=await Se(async()=>{const{parseISO:s}=await import("./datefns-C8_rfWt_.js").then(i=>i.r);return{parseISO:s}},[]),n=await y.tage.toArray(),a=[];for(const s of n){if(!s.datum)continue;const i=e(t(s.datum));i!==s.wocheKey&&a.push({...s,wocheKey:i})}return a.length&&await y.tage.bulkPut(a),a.length}catch(e){return console.warn("[db] refreshWocheKeys fehlgeschlagen:",e),0}}async function Hs(){try{const e=await y.mailVorlagen.toArray(),t=e.some(a=>a.betreff&&!a.betreff.startsWith("Bitte um Zeitkorrektur im ESS")),n=e.some(a=>a.text&&!/Vielen Dank!\s*$/.test(a.text));return t||n?(await y.mailVorlagen.clear(),!0):!1}catch(e){return console.warn("[db] ensureMailVorlagenFresh fehlgeschlagen:",e),!1}}async function Rs(){const e=await y.einstellungen.get("__migration_reset");return(e==null?void 0:e.value)===!0?(await y.einstellungen.delete("__migration_reset"),!0):!1}async function re(){return await y.profil.get("self")??Nn()}async function st(e){const t={...e,id:"self",updatedAt:new Date().toISOString()};return await y.profil.put(t),t}function Nn(){return{id:"self",ueber18:!0,sollStundenProWoche:35,sollStundenProTag:7,berufsschulMuster:{wochentageWoechentlich:[],wochentage14Taegig:[],referenzDatum14Taegig:null,stundenProTag:null,halbtags:!1},zeitwirtschaftEmail:"Zeitwirtschaft.Aichtal@putzmeister.com",zeitwirtschaftAnrede:"Frau Kanarya",pausenRegel:"auto",erstelltAm:new Date().toISOString()}}async function Qt(e,t=null){const n=await y.einstellungen.get(e);return n?n.value:t}async function en(e,t){await y.einstellungen.put({key:e,value:t})}async function ce(){return await y.tage.orderBy("datum").toArray()}async function js(e,t,n){const a=n instanceof Date?n.toISOString():typeof n=="string"&&n?n:null,s=(l,c)=>c?l?l>c:!1:!0;let i=0,o=0,d=0,r=0;if(e.length){const l=e.map(h=>h.datum),c=await y.tage.bulkGet(l),g=[];for(let h=0;h<e.length;h++){const u={...e[h],_quellStichtag:a},m=c[h];!m||s(a,m._quellStichtag)?g.push(u):o++}g.length&&(await y.tage.bulkPut(g),i=g.length)}if(t.length){const l=t.map(h=>h.monatKey),c=await y.monate.bulkGet(l),g=[];for(let h=0;h<t.length;h++){const u={...t[h],_quellStichtag:a},m=c[h];!m||s(a,m._quellStichtag)?g.push(u):r++}g.length&&(await y.monate.bulkPut(g),d=g.length)}return{tage:i,monate:d,skippedTage:o,skippedMonate:r}}async function ot(){return await y.monate.orderBy("monatKey").toArray()}async function qs(e){return await y.uploads.add({...e,hochladeDatum:new Date().toISOString()})}async function Ue(){return await y.uploads.orderBy("hochladeDatum").last()}async function Vn(){return await y.uploads.orderBy("hochladeDatum").reverse().toArray()}async function Ie(){return await y.fahrtgeldTemplate.get("self")}async function _t(e){await y.fahrtgeldTemplate.put({id:"self",...e})}async function Zs(){await y.fahrtgeldTemplate.delete("self")}async function Gs(){await Promise.all([y.profil.clear(),y.tage.clear(),y.monate.clear(),y.uploads.clear(),y.einstellungen.clear(),y.mailVorlagen.clear(),y.warnungDismissals.clear(),y.fahrtgeldTemplate.clear()])}async function On(){await Promise.all([y.tage.clear(),y.monate.clear(),y.uploads.clear(),y.warnungDismissals.clear()])}async function Us(){const[e,t,n,a,s,i,o]=await Promise.all([y.profil.toArray(),y.tage.toArray(),y.monate.toArray(),y.uploads.toArray(),y.einstellungen.toArray(),y.mailVorlagen.toArray(),y.warnungDismissals.toArray()]);return{version:1,exportedAt:new Date().toISOString(),data:{profil:e,tage:t,monate:n,uploads:a,einstellungen:s,mailVorlagen:i,warnungDismissals:o}}}async function Js(e){if(!e||e.version!==1||!e.data)throw new Error("Ungültiges oder inkompatibles Backup-Format.");const t=e.data;await y.transaction("rw",y.profil,y.tage,y.monate,y.uploads,y.einstellungen,y.mailVorlagen,y.warnungDismissals,async()=>{var n,a,s,i,o,d,r;(n=t.profil)!=null&&n.length&&await y.profil.bulkPut(t.profil),(a=t.tage)!=null&&a.length&&await y.tage.bulkPut(t.tage),(s=t.monate)!=null&&s.length&&await y.monate.bulkPut(t.monate),(i=t.uploads)!=null&&i.length&&await y.uploads.bulkPut(t.uploads),(o=t.einstellungen)!=null&&o.length&&await y.einstellungen.bulkPut(t.einstellungen),(d=t.mailVorlagen)!=null&&d.length&&await y.mailVorlagen.bulkPut(t.mailVorlagen),(r=t.warnungDismissals)!=null&&r.length&&await y.warnungDismissals.bulkPut(t.warnungDismissals)})}async function it(e,t){await y.mailVorlagen.put({key:e,...t})}async function Ys(e){return await y.mailVorlagen.get(e)}async function ct(){return await y.mailVorlagen.toArray()}async function Xs(e,t){await y.warnungDismissals.put({key:`${e}-${t}`,datum:e,typ:t,dismissedAt:new Date().toISOString()})}async function Qs(){return await y.warnungDismissals.toArray()}function ei(e=22){return`<svg class="kg-icon" width="${e}" height="${e}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
...
`):"",h=l?t[0].schweregrad:null;return`
    <a href="#/tag/${e.datum}" class="tag-row${l?" has-warn severity-"+h:""}">
      <div class="tag-row-datum">
        <div class="tabular">${$(K(new Date(e.datum)))}</div>
  ...
  `}function di(e){return li[e]??e}function ui(e){const t={error:3,warn:2,info:1};let n=e[0];for(const a of e)(t[a.schweregrad]||0)>(t[n.schweregrad]||0)&&(n=a);return n.schweregrad==="error"?"!":n.schweregrad==="warn"?"⚠":"i"}function gi(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function Wt(e){e._istCopyAttached||(e._istCopyAttached=!0,e.addEventListener("click",async t=>{const n=t.target.closest(".ist-part");if(!n)return;t.preventDefault(),t.stopPropagation();const a=n.getAttribute("data-val");try{await navigator.clipboard.writeText(a),n._copyResetTimer&&clearTimeout(n._copyResetTimer),n.classList.add("ok"),n.textContent="✓",n._copyResetTimer=setTimeout(()=>{n.classList.remove("ok"),n.textContent=a,n._copyResetTimer=null},800)}catch{V(`Bitte kopieren: ${a}`)}}))}const hi=[{key:7,label:"1 Woche"},{key:14,label:"2 Wochen"},{key:30,label:"1 Monat"},{key:90,label:"3 Monate"},{key:180,label:"6 Monate"},{key:365,label:"1 Jahr"},{key:730,label:"2 Jahre"},{key:"alles",label:"Alles"}];function fi(e){return hi.filter(t=>t.key==="alles"||t.key<e)}async function an({root:e}){const[t,n,a,s,i,o,d,r]=await Promise.all([re(),ot(),ce(),Qs(),Qt("dashboardZeitraum",14),ct(),Ue(),Qt("saldoFormat","hhmm")]),l=Object.fromEntries(o.map(M=>[M.key,M]));if(a.length===0){e.innerHTML=pi();return}const c=En(a,n),g=c.length,h=fi(g);let u=i;h.some(M=>M.key===u)||(u="alles");const m=new Set(s.map(M=>M.key)),f=d!=null&&d.stichtagAuswertung?new Date(d.stichtagAuswertung):new Date,b=ut(a,t,f,m),p=jn(n,m),w=[...b,...p],v=fs(c),E=v>.05?"positive":v<-.05?"negative":"";e.innerHTML=`
    ...
    <div class="saldo-hero" style="margin-bottom: 32px; align-items: stretch;">
      <div class="saldo-hero-text" style="min-width: 260px;">
        ...
        <div class="saldo-value-row">
          <div class="saldo-value ${E}" id="saldo-hero-value">${Ee(Ut(v,r))}</div>
    ...
    ${w.length>0?`
      <div class="card" style="margin-bottom: 32px;">
        ...
        ${w.slice(0,8).map(M=>mi(M,t,l)).join("")}
        ${w.length>8?`<div style="margin-top: 12px; color: var(--fg-muted); font-size: 13px; text-align: center;">+ ${w.length-8} weitere Warnungen vorhanden</div>`:""}
      </div>
    `:`
  ...
  `,sn(u,e,c,w);const F=e.querySelector("#saldo-format-toggle");F==null||F.addEventListener("click",async()=>{const z=(F.getAttribute("data-format")||"hhmm")==="hhmm"?"dezimal":"hhmm";await en("saldoFormat",z);const W=e.querySelector("#saldo-hero-value");W&&(W.textContent=Ut(v,z)),F.setAttribute("data-format",z),F.textContent=z==="hhmm"?"als Dezimal":"als Std:Min",F.title=z==="hhmm"?"Auf Dezimal umstellen":"Auf Stunden:Minuten umstellen"});const C=()=>e.querySelectorAll("#zeitraum-picker button, #zeitraum-picker-2 button");C().forEach(M=>{M.addEventListener("click",async()=>{if(M.disabled)return;const z=M.getAttribute("data-key"),W=z==="alles"?"alles":parseInt(z,10);C().forEach(x=>x.classList.toggle("active",x.getAttribute("data-key")===z)),await en("dashboardZeitraum",W),sn(W,e,c,w)})}),e.addEventListener("click",async M=>{const z=M.target.closest(".ist-part");if(z){M.preventDefault(),M.stopPropagation();const O=z.getAttribute("data-val");try{await navigator.clipboard.writeText(O),z._copyResetTimer&&clearTimeout(z._copyResetTimer),z.classList.add("ok"),z.textContent="✓",z._copyResetTimer=setTimeout(()=>{z.classList.remove("ok"),z.textContent=O,z._copyResetTimer=null},800)}catch{V(`Bitte kopieren: ${O}`)}return}const W=M.target.closest(".btn-dismiss");if(!W)return;const x=W.getAttribute("data-datum"),k=W.getAttribute("data-typ");if(!x||!k)return;await Xs(x,k),V("Warnung ausgeblendet.");const T=W.closest(".alert");T&&(T.style.display="none")})}function sn(e,t,n,a=[]){const s=hs(n,e),i=ms(s);requestAnimationFrame(()=>{const l=t.querySelector("#saldo-chart");Lt(l,s)});const o=t.querySelector("#hero-bewegung");if(o){const l=i>.05?"up":i<-.05?"down":"flat",c=i>.05?"↑":i<-.05?"↓":"→";o.className=`saldo-trend ${l}`,o.innerHTML=`${c} ${Math.abs(i)<.01?"Unverändert":ge(i,{signed:!0})} im Zeitraum`}const d=t.querySelector("#tage-info");if(d){const l=s.length;d.textContent=`${l} ${l===1?"Tag":"Tage"}`}const r=t.querySelector("#tage-liste");r&&(r.innerHTML=gt(s.slice().reverse(),{warnungen:a.filter(l=>s.some(c=>c.datum===l.datum))}))}function mi(e,t,n){const a=e.schweregrad==="error"?"!":e.schweregrad==="warn"?"⚠":"i";let s=null;if(e.mailVorlageKey&&t){const i=Je(e.mailVorlageKey,n==null?void 0:n[e.mailVorlageKey]);if(i){const o=Ct(t,e);s=Bt(t,i,o)}}return`
  ...
  `}function Ee(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function bt(e){return Ee(e)}const Zn="/better-ess/assets/pdf.worker.min-yatZIOMy.mjs";Mn.workerSrc=Zn;const rn={Januar:1,Februar:2,März:3,Maerz:3,April:4,Mai:5,Juni:6,Juli:7,August:8,September:9,Oktober:10,November:11,Dezember:12},bi=["Stempelzeit","Berufsschule Std. bez","Berufsschule","Dienstreise Arbeitszeit","Reise öff.VM/PKW Beifahr.","Reise öff.VM/PKW","Urlaub","Gleitzeit","Arbeitsunfähigkeit","TgDtEinh","Neujahr","Karfreitag","Ostermontg","Ostmontg","Osterso.","Hl.3 Kön.","Allerhlg","Pfingstmo","Fronleichn","TdDtEinh"];async function vi(e){var r,l;const n=await Dn({data:e}).promise,a=[];let s=0;for(let c=1;c<=n.numPages;c++){const h=await(await n.getPage(c)).getTextContent();s+=h.items.length;const u=yi(h.items);for(const m of u)a.push({page:c,text:m})}const i=wi(a),{tage:o,monate:d}=ki(a);try{const c=await n.getMetadata();i.producer=((r=c==null?void 0:c.info)==null?void 0:r.Producer)??null,i.creator=((l=c==null?void 0:c.info)==null?void 0:l.Creator)??null}catch{}return i.totalTextItems=s,{meta:i,tage:o,monate:d}}function yi(e){if(!e.length)return[];const t=e.slice().sort((o,d)=>{const r=d.transform[5]-o.transform[5];return Math.abs(r)>2?r:o.transform[4]-d.transform[4]}),n=[];let a=null,s=[];const i=3;for(const o of t){const d=o.transform[5];a==null||Math.abs(d-a)<=i?(s.push(o),a==null&&(a=d)):(n.push(ln(s)),s=[o],a=d)}return s.length&&n.push(ln(s)),n.filter(o=>o.trim().length>0)}function ln(e){e.sort((a,s)=>a.transform[4]-s.transform[4]);let t="",n=-1;for(const a of e){const s=a.transform[4];n>=0&&s-n>4?t+="  ":n>=0&&s-n>.5&&(t+=" "),t+=a.str,n=s+a.width}return t}function wi(e){var n,a;const t={personalnummer:null,name:null,kostenstelle:null,personalbereich:null,einstellungsdatum:null,mitarbeiterkreis:null,arbeitszeitplanregel:null,zeitraumVon:null,zeitraumBis:null,stichtagAuswertung:null};for(let s=0;s<e.length;s++){const i=e[s].text,o=/vom\s+(\d{2}\.\d{2}\.\d{4})\s+bis\s+(\d{2}\.\d{2}\.\d{4})/i.exec(i);o&&(t.zeitraumVon=Te(o[1]),t.zeitraumBis=Te(o[2]));const d=/bis einschließlich dem\s+(\d{2}\.\d{2}\.\d{4})/i.exec(i);if(d&&(t.stichtagAuswertung=Te(d[1])),/Personalnummer/i.test(i)&&/Kostenstelle/i.test(i)){const r=(((n=e[s+1])==null?void 0:n.text)??"").trim();let l=r.split(/\s{2,}/);l.length<3&&(l=r.split(/\s+/)),l.length>=3&&/^\d/.test(l[0])&&(t.personalnummer=l[0],t.kostenstelle=l[1],t.personalbereich=l[2])}if(/Einstellungsdatum/i.test(i)&&/Mitarbeiterkreis/i.test(i)){const r=(((a=e[s+1])==null?void 0:a.text)??"").trim();let l=r.split(/\s{2,}/);l.length<3&&(l=r.split(/\s+/)),l.length>=3&&/^\d{2}\.\d{2}\.\d{4}$/.test(l[0])&&(t.einstellungsdatum=Te(l[0]),t.mitarbeiterkreis=l[1],t.arbeitszeitplanregel=l[2])}if(/Bei Rückfragen wenden Sie sich an/i.test(i))for(let r=s+1;r<Math.min(s+8,e.length);r++){const l=e[r].text.trim();if(/^[A-ZÄÖÜ][a-zäöüß]+(?:\s[A-ZÄÖÜ][a-zäöüß]+)+$/.test(l)&&!/kanarya/i.test(l)&&!/tel/i.test(l)){t.name=l;break}}}return t}function ki(e,t){var r;const n=[],a=[];let s=null,i=null,o=!1,d=0;for(;d<e.length;){const l=e[d].text,c=/Monat:\s*([A-Za-zäöüÄÖÜß]+)\s*-\s*(\d{4})/.exec(l);if(c){const m=c[1].trim(),f=parseInt(c[2],10),b=rn[m]??rn[m.replace("ä","ae")]??null;b&&(s={jahr:f,monat:b,monatKey:`${f}-${String(b).padStart(2,"0")}`},o=!0,i=null),d++;continue}if(/Monats.bersicht zum Stichtag\s+(\d{2}\.\d{2}\.\d{4})/i.test(l)){const m=/Monats.bersicht zum Stichtag\s+(\d{2}\.\d{2}\.\d{4})/i.exec(l),f=Te(m[1]);i={monatKey:(s==null?void 0:s.monatKey)??Ft(f),stichtag:f,glz:{},flexi:{},zeitkonten:{},raw:{}},d=xi(e,d+1,i),a.push(i);continue}let g=s;const h=/^(\d{2})\s+(MO|DI|MI|DO|FR|SA|SO)\b/.exec(l.trim());if(h&&s){const m=parseInt(h[1],10);o&&m>=20?g=Mi(s):m<=15&&(o=!1)}const u=on(l,g);if(u){const m=[];let f=d+1;for(;f<e.length;){const p=e[f].text;if(/^\s*\d{4}\s+Umbuchung/.test(p)||on(p,s)||/Wochensumme/i.test(p)||/Monats.bersicht/i.test(p)||/Monat:\s*[A-Za-z]/i.test(p))break;const w=$i(p);if(w){m.push(w),f++;continue}break}if(m.length&&u.zeitSpannen.push(...m),u.tagestyp==="Wochenende"||u.wochentag==="SA"||u.wochentag==="SO"){d=f;continue}(u.ist!=null||u.soll!=null||(((r=u.zeitSpannen)==null?void 0:r.length)??0)>0||u.tagestyp!=null)&&n.push(u),d=f;continue}d++}return{tage:n,monate:a}}function xi(e,t,n){let a=t;const s=/(\d{4,5}|KTAU|AZAU)\s*-\s*(.+?)\s+(-?[\d,.]+-?)(?=\s+(?:\d{4,5}|KTAU|AZAU)\s*-|\s*$)/g;for(;a<e.length;){const i=e[a].text.trim();if(/^Monat:\s/.test(i)||/^Einzelergebnisse\s/.test(i)||/^Tag\b/.test(i)||/^Wochensumme/.test(i)||/^\d{2}\s+(MO|DI|MI|DO|FR|SA|SO)\b/.test(i)||/^Übersicht für den Zeitraum/i.test(i)||/^Abwesenheitsansprüche/i.test(i))break;s.lastIndex=0;let o;for(;(o=s.exec(i))!=null;){const d=o[1],r=o[2].trim(),l=zn(o[3]);n.raw[d]={beschreibung:r,wert:l},d==="0008"&&(n.glz.saldoVorperiode=l),d==="8016"&&(n.glz.saldoAktuellePeriode=l),d==="9802"&&(n.glz.umgebuchteStunden=l),d==="0005"&&(n.glz.saldoGesamt=l),d==="9803"&&(n.glz.ueberzaehligeStd=l),d==="0050"&&(n.zeitkonten.produktivstunden=l),d==="9011"&&(n.flexi.jahreskontoVorperiode=l),d==="9010"&&(n.flexi.jahreskontoSaldo=l),d==="9020"&&(n.flexi.langzeitkontoSaldo=l),d==="9203"&&(n.zeitkonten.azMonatsendeUeber216=l),d==="9207"&&(n.zeitkonten.auszahlungBav=l),d==="9205"&&(n.zeitkonten.summeAuszahlung=l)}if(a++,a-t>80)break}return a}function on(e,t){if(!t)return null;const n=e.trim(),a=/^(\d{2})\s+(MO|DI|MI|DO|FR|SA|SO)(?:\s+(.+))?$/.exec(n);if(!a)return null;const s=parseInt(a[1],10),i=a[2],o=(a[3]??"").trim();let d=t.jahr,r=t.monat;const l=new Date(d,r-1,s),c={datum:Cn(l),datumDate:l.toISOString(),wochentag:i,tagNr:s,monatKey:Ft(l),wocheKey:_n(l),zeitSpannen:[],aktivitaeten:[],ist:null,soll:null,diff:null,pause:null,tazp:null,tagestyp:null,raw:n};return o?(Si(o,c),c):(c.tagestyp=["SA","SO"].includes(i)?"Wochenende":null,c)}function $i(e){const t=e.trim(),n=/^(Stempelzeit|Reise öff\.VM\/PKW Beifahr\.|Reise öff\.VM\/PKW|Dienstreise Arbeitszeit)\s+(\d{2}:\d{2})\s+(\d{2}:\d{2})\s*$/.exec(t);return n?{aktivitaet:n[1],von:n[2],bis:n[3]}:null}function Si(e,t){let n=null,a=e;for(const c of bi)if(e.startsWith(c)){n=c,a=e.slice(c.length).trim();break}n||(n=e.split(/\s+/)[0],a=e.slice(n.length).trim()),t.tagestyp=Di(n),t.aktivitaeten.push(n);const s=a.split(/\s+/).filter(Boolean),i=/^\d{2}:\d{2}$/,o=/^-?[\d,.]+-?$/;let d=0;for(;s[d]&&i.test(s[d])&&s[d+1]&&i.test(s[d+1]);)t.zeitSpannen.push({aktivitaet:n,von:s[d],bis:s[d+1]}),d+=2;const r=[];for(;d<s.length&&o.test(s[d]);){const c=zn(s[d]);c!=null&&r.push(c),d++}let l=s[d];r.length>=5?([t.ist,t.soll,t.diff,t.pause]=r,l||(l=String(r[4]))):r.length===4?[t.ist,t.soll,t.diff,t.pause]=r:r.length===3?[t.ist,t.soll,t.diff]=r:r.length===2?[t.ist,t.soll]=r:r.length===1&&(t.ist=r[0]),l&&(t.tazp=String(l))}function Mi(e){if(!e)return null;let t=e.monat-1,n=e.jahr;return t<1&&(t=12,n-=1),{jahr:n,monat:t,monatKey:`${n}-${String(t).padStart(2,"0")}`}}function Di(e){return e?/^Stempelzeit$/i.test(e)?"Stempelzeit":/^Berufsschule Std\. bez$/i.test(e)||/^Berufsschule$/i.test(e)?"Berufsschule":/Dienstreise/i.test(e)||/Reise/i.test(e)?"Dienstreise":/^Urlaub$/i.test(e)?"Urlaub":/^Gleitzeit$/i.test(e)?"Gleitzeit":/Arbeitsunf.higkeit/i.test(e)?"Arbeitsunfähigkeit":/^(Neujahr|Karfreitag|Ostermontg|Ostmontg|Osterso\.|Hl\.3 Kön\.|Allerhlg|Pfingstmo|Fronleichn|TdDtEinh|TgDtEinh)$/i.test(e)?"Feiertag":e:null}function ie(e,t={}){const{title:n="Bestätigen",confirmLabel:a="Bestätigen",cancelLabel:s="Abbrechen",variant:i="default"}=t;return Ai({message:e,title:n,confirmLabel:a,cancelLabel:s,variant:i,kind:"confirm"})}function zi(e,t,n={}){const{title:a="Bestätigen",confirmLabel:s="Weiter",cancelLabel:i="Abbrechen",variant:o="default",icon:d=null}=n;return new Promise(r=>{const l=document.activeElement,c=document.createElement("div");c.className="app-dialog-overlay";const g=d==="info"?`
    ...
    </div>`,t)n.style.opacity="0",requestAnimationFrame(()=>{Wi(n,t,e.placement||"right"),n.style.visibility="visible",n.style.opacity="1"});else{n.style.top=n.style.left=n.style.right=n.style.bottom="",n.style.opacity="0",n.style.visibility="visible";const c=document.querySelector(".tour-blur-frame.full");requestAnimationFrame(()=>{c&&(c.style.opacity="1"),n.style.opacity="1"})}if((d=n.querySelector(".tour-skip"))==null||d.addEventListener("click",()=>{Mt()}),a||(r=n.querySelector(".tour-prev"))==null||r.addEventListener("click",async()=>{_.idx=Math.max(0,_.idx-1),await le()}),!i)(l=n.querySelector(".tour-next"))==null||l.addEventListener("click",async()=>{if(e.autoClick&&t){await Ci();try{const c=t.getAttribute("href");c&&c.startsWith("#/")?window.location.hash=c.slice(1):t.click()}catch(c){console.warn("tour autoClick error:",c)}if(e.onAfterClick)try{await e.onAfterClick()}catch(c){console.warn("tour onAfterClick error:",c)}else await new Promise(c=>setTimeout(c,350))}else if(e.onNext)try{await e.onNext()}catch(c){console.warn("tour onNext error:",c)}_.idx++,await le()});else{const c=_.idx,g=c<cn,h=async()=>{Nt(),document.querySelectorAll(".upload-modal-overlay").forEach(u=>u.remove()),await new Promise(u=>setTimeout(u,300)),_={idx:g?cn:c+1},await le()};document.addEventListener(e.waitForEvent,h,{once:!0}),we=()=>document.removeEventListener(e.waitForEvent,h)}}function Bi(e){var a,s,i;let t=document.querySelector(".tour-popover");t||(t=document.createElement("div"),t.className="tour-popover",t.style.visibility="hidden",document.body.appendChild(t)),t.classList.add("tour-popover-large","center"),t.style.visibility="visible";const n=_.idx===0;_.idx,Fe.length-1,t.innerHTML=`
    <div class="tour-popover-header">
      <span class="tour-popover-step">${_.idx+1} / ${Fe.length}</span>
      <button class="tour-skip" type="button" aria-label="Tour beenden">Überspringen</button>
    </div>
    ...
    </div>`,t.style.top=t.style.left=t.style.right=t.style.bottom="",t.style.opacity="1",(a=t.querySelector(".tour-skip"))==null||a.addEventListener("click",()=>{Mt()}),n||(s=t.querySelector(".tour-prev"))==null||s.addEventListener("click",async()=>{_.idx=Math.max(0,_.idx-1),await le()}),(i=t.querySelector(".tour-next"))==null||i.addEventListener("click",async()=>{_.idx++,await le()})}function Wi(e,t,n){const a=t.getBoundingClientRect(),s=16,i=e.offsetWidth||360,o=e.offsetHeight||220,d=window.innerWidth,r=window.innerHeight,l=[n,"right","bottom","left","top"];let c=null;for(const u of l)if((()=>{switch(u){case"right":return a.right+s+i<=d;case"left":return a.left-s-i>=0;case"bottom":return a.bottom+s+o<=r;case"top":return a.top-s-o>=0}})()){c=u;break}c=c||n;let g,h;switch(c){case"right":g=a.top+a.height/2-o/2,h=a.right+s;break;case"left":g=a.top+a.height/2-o/2,h=a.left-i-s;break;case"bottom":g=a.bottom+s,h=a.left+a.width/2-i/2;break;case"top":default:g=a.top-o-s,h=a.left+a.width/2-i/2;break}g=Math.max(s,Math.min(r-o-s,g)),h=Math.max(s,Math.min(d-i-s,h)),e.style.position="fixed",e.style.top=g+"px",e.style.left=h+"px",e.style.right="auto",e.style.bottom="auto",e.style.transform=""}function Mt(){Nt(),Li()}async function Ki({root:e}){var o;const t=await Vn(),n=await re();e.innerHTML=`
      ...
      <tbody>
        ${e.map(t=>`
          <tr>
            ...
            <td>${$(t.dateiname||"—")}</td>
            <td>${t.zeitraumVon?$(K(new Date(t.zeitraumVon))):"—"} – ${t.zeitraumBis?$(K(new Date(t.zeitraumBis))):"—"}</td>
            <td>${t.stichtagAuswertung?$(K(new Date(t.stichtagAuswertung))):"—"}</td>
...
Wenn du fortfährst, werden alle alten Tagesdaten gelöscht und durch die neuen ersetzt. (Profil-Einstellungen wie Theme und Mail-Vorlagen bleiben erhalten.)`,{title:"Anderer Azubi erkannt",confirmLabel:"Daten ersetzen",variant:"danger"})){s.style.pointerEvents="",s.style.opacity="",a.innerHTML=`
      ...
      <div class="card" style="grid-column: 1 / -1;">
        ...
        ${a?`
          ...
          <div class="tag-detail">
            ...
            <div class="tag-detail-value"><strong>${((d=n.wochentage14Taegig)==null?void 0:d.map(l=>hn[l]).join(", "))||"—"}</strong>${n.referenzDatum14Taegig?` <span class="hint">(Anker: ${K(new Date(n.referenzDatum14Taegig))})</span>`:""}</div>
          </div>
          <div class="tag-detail">
  ...
  `,e.querySelector("#profil-form").addEventListener("submit",async l=>{var h,u;l.preventDefault();const c=new FormData(l.target),g={...t,ueber18:c.get("ueber18")==="on",zeitwirtschaftEmail:((h=c.get("zeitwirtschaftEmail"))==null?void 0:h.trim())||"Zeitwirtschaft.Aichtal@putzmeister.com",zeitwirtschaftAnrede:((u=c.get("zeitwirtschaftAnrede"))==null?void 0:u.trim())||"Frau Kanarya"};await st(g),V("Profil gespeichert.")})}function fn(e){return String(e??"").replace(/"/g,"&quot;")}async function qi({params:e,root:t}){var l,c,g,h;const n=e.datum,a=await y.tage.get(n),s=await re();if(!a){t.innerHTML=`<h1 class="view-title">Tag nicht gefunden</h1><p>Für ${n} liegen keine Daten vor.</p><a href="#/" class="btn">← Dashboard</a>`;return}const i=N(n),o=a.tagestyp==="Stempelzeit"?Tn(a,s):null,d=dt(i,s.berufsschulMuster),r=An(a.zeitSpannen);t.innerHTML=`
    <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 8px;">
      <a href="#/kalender/${n.slice(0,7)}" class="btn sm">← Zum Monat</a>
    </div>
    <h1 class="view-title">${Et(i)}</h1>
    ...
    <div class="grid cols-2" style="gap: 24px;">
      <div class="card">
        ...
        ${(c=a.zeitSpannen)!=null&&c.length?a.zeitSpannen.map(u=>`
              <div class="tag-detail">
                <div class="tag-detail-label">${Oe(u.aktivitaet??"Stempelzeit")}</div>
      ...
      <div class="card">
        ...
        <div class="tag-detail">
          ...
          <div class="tag-detail-value">${a.tagestyp?`<span class="pill ${Zi(a.tagestyp)}">${Oe(a.tagestyp)}</span>`:"—"}</div>
        </div>
        <div class="tag-detail">
        ...
        <div class="tag-detail">
          ...
          <div class="tag-detail-value"><code>${Oe(a.tazp??"—")}</code></div>
        </div>
        <div class="tag-detail">
          <div class="tag-detail-label">Monat</div>
          <div class="tag-detail-value">${Oe(a.monatKey)}</div>
        </div>
      </div>
        ...
        <div class="card" style="grid-column: 1 / -1;">
          ...
          ${o.warnung?`
            <div class="alert severity-warn" style="margin-top: 12px;">
              ...
              <div class="alert-body">${Oe(o.warnung)}</div>
            </div>
          `:""}
        </div>
      `:""}
    </div>
  `}function Zi(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function Oe(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}const Gi=[{key:14,label:"2 Wochen"},{key:30,label:"1 Monat"},{key:90,label:"3 Monate"},{key:180,label:"6 Monate"},{key:365,label:"1 Jahr"},{key:730,label:"2 Jahre"},{key:"alles",label:"Alles"}];function Ui(e){return Gi.filter(t=>t.key==="alles"||t.key<e)}async function Ji({root:e}){var o;const[t,n]=await Promise.all([ce(),ot()]);if(!t.length){e.innerHTML='<h1 class="view-title">Analytics</h1><p class="view-subtitle">Keine Daten.</p><a href="#/daten" class="btn primary">Zum Upload</a>';return}const a=Ui(t.length);let s=a.some(d=>d.key===30)?30:"alles";e.innerHTML=`
  ...
  `;const i=()=>s==="alles"?t:t.slice(-s);requestAnimationFrame(()=>{Ds(e.querySelector("#c-saldo"),n),Es(e.querySelector("#c-wochen"),t),Jt(e.querySelector("#c-startend"),i()),Ps(e.querySelector("#c-wochentag"),t),As(e.querySelector("#c-pausen"),t),Ts(e.querySelector("#c-donut"),t),zs(e.querySelector("#c-alle-tage"),t.slice(-30))}),(o=e.querySelector("#startend-zeitraum"))==null||o.addEventListener("click",d=>{const r=d.target.closest("button[data-key]");if(!r||r.disabled)return;const l=r.getAttribute("data-key"),c=l==="alles"?"alles":parseInt(l,10);c!==s&&(s=c,e.querySelectorAll("#startend-zeitraum button").forEach(g=>g.classList.toggle("active",g===r)),Jt(e.querySelector("#c-startend"),i()))})}function Yi(e){return String(e??"").replace(/"/g,"&quot;")}async function vt({params:e,root:t}){const[n,a,s,i,o]=await Promise.all([ce(),ot(),re(),Ue(),ct()]),d=Object.fromEntries(o.map(x=>[x.key,x]));if(!n.length){t.innerHTML=`
      <h1 class="view-title">Kalender</h1>
      <p class="view-subtitle">Noch keine Daten geladen.</p>
      <a href="#/daten" class="btn primary">Zum Upload</a>`;return}const r=[...new Set(n.map(x=>x.monatKey))].sort(),l=e.yyyymm,c=r.includes(l)?l:r[r.length-1],g=n.filter(x=>x.monatKey===c),h=[...new Set(g.map(x=>x.wocheKey))].sort(),u=e.yyyykw,m=h.includes(u)?u:null,f=r.indexOf(c),b=f>0?r[f-1]:null,p=f<r.length-1?r[f+1]:null,w=Dt(c),v=a.find(x=>x.monatKey===c),E=En(n,a),F=E.filter(x=>x.monatKey===c),C=i!=null&&i.stichtagAuswertung?new Date(i.stichtagAuswertung):new Date,M=ut(n,s,C),z=M.filter(x=>x.datum.startsWith(c)),W=er({aktiverMonatKey:c,monatLabel:w,prevMonatKey:b,nextMonatKey:p,tageAnzahl:g.length,warnungenAnzahl:z.length});m?await Qi({root:t,switcherHtml:W,aktiverMonatKey:c,aktiveWocheKey:m,vollKurve:E,alleWarnungen:M,profil:s,vorlagenOverrides:d}):await Xi({root:t,switcherHtml:W,monatLabel:w,tageMonat:g,monatsKurve:F,monatUebersicht:v,monatsWarnungen:z,aktiverMonatKey:c,profil:s,vorlagenOverrides:d})}async function Xi({root:e,switcherHtml:t,monatLabel:n,tageMonat:a,monatsKurve:s,monatUebersicht:i,monatsWarnungen:o,aktiverMonatKey:d,profil:r,vorlagenOverrides:l}){e.innerHTML=`
    ${t}
  ...
  `,s.length&&(requestAnimationFrame(()=>{const c=e.querySelector("#chart-kalender-monat");c&&Lt(c,s)}),Wt(e.querySelector("#tage-liste-kalender")))}async function Qi({root:e,switcherHtml:t,aktiverMonatKey:n,aktiveWocheKey:a,vollKurve:s,alleWarnungen:i,profil:o,vorlagenOverrides:d}){var p;const r=s.filter(w=>w.wocheKey===a),l=r.reduce((w,v)=>w+lt(v),0),c=r.reduce((w,v)=>w+Tt(v),0),g=+(l-c).toFixed(2),h=w=>w>.05?"var(--success)":w<-.05?"var(--danger)":"var(--fg)",u=i.filter(w=>r.some(v=>v.datum===w.datum)),m=(p=r[0])==null?void 0:p.datum,f=m?Ge(N(m)):"",b=a.split("-")[1]||"?";e.innerHTML=`
    ${t}
    ...
    `}
  `,r.length&&(requestAnimationFrame(()=>{const w=e.querySelector("#chart-kalender-woche");w&&Lt(w,r)}),Wt(e.querySelector("#tage-liste-kalender")))}function er({aktiverMonatKey:e,monatLabel:t,prevMonatKey:n,nextMonatKey:a,tageAnzahl:s,warnungenAnzahl:i}){const o=n?Dt(n):"",d=a?Dt(a):"";return`
    ...
    </div>`}function nr(e,t){var s;const n={};for(const i of e)n[s=i.wocheKey]??(n[s]={key:i.wocheKey,tage:[],ist:0,soll:0}),n[i.wocheKey].tage.push(i),n[i.wocheKey].ist+=lt(i),n[i.wocheKey].soll+=Tt(i);const a=Object.keys(n).sort();return a.length?a.map(i=>{var h;const o=n[i],d=+(o.ist-o.soll).toFixed(2),r=d>.05?"var(--success)":d<-.05?"var(--danger)":"var(--fg-muted)",l=(h=o.tage.slice().sort((u,m)=>u.datum.localeCompare(m.datum))[0])==null?void 0:h.datum,c=l?Ge(N(l)):"",g=i.split("-")[1]||"?";return`
...
Vielen Dank!`,o=bn(s,a),d=bn(i,a),r=new URLSearchParams;return r.set("cc","anika.kailer@putzmeister.com"),r.set("subject",o),r.set("body",d),`mailto:annika.mayer@putzmeister.com?${r.toString().replace(/\+/g,"%20")}`}function bn(e,t){return e.replace(/\{(\w+)\}/g,(n,a)=>t[a]!=null?String(t[a]):`{${a}}`)}function br(e){const t=new Set;for(const n of e)n.tagestyp==="Berufsschule"&&(n.ist??0)>0&&t.add(n.monatKey);return[...t].sort().reverse()}function vr(e,t,n,a){var h,u;const s=t==null?void 0:t.berufsschulMuster;if(!s||!((h=s.wochentageWoechentlich)!=null&&h.length)&&!((u=s.wochentage14Taegig)!=null&&u.length))return{ausstehend:[],imMonatGesamt:n.length,vorhandenAnzahl:n.length};const[i,o]=e.split("-").map(m=>parseInt(m,10)),d=new Date(i,o-1,1),r=new Date(i,o,0),l=new Set(n.map(m=>m.datum)),c=[];let g=new Date(d);for(;g<=r;){if(!Ze(g)&&dt(g,s)){const m=L(g,"yyyy-MM-dd");g>a&&!l.has(m)&&c.push(m)}g=qe(g,1)}return{ausstehend:c,imMonatGesamt:n.length+c.length,vorhandenAnzahl:n.length}}function yr(e){const t=e instanceof ArrayBuffer?e:e!=null&&e.buffer?e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength):null;if(!t||t.byteLength<24)return null;const n=new DataView(t);if(n.getUint32(0)===2303741511&&n.getUint32(4)===218765834)return{width:n.getUint32(16),height:n.getUint32(20)};if(n.getUint16(0)===65496){let a=2;for(;a+9<n.byteLength;){if(n.getUint8(a)!==255)return null;const s=n.getUint8(a+1);if(s>=192&&s<=207&&s!==196&&s!==200&&s!==204)return{height:n.getUint16(a+5),width:n.getUint16(a+7)};const o=n.getUint16(a+2);if(o<2)return null;a+=2+o}}return null}function wr(e,t){if(!e||!t)return null;const n=a=>String(a).toLowerCase().replace(/[,.]/g," ").split(/\s+/).filter(Boolean).sort().join(" ");return n(e)===n(t)}function vn(e,t){const n={...e||{}},a={},s=(m,f)=>{f?a[m]="vorlage":n[m]?a[m]="zeitnachweis":a[m]="fehlt"},i=(t==null?void 0:t.name)||"",o=(t==null?void 0:t.personalnummer)||"",d=(t==null?void 0:t.kostenstelle)||"",r=n.name||"",c=wr(r,i)===!1,g=!!n.name;!n.name&&i&&(n.name=i),s("name",g);const h=!!n.persNr;!n.persNr&&o&&!c&&(n.persNr=o),s("persNr",h);const u=!!n.kst;return!n.kst&&d&&!c&&(n.kst=d),s("kst",u),a.vonHaltestelle=n.vonHaltestelle?"vorlage":"fehlt",a.nachHaltestelle=n.nachHaltestelle?"vorlage":"fehlt",a.betragProTag=n.betragProTag&&n.betragProTag>0?"vorlage":"fehlt",{konstanten:n,herkunft:a,nameKonflikt:c,vorlagenName:r,zeitnachweisName:i}}function kr(e,t){const n=URL.createObjectURL(e),a=document.createElement("a");a.href=n,a.download=t,document.body.appendChild(a),a.click(),document.body.removeChild(a),setTimeout(()=>URL.revokeObjectURL(n),1e3)}async function je({root:e}){var ne,Me,Ye,be,ve,Le,Xe,_e,De;const t=await Ie();if(!t){xr(e);return}const[n,a,s,i]=await Promise.all([ce(),re(),Ue(),Ys("fahrgeld_abgabe")]),o=s!=null&&s.stichtagAuswertung?new Date(s.stichtagAuswertung):new Date,d=br(n),r=new Date,l=`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,"0")}`;d.includes(l)||d.unshift(l);const c=d,g=t.format||"excel",h=g==="pdf"?"PDF":"Excel",u={name:"Name",persNr:"Personalnummer",kst:"Kostenstelle",vonHaltestelle:'Strecke „von"',nachHaltestelle:'Strecke „nach"',betragProTag:"Tagessatz"},m=vn(t.konstanten,s),f=m.konstanten,b=m.herkunft,p=m.nameKonflikt,v=Object.entries(b).filter(([S,A])=>A==="fehlt").map(([S])=>S).map(S=>u[S]||S),E=Object.entries(b).filter(([S,A])=>A==="zeitnachweis").map(([S])=>u[S]||S),F=(S,A)=>S?b[A]==="zeitnachweis"?`<span class="fahrtgeld-aus-zeitnachweis" title="Aus deinem Zeitnachweis-PDF übernommen — die Vorlage hatte hier nichts stehen.">${$(S)} <small>(aus Zeitnachweis)</small></span>`:$(S):`<span class="fahrtgeld-fehlend" title="In der hochgeladenen Vorlage nicht gefunden — bitte vor Abgabe ergänzen.">${$(u[A]||A)} fehlt</span>`,C=(S,A)=>F(S,A);e.innerHTML=`
    ...
    <div class="card fahrtgeld-template-info" style="margin-bottom: 24px;">
      <div class="card-split">
        <div>
          ...
          <p class="hint" style="margin: 4px 0 0;">
            ${C(f.name,"name")} ·
            Pers.-Nr. ${C(f.persNr,"persNr")} ·
            KST ${C(f.kst,"kst")}
          </p>
          <p class="hint" style="margin: 4px 0 0;">
            ${C(f.vonHaltestelle,"vonHaltestelle")} → ${C(f.nachHaltestelle,"nachHaltestelle")} ·
      ...
      ${E.length>0?`
        <div class="fahrtgeld-info-box" style="margin-top: 12px;">
          <strong>ℹ️ ${E.length} Feld${E.length===1?"":"er"} aus deinem Zeitnachweis ergänzt:</strong>
          ${E.map(S=>`<span class="fahrtgeld-info-chip">${$(S)}</span>`).join(" ")}
    ...
    <div class="card fahrtgeld-signature-info" style="margin-bottom: 24px;">
      <div class="card-split">
        <div>
          ...
          ${(ne=t.unterschrift)!=null&&ne.dataUrl?`
        ...
        <div style="display: flex; gap: 8px; align-items: flex-start;">
          <button class="btn sm" id="btn-signature-upload">${(Me=t.unterschrift)!=null&&Me.dataUrl?"Ersetzen":"Hochladen"}</button>
    ...
    `:(()=>{var Z;const S=c.map((D,ae)=>{const I=mn(n,D),X=+(I.length*(t.konstanten.betragProTag??0)).toFixed(2),ze=I.length>10,ye=vr(D,a,I,o),U=ye.ausstehend.length,H=+((I.length+U)*(t.konstanten.betragProTag??0)).toFixed(2),ht=U>0?ye.ausstehend.map(Ce=>K(N(Ce))).join(", "):"";return{mk:D,bs:I,summe:X,ueberzaehlig:ze,offen:U,offenListe:ht,summeMitOffen:H,idx:ae}}),A=((Z=S.find(D=>D.bs.length>0))==null?void 0:Z.mk)??S[0].mk,P=S.find(D=>D.mk===A)??S[0];return`
          <div class="card fahrtgeld-generate-card">
            <div class="fahrtgeld-generate-buttons">
              ...
              <div class="fahrtgeld-step-buttons fahrtgeld-step-buttons-files">
                <button class="btn-generate-big" id="btn-fahrtgeld-generate-excel" data-format="excel" ${P.bs.length===0?"disabled":""}>
                ...
                <button class="btn-generate-big" id="btn-fahrtgeld-generate-pdf" data-format="pdf" ${P.bs.length===0?"disabled":""}>
              ...
              <div class="fahrtgeld-step-buttons fahrtgeld-step-buttons-mail">
                <a class="btn-mail-big" id="btn-fahrtgeld-mail" href="${$(pn(P.mk,i))}" target="_blank" rel="noopener" ${P.bs.length===0?'aria-disabled="true"':""}>
            ...
            <div class="fahrtgeld-generate-info" id="fahrtgeld-generate-info">
              <div class="fahrtgeld-generate-monat">${$(nt(P.mk))}</div>
              <div class="hint" id="fahrtgeld-generate-detail">
                ${P.bs.length} BS-Tag${P.bs.length===1?"":"e"} erfasst · ${P.summe.toFixed(2).replace(".",",")} €
                ${P.offen>0?`<br><span class="fahrtgeld-pending">⏳ Laut Schul-Rhythmus kommen noch ${P.offen} BS-Tag${P.offen===1?"":"e"}: ${$(P.offenListe)} (mit allen: ${P.summeMitOffen.toFixed(2).replace(".",",")} €)</span>`:""}
                ${P.ueberzaehlig?`<br><span style="color: var(--warn); font-weight: 600;">· ${P.bs.length-10} überzählig (max 10/Monat)</span>`:""}
              </div>
          ...
          <div class="card">
            ...
            <div class="fahrtgeld-monate">
              ${S.map(D=>{const ae=D.mk===A?"checked":"",I=`data-monat="${$(D.mk)}" data-offen="${D.offen}" data-offen-liste="${$(D.offenListe)}" data-anzahl="${D.bs.length}" data-summe="${D.summe.toFixed(2).replace(".",",")}" data-summe-mit-offen="${D.summeMitOffen.toFixed(2).replace(".",",")}" data-monat-label="${$(nt(D.mk))}" data-ueberzaehlig="${D.ueberzaehlig?"1":"0"}"`;return`
                  <label class="fahrtgeld-monat-row${D.offen>0?" has-pending":""}${D.bs.length===0?" empty":""}" ${I}>
  ...
  `,(be=e.querySelector("#btn-template-replace"))==null||be.addEventListener("click",()=>{e.querySelector("#fahrtgeld-replace-input").click()}),(ve=e.querySelector("#fahrtgeld-replace-input"))==null||ve.addEventListener("change",async S=>{var P;const A=(P=S.target.files)==null?void 0:P[0];A&&await zt(A,e)}),(Le=e.querySelector("#btn-template-clear"))==null||Le.addEventListener("click",async()=>{await ie("Beim nächsten Öffnen wirst du gebeten, eine neue Vorlage hochzuladen.",{title:"Vorlage löschen?",confirmLabel:"Löschen",variant:"danger"})&&(await Zs(),V("Vorlage gelöscht."),je({root:e}))}),(Xe=e.querySelector("#btn-signature-upload"))==null||Xe.addEventListener("click",()=>{e.querySelector("#fahrtgeld-signature-input").click()}),(_e=e.querySelector("#fahrtgeld-signature-input"))==null||_e.addEventListener("change",async S=>{var P;const A=(P=S.target.files)==null?void 0:P[0];A&&await $r(A,e)}),(De=e.querySelector("#btn-signature-clear"))==null||De.addEventListener("click",async()=>{if(!await ie("Die hochgeladene Unterschrift wird entfernt — generierte Excel haben dann keine Unterschrift mehr.",{title:"Unterschrift entfernen?",confirmLabel:"Entfernen",variant:"danger"}))return;const S=await Ie();S&&(await _t({...S,unterschrift:null}),V("Unterschrift entfernt."),je({root:e}))});const M=e.querySelector("#btn-fahrtgeld-generate-excel"),z=e.querySelector("#btn-fahrtgeld-generate-pdf"),W=[M,z].filter(Boolean),x=e.querySelector("#btn-fahrtgeld-mail"),k=e.querySelector(".fahrtgeld-generate-monat"),T=e.querySelector("#fahrtgeld-generate-detail"),O=e.querySelectorAll(".fahrtgeld-monat-radio");function te(){const S=e.querySelector(".fahrtgeld-monat-radio:checked");if(!S)return;const A=S.closest(".fahrtgeld-monat-row");if(!A)return;const P=S.value,Z=parseInt(A.getAttribute("data-anzahl")||"0",10),D=A.getAttribute("data-summe")||"0,00",ae=parseInt(A.getAttribute("data-offen")||"0",10),I=A.getAttribute("data-offen-liste")||"",X=A.getAttribute("data-summe-mit-offen")||D,ze=A.getAttribute("data-monat-label")||"",ye=A.getAttribute("data-ueberzaehlig")==="1";if(k&&(k.textContent=ze),T){const U=[`${Z} BS-Tag${Z===1?"":"e"} erfasst · ${D} €`];ae>0&&U.push(`<br><span class="fahrtgeld-pending">⏳ Laut Schul-Rhythmus kommen noch ${ae} BS-Tag${ae===1?"":"e"}: ${$(I)} (mit allen: ${X} €)</span>`),ye&&U.push(`<br><span style="color: var(--warn); font-weight: 600;">· ${Z-10} überzählig (max 10/Monat)</span>`),T.innerHTML=U.join("")}W.forEach(U=>{U.disabled=Z===0}),x&&(x.href=pn(P,i),Z===0?x.setAttribute("aria-disabled","true"):x.removeAttribute("aria-disabled"))}O.forEach(S=>S.addEventListener("change",te));async function j(S){var ye,U;const A=e.querySelector(".fahrtgeld-monat-radio:checked");if(!A){J("Bitte einen Monat auswählen.",{type:"warn"});return}const P=A.closest(".fahrtgeld-monat-row"),Z=A.value,D=parseInt((P==null?void 0:P.getAttribute("data-offen"))||"0",10),ae=(P==null?void 0:P.getAttribute("data-offen-liste"))||"";if(D>0&&!await ie(`Laut deinem Schul-Rhythmus kommen in diesem Monat noch ${D} BS-Tag${D===1?"":"e"}:

${ae}

Diese Tage sind noch nicht im Zeitnachweis-PDF und werden in der ${S==="pdf"?"PDF":"Excel"} fehlen. Trotzdem jetzt für die bisher erfassten Tage generieren?`,{title:"Noch ausstehende BS-Tage",confirmLabel:"Trotzdem generieren"}))return;const I=S==="pdf"?z:M;I&&(I.disabled=!0);const X=I==null?void 0:I.querySelector(".btn-generate-label"),ze=X==null?void 0:X.textContent;X&&(X.textContent="Erstelle …");try{const H=await Ie(),ht=await ce(),Ce=mn(ht,Z);if(!Ce.length){J("Für diesen Monat sind keine BS-Anwesenheits-Tage erkannt.",{type:"warn"});return}const Ot=(ye=H.unterschrift)==null?void 0:ye.bytes,It=(U=H.unterschrift)==null?void 0:U.extension,Ht=H.format||"excel",ft=Ht===S,Rt=ft?H.bytes:null,oa=ft&&S==="pdf"?H.layout:null,jt=vn(H.konstanten,s).konstanten,{blob:ca,dateiname:qt,ueberzaehlig:mt}=S==="pdf"?await mr({templateBytes:Rt,layout:oa,monatKey:Z,bsTage:Ce,konstanten:jt,unterschriftBytes:Ot,unterschriftExtension:It}):await ur({templateBytes:Rt,monatKey:Z,bsTage:Ce,konstanten:jt,unterschriftBytes:Ot,unterschriftExtension:It});kr(ca,qt);const Zt=S==="pdf"?"PDF":"Excel",da=Array.isArray(H.missing)&&H.missing.length>0?` — bitte ${H.missing.length} fehlendes Feld${H.missing.length===1?"":"er"} vor Abgabe ergänzen`:"",ua=ft?"":` (aus deiner ${Ht==="pdf"?"PDF-":"Excel-"}Vorlage in ${Zt} überführt)`;V(`${Zt} erstellt: ${qt}${mt>0?` (${mt} weiterer Tag${mt===1?"":"e"} passte/n nicht in die Vorlage)`:""}${ua}${da}`)}catch(H){console.error("Fahrtgeld-Generierung fehlgeschlagen:",H),J(`Fehler: ${H.message||H}`,{type:"error",duration:8e3})}finally{I&&(I.disabled=!1),X&&ze&&(X.textContent=ze)}}M==null||M.addEventListener("click",()=>j("excel")),z==null||z.addEventListener("click",()=>j("pdf"))}function xr(e){e.innerHTML=`
    <h1 class="view-title">Fahrgelderstattung</h1>
...
`);navigator.clipboard.writeText(o).then(()=>V(`${i.length} Zeilen kopiert.`))});function s(){const i=a.value,d=(i?t.filter(r=>r.monatKey===i):t).filter(r=>r.ist!=null&&r.ist>0&&r.tagestyp!=="Wochenende");e.querySelector("#liste").innerHTML=Dr(d),e.querySelectorAll(".copy-val").forEach(r=>{r.addEventListener("click",async()=>{const l=r.getAttribute("data-val");await navigator.clipboard.writeText(l),r.classList.add("ok");const c=r.textContent;r.textContent="✓ kopiert",setTimeout(()=>{r.classList.remove("ok"),r.textContent=c},1200)})})}s()}function Dr(e){return e.length?`
    <table class="table">
      <thead>
        <tr>
          <th>Datum</th>
      ...
      <tbody>
        ${e.map(t=>{const n=He(t.ist),a=`${K(N(t.datum))}	${n}`;return`
            <tr data-copy="${yn(a)}">
              <td class="tabular">${K(N(t.datum))}</td>
  ...
  `:'<p style="color: var(--fg-muted);">Keine Tage in dieser Auswahl.</p>'}function zr(e){return{MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"}[e]??e}function Ar(e){const[t,n]=e.split("-");return L(new Date(parseInt(t),parseInt(n)-1,1),"LLLL yyyy",{locale:ee})}function Pr(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function la(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function yn(e){return la(e)}async function Tr({root:e}){const[t,n,a,s]=await Promise.all([ce(),re(),ot(),ct()]),i=Object.fromEntries(s.map(r=>[r.key,r])),o=ut(t,n,new Date).filter(r=>r.mailVorlageKey),d=jn(a);e.innerHTML=`
    ...
    <div class="card" style="margin-bottom: 24px;">
      ...
      ${o.length===0?'<div class="empty-state"><div class="empty-state-icon">✓</div><p>Keine akuten Warnungen — top.</p></div>':o.map(r=>Er(r,n,i)).join("")}
  ...
  `,Lr(e),_r(e)}function Er(e,t,n){const a=Je(e.mailVorlageKey,n[e.mailVorlageKey]);if(!a)return"";const s=Ct(t,e),i=qn(a,s),o=Bt(t,a,s);return`
...
${Q(i.text)}
  ...
  `}function Lr(e){e.querySelectorAll(".btn-save-vorlage").forEach(t=>{t.addEventListener("click",async()=>{const n=t.getAttribute("data-key"),a=t.closest(".vorlagen-item"),s=a.querySelector(".v-betreff").value,i=a.querySelector(".v-text").value;await it(n,{betreff:s,text:i}),V("Vorlage gespeichert.")})}),e.querySelectorAll(".btn-reset-vorlage").forEach(t=>{t.addEventListener("click",async()=>{const n=t.getAttribute("data-key"),a=Re[n];a&&await ie(`Deine Anpassungen an "${a.titel}" gehen verloren.`,{title:"Vorlage zurücksetzen?",confirmLabel:"Zurücksetzen",variant:"danger"})&&(await it(n,{betreff:a.betreff,text:a.text}),V("Zurückgesetzt."),setTimeout(()=>location.reload(),400))})})}function _r(e){e.querySelectorAll(".btn-copy-mail").forEach(t=>{t.addEventListener("click",async()=>{const n=t.getAttribute("data-subject"),a=t.getAttribute("data-body"),s=`Betreff: ${n}

${a}`;await navigator.clipboard.writeText(s),V("Mail-Text kopiert.")})})}function Q(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function At(e){return Q(e)}async function Cr({root:e}){const[t,n]=await Promise.all([re(),ct()]),a=Object.fromEntries(n.map(s=>[s.key,s]));e.innerHTML=`
  ...
  `,e.querySelector("#pause-sel").addEventListener("change",async s=>{const i={...t,pausenRegel:s.target.value};await st(i),V("Pausen-Regel gespeichert.")}),e.querySelectorAll(".btn-save-vorlage").forEach(s=>{s.addEventListener("click",async()=>{const i=s.getAttribute("data-key"),o=s.closest(".vorlagen-item"),d=o.querySelector(".v-betreff").value,r=o.querySelector(".v-text").value;await it(i,{betreff:d,text:r}),V("Vorlage gespeichert.")})}),e.querySelectorAll(".btn-reset-vorlage").forEach(s=>{s.addEventListener("click",async()=>{const i=s.getAttribute("data-key"),o=Re[i];o&&await ie(`Deine Anpassungen an "${o.titel}" gehen verloren.`,{title:"Vorlage zurücksetzen?",confirmLabel:"Zurücksetzen",variant:"danger"})&&(await it(i,{betreff:o.betreff,text:o.text}),V("Zurückgesetzt."),setTimeout(()=>location.reload(),400))})})}function Br(e){return`
    <div class="vorlagen-item" data-key="${e.key}" style="border: 1px solid var(--border); border-radius: var(--radius-md); padding: 16px; margin-bottom: 16px;">
      <div class="card-split" style="margin-bottom: 12px;">
        <div>
  ...
  `}function at(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Wr(e){return at(e)}async function wn(){document.documentElement.setAttribute("data-css-ready",""),_a();const e=document.getElementById("content");await Rs()&&setTimeout(()=>{J('Parser wurde aktualisiert. Bitte lade deinen Zeitnachweis unter "Daten" neu hoch.',{type:"info",duration:12e3})},500),await Hs(),await Os(),await Is(),q("/",an),q("/dashboard",an),q("/analytics",Ji),q("/kalender",vt),q("/kalender/typ/:typ",yt),q("/kalender/wochentag/:wd",yt),q("/kalender/pause/:bucket",yt),q("/kalender/:yyyymm",vt),q("/kalender/:yyyymm/:yyyykw",vt),q("/tag/:datum",qi),q("/berichtsheft",Mr),q("/mails",Tr),q("/fahrtgeld",je),q("/profil",ji),q("/daten",Ki),q("/einstellungen",Cr),Bs(e),location.hash||Cs("/");try{const t=await y.tage.count();Fi(t>0)&&setTimeout(()=>Jn(),700)}catch(t){console.warn("[boot] Tour-Auto-Start-Check fehlgeschlagen:",t)}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",wn):wn();
