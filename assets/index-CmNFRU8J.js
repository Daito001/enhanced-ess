import{D as nt}from"./dexie-BODkcwel.js";import{b as re,a as H,c as Z,d as st,f as x,e as Q,i as Oe,p as it,g as rt,h as lt,j as M,k as Ke,l as ot,s as ct,m as dt}from"./datefns-Dq49jaKA.js";import{C as E,L as ut,B as gt,D as ht,S as mt,a as ft,b as pt,P as vt,A as bt,c as yt,d as wt,T as $t,p as zt,e as Mt,i as xt}from"./chartjs-CRgZvhTJ.js";import{_ as St,a as kt}from"./pdfjs-BDGsuRSB.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const l of r.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&n(l)}).observe(document,{childList:!0,subtree:!0});function a(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(s){if(s.ep)return;s.ep=!0;const r=a(s);fetch(s.href,r)}})();const se="theme";function Dt(){const e=localStorage.getItem(se)??"auto";ue(e)}function ue(e){e==="auto"?document.documentElement.removeAttribute("data-theme"):document.documentElement.setAttribute("data-theme",e),localStorage.setItem(se,e),Tt(e)}function At(){const e=localStorage.getItem(se)??"auto",t=e==="auto"?"light":e==="light"?"dark":"auto";return ue(t),Ce(t),t}const le=new Set;function Pt(e){return le.add(e),()=>le.delete(e)}function Ce(e){for(const t of le)try{t(e)}catch(a){console.error(a)}}var Fe;if(typeof window<"u"&&window.matchMedia){const e=window.matchMedia("(prefers-color-scheme: dark)");(Fe=e.addEventListener)==null||Fe.call(e,"change",()=>{Ie()==="auto"&&Ce("auto")})}function Tt(e){const t=document.getElementById("theme-toggle");if(!t)return;const a=t.querySelector(".theme-label"),n=t.querySelector(".theme-icon-dark"),s=t.querySelector(".theme-icon-light");a&&(e==="auto"?(a.textContent="Auto",n&&(n.style.display="inline"),s&&(s.style.display="inline")):e==="light"?(a.textContent="Hell",n&&(n.style.display="none"),s&&(s.style.display="inline")):(a.textContent="Dunkel",n&&(n.style.display="inline"),s&&(s.style.display="none")))}function Ie(){return localStorage.getItem(se)??"auto"}const Be=[];let Re=null;function k(e,t){const a=e.split("/").filter(Boolean),n=[],s=new RegExp("^/?"+a.map(r=>r.startsWith(":")?(n.push(r.slice(1)),"([^/]+)"):Ot(r)).join("/")+"/?$");Be.push({pattern:e,regex:s,paramNames:n,render:t})}function Et(e){e.startsWith("#")||(e="#"+e),window.location.hash===e?L():window.location.hash=e}function Lt(e,{onNavigate:t}={}){window.addEventListener("hashchange",L),L.rootEl=e,L.onNavigate=t,L()}async function L(){var n;const e=L.rootEl,t=window.location.hash.slice(1)||"/",a=t.startsWith("/")?t:`/${t}`;for(const s of Be){const r=s.regex.exec(a);if(r){const l={};s.paramNames.forEach((i,o)=>l[i]=decodeURIComponent(r[o+1])),Re=a,(n=L.onNavigate)==null||n.call(L,a),Wt(a);try{e.classList.remove("view-enter"),await s.render({params:l,path:a,root:e}),e.classList.add("view-enter")}catch(i){console.error("Route render error:",i),e.innerHTML=`<div class="empty-state">
  ...
  </div>`}function Wt(e){document.querySelectorAll("[data-route]").forEach(t=>{const a=t.getAttribute("data-route"),n=a==="/"?e==="/":e===a||e.startsWith(a+"/");t.classList.toggle("active",n)})}function Ft(){Re!=null&&L()}function Ot(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function $e(e){return String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}const f=new nt("zeitnachweis");f.version(1).stores({profil:"id",tage:"datum, wochentag, tagestyp, monatKey, wocheKey",monate:"monatKey",uploads:"++id, hochladeDatum, stichtagAuswertung",einstellungen:"key",mailVorlagen:"key",warnungDismissals:"key"});f.version(2).stores({profil:"id",tage:"datum, wochentag, tagestyp, monatKey, wocheKey",monate:"monatKey",uploads:"++id, hochladeDatum, stichtagAuswertung",einstellungen:"key",mailVorlagen:"key",warnungDismissals:"key"}).upgrade(async e=>{await e.table("tage").clear(),await e.table("monate").clear(),await e.table("uploads").clear(),await e.table("warnungDismissals").clear(),await e.table("einstellungen").put({key:"__migration_reset",value:!0})});f.version(3).stores({profil:"id",tage:"datum, wochentag, tagestyp, monatKey, wocheKey",monate:"monatKey",uploads:"++id, hochladeDatum, stichtagAuswertung",einstellungen:"key",mailVorlagen:"key",warnungDismissals:"key"}).upgrade(async e=>{await e.table("tage").clear(),await e.table("monate").clear(),await e.table("uploads").clear(),await e.table("warnungDismissals").clear(),await e.table("einstellungen").put({key:"__migration_reset",value:!0})});async function Kt(){const e=await f.einstellungen.get("__migration_reset");return(e==null?void 0:e.value)===!0?(await f.einstellungen.delete("__migration_reset"),!0):!1}async function B(){return await f.profil.get("self")??Ve()}async function ge(e){const t={...e,id:"self",updatedAt:new Date().toISOString()};return await f.profil.put(t),t}function Ve(){return{id:"self",name:"",personalnummer:"",kostenstelle:"",einstellungsdatum:null,arbeitszeitplanregel:"",geburtsdatum:null,sollStundenProWoche:35,sollStundenProTag:7,berufsschulMuster:{wochentageWoechentlich:[],wochentage14Taegig:[],referenzDatum14Taegig:null},zeitwirtschaftEmail:"zeitwirtschaft@putzmeister.com",zeitwirtschaftAnrede:"Frau Kanarya",pausenRegel:"auto",erstelltAm:new Date().toISOString()}}async function Ct(e,t=null){const a=await f.einstellungen.get(e);return a?a.value:t}async function It(e,t){await f.einstellungen.put({key:e,value:t})}async function W(){return await f.tage.orderBy("datum").toArray()}async function Bt(e){return e.length?(await f.tage.bulkPut(e),e.length):0}async function Rt(e){return e.length?(await f.monate.bulkPut(e),e.length):0}async function Y(){return await f.monate.orderBy("monatKey").toArray()}async function Vt(e){return await f.uploads.add({...e,hochladeDatum:new Date().toISOString()})}async function _e(){return await f.uploads.orderBy("hochladeDatum").reverse().toArray()}async function _t(){await Promise.all([f.profil.clear(),f.tage.clear(),f.monate.clear(),f.uploads.clear(),f.einstellungen.clear(),f.mailVorlagen.clear(),f.warnungDismissals.clear()])}async function jt(){await Promise.all([f.tage.clear(),f.monate.clear(),f.uploads.clear(),f.warnungDismissals.clear()])}async function Ht(){const[e,t,a,n,s,r,l]=await Promise.all([f.profil.toArray(),f.tage.toArray(),f.monate.toArray(),f.uploads.toArray(),f.einstellungen.toArray(),f.mailVorlagen.toArray(),f.warnungDismissals.toArray()]);return{version:1,exportedAt:new Date().toISOString(),data:{profil:e,tage:t,monate:a,uploads:n,einstellungen:s,mailVorlagen:r,warnungDismissals:l}}}async function Zt(e){if(!e||e.version!==1||!e.data)throw new Error("Ungültiges oder inkompatibles Backup-Format.");const t=e.data;await f.transaction("rw",f.profil,f.tage,f.monate,f.uploads,f.einstellungen,f.mailVorlagen,f.warnungDismissals,async()=>{var a,n,s,r,l,i,o;(a=t.profil)!=null&&a.length&&await f.profil.bulkPut(t.profil),(n=t.tage)!=null&&n.length&&await f.tage.bulkPut(t.tage),(s=t.monate)!=null&&s.length&&await f.monate.bulkPut(t.monate),(r=t.uploads)!=null&&r.length&&await f.uploads.bulkPut(t.uploads),(l=t.einstellungen)!=null&&l.length&&await f.einstellungen.bulkPut(t.einstellungen),(i=t.mailVorlagen)!=null&&i.length&&await f.mailVorlagen.bulkPut(t.mailVorlagen),(o=t.warnungDismissals)!=null&&o.length&&await f.warnungDismissals.bulkPut(t.warnungDismissals)})}async function ze(e,t){await f.mailVorlagen.put({key:e,...t})}async function Gt(){return await f.mailVorlagen.toArray()}async function Nt(e,t){await f.warnungDismissals.put({key:`${e}-${t}`,datum:e,typ:t,dismissedAt:new Date().toISOString()})}async function qt(){return await f.warnungDismissals.toArray()}function je(e){if(e==null)return null;if(typeof e=="number")return e;let t=String(e).trim();if(!t)return null;let a=!1;t.endsWith("-")&&(a=!0,t=t.slice(0,-1).trim()),t=t.replace(",",".");const n=parseFloat(t);return isNaN(n)?null:a?-n:n}function He(e){if(e==null||isNaN(e))return"—";const t=e<0,a=Math.abs(e),n=Math.floor(a),s=Math.round((a-n)*60);let r=n,l=s;return l===60&&(r+=1,l=0),`${t?"-":""}${r}:${String(l).padStart(2,"0")}`}function D(e,t={}){if(e==null||isNaN(e))return"—";const{signed:a=!1,suffix:n="h"}=t,s=a&&e>0?"+":"",r=e.toFixed(2).replace(".",",");return`${s}${r}${n}`}function V(e){if(!e)return null;const t=/^(\d{1,2}):(\d{2})$/.exec(String(e).trim());return t?parseInt(t[1],10)*60+parseInt(t[2],10):null}const Me={lessThanXSeconds:{standalone:{one:"weniger als 1 Sekunde",other:"weniger als {{count}} Sekunden"},withPreposition:{one:"weniger als 1 Sekunde",other:"weniger als {{count}} Sekunden"}},xSeconds:{standalone:{one:"1 Sekunde",other:"{{count}} Sekunden"},withPreposition:{one:"1 Sekunde",other:"{{count}} Sekunden"}},halfAMinute:{standalone:"eine halbe Minute",withPreposition:"einer halben Minute"},lessThanXMinutes:{standalone:{one:"weniger als 1 Minute",other:"weniger als {{count}} Minuten"},withPreposition:{one:"weniger als 1 Minute",other:"weniger als {{count}} Minuten"}},xMinutes:{standalone:{one:"1 Minute",other:"{{count}} Minuten"},withPreposition:{one:"1 Minute",other:"{{count}} Minuten"}},aboutXHours:{standalone:{one:"etwa 1 Stunde",other:"etwa {{count}} Stunden"},withPreposition:{one:"etwa 1 Stunde",other:"etwa {{count}} Stunden"}},xHours:{standalone:{one:"1 Stunde",other:"{{count}} Stunden"},withPreposition:{one:"1 Stunde",other:"{{count}} Stunden"}},xDays:{standalone:{one:"1 Tag",other:"{{count}} Tage"},withPreposition:{one:"1 Tag",other:"{{count}} Tagen"}},aboutXWeeks:{standalone:{one:"etwa 1 Woche",other:"etwa {{count}} Wochen"},withPreposition:{one:"etwa 1 Woche",other:"etwa {{count}} Wochen"}},xWeeks:{standalone:{one:"1 Woche",other:"{{count}} Wochen"},withPreposition:{one:"1 Woche",other:"{{count}} Wochen"}},aboutXMonths:{standalone:{one:"etwa 1 Monat",other:"etwa {{count}} Monate"},withPreposition:{one:"etwa 1 Monat",other:"etwa {{count}} Monaten"}},xMonths:{standalone:{one:"1 Monat",other:"{{count}} Monate"},withPreposition:{one:"1 Monat",other:"{{count}} Monaten"}},aboutXYears:{standalone:{one:"etwa 1 Jahr",other:"etwa {{count}} Jahre"},withPreposition:{one:"etwa 1 Jahr",other:"etwa {{count}} Jahren"}},xYears:{standalone:{one:"1 Jahr",other:"{{count}} Jahre"},withPreposition:{one:"1 Jahr",other:"{{count}} Jahren"}},overXYears:{standalone:{one:"mehr als 1 Jahr",other:"mehr als {{count}} Jahre"},withPreposition:{one:"mehr als 1 Jahr",other:"mehr als {{count}} Jahren"}},almostXYears:{standalone:{one:"fast 1 Jahr",other:"fast {{count}} Jahre"},withPreposition:{one:"fast 1 Jahr",other:"fast {{count}} Jahren"}}},Jt=(e,t,a)=>{let n;const s=a!=null&&a.addSuffix?Me[e].withPreposition:Me[e].standalone;return typeof s=="string"?n=s:t===1?n=s.one:n=s.other.replace("{{count}}",String(t)),a!=null&&a.addSuffix?a.comparison&&a.comparison>0?"in "+n:"vor "+n:n},Ut={full:"EEEE, do MMMM y",long:"do MMMM y",medium:"do MMM y",short:"dd.MM.y"},Qt={full:"HH:mm:ss zzzz",long:"HH:mm:ss z",medium:"HH:mm:ss",short:"HH:mm"},Yt={full:"{{date}} 'um' {{time}}",long:"{{date}} 'um' {{time}}",medium:"{{date}} {{time}}",short:"{{date}} {{time}}"},Xt={date:re({formats:Ut,defaultWidth:"full"}),time:re({formats:Qt,defaultWidth:"full"}),dateTime:re({formats:Yt,defaultWidth:"full"})},ea={lastWeek:"'letzten' eeee 'um' p",yesterday:"'gestern um' p",today:"'heute um' p",tomorrow:"'morgen um' p",nextWeek:"eeee 'um' p",other:"P"},ta=(e,t,a,n)=>ea[e],aa={narrow:["v.Chr.","n.Chr."],abbreviated:["v.Chr.","n.Chr."],wide:["vor Christus","nach Christus"]},na={narrow:["1","2","3","4"],abbreviated:["Q1","Q2","Q3","Q4"],wide:["1. Quartal","2. Quartal","3. Quartal","4. Quartal"]},oe={narrow:["J","F","M","A","M","J","J","A","S","O","N","D"],abbreviated:["Jan","Feb","Mär","Apr","Mai","Jun","Jul","Aug","Sep","Okt","Nov","Dez"],wide:["Januar","Februar","März","April","Mai","Juni","Juli","August","September","Oktober","November","Dezember"]},sa={narrow:oe.narrow,abbreviated:["Jan.","Feb.","März","Apr.","Mai","Juni","Juli","Aug.","Sep.","Okt.","Nov.","Dez."],wide:oe.wide},ia={narrow:["S","M","D","M","D","F","S"],short:["So","Mo","Di","Mi","Do","Fr","Sa"],abbreviated:["So.","Mo.","Di.","Mi.","Do.","Fr.","Sa."],wide:["Sonntag","Montag","Dienstag","Mittwoch","Donnerstag","Freitag","Samstag"]},ra={narrow:{am:"vm.",pm:"nm.",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachm.",evening:"Abend",night:"Nacht"},abbreviated:{am:"vorm.",pm:"nachm.",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachmittag",evening:"Abend",night:"Nacht"},wide:{am:"vormittags",pm:"nachmittags",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachmittag",evening:"Abend",night:"Nacht"}},la={narrow:{am:"vm.",pm:"nm.",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachm.",evening:"abends",night:"nachts"},abbreviated:{am:"vorm.",pm:"nachm.",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachmittags",evening:"abends",night:"nachts"},wide:{am:"vormittags",pm:"nachmittags",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachmittags",evening:"abends",night:"nachts"}},oa=e=>Number(e)+".",ca={ordinalNumber:oa,era:H({values:aa,defaultWidth:"wide"}),quarter:H({values:na,defaultWidth:"wide",argumentCallback:e=>e-1}),month:H({values:oe,formattingValues:sa,defaultWidth:"wide"}),day:H({values:ia,defaultWidth:"wide"}),dayPeriod:H({values:ra,defaultWidth:"wide",formattingValues:la,defaultFormattingWidth:"wide"})},da=/^(\d+)(\.)?/i,ua=/\d+/i,ga={narrow:/^(v\.? ?Chr\.?|n\.? ?Chr\.?)/i,abbreviated:/^(v\.? ?Chr\.?|n\.? ?Chr\.?)/i,wide:/^(vor Christus|vor unserer Zeitrechnung|nach Christus|unserer Zeitrechnung)/i},ha={any:[/^v/i,/^n/i]},ma={narrow:/^[1234]/i,abbreviated:/^q[1234]/i,wide:/^[1234](\.)? Quartal/i},fa={any:[/1/i,/2/i,/3/i,/4/i]},pa={narrow:/^[jfmasond]/i,abbreviated:/^(j[aä]n|feb|mär[z]?|apr|mai|jun[i]?|jul[i]?|aug|sep|okt|nov|dez)\.?/i,wide:/^(januar|februar|märz|april|mai|juni|juli|august|september|oktober|november|dezember)/i},va={narrow:[/^j/i,/^f/i,/^m/i,/^a/i,/^m/i,/^j/i,/^j/i,/^a/i,/^s/i,/^o/i,/^n/i,/^d/i],any:[/^j[aä]/i,/^f/i,/^mär/i,/^ap/i,/^mai/i,/^jun/i,/^jul/i,/^au/i,/^s/i,/^o/i,/^n/i,/^d/i]},ba={narrow:/^[smdmf]/i,short:/^(so|mo|di|mi|do|fr|sa)/i,abbreviated:/^(son?|mon?|die?|mit?|don?|fre?|sam?)\.?/i,wide:/^(sonntag|montag|dienstag|mittwoch|donnerstag|freitag|samstag)/i},ya={any:[/^so/i,/^mo/i,/^di/i,/^mi/i,/^do/i,/^f/i,/^sa/i]},wa={narrow:/^(vm\.?|nm\.?|Mitternacht|Mittag|morgens|nachm\.?|abends|nachts)/i,abbreviated:/^(vorm\.?|nachm\.?|Mitternacht|Mittag|morgens|nachm\.?|abends|nachts)/i,wide:/^(vormittags|nachmittags|Mitternacht|Mittag|morgens|nachmittags|abends|nachts)/i},$a={any:{am:/^v/i,pm:/^n/i,midnight:/^Mitte/i,noon:/^Mitta/i,morning:/morgens/i,afternoon:/nachmittags/i,evening:/abends/i,night:/nachts/i}},za={ordinalNumber:st({matchPattern:da,parsePattern:ua,valueCallback:e=>parseInt(e)}),era:Z({matchPatterns:ga,defaultMatchWidth:"wide",parsePatterns:ha,defaultParseWidth:"any"}),quarter:Z({matchPatterns:ma,defaultMatchWidth:"wide",parsePatterns:fa,defaultParseWidth:"any",valueCallback:e=>e+1}),month:Z({matchPatterns:pa,defaultMatchWidth:"wide",parsePatterns:va,defaultParseWidth:"any"}),day:Z({matchPatterns:ba,defaultMatchWidth:"wide",parsePatterns:ya,defaultParseWidth:"any"}),dayPeriod:Z({matchPatterns:wa,defaultMatchWidth:"wide",parsePatterns:$a,defaultParseWidth:"any"})},I={code:"de",formatDistance:Jt,formatLong:Xt,formatRelative:ta,localize:ca,match:za,options:{weekStartsOn:1,firstWeekContainsDate:4}};function U(e){if(!e)return null;const t=e.trim();return it(t,"dd.MM.yyyy",new Date)}function b(e){return x(e,"dd.MM.yyyy")}function Ze(e){return x(e,"EE, dd.MM.yyyy",{locale:I})}function Ma(e){return`${rt(e)}-${String(lt(e)).padStart(2,"0")}`}function Ge(e){return x(e,"yyyy-MM")}function xa(e){return x(e,"yyyy-MM-dd")}function Sa(e,t){if(!e||!t)return 0;e>t&&([e,t]=[t,e]);let a=0,n=new Date(e);for(;n<t;)n=Q(n,1),Oe(n)||a++;return a}function C(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Ne(e){var l;const t=e.filter(i=>i.tagestyp==="Berufsschule");if(t.length<2)return{wochentageWoechentlich:[],wochentage14Taegig:[],referenzDatum14Taegig:null};const a={};for(const i of t)a[l=i.wochentag]??(a[l]=[]),a[i.wochentag].push(i);const n=[],s=[];let r=null;for(const[i,o]of Object.entries(a)){o.sort((u,g)=>u.datum.localeCompare(g.datum));const c=M(o[0].datum),d=M(o[o.length-1].datum),p=Ke(d,c,{weekStartsOn:1})+1,h=o.length/Math.max(1,p);h>=.75?n.push(i):h>=.35&&h<=.65&&(s.push(i),(!r||M(o[0].datum)<M(r))&&(r=o[0].datum))}return{wochentageWoechentlich:n,wochentage14Taegig:s,referenzDatum14Taegig:r}}function qe(e,t){var s,r;if(!t)return!1;const n=["SO","MO","DI","MI","DO","FR","SA"][e.getDay()];if((s=t.wochentageWoechentlich)!=null&&s.includes(n))return!0;if((r=t.wochentage14Taegig)!=null&&r.includes(n)&&t.referenzDatum14Taegig){const l=M(t.referenzDatum14Taegig),i=Ke(e,l,{weekStartsOn:1});if(i>=0&&i%2===0)return!0}return!1}function ka(e,t){if(!e)return"arbzg";const a=M(e);return ot(t,a)<18?"jarbschg":"arbzg"}function Da(e,t){return e==null?0:t==="jarbschg"?e>6?1:e>4.5?.5:0:e>9?.75:e>6?.5:0}function Aa(e){if(!e||e.length<2)return 0;const t=e.filter(n=>n.von&&n.bis).map(n=>({von:V(n.von),bis:V(n.bis)})).filter(n=>n.von!=null&&n.bis!=null).sort((n,s)=>n.von-s.von);let a=0;for(let n=1;n<t.length;n++){const s=t[n].von-t[n-1].bis;(s>0&&s>=15||s>0)&&(a+=s)}return a/60}function Je(e,t){const a=e.zeitSpannen??[];if(!a.length||a.every(g=>!g.von))return{keinAnspruch:!0};const n=Aa(a),s=e.pause??0,r=Pa(a),l=r-s,i=t.pausenRegel&&t.pausenRegel!=="auto"?t.pausenRegel==="jarbschg"?"jarbschg":"arbzg":ka(t.geburtsdatum,M(e.datum)),o=Da(l,i),c=Math.max(n,o),d=s-c,p=Math.max(0,o-n);let h="ok",u=null;if(d>.05)h="fehler_zeitwirtschaft",u=`${Math.round(d*60)} min Pause wurden zusätzlich zur gesetzlichen Pflicht und zur gestempelten Pause abgezogen. Das sieht nach einem Zeitwirtschafts-Fehler aus.`;else if(p>.05&&s>n+.02){h="aufstockung_legal";const g=Math.round(p*60);u=`Du hast ${Math.round(n*60)} min Pause gestempelt, aber bei ${l.toFixed(2).replace(".",",")}h Arbeitszeit schreibt das Gesetz (${i.toUpperCase()}) ${Math.round(o*60)} min vor. Die fehlenden ${g} min wurden automatisch als Pause gewertet. Das ist gesetzeskonform — nächstes Mal einfach länger Pause machen.`}return{arbeitszeitMitPause:r,arbeitszeitOhnePause:l,gestempeltePause:n,abgezogenePause:s,gesetzlichePflicht:o,gesetz:i,legalerAbzug:c,unrechtmaessigerVerlustMin:Math.round(Math.max(0,d)*60),aufstockungMin:Math.round(Math.max(0,p)*60),typ:h,warnung:u}}function Pa(e){let t=0;for(const a of e){if(!a.von||!a.bis)continue;const n=V(a.von),s=V(a.bis);n!=null&&s!=null&&s>n&&(t+=s-n)}return t/60}const G={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"};function he(e,t,a,n=new Set){var d,p;const s=[],r=a??new Date,l=new Map(e.map(h=>[h.datum,h]));if(!e.length)return s;const i=M(e[0].datum),o=r;for(let h=new Date(i);h<=o;h=Q(h,1)){if(Oe(h))continue;const u=x(h,"yyyy-MM-dd"),g=l.get(u),v=Sa(h,o);if(!g||!g.tagestyp&&!g.ist&&(((d=g.zeitSpannen)==null?void 0:d.length)??0)===0){if(qe(h,t.berufsschulMuster)){const m=v>=4?"error":v>=2?"warn":"info";N(s,n,{datum:u,wochentag:(g==null?void 0:g.wochentag)??X(h),typ:"bs_tag_fehlt",schweregrad:m,titel:`Berufsschultag nicht eingetragen: ${b(h)}`,beschreibung:`Laut deinem Profil hast du am ${G[X(h)]}, ${b(h)} Berufsschule. Im Zeitnachweis fehlt der Tag bisher${v>=4?" — bitte bei der Zeitwirtschaft nachhaken":""}.`,alter:v,mailVorlageKey:m==="error"?"bs_tag_fehlt":null})}else{const m=v>=4?"error":v>=2?"warn":"info";N(s,n,{datum:u,wochentag:X(h),typ:"stempelzeit_fehlt",schweregrad:m,titel:`Keine Stempelzeit am ${b(h)}`,beschreibung:`Am ${G[X(h)]}, ${b(h)} wurde keine Stempelzeit erfasst. Falls du an diesem Tag im Haus warst, sollte die Zeitwirtschaft das nachtragen${v>=4?" — es ist inzwischen ≥4 Werktage her":""}.`,alter:v,mailVorlageKey:m==="error"?"stempelzeit_fehlt":null})}continue}if(g.tagestyp==="Berufsschule"&&g.ist!=null&&g.soll!=null&&g.ist<g.soll-.01&&N(s,n,{datum:u,wochentag:g.wochentag,typ:"bs_stunden_falsch",schweregrad:"error",titel:`Berufsschultag mit zu wenig Stunden: ${b(h)}`,beschreibung:`Am ${G[g.wochentag]}, ${b(h)} sind nur ${g.ist.toFixed(2).replace(".",",")}h gebucht statt regulär ${g.soll.toFixed(2).replace(".",",")}h. Die Zeitwirtschaft hat den Berufsschultag möglicherweise nur halb erfasst.`,ist:g.ist,soll:g.soll,mailVorlageKey:"bs_stunden_falsch"}),g.tagestyp==="Stempelzeit"&&((p=g.zeitSpannen)==null?void 0:p.length)>1&&u>="2026-04-01"){const m=Je(g,t);(m==null?void 0:m.typ)==="fehler_zeitwirtschaft"&&m.unrechtmaessigerVerlustMin>=5?N(s,n,{datum:u,wochentag:g.wochentag,typ:"pausen_abzug",schweregrad:m.unrechtmaessigerVerlustMin>=15?"error":"warn",titel:`Pausen-Abzug fehlerhaft (${b(h)})`,beschreibung:`Am ${G[g.wochentag]}, ${b(h)} wurden ${Math.round(m.abgezogenePause*60)} min Pause abgezogen. Gestempelt: ${Math.round(m.gestempeltePause*60)} min, gesetzlich nötig (${m.gesetz.toUpperCase()}): ${Math.round(m.gesetzlichePflicht*60)} min. Differenz von ${m.unrechtmaessigerVerlustMin} min ist unerklärlich.`,verlustMinuten:m.unrechtmaessigerVerlustMin,abgezogen:m.abgezogenePause,gestempelt:m.gestempeltePause,mailVorlageKey:"pausen_abzug"}):(m==null?void 0:m.typ)==="aufstockung_legal"&&m.aufstockungMin>=10&&N(s,n,{datum:u,wochentag:g.wochentag,typ:"pausen_aufstockung",schweregrad:"info",titel:`Zu wenig Pause gestempelt (${b(h)}) — ${m.aufstockungMin} min automatisch aufgestockt`,beschreibung:`Am ${G[g.wochentag]}, ${b(h)} hast du nur ${Math.round(m.gestempeltePause*60)} min Pause gemacht. Gesetz (${m.gesetz.toUpperCase()}) schreibt ${Math.round(m.gesetzlichePflicht*60)} min vor. Fehlende ${m.aufstockungMin} min wurden als Pause gewertet — das ist legal, aber du verlierst dadurch Arbeitszeit. Tipp: mach beim nächsten Mal etwas länger Mittag.`})}}const c={error:0,warn:1,info:2};return s.sort((h,u)=>{const g=c[h.schweregrad]-c[u.schweregrad];return g!==0?g:u.datum.localeCompare(h.datum)}),s}function Ue(e,t=new Set){var n,s,r,l;const a=[];for(const i of e){const o=((n=i.glz)==null?void 0:n.saldoVorperiode)??0,c=((s=i.glz)==null?void 0:s.saldoAktuellePeriode)??0,d=((r=i.glz)==null?void 0:r.umgebuchteStunden)??0,p=(l=i.glz)==null?void 0:l.saldoGesamt;if(p==null)continue;const h=o+c+d,u=Math.abs(p-h);if(u>.03){const g=`${i.monatKey}-saldo_plausi`;t.has(g)||a.push({datum:`${i.monatKey}-01`,wochentag:"",typ:"saldo_plausi",schweregrad:"warn",titel:`Saldo-Differenz im Monat ${i.monatKey}`,beschreibung:`Rechnung: Vorperiode ${o.toFixed(2)} + aktuelle Periode ${c.toFixed(2)} + umgebucht ${d.toFixed(2)} = ${h.toFixed(2)}, aber dein Saldo wird mit ${p.toFixed(2)} angezeigt. Abweichung: ${u.toFixed(2)}h.`,soll:h,ist:p})}}return a}function N(e,t,a){const n=`${a.datum}-${a.typ}`;t.has(n)||(a.id=n,e.push(a))}function X(e){return["SO","MO","DI","MI","DO","FR","SA"][e.getDay()]}function Ta(e,t){var o,c,d;const a=[...e].sort((p,h)=>p.datum.localeCompare(h.datum));if(!a.length)return[];const n=new Map(t.map(p=>[p.monatKey,p])),s={};for(const p of a)s[o=p.monatKey]??(s[o]=[]),s[p.monatKey].push(p);const r=Object.keys(s).sort(),l=[];let i=null;for(const p of r){const h=n.get(p);let u;((c=h==null?void 0:h.glz)==null?void 0:c.saldoVorperiode)!=null?u=h.glz.saldoVorperiode:i!=null?u=i:u=0;const g=s[p];for(const v of g)v.diff!=null&&(u+=v.diff),l.push({datum:v.datum,wochentag:v.wochentag,saldo:Math.round(u*100)/100,diff:v.diff,ist:v.ist,soll:v.soll,tagestyp:v.tagestyp,monatKey:v.monatKey,zeitSpannen:v.zeitSpannen});if(((d=h==null?void 0:h.glz)==null?void 0:d.saldoGesamt)!=null){const v=h.glz.saldoGesamt-u;if(Math.abs(v)>.02&&l.length>0){const $=l.length-1;l[$].umbuchung=v,l[$].saldo=Math.round((l[$].saldo+v)*100)/100,u=l[$].saldo}i=h.glz.saldoGesamt}else i=u}return l}function Ea(e,t){if(!e.length)return[];if(t==="alles")return e;const a=Math.min(t,e.length);return e.slice(-a)}function La(e){return e.length?e[e.length-1].saldo:0}function Wa(e){if(!e.length)return 0;const t=e[0].saldo-(e[0].diff??0),a=e[e.length-1].saldo;return Math.round((a-t)*100)/100}E.register(ut,gt,ht,mt,ft,pt,vt,bt,yt,wt,$t,zt,Mt,xt);function z(e){return getComputedStyle(document.documentElement).getPropertyValue(e).trim()}function O(){return{fg:z("--fg"),fgMuted:z("--fg-muted"),fgSubtle:z("--fg-subtle"),border:z("--border"),surface:z("--surface"),accent:z("--accent"),success:z("--success"),warn:z("--warn"),danger:z("--danger"),info:z("--info"),palette:[z("--chart-1"),z("--chart-2"),z("--chart-3"),z("--chart-4"),z("--chart-5"),z("--chart-6"),z("--chart-7")]}}function y(e){return{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{labels:{color:e.fgMuted,font:{size:12}}},tooltip:{backgroundColor:e.surface,titleColor:e.fg,bodyColor:e.fg,borderColor:e.border,borderWidth:1,padding:10,displayColors:!0}},scales:{x:{ticks:{color:e.fgMuted,font:{size:11}},grid:{color:e.border,drawBorder:!1}},y:{ticks:{color:e.fgMuted,font:{size:11}},grid:{color:e.border,drawBorder:!1}}}}}function Fa(e,t){const a=O();if(K(e),!(t!=null&&t.length))return;const n=t.map(r=>x(M(r.datum),"dd.MM.")),s=t.map(r=>r.saldo);return s.map(r=>r>=0?a.success:a.danger),new E(e,{type:"line",data:{labels:n,datasets:[{label:"Tages-Saldo",data:s,borderColor:a.accent,backgroundColor:fe(a.accent,.14),tension:.25,pointRadius:2,pointHoverRadius:5,pointBackgroundColor:s.map(r=>r>=0?a.success:a.danger),pointBorderColor:a.surface,pointBorderWidth:1,fill:!0,borderWidth:2}]},options:{...y(a),plugins:{...y(a).plugins,legend:{display:!1},tooltip:{...y(a).plugins.tooltip,callbacks:{title:r=>{const l=t[r[0].dataIndex];return x(M(l.datum),"EE, dd.MM.yyyy",{locale:I})},label:r=>{const l=t[r.dataIndex],i=[`Saldo: ${l.saldo.toFixed(2).replace(".",",")}h`];return l.diff!=null&&i.push(`Tages-Diff: ${l.diff>=0?"+":""}${l.diff.toFixed(2).replace(".",",")}h`),l.tagestyp&&i.push(`Typ: ${l.tagestyp}`),l.umbuchung&&i.push(`Umbuchung: ${l.umbuchung>=0?"+":""}${l.umbuchung.toFixed(2).replace(".",",")}h`),i}}}},scales:{...y(a).scales,y:{...y(a).scales.y,ticks:{...y(a).scales.y.ticks,callback:r=>`${r>=0?"+":""}${r.toFixed(1).replace(".",",")}h`}}}}})}function Oa(e,t){const a=O();if(K(e),!(t!=null&&t.length))return;const n=t.map(r=>r.monatKey),s=t.map(r=>{var l;return((l=r.glz)==null?void 0:l.saldoGesamt)??0});return new E(e,{type:"line",data:{labels:n,datasets:[{label:"GLZ-Saldo (Monatsende)",data:s,borderColor:a.accent,backgroundColor:fe(a.accent,.18),tension:.35,fill:!0,pointRadius:4}]},options:y(a)})}function me(e,t){const a=O();if(K(e),!(t!=null&&t.length))return;const n=t.map(l=>x(M(l.datum),"dd.MM.")),s=t.map(l=>l.ist??0),r=t.map(l=>_a(l.tagestyp,a));return new E(e,{type:"bar",data:{labels:n,datasets:[{label:"Ist-Stunden",data:s,backgroundColor:r,borderRadius:4,borderSkipped:!1}]},options:{...y(a),plugins:{...y(a).plugins,legend:{display:!1},tooltip:{...y(a).plugins.tooltip,callbacks:{label:l=>{const i=t[l.dataIndex];return`${i.tagestyp??"—"}: ${(i.ist??0).toFixed(2).replace(".",",")}h`}}}},scales:{...y(a).scales,y:{...y(a).scales.y,suggestedMin:0,suggestedMax:10}}}})}function Ka(e,t){const a=O();if(K(e),!(t!=null&&t.length))return;const n=t.filter(s=>{var r;return((r=s.zeitSpannen)==null?void 0:r.length)&&s.zeitSpannen[0].von}).map(s=>({x:M(s.datum).getTime(),von:V(s.zeitSpannen[0].von),bis:V(s.zeitSpannen[s.zeitSpannen.length-1].bis)}));return new E(e,{type:"scatter",data:{datasets:[{label:"Arbeitsbeginn",data:n.map(s=>({x:s.x,y:s.von})),backgroundColor:a.palette[0],pointRadius:3},{label:"Arbeitsende",data:n.map(s=>({x:s.x,y:s.bis})),backgroundColor:a.palette[3],pointRadius:3}]},options:{...y(a),scales:{x:{type:"linear",ticks:{color:a.fgMuted,callback:s=>x(new Date(s),"MMM yyyy",{locale:I})},grid:{color:a.border}},y:{min:0,max:20*60,ticks:{color:a.fgMuted,stepSize:60,callback:s=>`${String(Math.floor(s/60)).padStart(2,"0")}:00`},grid:{color:a.border}}}}})}function Ca(e,t){const a=O();K(e);const n={};for(const l of t){if(l.pause==null||l.tagestyp!=="Stempelzeit")continue;const i=Math.round(l.pause*60),o=Math.floor(i/15)*15;n[o]=(n[o]??0)+1}const s=Object.keys(n).map(Number).sort((l,i)=>l-i),r=s.map(l=>n[l]);return new E(e,{type:"bar",data:{labels:s.map(l=>`${l}–${l+14}min`),datasets:[{label:"Häufigkeit",data:r,backgroundColor:a.palette[1],borderRadius:4}]},options:{...y(a),plugins:{...y(a).plugins,legend:{display:!1}}}})}function Ia(e,t){const a=O();K(e);const n=["MO","DI","MI","DO","FR"],s={},r={};for(const i of n)s[i]=0,r[i]=0;for(const i of t)n.includes(i.wochentag)&&(i.ist==null||i.ist===0||(s[i.wochentag]+=i.ist,r[i.wochentag]+=1));const l=n.map(i=>r[i]>0?s[i]/r[i]:0);return new E(e,{type:"bar",data:{labels:["Montag","Dienstag","Mittwoch","Donnerstag","Freitag"],datasets:[{label:"Ø Ist-Stunden",data:l,backgroundColor:a.palette[2],borderRadius:4}]},options:{...y(a),plugins:{...y(a).plugins,legend:{display:!1}}}})}function Ba(e,t){const a=O();K(e);const n={};for(const l of t)!l.tagestyp||l.tagestyp==="Wochenende"||(n[l.tagestyp]=(n[l.tagestyp]??0)+1);const s=Object.keys(n),r=Object.values(n);return new E(e,{type:"doughnut",data:{labels:s,datasets:[{data:r,backgroundColor:s.map((l,i)=>a.palette[i%a.palette.length]),borderColor:a.surface,borderWidth:2}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"right",labels:{color:a.fgMuted,font:{size:12}}},tooltip:y(a).plugins.tooltip}}})}function Ra(e,t){const a=O();K(e);const n={};for(const i of t){const o=i.wocheKey;n[o]??(n[o]={ist:0,soll:0}),n[o].ist+=i.ist??0,n[o].soll+=i.soll??0}const s=Object.keys(n).sort(),r=s.map(i=>n[i].ist),l=s.map(i=>n[i].soll);return new E(e,{type:"bar",data:{labels:s.map(i=>"KW "+i.split("-")[1]),datasets:[{label:"Ist",data:r,backgroundColor:a.palette[0],borderRadius:4},{label:"Soll",data:l,backgroundColor:a.palette[3],borderRadius:4}]},options:y(a)})}function Va(e,t){const a=O();K(e);const n=t.slice().sort((l,i)=>l.datum.localeCompare(i.datum));let s=0;const r=n.map(l=>(s+=l.diff??0,{x:l.datum,y:s}));return new E(e,{type:"line",data:{labels:r.map(l=>l.x),datasets:[{label:"Kumulative Differenz (+/- Soll)",data:r.map(l=>l.y),borderColor:a.palette[5],backgroundColor:fe(a.palette[5],.15),fill:!0,tension:.2,pointRadius:0}]},options:{...y(a),scales:{x:{display:!1,grid:{display:!1}},y:{...y(a).scales.y}}}})}function Qe(e,t,{monate:a=8}={}){if(!e)return;if(e.innerHTML="",!t.length){e.innerHTML='<p style="color: var(--fg-muted); font-size: 13px;">Keine Daten.</p>';return}const n=new Map(t.map(g=>[g.datum,g])),r=M(t[t.length-1].datum),l=a*30,i=Q(r,-l),o=ct(i,{weekStartsOn:1}),c=dt(r,o)+1,d=Math.ceil(c/7),p=document.createElement("div");p.className="heatmap-month-labels",p.style.gridTemplateColumns=`repeat(${d}, 14px)`,e.appendChild(p);let h=-1;for(let g=0;g<d;g++){const v=Q(o,g*7),$=v.getMonth(),m=document.createElement("span");m.textContent=$!==h?x(v,"MMM",{locale:I}):"",p.appendChild(m),h=$}const u=document.createElement("div");u.className="heatmap",u.style.gridAutoFlow="column",u.style.gridTemplateRows="repeat(7, 14px)",u.style.gridTemplateColumns=`repeat(${d}, 14px)`;for(let g=0;g<d*7;g++){const v=Q(o,g);if(v>r||v<i){const R=document.createElement("div");R.className="heatmap-cell",R.style.background="transparent",u.appendChild(R);continue}const $=x(v,"yyyy-MM-dd"),m=n.get($),S=document.createElement("div");S.className="heatmap-cell",S.title=`${x(v,"EE, dd.MM.yyyy",{locale:I})}${(m==null?void 0:m.ist)!=null?" · Ist "+m.ist.toFixed(2)+"h":""}${(m==null?void 0:m.diff)!=null?" · "+(m.diff>=0?"+":"")+m.diff.toFixed(2):""}`,(m==null?void 0:m.diff)!=null&&(m.diff<=-1?S.classList.add("neg-2"):m.diff<-.05?S.classList.add("neg-1"):m.diff>=1?S.classList.add("pos-2"):m.diff>.05&&S.classList.add("pos-1")),u.appendChild(S)}e.appendChild(u)}function K(e){const t=E.getChart(e);t&&t.destroy()}function fe(e,t){const a=e.replace("#","").trim();if(a.length!==6&&a.length!==3)return e;const n=a.length===3?a.split("").map(i=>i+i).join(""):a,s=parseInt(n.slice(0,2),16),r=parseInt(n.slice(2,4),16),l=parseInt(n.slice(4,6),16);return`rgba(${s}, ${r}, ${l}, ${t})`}function _a(e,t){const a=String(e??"").toLowerCase();return a.includes("stempel")?t.palette[0]:a.includes("berufs")?t.palette[1]:a.includes("urlaub")?t.palette[2]:a.includes("feiertag")?t.fgSubtle:a.includes("dienst")?t.palette[3]:a.includes("krank")?t.palette[4]:t.palette[5]}let ja=0;function ie(e,{type:t="info",duration:a=3500}={}){const n=document.getElementById("toast-root");if(!n)return;const s=document.createElement("div");s.className=`toast ${t}`,s.textContent=e,s.dataset.id=++ja,n.appendChild(s),setTimeout(()=>{s.style.opacity="0",s.style.transform="translateY(-8px)",s.style.transition="opacity 220ms, transform 220ms",setTimeout(()=>s.remove(),250)},a)}function pe(e){return ie(e,{type:"error",duration:6e3})}function A(e){return ie(e,{type:"success"})}const Ha=[{key:7,label:"1 Woche"},{key:14,label:"2 Wochen"},{key:30,label:"1 Monat"},{key:90,label:"3 Monate"},{key:"alles",label:"Alles"}];async function xe({root:e}){var S,R,be,ye;const[t,a,n,s,r]=await Promise.all([B(),Y(),W(),qt(),Ct("dashboardZeitraum",14)]);if(n.length===0){e.innerHTML=Na();return}const l=!t.geburtsdatum||!((R=(S=t.berufsschulMuster)==null?void 0:S.wochentageWoechentlich)!=null&&R.length||(ye=(be=t.berufsschulMuster)==null?void 0:be.wochentage14Taegig)!=null&&ye.length),i=Ta(n,a),o=i.length;let c=r;typeof c=="number"&&c>o&&(c="alles");const d=new Set(s.map(w=>w.key)),p=he(n,t,new Date,d),h=Ue(a,d),u=[...p,...h],g=La(i),v=g>.05?"positive":g<-.05?"negative":"",$=u.filter(w=>w.schweregrad==="error"),m=u.filter(w=>w.schweregrad==="warn");e.innerHTML=`
    ...
    <div class="saldo-hero" style="margin-bottom: 32px; align-items: stretch;">
      <div class="saldo-hero-text" style="min-width: 260px;">
        ...
        <div class="saldo-value ${v}">${D(g,{signed:!0,suffix:""})}</div>
      ...
      <div style="flex: 1; min-width: 400px; display: flex; flex-direction: column;">
        <div class="card-split" style="margin-bottom: 12px; align-items: center;">
          ...
          <div class="segmented" id="zeitraum-picker">
            ${Ha.map(w=>{const F=typeof w.key=="number"&&w.key>o;return`<button type="button" data-key="${w.key}" class="${c===w.key?"active":""}" ${F?'disabled style="opacity:0.4"':""}>${w.label}</button>`}).join("")}
          </div>
        </div>
  ...
  `,Se(c,e,i),e.querySelectorAll("#zeitraum-picker button").forEach(w=>{w.addEventListener("click",async()=>{if(w.disabled)return;const F=w.getAttribute("data-key"),_=F==="alles"?"alles":parseInt(F,10);e.querySelectorAll("#zeitraum-picker button").forEach(j=>j.classList.toggle("active",j===w)),await It("dashboardZeitraum",_),Se(_,e,i)})}),requestAnimationFrame(()=>{Qe(e.querySelector("#mini-heatmap"),n,{monate:4})}),e.addEventListener("click",async w=>{const F=w.target.closest(".btn-dismiss");if(!F)return;const _=F.getAttribute("data-datum"),j=F.getAttribute("data-typ");if(!_||!j)return;await Nt(_,j),A("Warnung ausgeblendet.");const we=F.closest(".alert");we&&(we.style.display="none")})}function Se(e,t,a){const n=Ea(a,e),s=Wa(n);requestAnimationFrame(()=>{const o=t.querySelector("#saldo-chart");Fa(o,n)});const r=t.querySelector("#hero-bewegung");if(r){const o=s>.05?"up":s<-.05?"down":"flat",c=s>.05?"↑":s<-.05?"↓":"→";r.className=`saldo-trend ${o}`,r.innerHTML=`${c} ${Math.abs(s)<.01?"Unverändert":D(s,{signed:!0})} im Zeitraum`}const l=t.querySelector("#tage-info");if(l){const o=n.length;l.textContent=`${o} ${o===1?"Tag":"Tage"}`}const i=t.querySelector("#tage-liste");i&&(i.innerHTML=Za(n.slice().reverse()))}function Za(e){if(!e.length)return'<p class="hint">Keine Tage im Zeitraum.</p>';const t=Math.max(1,...e.map(a=>Math.abs(a.diff??0)));return`
  ...
  `}function Ga(e){const t=e.schweregrad==="error"?"!":e.schweregrad==="warn"?"⚠":"i";return`
  ...
  `}async function Te(e,t,a){var r,l,i,o;const n=t.querySelector("#upload-status"),s=t.querySelector("#upload-zone");s.style.pointerEvents="none",s.style.opacity="0.6",n.innerHTML=`
    ...
    </div>`;try{const c=await e.arrayBuffer(),d=await Ya(c);await Bt(d.tage),await Rt(d.monate),await Vt({dateiname:e.name,zeitraumVon:((r=d.meta.zeitraumVon)==null?void 0:r.toISOString())??null,zeitraumBis:((l=d.meta.zeitraumBis)==null?void 0:l.toISOString())??null,stichtagAuswertung:((i=d.meta.stichtagAuswertung)==null?void 0:i.toISOString())??null,tageCount:d.tage.length,monateCount:d.monate.length});const p=await W(),h=Ne(p),u={...Ve(),...a};d.meta.personalnummer&&!a.personalnummer&&(u.name=d.meta.name??a.name,u.personalnummer=d.meta.personalnummer,u.einstellungsdatum=((o=d.meta.einstellungsdatum)==null?void 0:o.toISOString())??a.einstellungsdatum,u.arbeitszeitplanregel=d.meta.arbeitszeitplanregel??a.arbeitszeitplanregel),(h.wochentageWoechentlich.length>0||h.wochentage14Taegig.length>0)&&(u.berufsschulMuster=h),await ge(u),n.innerHTML=`
      <div class="alert severity-info" style="border-color: var(--success); background: var(--success-bg);">
        ...
        <div class="alert-body">
          ...
          <p style="margin: 4px 0; font-size: 13px;">
            ...
            ${d.meta.zeitraumVon?` · Zeitraum: ${b(d.meta.zeitraumVon)} – ${b(d.meta.zeitraumBis)}`:""}
          </p>
          <div class="alert-actions">
    ...
    `,A(`PDF verarbeitet: ${d.tage.length} Tage.`);const g=await _e();t.querySelector("#uploads-list").innerHTML=Ye(g)}catch(c){console.error(c),n.innerHTML=`
    ...
    `,pe("PDF konnte nicht gelesen werden.")}finally{s.style.pointerEvents="",s.style.opacity=""}}async function dn(){try{const e=await Ht(),t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),a=URL.createObjectURL(t),n=document.createElement("a"),s=new Date().toISOString().slice(0,10);n.href=a,n.download=`zeitnachweis-backup-${s}.json`,n.click(),URL.revokeObjectURL(a),A("Backup heruntergeladen.")}catch(e){pe(`Export fehlgeschlagen: ${e.message}`)}}async function un(e){var a;const t=(a=e.target.files)==null?void 0:a[0];if(t)try{const n=await t.text(),s=JSON.parse(n);if(!confirm("Existierende Daten werden überschrieben. Fortfahren?"))return;await Zt(s),A("Backup erfolgreich importiert. Seite wird neu geladen…"),setTimeout(()=>location.reload(),800)}catch(n){pe(`Import fehlgeschlagen: ${n.message}`)}}async function gn(){confirm("ALLE Daten endgültig löschen? Das lässt sich nicht rückgängig machen.")&&confirm("Wirklich alle Daten löschen? Letzte Warnung.")&&(await _t(),A("Alle Daten gelöscht."),setTimeout(()=>location.reload(),600))}function hn(e){if(!e)return"—";const t=new Date(e);return t.toLocaleDateString("de-DE",{year:"numeric",month:"2-digit",day:"2-digit"})+" "+t.toLocaleTimeString("de-DE",{hour:"2-digit",minute:"2-digit"})}const q=["MO","DI","MI","DO","FR"],ee={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag"};async function mn({root:e}){var s,r;const t=await B(),a=await W(),n=Ne(a);e.innerHTML=`
    ...
    <form id="profil-form" class="grid cols-2" style="gap: 24px;">
      <div class="card">
        ...
        <div class="form-group">
          <label>Name</label>
          <input type="text" name="name" value="${te(t.name)}" placeholder="Florian Kern" />
        </div>
        <div class="form-group">
          <label>Personalnummer</label>
          <input type="text" name="personalnummer" value="${te(t.personalnummer)}" placeholder="00101473" />
        </div>
        <div class="form-group">
      ...
      <div class="card">
        ...
        ${n.wochentageWoechentlich.length||n.wochentage14Taegig.length?`<div class="alert severity-info" style="margin-bottom: 16px;">
               ...
               <div class="alert-body">
                 ...
                 <p style="margin: 4px 0; font-size: 13px;">
                   Wöchentlich: <strong>${n.wochentageWoechentlich.map(l=>ee[l]).join(", ")||"—"}</strong><br/>
                   Alle 2 Wochen: <strong>${n.wochentage14Taegig.map(l=>ee[l]).join(", ")||"—"}</strong>
                   ${n.referenzDatum14Taegig?` (erster erkannter Termin: ${b(new Date(n.referenzDatum14Taegig))})`:""}
                 </p>
      ...
      <div class="card" style="grid-column: 1 / -1;">
        ...
        <div class="grid cols-2">
          <div class="form-group">
            ...
            <input type="email" name="zeitwirtschaftEmail" value="${te(t.zeitwirtschaftEmail)}" />
          </div>
          <div class="form-group">
            <label>Anrede in Mails</label>
            <input type="text" name="zeitwirtschaftAnrede" value="${te(t.zeitwirtschaftAnrede)}" placeholder="Frau Kanarya" />
          </div>
        </div>
      </div>
  ...
  `,(r=e.querySelector("#btn-apply-vorschlag"))==null||r.addEventListener("click",()=>{for(const l of q)e.querySelector(`[name="woechentlich_${l}"]`).checked=n.wochentageWoechentlich.includes(l),e.querySelector(`[name="zweiwoechig_${l}"]`).checked=n.wochentage14Taegig.includes(l);n.referenzDatum14Taegig&&(e.querySelector('[name="referenzDatum14Taegig"]').value=n.referenzDatum14Taegig.slice(0,10)),ie("Vorschlag übernommen — noch speichern!",{type:"info"})}),e.querySelector("#profil-form").addEventListener("submit",async l=>{var c,d,p,h;l.preventDefault();const i=new FormData(l.target),o={...t,name:((c=i.get("name"))==null?void 0:c.trim())||"",personalnummer:((d=i.get("personalnummer"))==null?void 0:d.trim())||"",geburtsdatum:i.get("geburtsdatum")?new Date(i.get("geburtsdatum")).toISOString():null,pausenRegel:i.get("pausenRegel")||"auto",zeitwirtschaftEmail:((p=i.get("zeitwirtschaftEmail"))==null?void 0:p.trim())||"zeitwirtschaft@putzmeister.com",zeitwirtschaftAnrede:((h=i.get("zeitwirtschaftAnrede"))==null?void 0:h.trim())||"Frau Kanarya",berufsschulMuster:{wochentageWoechentlich:q.filter(u=>i.get(`woechentlich_${u}`)==="on"),wochentage14Taegig:q.filter(u=>i.get(`zweiwoechig_${u}`)==="on"),referenzDatum14Taegig:i.get("referenzDatum14Taegig")?new Date(i.get("referenzDatum14Taegig")).toISOString():null}};await ge(o),A("Profil gespeichert.")})}function te(e){return String(e??"").replace(/"/g,"&quot;")}async function fn({root:e}){var s;const t=await Y(),a=await W(),n={};for(const r of a)n[s=r.monatKey]??(n[s]=[]),n[r.monatKey].push(r);if(t.length===0){e.innerHTML=$n("Noch keine Monatsdaten. Lade zuerst ein PDF unter Daten hoch.");return}e.innerHTML=`
    <h1 class="view-title">Monate</h1>
    <p class="view-subtitle">${t.length} Monate erfasst. Klicke für Details.</p>

    <div class="grid cols-2">
      ${t.slice().reverse().map(r=>{var h;const i=(n[r.monatKey]??[]).filter(u=>u.ist!=null&&u.ist>0),o=i.reduce((u,g)=>u+(g.ist??0),0),c=i.reduce((u,g)=>u+(g.soll??0),0),d=o-c,p=(h=r.glz)==null?void 0:h.saldoGesamt;return`
    ...
    <div>
      ${n.map(r=>{const l=a[r],i=l.ist-l.soll,o=i>.05?"positive":i<-.05?"negative":"";return`
          <a href="#/woche/${r}" class="list-item">
            <div class="tabular" style="font-size: 16px; font-weight: 600; color: var(--fg-muted);">${ne(Xe(r))}</div>
            <div>
  ...
  `}async function Mn({params:e,root:t}){const a=await W(),n=e.yyyykw,s=a.filter(o=>o.wocheKey===n).sort((o,c)=>o.datum.localeCompare(c.datum));if(!s.length){t.innerHTML=`<h1 class="view-title">KW ${ne(n)}</h1><p>Keine Daten.</p><a href="#/woche" class="btn">← Alle Wochen</a>`;return}const r=s.reduce((o,c)=>o+(c.ist??0),0),l=s.reduce((o,c)=>o+(c.soll??0),0),i=r-l;t.innerHTML=`
    <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 8px;">
      <a href="#/woche" class="btn sm">← Alle Wochen</a>
    </div>
    <h1 class="view-title">${ne(Xe(n))}</h1>
  ...
  `}function Xe(e){const[t,a]=e.split("-");return`KW ${a} · ${t}`}function Sn(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function ne(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}async function kn({params:e,root:t}){var o,c,d;const a=e.datum,n=await f.tage.get(a),s=await B();if(!n){t.innerHTML=`<h1 class="view-title">Tag nicht gefunden</h1><p>Für ${a} liegen keine Daten vor.</p><a href="#/" class="btn">← Dashboard</a>`;return}const r=M(a),l=n.tagestyp==="Stempelzeit"?Je(n,s):null,i=qe(r,s.berufsschulMuster);t.innerHTML=`
    <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 8px;">
      <a href="#/monat/${a.slice(0,7)}" class="btn sm">← Zum Monat</a>
    </div>
    <h1 class="view-title">${Ze(r)}</h1>
    ...
    <div class="grid cols-2" style="gap: 24px;">
      <div class="card">
        ...
        ${(c=n.zeitSpannen)!=null&&c.length?n.zeitSpannen.map(p=>`
              <div class="tag-detail">
                <div class="tag-detail-label">${J(p.aktivitaet??"Stempelzeit")}</div>
      ...
      <div class="card">
        ...
        <div class="tag-detail">
          ...
          <div class="tag-detail-value">${n.tagestyp?`<span class="pill ${Dn(n.tagestyp)}">${J(n.tagestyp)}</span>`:"—"}</div>
        </div>
        <div class="tag-detail">
        ...
        <div class="tag-detail">
          ...
          <div class="tag-detail-value"><code>${J(n.tazp??"—")}</code></div>
        </div>
        <div class="tag-detail">
          <div class="tag-detail-label">Monat</div>
          <div class="tag-detail-value">${J(n.monatKey)}</div>
        </div>
      </div>
        ...
        <div class="card" style="grid-column: 1 / -1;">
          ...
          ${l.warnung?`
            <div class="alert severity-warn" style="margin-top: 12px;">
              <div class="alert-icon">⚠</div>
              <div class="alert-body">${J(l.warnung)}</div>
            </div>
          `:""}
        </div>
      `:""}
    </div>
  `}function Dn(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function J(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}async function An({root:e}){const[t,a]=await Promise.all([W(),Y()]);if(!t.length){e.innerHTML='<h1 class="view-title">Analytics</h1><p class="view-subtitle">Keine Daten.</p><a href="#/daten" class="btn primary">Zum Upload</a>';return}e.innerHTML=`
  ...
  `,requestAnimationFrame(()=>{Oa(e.querySelector("#c-saldo"),a),Qe(e.querySelector("#heatmap"),t,{monate:8}),Ra(e.querySelector("#c-istsoll"),t),Va(e.querySelector("#c-kumulativ"),t),Ka(e.querySelector("#c-startend"),t),Ia(e.querySelector("#c-wochentag"),t),Ca(e.querySelector("#c-pausen"),t),Ba(e.querySelector("#c-donut"),t);const n=t.slice(-30);me(e.querySelector("#c-alle-tage"),n)})}async function Pn({root:e}){const t=await W();if(!t.length){e.innerHTML='<h1 class="view-title">Berichtsheft</h1><p class="view-subtitle">Keine Daten.</p><a href="#/daten" class="btn primary">Zum Upload</a>';return}const a=[...new Set(t.map(r=>r.monatKey))].sort().reverse();e.innerHTML=`
...
`);navigator.clipboard.writeText(l).then(()=>A(`${r.length} Zeilen kopiert.`))});function s(){const r=n.value,i=(r?t.filter(o=>o.monatKey===r):t).filter(o=>o.ist!=null&&o.ist>0&&o.tagestyp!=="Wochenende");e.querySelector("#liste").innerHTML=Tn(i),e.querySelectorAll(".copy-val").forEach(o=>{o.addEventListener("click",async()=>{const c=o.getAttribute("data-val");await navigator.clipboard.writeText(c),o.classList.add("ok");const d=o.textContent;o.textContent="✓ kopiert",setTimeout(()=>{o.classList.remove("ok"),o.textContent=d},1200)})})}s()}function Tn(e){return e.length?`
    <table class="table">
      ...
      <tbody>
        ${e.map(t=>{const a=He(t.ist),n=`${b(M(t.datum))}	${a}`;return`
            <tr data-copy="${Ee(n)}">
              <td class="tabular">${b(M(t.datum))}</td>
              <td>${En(t.wochentag)}</td>
              <td>${t.tagestyp?`<span class="pill ${Wn(t.tagestyp)}">${et(t.tagestyp)}</span>`:"—"}</td>
...
Vielen Dank und freundliche Grüße
{name}
Personalnummer {personalnr}`}};function tt(e,t){const a=ve[e];return a?{...a,...t??{}}:null}function at(e,t){const a=Le(e.text,t);return{betreff:Le(e.betreff,t),text:a}}function Le(e,t){return e.replace(/\{(\w+)\}/g,(a,n)=>t[n]!=null?String(t[n]):`{${n}}`)}function On(e,t){const a=t.datum?new Date(t.datum):null,n=a?Ze(a).split(", ")[1]:"";return{name:e.name||"Ihr Mitarbeiter",personalnr:e.personalnummer||"—",kostenstelle:e.kostenstelle||"—",datum:n,wochentag:Fn[t.wochentag]??t.wochentag??"",zeitwirtschaft_anrede:e.zeitwirtschaftAnrede||"Frau Kanarya",zeitwirtschaft_email:e.zeitwirtschaftEmail||"zeitwirtschaft@putzmeister.com",ist:t.ist!=null?t.ist.toFixed(2).replace(".",","):"",soll:t.soll!=null?t.soll.toFixed(2).replace(".",","):"",abgezogen:t.abgezogen!=null?Math.round(t.abgezogen*60):"",gestempelt:t.gestempelt!=null?Math.round(t.gestempelt*60):"",verlust:t.verlustMinuten??""}}function Kn(e,t,a){const n=at(t,a),s=e.zeitwirtschaftEmail||"zeitwirtschaft@putzmeister.com",r=new URLSearchParams;return r.set("subject",n.betreff),r.set("body",n.text),`mailto:${encodeURIComponent(s)}?${r.toString().replace(/\+/g,"%20")}`}async function Cn({root:e}){const[t,a,n,s]=await Promise.all([W(),B(),Y(),Gt()]),r=Object.fromEntries(s.map(o=>[o.key,o])),l=he(t,a,new Date).filter(o=>o.mailVorlageKey),i=Ue(n);e.innerHTML=`
    ...
    <div class="card">
      ...
      <div id="vorlagen-editor">
        ${Object.keys(ve).map(o=>{const c=tt(o,r[o]);return Bn(c)}).join("")}
      </div>
    </div>
  `,Rn(e),Vn(e)}function In(e,t,a){const n=tt(e.mailVorlageKey,a[e.mailVorlageKey]);if(!n)return"";const s=On(t,e),r=at(n,s),l=Kn(t,n,s);return`
...
${n}`;await navigator.clipboard.writeText(s),A("Mail-Text kopiert.")})})}function P(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function de(e){return P(e)}async function _n({root:e}){const t=Ie(),a=await B();e.innerHTML=`
  ...
  `,e.querySelectorAll("[data-theme]").forEach(n=>{n.addEventListener("click",()=>{const s=n.getAttribute("data-theme");ue(s),e.querySelectorAll("[data-theme]").forEach(r=>r.classList.toggle("active",r===n)),A(`Theme: ${n.textContent.trim()}`)})}),e.querySelector("#pause-sel").addEventListener("change",async n=>{const s={...a,pausenRegel:n.target.value};await ge(s),A("Pausen-Regel gespeichert.")})}async function We(){var t;Dt();const e=document.getElementById("content");(t=document.getElementById("theme-toggle"))==null||t.addEventListener("click",()=>At()),Pt(()=>{Ft()}),await Kt()&&setTimeout(()=>{ie('Parser wurde aktualisiert. Bitte lade deinen Zeitnachweis unter "Daten" neu hoch.',{type:"info",duration:12e3})},500),k("/",xe),k("/dashboard",xe),k("/analytics",An),k("/monat",fn),k("/monat/:yyyymm",pn),k("/woche",zn),k("/woche/:yyyykw",Mn),k("/tag/:datum",kn),k("/berichtsheft",Pn),k("/mails",Cn),k("/profil",mn),k("/daten",on),k("/einstellungen",_n),Lt(e),location.hash||Et("/")}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",We):We();
