import{D as dt}from"./dexie-BODkcwel.js";import{b as oe,a as G,c as q,d as ut,f as x,e as Re,i as Ze,s as gt,g as ht,p as ft,h as mt,j as pt,k as vt,l as S,m as bt}from"./datefns-Dlft8rFK.js";import{C as E,L as yt,B as wt,D as $t,S as Mt,a as kt,b as St,P as xt,A as zt,c as Dt,d as At,T as Pt,p as Tt,e as Et,i as Lt}from"./chartjs-CRgZvhTJ.js";import{_ as Kt,a as Wt}from"./pdfjs-BDGsuRSB.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function a(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(s){if(s.ep)return;s.ep=!0;const r=a(s);fetch(s.href,r)}})();const se="theme";function Ft(){const e=localStorage.getItem(se)??"auto";he(e)}function he(e){e==="auto"?document.documentElement.removeAttribute("data-theme"):document.documentElement.setAttribute("data-theme",e),localStorage.setItem(se,e),Bt(e)}function Ot(){const e=localStorage.getItem(se)??"auto",t=e==="auto"?"light":e==="light"?"dark":"auto";return he(t),He(t),t}const ce=new Set;function Ct(e){return ce.add(e),()=>ce.delete(e)}function He(e){for(const t of ce)try{t(e)}catch(a){console.error(a)}}var je;if(typeof window<"u"&&window.matchMedia){const e=window.matchMedia("(prefers-color-scheme: dark)");(je=e.addEventListener)==null||je.call(e,"change",()=>{Ne()==="auto"&&He("auto")})}function Bt(e){const t=document.getElementById("theme-toggle");if(!t)return;const a=t.querySelector(".theme-label"),n=t.querySelector(".theme-icon-dark"),s=t.querySelector(".theme-icon-light");a&&(e==="auto"?(a.textContent="Auto",n&&(n.style.display="inline"),s&&(s.style.display="inline")):e==="light"?(a.textContent="Hell",n&&(n.style.display="none"),s&&(s.style.display="inline")):(a.textContent="Dunkel",n&&(n.style.display="inline"),s&&(s.style.display="none")))}function Ne(){return localStorage.getItem(se)??"auto"}const Ge=[];let qe=null;function D(e,t){const a=e.split("/").filter(Boolean),n=[],s=new RegExp("^/?"+a.map(r=>r.startsWith(":")?(n.push(r.slice(1)),"([^/]+)"):Rt(r)).join("/")+"/?$");Ge.push({pattern:e,regex:s,paramNames:n,render:t})}function It(e){e.startsWith("#")||(e="#"+e),window.location.hash===e?L():window.location.hash=e}function Vt(e,{onNavigate:t}={}){window.addEventListener("hashchange",L),L.rootEl=e,L.onNavigate=t,L()}async function L(){var n;const e=L.rootEl,t=window.location.hash.slice(1)||"/",a=t.startsWith("/")?t:`/${t}`;for(const s of Ge){const r=s.regex.exec(a);if(r){const i={};s.paramNames.forEach((l,o)=>i[l]=decodeURIComponent(r[o+1])),qe=a,(n=L.onNavigate)==null||n.call(L,a),_t(a);try{e.classList.remove("view-enter"),await s.render({params:i,path:a,root:e}),e.classList.add("view-enter")}catch(l){console.error("Route render error:",l),e.innerHTML=`<div class="empty-state">
  ...
  `:'<span class="kg-empty">—</span>'}const De={lessThanXSeconds:{standalone:{one:"weniger als 1 Sekunde",other:"weniger als {{count}} Sekunden"},withPreposition:{one:"weniger als 1 Sekunde",other:"weniger als {{count}} Sekunden"}},xSeconds:{standalone:{one:"1 Sekunde",other:"{{count}} Sekunden"},withPreposition:{one:"1 Sekunde",other:"{{count}} Sekunden"}},halfAMinute:{standalone:"eine halbe Minute",withPreposition:"einer halben Minute"},lessThanXMinutes:{standalone:{one:"weniger als 1 Minute",other:"weniger als {{count}} Minuten"},withPreposition:{one:"weniger als 1 Minute",other:"weniger als {{count}} Minuten"}},xMinutes:{standalone:{one:"1 Minute",other:"{{count}} Minuten"},withPreposition:{one:"1 Minute",other:"{{count}} Minuten"}},aboutXHours:{standalone:{one:"etwa 1 Stunde",other:"etwa {{count}} Stunden"},withPreposition:{one:"etwa 1 Stunde",other:"etwa {{count}} Stunden"}},xHours:{standalone:{one:"1 Stunde",other:"{{count}} Stunden"},withPreposition:{one:"1 Stunde",other:"{{count}} Stunden"}},xDays:{standalone:{one:"1 Tag",other:"{{count}} Tage"},withPreposition:{one:"1 Tag",other:"{{count}} Tagen"}},aboutXWeeks:{standalone:{one:"etwa 1 Woche",other:"etwa {{count}} Wochen"},withPreposition:{one:"etwa 1 Woche",other:"etwa {{count}} Wochen"}},xWeeks:{standalone:{one:"1 Woche",other:"{{count}} Wochen"},withPreposition:{one:"1 Woche",other:"{{count}} Wochen"}},aboutXMonths:{standalone:{one:"etwa 1 Monat",other:"etwa {{count}} Monate"},withPreposition:{one:"etwa 1 Monat",other:"etwa {{count}} Monaten"}},xMonths:{standalone:{one:"1 Monat",other:"{{count}} Monate"},withPreposition:{one:"1 Monat",other:"{{count}} Monaten"}},aboutXYears:{standalone:{one:"etwa 1 Jahr",other:"etwa {{count}} Jahre"},withPreposition:{one:"etwa 1 Jahr",other:"etwa {{count}} Jahren"}},xYears:{standalone:{one:"1 Jahr",other:"{{count}} Jahre"},withPreposition:{one:"1 Jahr",other:"{{count}} Jahren"}},overXYears:{standalone:{one:"mehr als 1 Jahr",other:"mehr als {{count}} Jahre"},withPreposition:{one:"mehr als 1 Jahr",other:"mehr als {{count}} Jahren"}},almostXYears:{standalone:{one:"fast 1 Jahr",other:"fast {{count}} Jahre"},withPreposition:{one:"fast 1 Jahr",other:"fast {{count}} Jahren"}}},da=(e,t,a)=>{let n;const s=a!=null&&a.addSuffix?De[e].withPreposition:De[e].standalone;return typeof s=="string"?n=s:t===1?n=s.one:n=s.other.replace("{{count}}",String(t)),a!=null&&a.addSuffix?a.comparison&&a.comparison>0?"in "+n:"vor "+n:n},ua={full:"EEEE, do MMMM y",long:"do MMMM y",medium:"do MMM y",short:"dd.MM.y"},ga={full:"HH:mm:ss zzzz",long:"HH:mm:ss z",medium:"HH:mm:ss",short:"HH:mm"},ha={full:"{{date}} 'um' {{time}}",long:"{{date}} 'um' {{time}}",medium:"{{date}} {{time}}",short:"{{date}} {{time}}"},fa={date:oe({formats:ua,defaultWidth:"full"}),time:oe({formats:ga,defaultWidth:"full"}),dateTime:oe({formats:ha,defaultWidth:"full"})},ma={lastWeek:"'letzten' eeee 'um' p",yesterday:"'gestern um' p",today:"'heute um' p",tomorrow:"'morgen um' p",nextWeek:"eeee 'um' p",other:"P"},pa=(e,t,a,n)=>ma[e],va={narrow:["v.Chr.","n.Chr."],abbreviated:["v.Chr.","n.Chr."],wide:["vor Christus","nach Christus"]},ba={narrow:["1","2","3","4"],abbreviated:["Q1","Q2","Q3","Q4"],wide:["1. Quartal","2. Quartal","3. Quartal","4. Quartal"]},de={narrow:["J","F","M","A","M","J","J","A","S","O","N","D"],abbreviated:["Jan","Feb","Mär","Apr","Mai","Jun","Jul","Aug","Sep","Okt","Nov","Dez"],wide:["Januar","Februar","März","April","Mai","Juni","Juli","August","September","Oktober","November","Dezember"]},ya={narrow:de.narrow,abbreviated:["Jan.","Feb.","März","Apr.","Mai","Juni","Juli","Aug.","Sep.","Okt.","Nov.","Dez."],wide:de.wide},wa={narrow:["S","M","D","M","D","F","S"],short:["So","Mo","Di","Mi","Do","Fr","Sa"],abbreviated:["So.","Mo.","Di.","Mi.","Do.","Fr.","Sa."],wide:["Sonntag","Montag","Dienstag","Mittwoch","Donnerstag","Freitag","Samstag"]},$a={narrow:{am:"vm.",pm:"nm.",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachm.",evening:"Abend",night:"Nacht"},abbreviated:{am:"vorm.",pm:"nachm.",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachmittag",evening:"Abend",night:"Nacht"},wide:{am:"vormittags",pm:"nachmittags",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachmittag",evening:"Abend",night:"Nacht"}},Ma={narrow:{am:"vm.",pm:"nm.",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachm.",evening:"abends",night:"nachts"},abbreviated:{am:"vorm.",pm:"nachm.",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachmittags",evening:"abends",night:"nachts"},wide:{am:"vormittags",pm:"nachmittags",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachmittags",evening:"abends",night:"nachts"}},ka=e=>Number(e)+".",Sa={ordinalNumber:ka,era:G({values:va,defaultWidth:"wide"}),quarter:G({values:ba,defaultWidth:"wide",argumentCallback:e=>e-1}),month:G({values:de,formattingValues:ya,defaultWidth:"wide"}),day:G({values:wa,defaultWidth:"wide"}),dayPeriod:G({values:$a,defaultWidth:"wide",formattingValues:Ma,defaultFormattingWidth:"wide"})},xa=/^(\d+)(\.)?/i,za=/\d+/i,Da={narrow:/^(v\.? ?Chr\.?|n\.? ?Chr\.?)/i,abbreviated:/^(v\.? ?Chr\.?|n\.? ?Chr\.?)/i,wide:/^(vor Christus|vor unserer Zeitrechnung|nach Christus|unserer Zeitrechnung)/i},Aa={any:[/^v/i,/^n/i]},Pa={narrow:/^[1234]/i,abbreviated:/^q[1234]/i,wide:/^[1234](\.)? Quartal/i},Ta={any:[/1/i,/2/i,/3/i,/4/i]},Ea={narrow:/^[jfmasond]/i,abbreviated:/^(j[aä]n|feb|mär[z]?|apr|mai|jun[i]?|jul[i]?|aug|sep|okt|nov|dez)\.?/i,wide:/^(januar|februar|märz|april|mai|juni|juli|august|september|oktober|november|dezember)/i},La={narrow:[/^j/i,/^f/i,/^m/i,/^a/i,/^m/i,/^j/i,/^j/i,/^a/i,/^s/i,/^o/i,/^n/i,/^d/i],any:[/^j[aä]/i,/^f/i,/^mär/i,/^ap/i,/^mai/i,/^jun/i,/^jul/i,/^au/i,/^s/i,/^o/i,/^n/i,/^d/i]},Ka={narrow:/^[smdmf]/i,short:/^(so|mo|di|mi|do|fr|sa)/i,abbreviated:/^(son?|mon?|die?|mit?|don?|fre?|sam?)\.?/i,wide:/^(sonntag|montag|dienstag|mittwoch|donnerstag|freitag|samstag)/i},Wa={any:[/^so/i,/^mo/i,/^di/i,/^mi/i,/^do/i,/^f/i,/^sa/i]},Fa={narrow:/^(vm\.?|nm\.?|Mitternacht|Mittag|morgens|nachm\.?|abends|nachts)/i,abbreviated:/^(vorm\.?|nachm\.?|Mitternacht|Mittag|morgens|nachm\.?|abends|nachts)/i,wide:/^(vormittags|nachmittags|Mitternacht|Mittag|morgens|nachmittags|abends|nachts)/i},Oa={any:{am:/^v/i,pm:/^n/i,midnight:/^Mitte/i,noon:/^Mitta/i,morning:/morgens/i,afternoon:/nachmittags/i,evening:/abends/i,night:/nachts/i}},Ca={ordinalNumber:ut({matchPattern:xa,parsePattern:za,valueCallback:e=>parseInt(e)}),era:q({matchPatterns:Da,defaultMatchWidth:"wide",parsePatterns:Aa,defaultParseWidth:"any"}),quarter:q({matchPatterns:Pa,defaultMatchWidth:"wide",parsePatterns:Ta,defaultParseWidth:"any",valueCallback:e=>e+1}),month:q({matchPatterns:Ea,defaultMatchWidth:"wide",parsePatterns:La,defaultParseWidth:"any"}),day:q({matchPatterns:Ka,defaultMatchWidth:"wide",parsePatterns:Wa,defaultParseWidth:"any"}),dayPeriod:q({matchPatterns:Fa,defaultMatchWidth:"wide",parsePatterns:Oa,defaultParseWidth:"any"})},ee={code:"de",formatDistance:da,formatLong:fa,formatRelative:pa,localize:Sa,match:Ca,options:{weekStartsOn:1,firstWeekContainsDate:4}};function Q(e){if(!e)return null;const t=e.trim();return ft(t,"dd.MM.yyyy",new Date)}function y(e){return x(e,"dd.MM.yyyy")}function Qe(e){return x(e,"EE, dd.MM.yyyy",{locale:ee})}function Ba(e){const t=gt(e,{weekStartsOn:1}),a=ht(e,{weekStartsOn:1});return`${x(t,"dd.MM.")} – ${x(a,"dd.MM.yyyy")}`}function Ia(e){return`${mt(e)}-${String(pt(e)).padStart(2,"0")}`}function Xe(e){return x(e,"yyyy-MM")}function Va(e){return x(e,"yyyy-MM-dd")}function _a(e,t){if(!e||!t)return 0;e>t&&([e,t]=[t,e]);let a=0,n=new Date(e);for(;n<t;)n=Re(n,1),Ze(n)||a++;return a}function _(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function et(e){var i;const t=e.filter(l=>l.tagestyp==="Berufsschule");if(t.length<2)return{wochentageWoechentlich:[],wochentage14Taegig:[],referenzDatum14Taegig:null};const a={};for(const l of t)a[i=l.wochentag]??(a[i]=[]),a[l.wochentag].push(l);const n=[],s=[];let r=null;for(const[l,o]of Object.entries(a)){if(o.sort((h,u)=>h.datum.localeCompare(u.datum)),o.length<2)continue;const c=[];for(let h=1;h<o.length;h++)c.push(vt(S(o[h].datum),S(o[h-1].datum)));const d=ja(c);d<=10?n.push(l):d<=18&&(s.push(l),(!r||S(o[0].datum)<S(r))&&(r=o[0].datum))}return{wochentageWoechentlich:n,wochentage14Taegig:s,referenzDatum14Taegig:r}}function ja(e){if(!e.length)return null;const t=e.slice().sort((n,s)=>n-s),a=Math.floor(t.length/2);return t.length%2?t[a]:(t[a-1]+t[a])/2}function me(e,t){var s,r;if(!t)return!1;const n=["SO","MO","DI","MI","DO","FR","SA"][e.getDay()];if((s=t.wochentageWoechentlich)!=null&&s.includes(n))return!0;if((r=t.wochentage14Taegig)!=null&&r.includes(n)&&t.referenzDatum14Taegig){const i=S(t.referenzDatum14Taegig),l=bt(e,i,{weekStartsOn:1});if(l>=0&&l%2===0)return!0}return!1}const Ra=Object.freeze(Object.defineProperty({__proto__:null,erkenneBerufsschulMuster:et,istBerufsschulTagLautMuster:me},Symbol.toStringTag,{value:"Module"}));function Za(e){return e?"arbzg":"jarbschg"}function Ha(e,t){return e==null?0:t==="jarbschg"?e>6?1:e>4.5?.5:0:e>9?.75:e>6?.5:0}function tt(e){if(!e||e.length<2)return 0;const t=e.filter(n=>n.von&&n.bis).map(n=>({von:K(n.von),bis:K(n.bis)})).filter(n=>n.von!=null&&n.bis!=null).sort((n,s)=>n.von-s.von);let a=0;for(let n=1;n<t.length;n++){const s=t[n].von-t[n-1].bis;(s>0&&s>=15||s>0)&&(a+=s)}return a/60}function at(e,t){const a=e.zeitSpannen??[];if(!a.length||a.every(m=>!m.von))return{keinAnspruch:!0};const n=tt(a),s=e.pause??0,r=Na(a),i=r-s,l=t.pausenRegel&&t.pausenRegel!=="auto"?t.pausenRegel==="jarbschg"?"jarbschg":"arbzg":Za(!!t.ueber18),o=Ha(i,l),c=Math.max(n,o),d=s-c,h=Math.max(0,o-n);let u="ok",g=null;if(d>.05)u="fehler_zeitwirtschaft",g=`${Math.round(d*60)} min Pause wurden zusätzlich zur gesetzlichen Pflicht und zur gestempelten Pause abgezogen. Das sieht nach einem Zeitwirtschafts-Fehler aus.`;else if(h>.05&&s>n+.02){u="aufstockung_legal";const m=Math.round(h*60);g=`Du hast ${Math.round(n*60)} min Pause gestempelt, aber bei ${i.toFixed(2).replace(".",",")}h Arbeitszeit schreibt das Gesetz (${l.toUpperCase()}) ${Math.round(o*60)} min vor. Die fehlenden ${m} min wurden automatisch als Pause gewertet. Das ist gesetzeskonform — nächstes Mal einfach länger Pause machen.`}return{arbeitszeitMitPause:r,arbeitszeitOhnePause:i,gestempeltePause:n,abgezogenePause:s,gesetzlichePflicht:o,gesetz:l,legalerAbzug:c,unrechtmaessigerVerlustMin:Math.round(Math.max(0,d)*60),aufstockungMin:Math.round(Math.max(0,h)*60),typ:u,warnung:g}}function Na(e){let t=0;for(const a of e){if(!a.von||!a.bis)continue;const n=K(a.von),s=K(a.bis);n!=null&&s!=null&&s>n&&(t+=s-n)}return t/60}const J={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"};function pe(e,t,a,n=new Set){var d,h;const s=[],r=a??new Date,i=new Map(e.map(u=>[u.datum,u]));if(!e.length)return s;const l=S(e[0].datum),o=r;for(let u=new Date(l);u<=o;u=Re(u,1)){if(Ze(u))continue;const g=x(u,"yyyy-MM-dd"),m=i.get(g),p=_a(u,o);if(!m||!m.tagestyp&&!m.ist&&(((d=m.zeitSpannen)==null?void 0:d.length)??0)===0){if(me(u,t.berufsschulMuster)){const v=p>=4?"error":p>=2?"warn":"info";U(s,n,{datum:g,wochentag:(m==null?void 0:m.wochentag)??te(u),typ:"bs_tag_fehlt",schweregrad:v,titel:`Berufsschultag nicht eingetragen: ${y(u)}`,beschreibung:`Laut deinem Profil hast du am ${J[te(u)]}, ${y(u)} Berufsschule. Im Zeitnachweis fehlt der Tag bisher${p>=4?" — bitte bei der Zeitwirtschaft nachhaken":""}.`,alter:p,mailVorlageKey:v==="error"?"bs_tag_fehlt":null})}else{const v=p>=4?"error":p>=2?"warn":"info";U(s,n,{datum:g,wochentag:te(u),typ:"stempelzeit_fehlt",schweregrad:v,titel:`Keine Stempelzeit am ${y(u)}`,beschreibung:`Am ${J[te(u)]}, ${y(u)} wurde keine Stempelzeit erfasst. Falls du an diesem Tag im Haus warst, sollte die Zeitwirtschaft das nachtragen${p>=4?" — es ist inzwischen ≥4 Werktage her":""}.`,alter:p,mailVorlageKey:v==="error"?"stempelzeit_fehlt":null})}continue}if(m.tagestyp==="Berufsschule"&&m.ist!=null&&m.soll!=null&&m.ist<m.soll-.01&&U(s,n,{datum:g,wochentag:m.wochentag,typ:"bs_stunden_falsch",schweregrad:"error",titel:`Berufsschultag mit zu wenig Stunden: ${y(u)}`,beschreibung:`Am ${J[m.wochentag]}, ${y(u)} sind nur ${m.ist.toFixed(2).replace(".",",")}h gebucht statt regulär ${m.soll.toFixed(2).replace(".",",")}h. Die Zeitwirtschaft hat den Berufsschultag möglicherweise nur halb erfasst.`,ist:m.ist,soll:m.soll,mailVorlageKey:"bs_stunden_falsch"}),m.tagestyp==="Stempelzeit"&&((h=m.zeitSpannen)==null?void 0:h.length)>1&&g>="2026-04-01"){const v=at(m,t);(v==null?void 0:v.typ)==="fehler_zeitwirtschaft"&&v.unrechtmaessigerVerlustMin>=5?U(s,n,{datum:g,wochentag:m.wochentag,typ:"pausen_abzug",schweregrad:v.unrechtmaessigerVerlustMin>=15?"error":"warn",titel:`Pausen-Abzug fehlerhaft (${y(u)})`,beschreibung:`Am ${J[m.wochentag]}, ${y(u)} wurden ${Math.round(v.abgezogenePause*60)} min Pause abgezogen. Gestempelt: ${Math.round(v.gestempeltePause*60)} min, gesetzlich nötig (${v.gesetz.toUpperCase()}): ${Math.round(v.gesetzlichePflicht*60)} min. Differenz von ${v.unrechtmaessigerVerlustMin} min ist unerklärlich.`,verlustMinuten:v.unrechtmaessigerVerlustMin,abgezogen:v.abgezogenePause,gestempelt:v.gestempeltePause,mailVorlageKey:"pausen_abzug"}):(v==null?void 0:v.typ)==="aufstockung_legal"&&v.aufstockungMin>=10&&U(s,n,{datum:g,wochentag:m.wochentag,typ:"pausen_aufstockung",schweregrad:"info",titel:`Zu wenig Pause gestempelt (${y(u)}) — ${v.aufstockungMin} min automatisch aufgestockt`,beschreibung:`Am ${J[m.wochentag]}, ${y(u)} hast du nur ${Math.round(v.gestempeltePause*60)} min Pause gemacht. Gesetz (${v.gesetz.toUpperCase()}) schreibt ${Math.round(v.gesetzlichePflicht*60)} min vor. Fehlende ${v.aufstockungMin} min wurden als Pause gewertet — das ist legal, aber du verlierst dadurch Arbeitszeit. Tipp: mach beim nächsten Mal etwas länger Mittag.`})}}const c={error:0,warn:1,info:2};return s.sort((u,g)=>{const m=c[u.schweregrad]-c[g.schweregrad];return m!==0?m:g.datum.localeCompare(u.datum)}),s}function nt(e,t=new Set){var n,s,r,i;const a=[];for(const l of e){const o=((n=l.glz)==null?void 0:n.saldoVorperiode)??0,c=((s=l.glz)==null?void 0:s.saldoAktuellePeriode)??0,d=((r=l.glz)==null?void 0:r.umgebuchteStunden)??0,h=(i=l.glz)==null?void 0:i.saldoGesamt;if(h==null)continue;const u=o+c+d,g=Math.abs(h-u);if(g>.03){const m=`${l.monatKey}-saldo_plausi`;t.has(m)||a.push({datum:`${l.monatKey}-01`,wochentag:"",typ:"saldo_plausi",schweregrad:"warn",titel:`Saldo-Differenz im Monat ${l.monatKey}`,beschreibung:`Rechnung: Vorperiode ${o.toFixed(2)} + aktuelle Periode ${c.toFixed(2)} + umgebucht ${d.toFixed(2)} = ${u.toFixed(2)}, aber dein Saldo wird mit ${h.toFixed(2)} angezeigt. Abweichung: ${g.toFixed(2)}h.`,soll:u,ist:h})}}return a}function U(e,t,a){const n=`${a.datum}-${a.typ}`;t.has(n)||(a.id=n,e.push(a))}function te(e){return["SO","MO","DI","MI","DO","FR","SA"][e.getDay()]}function Ga(e,t){var o,c,d;const a=[...e].sort((h,u)=>h.datum.localeCompare(u.datum));if(!a.length)return[];const n=new Map(t.map(h=>[h.monatKey,h])),s={};for(const h of a)s[o=h.monatKey]??(s[o]=[]),s[h.monatKey].push(h);const r=Object.keys(s).sort(),i=[];let l=null;for(const h of r){const u=n.get(h);let g;((c=u==null?void 0:u.glz)==null?void 0:c.saldoVorperiode)!=null?g=u.glz.saldoVorperiode:l!=null?g=l:g=0;const m=s[h];for(const p of m)p.diff!=null&&(g+=p.diff),i.push({datum:p.datum,wochentag:p.wochentag,saldo:Math.round(g*100)/100,diff:p.diff,ist:p.ist,soll:p.soll,tagestyp:p.tagestyp,monatKey:p.monatKey,wocheKey:p.wocheKey,zeitSpannen:p.zeitSpannen});if(((d=u==null?void 0:u.glz)==null?void 0:d.saldoGesamt)!=null){const p=u.glz.saldoGesamt-g;if(Math.abs(p)>.02&&i.length>0){const $=i.length-1;i[$].umbuchung=p,i[$].saldo=Math.round((i[$].saldo+p)*100)/100,g=i[$].saldo}l=u.glz.saldoGesamt}else l=g}return i}function qa(e,t){if(!e.length)return[];if(t==="alles")return e;const a=Math.min(t,e.length);return e.slice(-a)}function Ja(e){return e.length?e[e.length-1].saldo:0}function Ua(e){if(!e.length)return 0;const t=e[0].saldo-(e[0].diff??0),a=e[e.length-1].saldo;return Math.round((a-t)*100)/100}E.register(yt,wt,$t,Mt,kt,St,xt,zt,Dt,At,Pt,Tt,Et,Lt);function k(e){return getComputedStyle(document.documentElement).getPropertyValue(e).trim()}function O(){return{fg:k("--fg"),fgMuted:k("--fg-muted"),fgSubtle:k("--fg-subtle"),border:k("--border"),surface:k("--surface"),accent:k("--accent"),success:k("--success"),warn:k("--warn"),danger:k("--danger"),info:k("--info"),palette:[k("--chart-1"),k("--chart-2"),k("--chart-3"),k("--chart-4"),k("--chart-5"),k("--chart-6"),k("--chart-7")]}}function w(e){return{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{labels:{color:e.fgMuted,font:{size:12}}},tooltip:{backgroundColor:e.surface,titleColor:e.fg,bodyColor:e.fg,borderColor:e.border,borderWidth:1,padding:10,displayColors:!0}},scales:{x:{ticks:{color:e.fgMuted,font:{size:11}},grid:{color:e.border,drawBorder:!1}},y:{ticks:{color:e.fgMuted,font:{size:11}},grid:{color:e.border,drawBorder:!1}}}}}function Ya(e,t){const a=O();if(C(e),!(t!=null&&t.length))return;const n=t.map(r=>x(S(r.datum),"dd.MM.")),s=t.map(r=>r.saldo);return s.map(r=>r>=0?a.success:a.danger),new E(e,{type:"line",data:{labels:n,datasets:[{label:"Tages-Saldo",data:s,borderColor:a.accent,backgroundColor:r=>{const i=r.chart,{ctx:l,chartArea:o,scales:c}=i;return o?ln(l,o,c.y,a):B(a.accent,.14)},segment:{borderColor:r=>{const i=r.p0.parsed.y,l=r.p1.parsed.y,o=(i+l)/2;return o>=.02?a.success:o<=-.02?a.danger:a.fgMuted}},tension:.25,pointRadius:2,pointHoverRadius:6,pointHitRadius:20,pointBackgroundColor:s.map(r=>r>=.02?a.success:r<=-.02?a.danger:a.fgMuted),pointBorderColor:a.surface,pointBorderWidth:1,fill:!0,borderWidth:2}]},options:{...w(a),interaction:{mode:"index",intersect:!1,axis:"x"},hover:{mode:"index",intersect:!1,axis:"x"},plugins:{...w(a).plugins,legend:{display:!1},tooltip:{enabled:!1,mode:"index",intersect:!1,axis:"x",position:"nearest",external:Qa(t)}},scales:{...w(a).scales,y:{...w(a).scales.y,ticks:{...w(a).scales.y.ticks,callback:r=>`${r>=0?"+":""}${r.toFixed(1).replace(".",",")}h`}}}}})}function Qa(e){return function(t){var M;const{chart:a,tooltip:n}=t;let s=a.$saldoTooltipEl;if(!s){s=document.createElement("div"),s.className="saldo-tooltip",document.body.appendChild(s),a.$saldoTooltipEl=s;const P=a.destroy.bind(a);a.destroy=function(){s.parentNode&&s.parentNode.removeChild(s),P()}}if(n.opacity===0||!((M=n.dataPoints)!=null&&M.length)){s.style.opacity="0";return}const r=n.dataPoints[0].dataIndex,i=e[r];if(!i){s.style.opacity="0";return}const l=i.saldo>.05?"pos":i.saldo<-.05?"neg":"flat",o=(i.diff??0)>.05?"pos":(i.diff??0)<-.05?"neg":"flat",c=(i.saldo>0?"+":"")+i.saldo.toFixed(2).replace(".",",")+"h",d=i.diff!=null?(i.diff>0?"+":"")+i.diff.toFixed(2).replace(".",",")+"h":null;let u=`<div class="saldo-tooltip-title">${Ae(x(S(i.datum),"EE, dd.MM.yyyy",{locale:ee}))}</div>`;u+=`<div class="saldo-tooltip-row"><span class="saldo-tooltip-label">Saldo</span><span class="saldo-tooltip-value ${l}">${c}</span></div>`,d&&(u+=`<div class="saldo-tooltip-row"><span class="saldo-tooltip-label">Tages-Diff</span><span class="saldo-tooltip-value ${o}">${d}</span></div>`);const g=[];i.tagestyp&&g.push(`Typ: ${Ae(i.tagestyp)}`),i.umbuchung&&g.push(`Umbuchung: ${i.umbuchung>=0?"+":""}${i.umbuchung.toFixed(2).replace(".",",")}h`),g.length&&(u+=`<div class="saldo-tooltip-meta">${g.map(P=>`<span>${P}</span>`).join("")}</div>`),s.innerHTML=u;const m=a.canvas.getBoundingClientRect(),p=m.left+n.caretX,$=m.top+n.caretY;s.style.opacity="0",s.style.left="0px",s.style.top="0px";const v=s.offsetWidth,W=s.offsetHeight,Z=18;let R=p+Z;R+v>window.innerWidth-8&&(R=p-Z-v);let b=$-W/2;b<8&&(b=8),b+W>window.innerHeight-8&&(b=window.innerHeight-W-8),s.style.left=R+"px",s.style.top=b+"px",s.style.opacity="1"}}function Ae(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Xa(e,t){const a=O();if(C(e),!(t!=null&&t.length))return;const n=t.map(r=>r.monatKey),s=t.map(r=>{var i;return((i=r.glz)==null?void 0:i.saldoGesamt)??0});return new E(e,{type:"line",data:{labels:n,datasets:[{label:"GLZ-Saldo (Monatsende)",data:s,borderColor:a.accent,backgroundColor:B(a.accent,.18),tension:.35,fill:!0,pointRadius:4}]},options:w(a)})}function ve(e,t){const a=O();if(C(e),!(t!=null&&t.length))return;const n=t.map(i=>x(S(i.datum),"dd.MM.")),s=t.map(i=>i.ist??0),r=t.map(i=>on(i.tagestyp,a));return new E(e,{type:"bar",data:{labels:n,datasets:[{label:"Ist-Stunden",data:s,backgroundColor:r,borderRadius:4,borderSkipped:!1}]},options:{...w(a),plugins:{...w(a).plugins,legend:{display:!1},tooltip:{...w(a).plugins.tooltip,callbacks:{label:i=>{const l=t[i.dataIndex];return`${l.tagestyp??"—"}: ${(l.ist??0).toFixed(2).replace(".",",")}h`}}}},scales:{...w(a).scales,y:{...w(a).scales.y,suggestedMin:0,suggestedMax:10}}}})}function en(e,t){const a=O();if(C(e),!(t!=null&&t.length))return;const n=t.filter(c=>{var d;return((d=c.zeitSpannen)==null?void 0:d.length)&&c.zeitSpannen.some(h=>h.von&&h.bis)}).map(c=>{const d=c.zeitSpannen.filter(g=>g.von&&g.bis).map(g=>({von:K(g.von),bis:K(g.bis),vonStr:g.von,bisStr:g.bis})).filter(g=>g.von!=null&&g.bis!=null);if(d.length===0)return null;const h=Math.min(...d.map(g=>g.von)),u=Math.max(...d.map(g=>g.bis));return{...c,_spans:d,_minVon:h,_maxBis:u}}).filter(Boolean);if(!n.length)return;const s=c=>c.ist==null?a.fgMuted:c.ist>=7?a.success:a.danger,r={label:"Tages-Rahmen",data:n.map(c=>[c._minVon,c._maxBis]),backgroundColor:n.map(s),borderColor:n.map(s),borderWidth:0,borderRadius:4,borderSkipped:!1,barPercentage:.75,categoryPercentage:.95},i=Math.max(0,Math.floor(Math.min(...n.map(c=>c._minVon))/60)*60-60),l=Math.min(24*60,Math.ceil(Math.max(...n.map(c=>c._maxBis))/60)*60+60),o=c=>`${String(Math.floor(c/60)).padStart(2,"0")}:${String(c%60).padStart(2,"0")}`;return new E(e,{type:"bar",data:{labels:n.map(c=>x(S(c.datum),"dd.MM.")),datasets:[r]},options:{...w(a),interaction:{mode:"index",intersect:!1,axis:"x"},plugins:{legend:{display:!1},tooltip:{enabled:!0,backgroundColor:a.surface,borderColor:a.accent,borderWidth:2,padding:14,titleColor:a.fg,titleFont:{size:14,weight:"600"},titleMarginBottom:8,bodyColor:a.fg,bodyFont:{size:13},bodySpacing:4,displayColors:!1,caretPadding:10,cornerRadius:8,callbacks:{title:c=>{const d=n[c[0].dataIndex];return x(S(d.datum),"EE, dd.MM.yyyy",{locale:ee})},label:()=>"",beforeBody:c=>{const d=n[c[0].dataIndex],h=d.ist!=null?I(d.ist):"—",u=d.soll!=null?I(d.soll):"—",g=d.pause!=null?Math.round(d.pause*60)+" min":"—",p=[`Tages-Rahmen: ${`${o(d._minVon)} – ${o(d._maxBis)}`}`];return d._spans.length>1&&(p.push(""),d._spans.forEach(($,v)=>{p.push(`  Block ${v+1}: ${$.vonStr} – ${$.bisStr}`)})),[...p,"",`Arbeitszeit (netto): ${h}`,`Soll: ${u}`,`Pause (abgezogen): ${g}`]}}}},scales:{x:{ticks:{color:a.fgMuted,font:{size:10},maxRotation:60,minRotation:60,autoSkip:!0,maxTicksLimit:40},grid:{display:!1}},y:{min:i,max:l,ticks:{color:a.fgMuted,stepSize:60,callback:c=>o(c)},grid:{color:a.border}}}}})}function tn(e,t){const a=O();C(e);const n={};for(const i of t){if(i.tagestyp!=="Stempelzeit"||!i.zeitSpannen||i.zeitSpannen.length<2)continue;const l=tt(i.zeitSpannen);if(l<=0)continue;const o=Math.round(l*60),c=Math.floor(o/15)*15;n[c]=(n[c]??0)+1}const s=Object.keys(n).map(Number).sort((i,l)=>i-l),r=s.map(i=>n[i]);return new E(e,{type:"bar",data:{labels:s.map(i=>`${i}–${i+14} min`),datasets:[{label:"Häufigkeit",data:r,backgroundColor:a.palette[1],borderRadius:4}]},options:{...w(a),plugins:{...w(a).plugins,legend:{display:!1},tooltip:{...w(a).plugins.tooltip,callbacks:{title:i=>`Pause-Länge (gestempelt): ${i[0].label}`,label:i=>`${i.parsed.y} Tag(e)`}}}}})}function an(e,t){const a=O();C(e);const n=["MO","DI","MI","DO","FR"],s={},r={};for(const l of n)s[l]=0,r[l]=0;for(const l of t)n.includes(l.wochentag)&&(l.ist==null||l.ist===0||(s[l.wochentag]+=l.ist,r[l.wochentag]+=1));const i=n.map(l=>r[l]>0?s[l]/r[l]:0);return new E(e,{type:"bar",data:{labels:["Montag","Dienstag","Mittwoch","Donnerstag","Freitag"],datasets:[{label:"Ø Ist-Stunden",data:i,backgroundColor:a.palette[2],borderRadius:4}]},options:{...w(a),plugins:{...w(a).plugins,legend:{display:!1}}}})}function nn(e,t){const a=O();C(e);const n={};for(const i of t)!i.tagestyp||i.tagestyp==="Wochenende"||(n[i.tagestyp]=(n[i.tagestyp]??0)+1);const s=Object.keys(n),r=Object.values(n);return new E(e,{type:"doughnut",data:{labels:s,datasets:[{data:r,backgroundColor:s.map((i,l)=>a.palette[l%a.palette.length]),borderColor:a.surface,borderWidth:2}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"right",labels:{color:a.fgMuted,font:{size:12}}},tooltip:w(a).plugins.tooltip}}})}function sn(e,t){const a=O();C(e);const n={};for(const l of t){const o=l.wocheKey;n[o]??(n[o]={ist:0,soll:0}),n[o].ist+=l.ist??0,n[o].soll+=l.soll??0}const s=Object.keys(n).sort(),r=s.map(l=>n[l].ist),i=s.map(l=>n[l].soll);return new E(e,{type:"bar",data:{labels:s.map(l=>"KW "+l.split("-")[1]),datasets:[{label:"Ist",data:r,backgroundColor:a.palette[0],borderRadius:4},{label:"Soll",data:i,backgroundColor:a.palette[3],borderRadius:4}]},options:w(a)})}function rn(e,t){const a=O();C(e);const n=t.slice().sort((i,l)=>i.datum.localeCompare(l.datum));let s=0;const r=n.map(i=>(s+=i.diff??0,{x:i.datum,y:s}));return new E(e,{type:"line",data:{labels:r.map(i=>i.x),datasets:[{label:"Kumulative Differenz (+/- Soll)",data:r.map(i=>i.y),borderColor:a.palette[5],backgroundColor:B(a.palette[5],.15),fill:!0,tension:.2,pointRadius:0}]},options:{...w(a),scales:{x:{display:!1,grid:{display:!1}},y:{...w(a).scales.y}}}})}function C(e){const t=E.getChart(e);t&&t.destroy()}function B(e,t){const a=e.replace("#","").trim();if(a.length!==6&&a.length!==3)return e;const n=a.length===3?a.split("").map(l=>l+l).join(""):a,s=parseInt(n.slice(0,2),16),r=parseInt(n.slice(2,4),16),i=parseInt(n.slice(4,6),16);return`rgba(${s}, ${r}, ${i}, ${t})`}function ln(e,t,a,n){const{top:s,bottom:r}=t,i=e.createLinearGradient(0,s,0,r),l=a.min,o=a.max,c=o-l;if(c<=0)return B(n.success,.14);let d=(o-0)/c;return d=Math.max(0,Math.min(1,d)),i.addColorStop(0,B(n.success,.28)),i.addColorStop(Math.max(0,d-.001),B(n.success,.06)),i.addColorStop(Math.min(1,d+.001),B(n.danger,.06)),i.addColorStop(1,B(n.danger,.28)),i}function on(e,t){const a=String(e??"").toLowerCase();return a.includes("stempel")?t.palette[0]:a.includes("berufs")?t.palette[1]:a.includes("urlaub")?t.palette[2]:a.includes("feiertag")?t.fgSubtle:a.includes("dienst")?t.palette[3]:a.includes("krank")?t.palette[4]:t.palette[5]}let cn=0;function be(e,{type:t="info",duration:a=3500}={}){const n=document.getElementById("toast-root");if(!n)return;const s=document.createElement("div");s.className=`toast ${t}`,s.textContent=e,s.dataset.id=++cn,n.appendChild(s),setTimeout(()=>{s.style.opacity="0",s.style.transform="translateY(-8px)",s.style.transition="opacity 220ms, transform 220ms",setTimeout(()=>s.remove(),250)},a)}function ye(e){return be(e,{type:"error",duration:6e3})}function z(e){return be(e,{type:"success"})}const Pe=[{key:7,label:"1 Woche"},{key:14,label:"2 Wochen"},{key:30,label:"1 Monat"},{key:90,label:"3 Monate"},{key:"alles",label:"Alles"}];async function Te({root:e}){var v,W,Z,R;const[t,a,n,s,r]=await Promise.all([j(),X(),F(),la(),Ut("dashboardZeitraum",14)]);if(n.length===0){e.innerHTML=fn();return}const i=!((W=(v=t.berufsschulMuster)==null?void 0:v.wochentageWoechentlich)!=null&&W.length||(R=(Z=t.berufsschulMuster)==null?void 0:Z.wochentage14Taegig)!=null&&R.length),l=Ga(n,a),o=l.length;let c=r;typeof c=="number"&&c>o&&(c="alles");const d=new Set(s.map(b=>b.key)),h=pe(n,t,new Date,d),u=nt(a,d),g=[...h,...u],m=Ja(l),p=m>.05?"positive":m<-.05?"negative":"";e.innerHTML=`
    ...
    <div class="saldo-hero" style="margin-bottom: 32px; align-items: stretch;">
      <div class="saldo-hero-text" style="min-width: 260px;">
        ...
        <div class="saldo-value ${p}">${A(m,{signed:!0,suffix:""})}</div>
      ...
      <div style="flex: 1; min-width: 400px; display: flex; flex-direction: column;">
        <div class="card-split" style="margin-bottom: 12px; align-items: center;">
          ...
          <div class="segmented" id="zeitraum-picker">
            ${Pe.map(b=>{const M=typeof b.key=="number"&&b.key>o;return`<button type="button" data-key="${b.key}" class="${c===b.key?"active":""}" ${M?'disabled style="opacity:0.4"':""}>${b.label}</button>`}).join("")}
          </div>
        </div>
  ...
  `,Ee(c,e,l);const $=()=>e.querySelectorAll("#zeitraum-picker button, #zeitraum-picker-2 button");$().forEach(b=>{b.addEventListener("click",async()=>{if(b.disabled)return;const M=b.getAttribute("data-key"),P=M==="alles"?"alles":parseInt(M,10);$().forEach(H=>H.classList.toggle("active",H.getAttribute("data-key")===M)),await Yt("dashboardZeitraum",P),Ee(P,e,l)})}),e.addEventListener("click",async b=>{const M=b.target.closest(".ist-copy");if(M){b.preventDefault(),b.stopPropagation();const ke=M.getAttribute("data-val");try{await navigator.clipboard.writeText(ke),M.classList.add("ok");const N=M.querySelector(".ist-wert"),le=M.querySelector(".copy-icon");if(N&&le){const ct=N.textContent;N.textContent="✓ kopiert",le.style.display="none",setTimeout(()=>{M.classList.remove("ok"),N.textContent=ct,le.style.display=""},1e3)}}catch{z(`Bitte kopieren: ${ke}`)}return}const P=b.target.closest(".btn-dismiss");if(!P)return;const H=P.getAttribute("data-datum"),$e=P.getAttribute("data-typ");if(!H||!$e)return;await ra(H,$e),z("Warnung ausgeblendet.");const Me=P.closest(".alert");Me&&(Me.style.display="none")})}function Ee(e,t,a){const n=qa(a,e),s=Ua(n);requestAnimationFrame(()=>{const o=t.querySelector("#saldo-chart");Ya(o,n)});const r=t.querySelector("#hero-bewegung");if(r){const o=s>.05?"up":s<-.05?"down":"flat",c=s>.05?"↑":s<-.05?"↓":"→";r.className=`saldo-trend ${o}`,r.innerHTML=`${c} ${Math.abs(s)<.01?"Unverändert":A(s,{signed:!0})} im Zeitraum`}const i=t.querySelector("#tage-info");if(i){const o=n.length;i.textContent=`${o} ${o===1?"Tag":"Tage"}`}const l=t.querySelector("#tage-liste");l&&(l.innerHTML=dn(n.slice().reverse()))}function dn(e){if(!e.length)return'<p class="hint">Keine Tage im Zeitraum.</p>';const t=Math.max(1,...e.map(s=>Math.abs(s.diff??0))),a=[];let n=null;for(const s of e)(!n||n.key!==s.wocheKey)&&(n={key:s.wocheKey,tage:[]},a.push(n)),n.tage.push(s);return`<div class="tages-liste">${a.map(s=>un(s,t)).join("")}</div>`}function un(e,t){var d;const a=e.tage.reduce((h,u)=>h+(u.ist??0),0),n=e.tage.reduce((h,u)=>h+(u.diff??0),0),s=(d=e.tage[0])==null?void 0:d.datum,r=s?Ba(S(s)):"",i=e.key?e.key.split("-")[1]:"?",l=n>.05?"pos":n<-.05?"neg":"flat",o=(n>0?"+":"")+n.toFixed(2).replace(".",",")+"h",c=a.toFixed(2).replace(".",",")+"h";return`
    <div class="woche-group">
      <div class="woche-header">
        <div class="woche-header-titel">
          <span class="woche-header-kw">KW ${V(i)}</span>
          <span class="woche-header-range tabular">${V(r)}</span>
        </div>
      ...
      <div class="woche-tage">
        ${e.tage.map(h=>gn(h,t)).join("")}
      </div>
    </div>
  `}function gn(e,t){const a=e.diff??0,n=a>0,s=Math.min(100,Math.abs(a)/t*100),r=n?"var(--success)":a<0?"var(--danger)":"var(--fg-subtle)",i=ie(e.zeitSpannen);return`
    <a href="#/tag/${e.datum}" class="tag-row">
      ...
      <div class="tag-row-typ">
        ${e.tagestyp?`<span class="pill ${pn(e.tagestyp)}">${V(e.tagestyp)}</span>`:'<span style="color: var(--fg-subtle); font-size: 12px;">—</span>'}
      </div>
  ...
  `}function hn(e){const t=e.schweregrad==="error"?"!":e.schweregrad==="warn"?"⚠":"i";return`
  ...
  `}function mn(e){return{MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"}[e]??e}function pn(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function V(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Le(e){return V(e)}const vn="/zeitnachweis-app/assets/pdf.worker.min-yatZIOMy.mjs";Kt.workerSrc=vn;const Ke={Januar:1,Februar:2,März:3,Maerz:3,April:4,Mai:5,Juni:6,Juli:7,August:8,September:9,Oktober:10,November:11,Dezember:12},bn=["Stempelzeit","Berufsschule Std. bez","Berufsschule","Dienstreise Arbeitszeit","Reise öff.VM/PKW Beifahr.","Reise öff.VM/PKW","Urlaub","Gleitzeit","Arbeitsunfähigkeit","TgDtEinh","Neujahr","Karfreitag","Ostermontg","Ostmontg","Osterso.","Hl.3 Kön.","Allerhlg","Pfingstmo","Fronleichn","TdDtEinh"];async function yn(e){const a=await Wt({data:e}).promise,n=[];for(let l=1;l<=a.numPages;l++){const c=await(await a.getPage(l)).getTextContent(),d=wn(c.items);for(const h of d)n.push({page:l,text:h})}const s=$n(n),{tage:r,monate:i}=Mn(n);return{meta:s,tage:r,monate:i}}function wn(e){if(!e.length)return[];const t=e.slice().sort((i,l)=>{const o=l.transform[5]-i.transform[5];return Math.abs(o)>2?o:i.transform[4]-l.transform[4]}),a=[];let n=null,s=[];const r=3;for(const i of t){const l=i.transform[5];n==null||Math.abs(l-n)<=r?(s.push(i),n==null&&(n=l)):(a.push(We(s)),s=[i],n=l)}return s.length&&a.push(We(s)),a.filter(i=>i.trim().length>0)}function We(e){e.sort((n,s)=>n.transform[4]-s.transform[4]);let t="",a=-1;for(const n of e){const s=n.transform[4];a>=0&&s-a>4?t+="  ":a>=0&&s-a>.5&&(t+=" "),t+=n.str,a=s+n.width}return t}function $n(e){var a,n;const t={personalnummer:null,name:null,kostenstelle:null,personalbereich:null,einstellungsdatum:null,mitarbeiterkreis:null,arbeitszeitplanregel:null,zeitraumVon:null,zeitraumBis:null,stichtagAuswertung:null};for(let s=0;s<e.length;s++){const r=e[s].text,i=/vom\s+(\d{2}\.\d{2}\.\d{4})\s+bis\s+(\d{2}\.\d{2}\.\d{4})/i.exec(r);i&&(t.zeitraumVon=Q(i[1]),t.zeitraumBis=Q(i[2]));const l=/bis einschließlich dem\s+(\d{2}\.\d{2}\.\d{4})/i.exec(r);if(l&&(t.stichtagAuswertung=Q(l[1])),/Personalnummer/i.test(r)&&/Kostenstelle/i.test(r)){const c=(((a=e[s+1])==null?void 0:a.text)??"").trim().split(/\s{2,}/);c.length>=3&&(t.personalnummer=c[0],t.kostenstelle=c[1],t.personalbereich=c[2])}if(/Einstellungsdatum/i.test(r)&&/Mitarbeiterkreis/i.test(r)){const c=(((n=e[s+1])==null?void 0:n.text)??"").trim().split(/\s{2,}/);c.length>=3&&(t.einstellungsdatum=Q(c[0]),t.mitarbeiterkreis=c[1],t.arbeitszeitplanregel=c[2])}if(/Bei Rückfragen wenden Sie sich an/i.test(r))for(let o=s+1;o<Math.min(s+8,e.length);o++){const c=e[o].text.trim();if(/^[A-ZÄÖÜ][a-zäöüß]+(?:\s[A-ZÄÖÜ][a-zäöüß]+)+$/.test(c)&&!/kanarya/i.test(c)&&!/tel/i.test(c)){t.name=c;break}}}return t}function Mn(e,t){var o;const a=[],n=[];let s=null,r=null,i=!1,l=0;for(;l<e.length;){const c=e[l].text,d=/Monat:\s*([A-Za-zäöüÄÖÜß]+)\s*-\s*(\d{4})/.exec(c);if(d){const m=d[1].trim(),p=parseInt(d[2],10),$=Ke[m]??Ke[m.replace("ä","ae")]??null;$&&(s={jahr:p,monat:$,monatKey:`${p}-${String($).padStart(2,"0")}`},i=!0,r=null),l++;continue}if(/Monats.bersicht zum Stichtag\s+(\d{2}\.\d{2}\.\d{4})/i.test(c)){const m=/Monats.bersicht zum Stichtag\s+(\d{2}\.\d{2}\.\d{4})/i.exec(c),p=Q(m[1]);r={monatKey:(s==null?void 0:s.monatKey)??Xe(p),stichtag:p,glz:{},flexi:{},zeitkonten:{},raw:{}},l=kn(e,l+1,r),n.push(r);continue}let h=s;const u=/^(\d{2})\s+(MO|DI|MI|DO|FR|SA|SO)\b/.exec(c.trim());if(u&&s){const m=parseInt(u[1],10);i&&m>=20?h=zn(s):m<=15&&(i=!1)}const g=Fe(c,h);if(g){const m=[];let p=l+1;for(;p<e.length;){const v=e[p].text;if(/^\s*\d{4}\s+Umbuchung/.test(v)||Fe(v,s)||/Wochensumme/i.test(v)||/Monats.bersicht/i.test(v)||/Monat:\s*[A-Za-z]/i.test(v))break;const W=Sn(v);if(W){m.push(W),p++;continue}break}if(m.length&&g.zeitSpannen.push(...m),g.tagestyp==="Wochenende"||g.wochentag==="SA"||g.wochentag==="SO"){l=p;continue}(g.ist!=null||g.soll!=null||(((o=g.zeitSpannen)==null?void 0:o.length)??0)>0||g.tagestyp!=null)&&a.push(g),l=p;continue}l++}return{tage:a,monate:n}}function kn(e,t,a){let n=t;const s=/(\d{4,5}|KTAU|AZAU)\s*-\s*(.+?)\s+(-?[\d,.]+-?)(?=\s+(?:\d{4,5}|KTAU|AZAU)\s*-|\s*$)/g;for(;n<e.length;){const r=e[n].text.trim();if(/^Monat:\s/.test(r)||/^Einzelergebnisse\s/.test(r)||/^Tag\b/.test(r)||/^Wochensumme/.test(r)||/^\d{2}\s+(MO|DI|MI|DO|FR|SA|SO)\b/.test(r)||/^Übersicht für den Zeitraum/i.test(r)||/^Abwesenheitsansprüche/i.test(r))break;s.lastIndex=0;let i;for(;(i=s.exec(r))!=null;){const l=i[1],o=i[2].trim(),c=Ye(i[3]);a.raw[l]={beschreibung:o,wert:c},l==="0008"&&(a.glz.saldoVorperiode=c),l==="8016"&&(a.glz.saldoAktuellePeriode=c),l==="9802"&&(a.glz.umgebuchteStunden=c),l==="0005"&&(a.glz.saldoGesamt=c),l==="9803"&&(a.glz.ueberzaehligeStd=c),l==="0050"&&(a.zeitkonten.produktivstunden=c),l==="9011"&&(a.flexi.jahreskontoVorperiode=c),l==="9010"&&(a.flexi.jahreskontoSaldo=c),l==="9020"&&(a.flexi.langzeitkontoSaldo=c),l==="9203"&&(a.zeitkonten.azMonatsendeUeber216=c),l==="9207"&&(a.zeitkonten.auszahlungBav=c),l==="9205"&&(a.zeitkonten.summeAuszahlung=c)}if(n++,n-t>80)break}return n}function Fe(e,t){if(!t)return null;const a=e.trim(),n=/^(\d{2})\s+(MO|DI|MI|DO|FR|SA|SO)(?:\s+(.+))?$/.exec(a);if(!n)return null;const s=parseInt(n[1],10),r=n[2],i=(n[3]??"").trim();let l=t.jahr,o=t.monat;const c=new Date(l,o-1,s),d={datum:Va(c),datumDate:c.toISOString(),wochentag:r,tagNr:s,monatKey:Xe(c),wocheKey:Ia(c),zeitSpannen:[],aktivitaeten:[],ist:null,soll:null,diff:null,pause:null,tazp:null,tagestyp:null,raw:a};return i?(xn(i,d),d):(d.tagestyp=["SA","SO"].includes(r)?"Wochenende":null,d)}function Sn(e){const t=e.trim(),a=/^(Stempelzeit|Reise öff\.VM\/PKW Beifahr\.|Reise öff\.VM\/PKW|Dienstreise Arbeitszeit)\s+(\d{2}:\d{2})\s+(\d{2}:\d{2})\s*$/.exec(t);return a?{aktivitaet:a[1],von:a[2],bis:a[3]}:null}function xn(e,t){let a=null,n=e;for(const d of bn)if(e.startsWith(d)){a=d,n=e.slice(d.length).trim();break}a||(a=e.split(/\s+/)[0],n=e.slice(a.length).trim()),t.tagestyp=Dn(a),t.aktivitaeten.push(a);const s=n.split(/\s+/).filter(Boolean),r=/^\d{2}:\d{2}$/,i=/^-?[\d,.]+-?$/;let l=0;for(;s[l]&&r.test(s[l])&&s[l+1]&&r.test(s[l+1]);)t.zeitSpannen.push({aktivitaet:a,von:s[l],bis:s[l+1]}),l+=2;const o=[];for(;l<s.length&&i.test(s[l]);){const d=Ye(s[l]);d!=null&&o.push(d),l++}let c=s[l];o.length>=5?([t.ist,t.soll,t.diff,t.pause]=o,c||(c=String(o[4]))):o.length===4?[t.ist,t.soll,t.diff,t.pause]=o:o.length===3?[t.ist,t.soll,t.diff]=o:o.length===2?[t.ist,t.soll]=o:o.length===1&&(t.ist=o[0]),c&&(t.tazp=String(c))}function zn(e){if(!e)return null;let t=e.monat-1,a=e.jahr;return t<1&&(t=12,a-=1),{jahr:a,monat:t,monatKey:`${a}-${String(t).padStart(2,"0")}`}}function Dn(e){return e?/^Stempelzeit$/i.test(e)?"Stempelzeit":/^Berufsschule Std\. bez$/i.test(e)||/^Berufsschule$/i.test(e)?"Berufsschule":/Dienstreise/i.test(e)||/Reise/i.test(e)?"Dienstreise":/^Urlaub$/i.test(e)?"Urlaub":/^Gleitzeit$/i.test(e)?"Gleitzeit":/Arbeitsunf.higkeit/i.test(e)?"Arbeitsunfähigkeit":/^(Neujahr|Karfreitag|Ostermontg|Ostmontg|Osterso\.|Hl\.3 Kön\.|Allerhlg|Pfingstmo|Fronleichn|TdDtEinh|TgDtEinh)$/i.test(e)?"Feiertag":e:null}async function An({root:e}){const t=await Ue(),a=await j();e.innerHTML=`
  ...
  `;const n=e.querySelector("#upload-zone"),s=e.querySelector("#file-input");n.addEventListener("click",()=>s.click()),n.addEventListener("dragover",r=>{r.preventDefault(),n.classList.add("drag")}),n.addEventListener("dragleave",()=>n.classList.remove("drag")),n.addEventListener("drop",async r=>{var l;r.preventDefault(),n.classList.remove("drag");const i=(l=r.dataTransfer.files)==null?void 0:l[0];i&&await Oe(i,e,a)}),s.addEventListener("change",async r=>{var l;const i=(l=r.target.files)==null?void 0:l[0];i&&await Oe(i,e,a)}),e.querySelector("#btn-export").addEventListener("click",Tn),e.querySelector("#btn-import").addEventListener("click",()=>e.querySelector("#import-input").click()),e.querySelector("#import-input").addEventListener("change",En),e.querySelector("#btn-clear-parsed").addEventListener("click",Pn),e.querySelector("#btn-reset").addEventListener("click",Ln)}async function Pn(){confirm("PDF-abgeleitete Daten (Tage, Monate, Uploads) werden gelöscht. Profil und Mail-Vorlagen bleiben erhalten. Fortfahren?")&&(await aa(),z("Daten gelöscht. Profil bleibt."),setTimeout(()=>location.reload(),600))}function st(e){return`
    <table class="table">
      <thead>
        <tr>
  ...
  `}async function Oe(e,t,a){var r,i,l;const n=t.querySelector("#upload-status"),s=t.querySelector("#upload-zone");s.style.pointerEvents="none",s.style.opacity="0.6",n.innerHTML=`
    ...
    </div>`;try{const o=await e.arrayBuffer(),c=await yn(o);await Qt(c.tage),await Xt(c.monate),await ea({dateiname:e.name,zeitraumVon:((r=c.meta.zeitraumVon)==null?void 0:r.toISOString())??null,zeitraumBis:((i=c.meta.zeitraumBis)==null?void 0:i.toISOString())??null,stichtagAuswertung:((l=c.meta.stichtagAuswertung)==null?void 0:l.toISOString())??null,tageCount:c.tage.length,monateCount:c.monate.length});const d=await F(),h=et(d),u={...Je(),...a};(h.wochentageWoechentlich.length>0||h.wochentage14Taegig.length>0)&&(u.berufsschulMuster=h),await fe(u),n.innerHTML=`
    ...
    `,z(`PDF verarbeitet: ${c.tage.length} Tage.`);const g=await Ue();t.querySelector("#uploads-list").innerHTML=st(g)}catch(o){console.error(o),n.innerHTML=`
      ...
      <div class="card" style="grid-column: 1 / -1;">
        ...
        ${n?`
          <div class="tag-detail">
            ...
            <div class="tag-detail-value"><strong>${((i=a.wochentageWoechentlich)==null?void 0:i.map(o=>Ce[o]).join(", "))||"—"}</strong></div>
          </div>
          <div class="tag-detail">
            <div class="tag-detail-label">Alle 2 Wochen</div>
            <div class="tag-detail-value"><strong>${((l=a.wochentage14Taegig)==null?void 0:l.map(o=>Ce[o]).join(", "))||"—"}</strong>${a.referenzDatum14Taegig?` <span class="hint">(Anker: ${y(new Date(a.referenzDatum14Taegig))})</span>`:""}</div>
          </div>
  ...
  `,e.querySelector("#profil-form").addEventListener("submit",async o=>{var h,u;o.preventDefault();const c=new FormData(o.target),d={...t,ueber18:c.get("ueber18")==="on",zeitwirtschaftEmail:((h=c.get("zeitwirtschaftEmail"))==null?void 0:h.trim())||"Zeitwirtschaft.Aichtal@putzmeister.com",zeitwirtschaftAnrede:((u=c.get("zeitwirtschaftAnrede"))==null?void 0:u.trim())||"Frau Kanarya"};await fe(d),z("Profil gespeichert.")})}function Be(e){return String(e??"").replace(/"/g,"&quot;")}async function Fn({root:e}){var s;const t=await X(),a=await F(),n={};for(const r of a)n[s=r.monatKey]??(n[s]=[]),n[r.monatKey].push(r);if(t.length===0){e.innerHTML=_n("Noch keine Monatsdaten. Lade zuerst ein PDF unter Daten hoch.");return}e.innerHTML=`
    <h1 class="view-title">Monate</h1>
    <p class="view-subtitle">${t.length} Monate erfasst. Klicke für Details.</p>

    <div class="grid cols-2">
      ${t.slice().reverse().map(r=>{var u;const l=(n[r.monatKey]??[]).filter(g=>g.ist!=null&&g.ist>0),o=l.reduce((g,m)=>g+(m.ist??0),0),c=l.reduce((g,m)=>g+(m.soll??0),0),d=o-c,h=(u=r.glz)==null?void 0:u.saldoGesamt;return`
          <a href="#/monat/${r.monatKey}" class="card" style="text-decoration: none; color: inherit; display: block;">
            <div class="card-split" style="margin-bottom: 12px;">
              <h2 style="margin: 0;">${ue(r.monatKey)}</h2>
  ...
  `}async function On({params:e,root:t}){const a=e.yyyymm,[n,s,r]=await Promise.all([F(),X(),j()]),i=s.find(c=>c.monatKey===a),l=n.filter(c=>c.monatKey===a).sort((c,d)=>c.datum.localeCompare(d.datum));if(!l.length){t.innerHTML=`<h1 class="view-title">Monat ${ue(a)}</h1><p class="view-subtitle">Keine Daten für diesen Monat.</p><a href="#/monat" class="btn">← Alle Monate</a>`;return}const o=pe(n,r,new Date).filter(c=>c.datum.startsWith(a));t.innerHTML=`
  ...
  `,ve(t.querySelector("#chart-monat"),l)}function Cn(e){var n,s,r,i;const t=((n=e.glz)==null?void 0:n.saldoGesamt)??0;return`
    <div class="grid cols-4" style="margin-bottom: 24px;">
      ...
      <div class="card">
        <h3>Akt. Periode</h3>
        <div class="tabular" style="font-size: 28px; font-weight: 650;">${A(((r=e.glz)==null?void 0:r.saldoAktuellePeriode)??0,{signed:!0})}</div>
      </div>
      <div class="card">
        <h3>Produktivstd.</h3>
        <div class="tabular" style="font-size: 28px; font-weight: 650;">${A(((i=e.zeitkonten)==null?void 0:i.produktivstunden)??0,{suffix:""})}</div>
      </div>
    </div>
      ...
      <tbody>
        ${e.map(t=>{const a=t.diff>.05?"positive":t.diff<-.05?"negative":"",n=ie(t.zeitSpannen);return`
            <tr>
              ...
              <td>${t.tagestyp?`<span class="pill ${Vn(t.tagestyp)}">${ae(t.tagestyp)}</span>`:"—"}</td>
              <td>${re(n,{size:18})}</td>
  ...
  `}function ue(e){const[t,a]=e.split("-"),n=new Date(parseInt(t),parseInt(a)-1,1);return x(n,"LLLL yyyy",{locale:ee})}function Vn(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function _n(e){return`<div class="empty-state"><div class="empty-state-icon">📭</div><p>${ae(e)}</p><a href="#/daten" class="btn primary">Zu Daten</a></div>`}function ae(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}async function jn({root:e}){var s;const t=await F();if(!t.length){e.innerHTML='<h1 class="view-title">Wochen</h1><p class="view-subtitle">Noch keine Daten.</p><a href="#/daten" class="btn primary">Zum Upload</a>';return}const a={};for(const r of t)a[s=r.wocheKey]??(a[s]={key:r.wocheKey,tage:[],ist:0,soll:0}),a[r.wocheKey].tage.push(r),a[r.wocheKey].ist+=r.ist??0,a[r.wocheKey].soll+=r.soll??0;const n=Object.keys(a).sort().reverse();e.innerHTML=`
    ...
    <div>
      ${n.map(r=>{const i=a[r],l=i.ist-i.soll,o=l>.05?"positive":l<-.05?"negative":"";return`
          <a href="#/woche/${r}" class="list-item">
            <div class="tabular" style="font-size: 16px; font-weight: 600; color: var(--fg-muted);">${ne(it(r))}</div>
            <div>
  ...
  `,ve(t.querySelector("#chart-woche"),s)}function Zn(e){return`
    <table class="table">
      <thead>
        <tr>
          <th>Datum</th>
      ...
      <tbody>
        ${e.map(t=>{const a=t.diff>.05?"positive":t.diff<-.05?"negative":"",n=ie(t.zeitSpannen);return`
            <tr>
              <td><a href="#/tag/${t.datum}" style="color: inherit;"><span class="tabular">${x(S(t.datum),"dd.MM.yyyy")}</span> ${t.wochentag}</a></td>
              <td>${t.tagestyp?`<span class="pill ${Hn(t.tagestyp)}">${ne(t.tagestyp)}</span>`:"—"}</td>
              <td>${re(n,{size:18})}</td>
              <td class="num tabular">${t.ist!=null?t.ist.toFixed(2).replace(".",","):"—"}</td>
              <td class="num tabular">${t.soll!=null?t.soll.toFixed(2).replace(".",","):"—"}</td>
              <td class="num tabular ${a}">${t.diff!=null?A(t.diff,{signed:!0,suffix:""}):"—"}</td>
  ...
  `}function it(e){const[t,a]=e.split("-");return`KW ${a} · ${t}`}function Hn(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function ne(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}async function Nn({params:e,root:t}){var c,d,h;const a=e.datum,n=await f.tage.get(a),s=await j();if(!n){t.innerHTML=`<h1 class="view-title">Tag nicht gefunden</h1><p>Für ${a} liegen keine Daten vor.</p><a href="#/" class="btn">← Dashboard</a>`;return}const r=S(a),i=n.tagestyp==="Stempelzeit"?at(n,s):null,l=me(r,s.berufsschulMuster),o=ie(n.zeitSpannen);t.innerHTML=`
    <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 8px;">
      <a href="#/monat/${a.slice(0,7)}" class="btn sm">← Zum Monat</a>
    </div>
    <h1 class="view-title">${Qe(r)}</h1>
    ...
    <div class="grid cols-2" style="gap: 24px;">
      ...
      <div class="card">
        ...
        <div class="tag-detail">
          ...
          <div class="tag-detail-value">${n.tagestyp?`<span class="pill ${Gn(n.tagestyp)}">${Y(n.tagestyp)}</span>`:"—"}</div>
        </div>
        <div class="tag-detail">
        ...
        <div class="card" style="grid-column: 1 / -1;">
          ...
          ${i.warnung?`
            <div class="alert severity-warn" style="margin-top: 12px;">
              <div class="alert-icon">⚠</div>
              <div class="alert-body">${Y(i.warnung)}</div>
            </div>
          `:""}
        </div>
      `:""}
    </div>
  `}function Gn(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function Y(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}async function qn({root:e}){const[t,a]=await Promise.all([F(),X()]);if(!t.length){e.innerHTML='<h1 class="view-title">Analytics</h1><p class="view-subtitle">Keine Daten.</p><a href="#/daten" class="btn primary">Zum Upload</a>';return}e.innerHTML=`
  ...
  `,requestAnimationFrame(()=>{Xa(e.querySelector("#c-saldo"),a),sn(e.querySelector("#c-istsoll"),t),rn(e.querySelector("#c-kumulativ"),t),en(e.querySelector("#c-startend"),t),an(e.querySelector("#c-wochentag"),t),tn(e.querySelector("#c-pausen"),t),nn(e.querySelector("#c-donut"),t);const n=t.slice(-30);ve(e.querySelector("#c-alle-tage"),n)})}async function Jn({root:e}){const t=await F();if(!t.length){e.innerHTML='<h1 class="view-title">Berichtsheft</h1><p class="view-subtitle">Keine Daten.</p><a href="#/daten" class="btn primary">Zum Upload</a>';return}const a=[...new Set(t.map(r=>r.monatKey))].sort().reverse();e.innerHTML=`
      ...
      <div class="card-split" style="margin-bottom: 16px; align-items: center;">
        ...
        <div style="display: flex; gap: 8px; align-items: center;">
          ...
          <select id="filter-monat">
            ...
            ${a.map(r=>`<option value="${r}">${Qn(r)}</option>`).join("")}
          </select>
...
`);navigator.clipboard.writeText(i).then(()=>z(`${r.length} Zeilen kopiert.`))});function s(){const r=n.value,l=(r?t.filter(o=>o.monatKey===r):t).filter(o=>o.ist!=null&&o.ist>0&&o.tagestyp!=="Wochenende");e.querySelector("#liste").innerHTML=Un(l),e.querySelectorAll(".copy-val").forEach(o=>{o.addEventListener("click",async()=>{const c=o.getAttribute("data-val");await navigator.clipboard.writeText(c),o.classList.add("ok");const d=o.textContent;o.textContent="✓ kopiert",setTimeout(()=>{o.classList.remove("ok"),o.textContent=d},1200)})})}s()}function Un(e){return e.length?`
    <table class="table">
      <thead>
        <tr>
          <th>Datum</th>
      ...
      <tbody>
        ${e.map(t=>{const a=I(t.ist),n=`${y(S(t.datum))}	${a}`;return`
            <tr data-copy="${Ie(n)}">
              <td class="tabular">${y(S(t.datum))}</td>
              <td>${Yn(t.wochentag)}</td>
              <td>${t.tagestyp?`<span class="pill ${Xn(t.tagestyp)}">${rt(t.tagestyp)}</span>`:"—"}</td>
  ...
  `:'<p style="color: var(--fg-muted);">Keine Tage in dieser Auswahl.</p>'}function Yn(e){return{MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"}[e]??e}function Qn(e){const[t,a]=e.split("-");return x(new Date(parseInt(t),parseInt(a)-1,1),"LLLL yyyy",{locale:ee})}function Xn(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function rt(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Ie(e){return rt(e)}const es={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"},we={bs_tag_fehlt:{key:"bs_tag_fehlt",titel:"Berufsschultag fehlt",beschreibung:"Wenn ein Berufsschultag komplett nicht im Zeitnachweis eingetragen wurde.",betreff:"Bitte um Zeitkorrektur im ESS  - Fehlender Berufsschultag {datum}",text:`Guten Tag {zeitwirtschaft_anrede},
...
Vielen Dank!`}};function lt(e,t){const a=we[e];return a?{...a,...t??{}}:null}function ot(e,t){const a=Ve(e.text,t);return{betreff:Ve(e.betreff,t),text:a}}function Ve(e,t){return e.replace(/\{(\w+)\}/g,(a,n)=>t[n]!=null?String(t[n]):`{${n}}`)}function ts(e,t){const a=t.datum?new Date(t.datum):null;return{name:"",personalnr:"",kostenstelle:"",datum:a?Qe(a).split(", ")[1]:"",wochentag:es[t.wochentag]??t.wochentag??"",zeitwirtschaft_anrede:e.zeitwirtschaftAnrede||"Frau Kanarya",zeitwirtschaft_email:e.zeitwirtschaftEmail||"Zeitwirtschaft.Aichtal@putzmeister.com",ist:t.ist!=null?t.ist.toFixed(2).replace(".",","):"",soll:t.soll!=null?t.soll.toFixed(2).replace(".",","):"",abgezogen:t.abgezogen!=null?Math.round(t.abgezogen*60):"",gestempelt:t.gestempelt!=null?Math.round(t.gestempelt*60):"",verlust:t.verlustMinuten??""}}function as(e,t,a){const n=ot(t,a),s=e.zeitwirtschaftEmail||"Zeitwirtschaft.Aichtal@putzmeister.com",r=new URLSearchParams;return r.set("subject",n.betreff),r.set("body",n.text),`mailto:${s}?${r.toString().replace(/\+/g,"%20")}`}async function ns({root:e}){const[t,a,n,s]=await Promise.all([F(),j(),X(),ia()]),r=Object.fromEntries(s.map(o=>[o.key,o])),i=pe(t,a,new Date).filter(o=>o.mailVorlageKey),l=nt(n);e.innerHTML=`
    ...
    <div class="card">
      ...
      <div id="vorlagen-editor">
        ${Object.keys(we).map(o=>{const c=lt(o,r[o]);return is(c)}).join("")}
      </div>
    </div>
  `,rs(e),ls(e)}function ss(e,t,a){const n=lt(e.mailVorlageKey,a[e.mailVorlageKey]);if(!n)return"";const s=ts(t,e),r=ot(n,s),i=as(t,n,s);return`
...
<strong>Betreff:</strong> ${T(r.betreff)}
...
${T(r.text)}
      ...
      <div class="alert-actions" style="margin-top: 12px;">
        ...
        <button class="btn sm btn-copy-mail" data-subject="${ge(r.betreff)}" data-body="${ge(r.text)}">📋 Betreff + Text kopieren</button>
      </div>
    </div>
  ...
  `}function rs(e){e.querySelectorAll(".btn-save-vorlage").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-key"),n=t.closest(".vorlagen-item"),s=n.querySelector(".v-betreff").value,r=n.querySelector(".v-text").value;await ze(a,{betreff:s,text:r}),z("Vorlage gespeichert.")})}),e.querySelectorAll(".btn-reset-vorlage").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-key"),n=we[a];n&&confirm(`Vorlage "${n.titel}" auf Default zurücksetzen?`)&&(await ze(a,{betreff:n.betreff,text:n.text}),z("Zurückgesetzt."),setTimeout(()=>location.reload(),400))})})}function ls(e){e.querySelectorAll(".btn-copy-mail").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-subject"),n=t.getAttribute("data-body"),s=`Betreff: ${a}

${n}`;await navigator.clipboard.writeText(s),z("Mail-Text kopiert.")})})}function T(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function ge(e){return T(e)}async function os({root:e}){const t=Ne(),a=await j();e.innerHTML=`
  ...
  `,e.querySelectorAll("[data-theme]").forEach(n=>{n.addEventListener("click",()=>{const s=n.getAttribute("data-theme");he(s),e.querySelectorAll("[data-theme]").forEach(r=>r.classList.toggle("active",r===n)),z(`Theme: ${n.textContent.trim()}`)})}),e.querySelector("#pause-sel").addEventListener("change",async n=>{const s={...a,pausenRegel:n.target.value};await fe(s),z("Pausen-Regel gespeichert.")})}async function _e(){var t;Ft();const e=document.getElementById("content");(t=document.getElementById("theme-toggle"))==null||t.addEventListener("click",()=>Ot()),Ct(()=>{jt()}),await Jt()&&setTimeout(()=>{be('Parser wurde aktualisiert. Bitte lade deinen Zeitnachweis unter "Daten" neu hoch.',{type:"info",duration:12e3})},500),await qt(),await Gt(),D("/",Te),D("/dashboard",Te),D("/analytics",qn),D("/monat",Fn),D("/monat/:yyyymm",On),D("/woche",jn),D("/woche/:yyyykw",Rn),D("/tag/:datum",Nn),D("/berichtsheft",Jn),D("/mails",ns),D("/profil",Wn),D("/daten",An),D("/einstellungen",os),Vt(e),location.hash||It("/")}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",_e):_e();
