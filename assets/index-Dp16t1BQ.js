...
import{D as ma}from"./dexie-UpTFNL8S.js";import{b as Ye,a as xe,c as ke,d as pa,f as F,s as ba,e as va,g as lt,i as ot,p as ya,h as wa,j as xa,k as ka,l as B,m as $a}from"./datefns-VEit7B1-.js";import{C as te,L as Sa,B as Ma,D as za,S as Da,a as Aa,b as Ta,P as Pa,A as Ea,c as La,d as Fa,T as Ka,p as Ba,e as Ca,i as Wa}from"./chartjs-CRgZvhTJ.js";import{_ as _a,a as Va}from"./pdfjs-BDGsuRSB.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&n(l)}).observe(document,{childList:!0,subtree:!0});function a(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=a(s);fetch(s.href,i)}})();function Ia(){document.documentElement.setAttribute("data-theme","dark")}const Vt=[];function I(e,t){const a=e.split("/").filter(Boolean),n=[],s=new RegExp("^/?"+a.map(i=>i.startsWith(":")?(n.push(i.slice(1)),"([^/]+)"):ja(i)).join("/")+"/?$");Vt.push({pattern:e,regex:s,paramNames:n,render:t})}function Oa(e){e.startsWith("#")||(e="#"+e),window.location.hash===e?ne():window.location.hash=e}function Ha(e,{onNavigate:t}={}){window.addEventListener("hashchange",ne),ne.rootEl=e,ne.onNavigate=t,ne()}async function ne(){var n;const e=ne.rootEl,t=window.location.hash.slice(1)||"/",a=t.startsWith("/")?t:`/${t}`;for(const s of Vt){const i=s.regex.exec(a);if(i){const l={};s.paramNames.forEach((c,r)=>l[c]=decodeURIComponent(i[r+1])),(n=ne.onNavigate)==null||n.call(ne,a),Na(a);try{e.classList.remove("view-enter"),await s.render({params:l,path:a,root:e}),e.classList.add("view-enter")}catch(c){console.error("Route render error:",c),e.innerHTML=`<div class="empty-state">
  ...
  </svg>`}function Rt(e,t={}){const{size:a=20,layout:n="inline"}=t;return e?`
...
Vielen Dank!`}};function Ze(e,t){const a=Te[e];return a?{...a,...t??{}}:null}function ta(e,t){const a=xt(e.text,t);return{betreff:xt(e.betreff,t),text:a}}function xt(e,t){return e.replace(/\{(\w+)\}/g,(a,n)=>t[n]!=null?String(t[n]):`{${n}}`)}function aa(e,t){const a=t.datum?new Date(t.datum):null;return{name:"",personalnr:"",kostenstelle:"",datum:a?qt(a).split(", ")[1]:"",wochentag:Gn[t.wochentag]??t.wochentag??"",zeitwirtschaft_anrede:e.zeitwirtschaftAnrede||"Frau Kanarya",zeitwirtschaft_email:e.zeitwirtschaftEmail||"Zeitwirtschaft.Aichtal@putzmeister.com",ist:t.ist!=null?t.ist.toFixed(2).replace(".",","):"",soll:t.soll!=null?t.soll.toFixed(2).replace(".",","):"",abgezogen:t.abgezogen!=null?Math.round(t.abgezogen*60):"",gestempelt:t.gestempelt!=null?Math.round(t.gestempelt*60):"",verlust:t.verlustMinuten??""}}function na(e,t,a){const n=ta(t,a),s=e.zeitwirtschaftEmail||"Zeitwirtschaft.Aichtal@putzmeister.com",i=new URLSearchParams;return i.set("subject",n.betreff),i.set("body",n.text),`mailto:${s}?${i.toString().replace(/\+/g,"%20")}`}te.register(Sa,Ma,za,Da,Aa,Ta,Pa,Ea,La,Fa,Ka,Ba,Ca,Wa);function O(e){return getComputedStyle(document.documentElement).getPropertyValue(e).trim()}function re(){return{fg:O("--fg"),fgMuted:O("--fg-muted"),fgSubtle:O("--fg-subtle"),border:O("--border"),surface:O("--surface"),accent:O("--accent"),success:O("--success"),warn:O("--warn"),danger:O("--danger"),info:O("--info"),palette:[O("--chart-1"),O("--chart-2"),O("--chart-3"),O("--chart-4"),O("--chart-5"),O("--chart-6"),O("--chart-7")]}}function L(e){return{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{labels:{color:e.fgMuted,font:{size:12}}},tooltip:{backgroundColor:e.surface,titleColor:e.fg,bodyColor:e.fg,borderColor:e.border,borderWidth:1,padding:10,displayColors:!0}},scales:{x:{ticks:{color:e.fgMuted,font:{size:11}},grid:{color:e.border,drawBorder:!1}},y:{ticks:{color:e.fgMuted,font:{size:11}},grid:{color:e.border,drawBorder:!1}}}}}function Ge(e,t){const a=re();if(oe(e),!(t!=null&&t.length))return;const n=t.map(i=>F(B(i.datum),"dd.MM.")),s=t.map(i=>i.saldo);return s.map(i=>i>=0?a.success:a.danger),new te(e,{type:"line",data:{labels:n,datasets:[{label:"Tages-Saldo",data:s,borderColor:a.accent,backgroundColor:i=>{const l=i.chart,{ctx:c,chartArea:r,scales:o}=l;return r?sa(c,r,o.y,a):se(a.accent,.14)},segment:{borderColor:i=>{const l=i.p0.parsed.y,c=i.p1.parsed.y,r=(l+c)/2;return r>=.02?a.success:r<=-.02?a.danger:a.fgMuted}},tension:.25,pointRadius:2,pointHoverRadius:6,pointHitRadius:20,pointBackgroundColor:s.map(i=>i>=.02?a.success:i<=-.02?a.danger:a.fgMuted),pointBorderColor:a.surface,pointBorderWidth:1,fill:!0,borderWidth:2}]},options:{...L(a),interaction:{mode:"index",intersect:!1,axis:"x"},hover:{mode:"index",intersect:!1,axis:"x"},plugins:{...L(a).plugins,legend:{display:!1},tooltip:{enabled:!1,mode:"index",intersect:!1,axis:"x",position:"nearest",external:Un(t)}},scales:{...L(a).scales,y:{...L(a).scales.y,ticks:{...L(a).scales.y.ticks,callback:i=>`${i>=0?"+":""}${i.toFixed(1).replace(".",",")}h`}}}}})}function le(e){return function(t){var m,v;const{chart:a,tooltip:n}=t;let s=a.$richTooltipEl;if(!s){s=document.createElement("div"),s.className="saldo-tooltip",document.body.appendChild(s),a.$richTooltipEl=s;const p=a.destroy.bind(a);a.destroy=function(){s.parentNode&&s.parentNode.removeChild(s),p()}}if(n.opacity===0||!((m=n.dataPoints)!=null&&m.length)){s.style.opacity="0";return}const i=e({tooltip:n,chart:a});if(!i){s.style.opacity="0";return}let l=`<div class="saldo-tooltip-title">${at(i.title)}</div>`;for(const p of i.rows||[]){const M=p.klasse||"flat";l+=`<div class="saldo-tooltip-row"><span class="saldo-tooltip-label">${at(p.label)}</span><span class="saldo-tooltip-value ${M}">${p.value}</span></div>`}(v=i.meta)!=null&&v.length&&(l+=`<div class="saldo-tooltip-meta">${i.meta.map(p=>`<span>${p}</span>`).join("")}</div>`),s.innerHTML=l;const c=a.canvas.getBoundingClientRect(),r=c.left+n.caretX,o=c.top+n.caretY;s.style.opacity="0",s.style.left="0px",s.style.top="0px";const d=s.offsetWidth,u=s.offsetHeight,g=18;let h=r+g;h+d>window.innerWidth-8&&(h=r-g-d);let f=o-u/2;f<8&&(f=8),f+u>window.innerHeight-8&&(f=window.innerHeight-u-8),s.style.left=h+"px",s.style.top=f+"px",s.style.opacity="1"}}function ie(e){return e==null?"flat":e>.05?"pos":e<-.05?"neg":"flat"}function ge(e){return e==null?"—":(e>0?"+":"")+e.toFixed(2).replace(".",",")+"h"}function he(e){return e==null?"—":e.toFixed(2).replace(".",",")+"h"}function Un(e){return le(({tooltip:t})=>{const a=t.dataPoints[0].dataIndex,n=e[a];if(!n)return null;const s=[{label:"Saldo",value:ge(n.saldo),klasse:ie(n.saldo)}];n.diff!=null&&s.push({label:"Tages-Diff",value:ge(n.diff),klasse:ie(n.diff)});const i=[];return n.tagestyp&&i.push(`Typ: ${at(n.tagestyp)}`),n.umbuchung&&i.push(`Umbuchung: ${n.umbuchung>=0?"+":""}${n.umbuchung.toFixed(2).replace(".",",")}h`),{title:F(B(n.datum),"EE, dd.MM.yyyy",{locale:Y}),rows:s,meta:i}})}function at(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Jn(e,t){const a=re();if(oe(e),!(t!=null&&t.length))return;const n=t.map(c=>c.monatKey),s=n.map(c=>{const[r,o]=c.split("-"),d=new Date(parseInt(r,10),parseInt(o,10)-1,1);return F(d,"MMM yyyy",{locale:Y})}),i=t.map(c=>{var r;return((r=c.glz)==null?void 0:r.saldoGesamt)??0}),l=t.map(c=>{var r;return((r=c.glz)==null?void 0:r.saldoVorperiode)??null});return new te(e,{type:"line",data:{labels:s,datasets:[{label:"GLZ-Saldo (Monatsende)",data:i,borderColor:a.accent,backgroundColor:c=>{const r=c.chart,{ctx:o,chartArea:d,scales:u}=r;return d?sa(o,d,u.y,a):se(a.accent,.14)},segment:{borderColor:c=>{const r=c.p0.parsed.y,o=c.p1.parsed.y,d=(r+o)/2;return d>=.05?a.success:d<=-.05?a.danger:a.fgMuted}},pointBackgroundColor:i.map(c=>c>=.05?a.success:c<=-.05?a.danger:a.fgMuted),pointBorderColor:a.surface,pointBorderWidth:1,tension:.35,fill:!0,pointRadius:4,pointHoverRadius:7,pointHitRadius:20}]},options:{...L(a),interaction:{mode:"index",intersect:!1,axis:"x"},hover:{mode:"index",intersect:!1,axis:"x"},onHover:(c,r,o)=>{const d=o.getElementsAtEventForMode(c,"index",{intersect:!1},!1);o.canvas.style.cursor=d.length>0?"pointer":"default"},onClick:(c,r,o)=>{const d=o.getElementsAtEventForMode(c,"index",{intersect:!1},!1);if(d.length>0){const u=d[0].index,g=n[u];g&&(window.location.hash=`#/monat/${g}`)}},plugins:{...L(a).plugins,legend:{display:!1},tooltip:{enabled:!1,external:le(({tooltip:c})=>{const r=c.dataPoints[0].dataIndex,o=i[r],d=l[r],u=[{label:"Saldo Monatsende",value:ge(o),klasse:ie(o)}];if(d!=null){const g=+(o-d).toFixed(2);u.push({label:"Vorperiode",value:ge(d),klasse:ie(d)}),u.push({label:"Bewegung",value:ge(g),klasse:ie(g)})}return u.push({label:"",value:"→ Klick öffnet Monat",klasse:"flat"}),{title:s[r],rows:u}})}}}})}function Xn(e,t){const a=re();if(oe(e),!(t!=null&&t.length))return;const n=t.map(l=>F(B(l.datum),"dd.MM.")),s=t.map(l=>l.ist??0),i=t.map(l=>as(l.tagestyp,a));return new te(e,{type:"bar",data:{labels:n,datasets:[{label:"Ist-Stunden",data:s,backgroundColor:i,borderRadius:4,borderSkipped:!1,maxBarThickness:32,categoryPercentage:.85,barPercentage:.9}]},options:{...L(a),plugins:{...L(a).plugins,legend:{display:!1},tooltip:{enabled:!1,external:le(({tooltip:l})=>{const c=l.dataPoints[0].dataIndex,r=t[c],o=[{label:"Ist",value:he(r.ist),klasse:"flat"}];r.soll!=null&&o.push({label:"Soll",value:he(r.soll),klasse:"flat"}),r.diff!=null&&o.push({label:"Diff",value:ge(r.diff),klasse:ie(r.diff)});const d=r.tagestyp?[`Typ: ${r.tagestyp}`]:[];return{title:F(B(r.datum),"EE, dd.MM.yyyy",{locale:Y}),rows:o,meta:d}})}},scales:{...L(a).scales,y:{...L(a).scales.y,suggestedMin:0,suggestedMax:10}}}})}function kt(e,t){const a=re();if(oe(e),!(t!=null&&t.length))return;const n=t.filter(o=>{var d;return((d=o.zeitSpannen)==null?void 0:d.length)&&o.zeitSpannen.some(u=>u.von&&u.bis)}).map(o=>{const d=o.zeitSpannen.filter(h=>h.von&&h.bis).map(h=>({von:Q(h.von),bis:Q(h.bis),vonStr:h.von,bisStr:h.bis})).filter(h=>h.von!=null&&h.bis!=null);if(d.length===0)return null;const u=Math.min(...d.map(h=>h.von)),g=Math.max(...d.map(h=>h.bis));return{...o,_spans:d,_minVon:u,_maxBis:g}}).filter(Boolean);if(!n.length)return;const s=o=>o.ist==null?a.fgMuted:o.ist>=7?a.success:a.danger,i={label:"Tages-Rahmen",data:n.map(o=>[o._minVon,o._maxBis]),backgroundColor:n.map(s),borderColor:n.map(s),borderWidth:0,borderRadius:4,borderSkipped:!1,barPercentage:.7,categoryPercentage:.9,maxBarThickness:18},l=Math.max(0,Math.floor(Math.min(...n.map(o=>o._minVon))/60)*60-60),c=Math.min(24*60,Math.ceil(Math.max(...n.map(o=>o._maxBis))/60)*60+60),r=o=>`${String(Math.floor(o/60)).padStart(2,"0")}:${String(o%60).padStart(2,"0")}`;return new te(e,{type:"bar",data:{labels:n.map(o=>F(B(o.datum),"dd.MM.")),datasets:[i]},options:{...L(a),interaction:{mode:"index",intersect:!1,axis:"x"},plugins:{legend:{display:!1},tooltip:{enabled:!1,external:le(({tooltip:o})=>{const d=n[o.dataPoints[0].dataIndex],u=[];d.ist!=null&&u.push({label:"Ist",value:he(d.ist),klasse:ie(d.ist-7)}),d.soll!=null&&u.push({label:"Soll",value:he(d.soll)});const g=[`Rahmen: ${r(d._minVon)} – ${r(d._maxBis)}`];return d._spans.length>1&&d._spans.forEach((h,f)=>g.push(`Block ${f+1}: ${h.vonStr} – ${h.bisStr}`)),d.pause!=null&&g.push(`Pause: ${Math.round(d.pause*60)} min`),{title:F(B(d.datum),"EE, dd.MM.yyyy",{locale:Y}),rows:u,meta:g}})}},scales:{x:{ticks:{color:a.fgMuted,font:{size:10},maxRotation:60,minRotation:60,autoSkip:!0,maxTicksLimit:40},grid:{display:!1}},y:{min:l,max:c,ticks:{color:a.fgMuted,stepSize:60,callback:o=>r(o)},grid:{color:a.border}}}}})}function Yn(e,t){const a=re();oe(e);const n={};for(const l of t){if(l.tagestyp!=="Stempelzeit"||!l.zeitSpannen||l.zeitSpannen.length<2)continue;const c=Jt(l.zeitSpannen);if(c<=0)continue;const r=Math.round(c*60),o=Math.floor(r/15)*15;n[o]=(n[o]??0)+1}const s=Object.keys(n).map(Number).sort((l,c)=>l-c),i=s.map(l=>n[l]);return new te(e,{type:"bar",data:{labels:s.map(l=>`${l}–${l+14} min`),datasets:[{label:"Häufigkeit",data:i,backgroundColor:a.palette[1],borderRadius:4}]},options:{...L(a),plugins:{...L(a).plugins,legend:{display:!1},tooltip:{enabled:!1,external:le(({tooltip:l})=>{const c=l.dataPoints[0].dataIndex;return{title:"Pause-Länge "+(s[c]!=null?`${s[c]}–${s[c]+14} min`:""),rows:[{label:"Häufigkeit",value:`${i[c]} Tag${i[c]===1?"":"e"}`}]}})}}}})}function Qn(e,t){const a=re();oe(e);const n=["MO","DI","MI","DO","FR"],s={},i={};for(const r of n)s[r]=0,i[r]=0;for(const r of t)n.includes(r.wochentag)&&(r.ist==null||r.ist===0||(s[r.wochentag]+=r.ist,i[r.wochentag]+=1));const l=n.map(r=>i[r]>0?s[r]/i[r]:0),c={id:"wochentag-datalabels",afterDatasetsDraw(r){const{ctx:o,data:d,scales:u}=r;o.save(),o.fillStyle=a.fg,o.font="600 12px system-ui",o.textAlign="center",o.textBaseline="bottom",r.getDatasetMeta(0).data.forEach((h,f)=>{const m=d.datasets[0].data[f];if(!m||m===0)return;const v=m.toFixed(2).replace(".",",")+"h";o.fillText(v,h.x,h.y-6)}),o.restore()}};return new te(e,{type:"bar",data:{labels:["Montag","Dienstag","Mittwoch","Donnerstag","Freitag"],datasets:[{label:"Ø Ist-Stunden",data:l,backgroundColor:a.palette[2],borderRadius:4,maxBarThickness:56,categoryPercentage:.7,barPercentage:.8}]},options:{...L(a),layout:{padding:{top:24}},plugins:{...L(a).plugins,legend:{display:!1},tooltip:{enabled:!1,external:le(({tooltip:r})=>{const o=r.dataPoints[0].dataIndex,d=n[o];return{title:["Montag","Dienstag","Mittwoch","Donnerstag","Freitag"][o],rows:[{label:"Ø Stunden",value:he(l[o])},{label:"Anzahl Tage",value:String(i[d]||0)}]}})}},scales:{...L(a).scales,y:{...L(a).scales.y,suggestedMax:Math.max(...l)*1.15}}},plugins:[c]})}function es(e,t){const a=re();oe(e);const n={};for(const l of t)!l.tagestyp||l.tagestyp==="Wochenende"||(n[l.tagestyp]=(n[l.tagestyp]??0)+1);const s=Object.keys(n),i=Object.values(n);return new te(e,{type:"doughnut",data:{labels:s,datasets:[{data:i,backgroundColor:s.map((l,c)=>a.palette[c%a.palette.length]),borderColor:a.surface,borderWidth:2}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"right",labels:{color:a.fgMuted,font:{size:12}}},tooltip:{enabled:!1,external:le(({tooltip:l})=>{const c=l.dataPoints[0].dataIndex,r=i.reduce((d,u)=>d+u,0),o=r?i[c]/r*100:0;return{title:s[c],rows:[{label:"Anzahl",value:`${i[c]} Tag${i[c]===1?"":"e"}`},{label:"Anteil",value:o.toFixed(1).replace(".",",")+"%"}]}})}}}})}function ts(e,t){const a=re();oe(e);const n={};for(const r of t){const o=r.wocheKey;n[o]??(n[o]={ist:0,soll:0,days:0,ersterTag:null}),n[o].ist+=we(r),n[o].soll+=Fe(r),n[o].days++,(!n[o].ersterTag||r.datum&&r.datum<n[o].ersterTag)&&(n[o].ersterTag=r.datum)}const s=Object.keys(n).sort();if(!s.length)return;const i=s.map(r=>+n[r].ist.toFixed(2)),l=s.map(r=>+n[r].soll.toFixed(2)),c=s.map(r=>{const o=n[r].ersterTag;return o?Ee(B(o)):""});return new te(e,{type:"line",data:{labels:s.map(r=>"KW "+r.split("-")[1]),datasets:[{label:"Wochenstunden",data:i,borderColor:a.accent,backgroundColor:se(a.accent,.1),segment:{borderColor:r=>{const o=r.p0.parsed.y,d=r.p1.parsed.y,u=l[r.p0.parsed.x]??35,g=l[r.p1.parsed.x]??35,h=(u+g)/2,f=(o+d)/2;return f>=h+.1?a.success:f<=h-.1?a.danger:a.fgMuted}},pointBackgroundColor:i.map((r,o)=>r>=l[o]+.1?a.success:r<=l[o]-.1?a.danger:a.fgMuted),pointBorderColor:a.surface,pointBorderWidth:1,pointRadius:3,pointHoverRadius:6,pointHitRadius:20,tension:.25,fill:!0,borderWidth:2}]},options:{...L(a),interaction:{mode:"index",intersect:!1,axis:"x"},hover:{mode:"index",intersect:!1,axis:"x"},onHover:(r,o,d)=>{const u=d.getElementsAtEventForMode(r,"index",{intersect:!1},!1);d.canvas.style.cursor=u.length>0?"pointer":"default"},onClick:(r,o,d)=>{const u=d.getElementsAtEventForMode(r,"index",{intersect:!1},!1);if(u.length>0){const g=u[0].index,h=s[g];h&&(window.location.hash=`#/woche/${h}`)}},plugins:{...L(a).plugins,legend:{display:!1},tooltip:{enabled:!1,external:le(({tooltip:r})=>{const o=r.dataPoints[0].dataIndex,d=s[o],u=i[o],g=l[o],h=+(u-g).toFixed(2),f=c[o];return{title:f?"KW "+d.split("-")[1]+" · "+f:"KW "+d.split("-")[1]+" · "+d.split("-")[0],rows:[{label:"Ist",value:he(u),klasse:"flat"},{label:"Soll",value:he(g),klasse:"flat"},{label:"Diff",value:ge(h),klasse:ie(h)},{label:"",value:"→ Klick öffnet Woche",klasse:"flat"}]}})}},scales:{...L(a).scales,y:{...L(a).scales.y,ticks:{...L(a).scales.y.ticks,callback:r=>`${r.toFixed(0)}h`}}}}})}function oe(e){const t=te.getChart(e);t&&t.destroy()}function se(e,t){const a=e.replace("#","").trim();if(a.length!==6&&a.length!==3)return e;const n=a.length===3?a.split("").map(c=>c+c).join(""):a,s=parseInt(n.slice(0,2),16),i=parseInt(n.slice(2,4),16),l=parseInt(n.slice(4,6),16);return`rgba(${s}, ${i}, ${l}, ${t})`}function sa(e,t,a,n){const{top:s,bottom:i}=t,l=e.createLinearGradient(0,s,0,i),c=a.min,r=a.max,o=r-c;if(o<=0)return se(n.success,.14);let d=(r-0)/o;return d=Math.max(0,Math.min(1,d)),l.addColorStop(0,se(n.success,.28)),l.addColorStop(Math.max(0,d-.001),se(n.success,.06)),l.addColorStop(Math.min(1,d+.001),se(n.danger,.06)),l.addColorStop(1,se(n.danger,.28)),l}function as(e,t){const a=String(e??"").toLowerCase();return a.includes("stempel")?t.palette[0]:a.includes("berufs")?t.palette[1]:a.includes("urlaub")?t.palette[2]:a.includes("feiertag")?t.fgSubtle:a.includes("dienst")?t.palette[3]:a.includes("krank")?t.palette[4]:t.palette[5]}let ns=0;function Z(e,{type:t="info",duration:a=3500}={}){const n=document.getElementById("toast-root");if(!n)return;const s=document.createElement("div");s.className=`toast ${t}`,s.textContent=e,s.dataset.id=++ns,n.appendChild(s),setTimeout(()=>{s.style.opacity="0",s.style.transform="translateY(-8px)",s.style.transition="opacity 220ms, transform 220ms",setTimeout(()=>s.remove(),250)},a)}function Ne(e){return Z(e,{type:"error",duration:6e3})}function C(e){return Z(e,{type:"success"})}const ss=3,is=2.5,rs={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"};function Ue(e,t={}){if(!(e!=null&&e.length))return'<p style="color: var(--fg-muted);">Keine Tage im Zeitraum.</p>';const a=new Map;for(const i of t.warnungen??[])a.has(i.datum)||a.set(i.datum,[]),a.get(i.datum).push(i);const n=[];let s=null;for(const i of e)(!s||s.key!==i.wocheKey)&&(s={key:i.wocheKey,tage:[]},n.push(s)),s.tage.push(i);return`<div class="tages-liste">${n.map(i=>ls(i,a)).join("")}</div>`}function ls(e,t){var d;const a=e.tage.reduce((u,g)=>u+we(g),0),n=e.tage.reduce((u,g)=>u+(g.diff??0),0),s=(d=e.tage[0])==null?void 0:d.datum,i=s?Ee(B(s)):"",l=e.key?e.key.split("-")[1]:"?",c=n>.05?"pos":n<-.05?"neg":"flat",r=(n>0?"+":"")+n.toFixed(2).replace(".",",")+"h",o=a.toFixed(2).replace(".",",")+"h";return`
  ...
  `}function os(e,t=[]){const a=e.diff??0,n=a>0,s=n?ss:is,i=Math.min(150,Math.abs(a)/s*50),l=n?"var(--success)":a<0?"var(--danger)":"var(--fg-subtle)",c=jt(e.zeitSpannen),r=e.saldo??0,o=t.length>0,d=o?ds(t):"",u=o?t.map(h=>`${h.titel}${h.beschreibung?`
`+h.beschreibung:""}`).join(`
...
`):"",g=o?t[0].schweregrad:null;return`
    <a href="#/tag/${e.datum}" class="tag-row${o?" has-warn severity-"+g:""}">
      ...
      <div class="tag-row-typ">
        ${e.tagestyp?`<span class="pill ${us(e.tagestyp)}">${y(e.tagestyp)}</span>`:'<span style="color: var(--fg-subtle); font-size: 12px;">—</span>'}
      </div>
  ...
  `}function cs(e){return rs[e]??e}function ds(e){const t={error:3,warn:2,info:1};let a=e[0];for(const n of e)(t[n.schweregrad]||0)>(t[a.schweregrad]||0)&&(a=n);return a.schweregrad==="error"?"!":a.schweregrad==="warn"?"⚠":"i"}function us(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function gt(e){e._istCopyAttached||(e._istCopyAttached=!0,e.addEventListener("click",async t=>{const a=t.target.closest(".ist-part");if(!a)return;t.preventDefault(),t.stopPropagation();const n=a.getAttribute("data-val");try{await navigator.clipboard.writeText(n);const s=a.textContent;a.classList.add("ok"),a.textContent="✓",setTimeout(()=>{a.classList.remove("ok"),a.textContent=s},800)}catch{C(`Bitte kopieren: ${n}`)}}))}const $t=[{key:7,label:"1 Woche"},{key:14,label:"2 Wochen"},{key:30,label:"1 Monat"},{key:90,label:"3 Monate"},{key:"alles",label:"Alles"}];async function St({root:e}){const[t,a,n,s,i,l,c]=await Promise.all([X(),fe(),G(),ln(),Ja("dashboardZeitraum",14),ut(),ye()]),r=Object.fromEntries(l.map(x=>[x.key,x]));if(n.length===0){e.innerHTML=hs();return}const o=qe(n,a),d=o.length;let u=i;typeof u=="number"&&u>d&&(u="alles");const g=new Set(s.map(x=>x.key)),h=c!=null&&c.stichtagAuswertung?new Date(c.stichtagAuswertung):new Date,f=Le(n,t,h,g),m=Yt(a,g),v=[...f,...m],p=qn(o),M=p>.05?"positive":p<-.05?"negative":"";e.innerHTML=`
      ...
      <div style="flex: 1; min-width: 400px; display: flex; flex-direction: column;">
        <div class="card-split" style="margin-bottom: 12px; align-items: center;">
          ...
          <div class="segmented" id="zeitraum-picker">
            ${$t.map(x=>{const P=typeof x.key=="number"&&x.key>d;return`<button type="button" data-key="${x.key}" class="${u===x.key?"active":""}" ${P?'disabled style="opacity:0.4"':""}>${x.label}</button>`}).join("")}
          </div>
        </div>
    ...
    ${v.length>0?`
      <div class="card" style="margin-bottom: 32px;">
        ...
        ${v.slice(0,8).map(x=>gs(x,t,r)).join("")}
  ...
  `,Mt(u,e,o,v);const V=()=>e.querySelectorAll("#zeitraum-picker button, #zeitraum-picker-2 button");V().forEach(x=>{x.addEventListener("click",async()=>{if(x.disabled)return;const P=x.getAttribute("data-key"),K=P==="alles"?"alles":parseInt(P,10);V().forEach(q=>q.classList.toggle("active",q.getAttribute("data-key")===P)),await Xa("dashboardZeitraum",K),Mt(K,e,o,v)})}),e.addEventListener("click",async x=>{const P=x.target.closest(".ist-part");if(P){x.preventDefault(),x.stopPropagation();const $=P.getAttribute("data-val");try{await navigator.clipboard.writeText($);const S=P.textContent;P.classList.add("ok"),P.textContent="✓",setTimeout(()=>{P.classList.remove("ok"),P.textContent=S},800)}catch{C(`Bitte kopieren: ${$}`)}return}const K=x.target.closest(".btn-dismiss");if(!K)return;const q=K.getAttribute("data-datum"),z=K.getAttribute("data-typ");if(!q||!z)return;await rn(q,z),C("Warnung ausgeblendet.");const H=K.closest(".alert");H&&(H.style.display="none")})}function Mt(e,t,a,n=[]){const s=Rn(a,e),i=Zn(s);requestAnimationFrame(()=>{const o=t.querySelector("#saldo-chart");Ge(o,s)});const l=t.querySelector("#hero-bewegung");if(l){const o=i>.05?"up":i<-.05?"down":"flat",d=i>.05?"↑":i<-.05?"↓":"→";l.className=`saldo-trend ${o}`,l.innerHTML=`${d} ${Math.abs(i)<.01?"Unverändert":R(i,{signed:!0})} im Zeitraum`}const c=t.querySelector("#tage-info");if(c){const o=s.length;c.textContent=`${o} ${o===1?"Tag":"Tage"}`}const r=t.querySelector("#tage-liste");r&&(r.innerHTML=Ue(s.slice().reverse(),{warnungen:n.filter(o=>s.some(d=>d.datum===o.datum))}))}function gs(e,t,a){const n=e.schweregrad==="error"?"!":e.schweregrad==="warn"?"⚠":"i";let s=null;if(e.mailVorlageKey&&t){const i=Ze(e.mailVorlageKey,a==null?void 0:a[e.mailVorlageKey]);if(i){const l=aa(t,e);s=na(t,i,l)}}return`
  ...
  `}function je(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Qe(e){return je(e)}const fs="/better-ess/assets/pdf.worker.min-yatZIOMy.mjs";_a.workerSrc=fs;const zt={Januar:1,Februar:2,März:3,Maerz:3,April:4,Mai:5,Juni:6,Juli:7,August:8,September:9,Oktober:10,November:11,Dezember:12},ms=["Stempelzeit","Berufsschule Std. bez","Berufsschule","Dienstreise Arbeitszeit","Reise öff.VM/PKW Beifahr.","Reise öff.VM/PKW","Urlaub","Gleitzeit","Arbeitsunfähigkeit","TgDtEinh","Neujahr","Karfreitag","Ostermontg","Ostmontg","Osterso.","Hl.3 Kön.","Allerhlg","Pfingstmo","Fronleichn","TdDtEinh"];async function ps(e){var r,o;const a=await Va({data:e}).promise,n=[];let s=0;for(let d=1;d<=a.numPages;d++){const g=await(await a.getPage(d)).getTextContent();s+=g.items.length;const h=bs(g.items);for(const f of h)n.push({page:d,text:f})}const i=vs(n),{tage:l,monate:c}=ys(n);try{const d=await a.getMetadata();i.producer=((r=d==null?void 0:d.info)==null?void 0:r.Producer)??null,i.creator=((o=d==null?void 0:d.info)==null?void 0:o.Creator)??null}catch{}return i.totalTextItems=s,{meta:i,tage:l,monate:c}}function bs(e){if(!e.length)return[];const t=e.slice().sort((l,c)=>{const r=c.transform[5]-l.transform[5];return Math.abs(r)>2?r:l.transform[4]-c.transform[4]}),a=[];let n=null,s=[];const i=3;for(const l of t){const c=l.transform[5];n==null||Math.abs(c-n)<=i?(s.push(l),n==null&&(n=c)):(a.push(Dt(s)),s=[l],n=c)}return s.length&&a.push(Dt(s)),a.filter(l=>l.trim().length>0)}function Dt(e){e.sort((n,s)=>n.transform[4]-s.transform[4]);let t="",a=-1;for(const n of e){const s=n.transform[4];a>=0&&s-a>4?t+="  ":a>=0&&s-a>.5&&(t+=" "),t+=n.str,a=s+n.width}return t}function vs(e){var a,n;const t={personalnummer:null,name:null,kostenstelle:null,personalbereich:null,einstellungsdatum:null,mitarbeiterkreis:null,arbeitszeitplanregel:null,zeitraumVon:null,zeitraumBis:null,stichtagAuswertung:null};for(let s=0;s<e.length;s++){const i=e[s].text,l=/vom\s+(\d{2}\.\d{2}\.\d{4})\s+bis\s+(\d{2}\.\d{2}\.\d{4})/i.exec(i);l&&(t.zeitraumVon=De(l[1]),t.zeitraumBis=De(l[2]));const c=/bis einschließlich dem\s+(\d{2}\.\d{2}\.\d{4})/i.exec(i);if(c&&(t.stichtagAuswertung=De(c[1])),/Personalnummer/i.test(i)&&/Kostenstelle/i.test(i)){const r=(((a=e[s+1])==null?void 0:a.text)??"").trim();let o=r.split(/\s{2,}/);o.length<3&&(o=r.split(/\s+/)),o.length>=3&&/^\d/.test(o[0])&&(t.personalnummer=o[0],t.kostenstelle=o[1],t.personalbereich=o[2])}if(/Einstellungsdatum/i.test(i)&&/Mitarbeiterkreis/i.test(i)){const r=(((n=e[s+1])==null?void 0:n.text)??"").trim();let o=r.split(/\s{2,}/);o.length<3&&(o=r.split(/\s+/)),o.length>=3&&/^\d{2}\.\d{2}\.\d{4}$/.test(o[0])&&(t.einstellungsdatum=De(o[0]),t.mitarbeiterkreis=o[1],t.arbeitszeitplanregel=o[2])}if(/Bei Rückfragen wenden Sie sich an/i.test(i))for(let r=s+1;r<Math.min(s+8,e.length);r++){const o=e[r].text.trim();if(/^[A-ZÄÖÜ][a-zäöüß]+(?:\s[A-ZÄÖÜ][a-zäöüß]+)+$/.test(o)&&!/kanarya/i.test(o)&&!/tel/i.test(o)){t.name=o;break}}}return t}function ys(e,t){var r;const a=[],n=[];let s=null,i=null,l=!1,c=0;for(;c<e.length;){const o=e[c].text,d=/Monat:\s*([A-Za-zäöüÄÖÜß]+)\s*-\s*(\d{4})/.exec(o);if(d){const f=d[1].trim(),m=parseInt(d[2],10),v=zt[f]??zt[f.replace("ä","ae")]??null;v&&(s={jahr:m,monat:v,monatKey:`${m}-${String(v).padStart(2,"0")}`},l=!0,i=null),c++;continue}if(/Monats.bersicht zum Stichtag\s+(\d{2}\.\d{2}\.\d{4})/i.test(o)){const f=/Monats.bersicht zum Stichtag\s+(\d{2}\.\d{2}\.\d{4})/i.exec(o),m=De(f[1]);i={monatKey:(s==null?void 0:s.monatKey)??Zt(m),stichtag:m,glz:{},flexi:{},zeitkonten:{},raw:{}},c=ws(e,c+1,i),n.push(i);continue}let u=s;const g=/^(\d{2})\s+(MO|DI|MI|DO|FR|SA|SO)\b/.exec(o.trim());if(g&&s){const f=parseInt(g[1],10);l&&f>=20?u=$s(s):f<=15&&(l=!1)}const h=At(o,u);if(h){const f=[];let m=c+1;for(;m<e.length;){const p=e[m].text;if(/^\s*\d{4}\s+Umbuchung/.test(p)||At(p,s)||/Wochensumme/i.test(p)||/Monats.bersicht/i.test(p)||/Monat:\s*[A-Za-z]/i.test(p))break;const M=xs(p);if(M){f.push(M),m++;continue}break}if(f.length&&h.zeitSpannen.push(...f),h.tagestyp==="Wochenende"||h.wochentag==="SA"||h.wochentag==="SO"){c=m;continue}(h.ist!=null||h.soll!=null||(((r=h.zeitSpannen)==null?void 0:r.length)??0)>0||h.tagestyp!=null)&&a.push(h),c=m;continue}c++}return{tage:a,monate:n}}function ws(e,t,a){let n=t;const s=/(\d{4,5}|KTAU|AZAU)\s*-\s*(.+?)\s+(-?[\d,.]+-?)(?=\s+(?:\d{4,5}|KTAU|AZAU)\s*-|\s*$)/g;for(;n<e.length;){const i=e[n].text.trim();if(/^Monat:\s/.test(i)||/^Einzelergebnisse\s/.test(i)||/^Tag\b/.test(i)||/^Wochensumme/.test(i)||/^\d{2}\s+(MO|DI|MI|DO|FR|SA|SO)\b/.test(i)||/^Übersicht für den Zeitraum/i.test(i)||/^Abwesenheitsansprüche/i.test(i))break;s.lastIndex=0;let l;for(;(l=s.exec(i))!=null;){const c=l[1],r=l[2].trim(),o=Nt(l[3]);a.raw[c]={beschreibung:r,wert:o},c==="0008"&&(a.glz.saldoVorperiode=o),c==="8016"&&(a.glz.saldoAktuellePeriode=o),c==="9802"&&(a.glz.umgebuchteStunden=o),c==="0005"&&(a.glz.saldoGesamt=o),c==="9803"&&(a.glz.ueberzaehligeStd=o),c==="0050"&&(a.zeitkonten.produktivstunden=o),c==="9011"&&(a.flexi.jahreskontoVorperiode=o),c==="9010"&&(a.flexi.jahreskontoSaldo=o),c==="9020"&&(a.flexi.langzeitkontoSaldo=o),c==="9203"&&(a.zeitkonten.azMonatsendeUeber216=o),c==="9207"&&(a.zeitkonten.auszahlungBav=o),c==="9205"&&(a.zeitkonten.summeAuszahlung=o)}if(n++,n-t>80)break}return n}function At(e,t){if(!t)return null;const a=e.trim(),n=/^(\d{2})\s+(MO|DI|MI|DO|FR|SA|SO)(?:\s+(.+))?$/.exec(a);if(!n)return null;const s=parseInt(n[1],10),i=n[2],l=(n[3]??"").trim();let c=t.jahr,r=t.monat;const o=new Date(c,r-1,s),d={datum:Vn(o),datumDate:o.toISOString(),wochentag:i,tagNr:s,monatKey:Zt(o),wocheKey:_n(o),zeitSpannen:[],aktivitaeten:[],ist:null,soll:null,diff:null,pause:null,tazp:null,tagestyp:null,raw:a};return l?(ks(l,d),d):(d.tagestyp=["SA","SO"].includes(i)?"Wochenende":null,d)}function xs(e){const t=e.trim(),a=/^(Stempelzeit|Reise öff\.VM\/PKW Beifahr\.|Reise öff\.VM\/PKW|Dienstreise Arbeitszeit)\s+(\d{2}:\d{2})\s+(\d{2}:\d{2})\s*$/.exec(t);return a?{aktivitaet:a[1],von:a[2],bis:a[3]}:null}function ks(e,t){let a=null,n=e;for(const d of ms)if(e.startsWith(d)){a=d,n=e.slice(d.length).trim();break}a||(a=e.split(/\s+/)[0],n=e.slice(a.length).trim()),t.tagestyp=Ss(a),t.aktivitaeten.push(a);const s=n.split(/\s+/).filter(Boolean),i=/^\d{2}:\d{2}$/,l=/^-?[\d,.]+-?$/;let c=0;for(;s[c]&&i.test(s[c])&&s[c+1]&&i.test(s[c+1]);)t.zeitSpannen.push({aktivitaet:a,von:s[c],bis:s[c+1]}),c+=2;const r=[];for(;c<s.length&&l.test(s[c]);){const d=Nt(s[c]);d!=null&&r.push(d),c++}let o=s[c];r.length>=5?([t.ist,t.soll,t.diff,t.pause]=r,o||(o=String(r[4]))):r.length===4?[t.ist,t.soll,t.diff,t.pause]=r:r.length===3?[t.ist,t.soll,t.diff]=r:r.length===2?[t.ist,t.soll]=r:r.length===1&&(t.ist=r[0]),o&&(t.tazp=String(o))}function $s(e){if(!e)return null;let t=e.monat-1,a=e.jahr;return t<1&&(t=12,a-=1),{jahr:a,monat:t,monatKey:`${a}-${String(t).padStart(2,"0")}`}}function Ss(e){return e?/^Stempelzeit$/i.test(e)?"Stempelzeit":/^Berufsschule Std\. bez$/i.test(e)||/^Berufsschule$/i.test(e)?"Berufsschule":/Dienstreise/i.test(e)||/Reise/i.test(e)?"Dienstreise":/^Urlaub$/i.test(e)?"Urlaub":/^Gleitzeit$/i.test(e)?"Gleitzeit":/Arbeitsunf.higkeit/i.test(e)?"Arbeitsunfähigkeit":/^(Neujahr|Karfreitag|Ostermontg|Ostmontg|Osterso\.|Hl\.3 Kön\.|Allerhlg|Pfingstmo|Fronleichn|TdDtEinh|TgDtEinh)$/i.test(e)?"Feiertag":e:null}function ee(e,t={}){const{title:a="Bestätigen",confirmLabel:n="Bestätigen",cancelLabel:s="Abbrechen",variant:i="default"}=t;return Ms({message:e,title:a,confirmLabel:n,cancelLabel:s,variant:i,kind:"confirm"})}function Ms({message:e,title:t,confirmLabel:a,cancelLabel:n,variant:s,kind:i}){return new Promise(l=>{const c=document.activeElement,r=document.createElement("div");r.className="app-dialog-overlay",r.innerHTML=`
    ...
    `,document.body.appendChild(r),requestAnimationFrame(()=>r.classList.add("is-open"));const o=r.querySelector(".app-dialog-confirm"),d=r.querySelector(".app-dialog-cancel"),u=h=>{r.classList.remove("is-open"),setTimeout(()=>{if(r.remove(),document.removeEventListener("keydown",g),c&&c.focus)try{c.focus()}catch{}l(h)},180)},g=h=>{h.key==="Escape"?(h.preventDefault(),u(!1)):h.key==="Enter"&&(h.preventDefault(),u(!0))};o==null||o.addEventListener("click",()=>u(!0)),d==null||d.addEventListener("click",()=>u(!1)),r.addEventListener("click",h=>{h.target===r&&u(!1)}),document.addEventListener("keydown",g),setTimeout(()=>o==null?void 0:o.focus(),50)})}function Ce(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function zs(e){return Ce(e).replace(/\n/g,"<br>")}const ia="better-ess-tour-completed",ht=typeof import.meta<"u"?"/better-ess/":"/",Ds=ht+"tutorial/speichern.png",As=ht+"tutorial/download.png",Ts=ht+"tutorial/zeitraum.png",ve=[{type:"modal",hero:!0,icon:"👋",title:"Willkommen bei Better ESS",text:"Diese App liest deinen <strong>Zeitnachweis</strong> und macht ihn auf einen Blick verständlich."},{type:"modal",hero:!0,icon:"🔒",title:"Deine Daten bleiben bei dir",text:"Dein PDF geht <strong>nicht ins Internet</strong>.<br><br>Alles läuft lokal in deinem Browser — wie eine Notizen-App. Kein Upload, kein Server, kein Konto."},{type:"highlight",target:'a[href="#/daten"]',icon:"📂",title:"Hier startet alles",text:"Hier lädst du deinen Zeitnachweis hoch.",placement:"right",autoClick:!0,onAfterClick:async()=>{window.location.hash!=="#/daten"&&(window.location.hash="#/daten"),await We("#upload-zone",1500)}},{type:"download-modal",icon:"📥",title:'1. Im ESS auf „Zeitnachweis herunterladen" klicken',image:As,points:[{kind:"good",icon:"✓",text:"Den Button findest du unten rechts in der ESS-Zeitbuchungs-Ansicht."}]},{type:"download-modal",icon:"📅",title:'2. „Anderer Zeitraum" wählen — möglichst groß',image:Ts,points:[{kind:"good",icon:"✓",text:'Wähle <strong>„Anderer Zeitraum"</strong> und nimm einen möglichst großen Bereich (am besten Ausbildungsstart bis heute) — die App nutzt alle Daten für Saldo-Verlauf und Trends.'},{kind:"bad",icon:"✕",text:'Nicht „Aktuelle Woche" oder „Aktueller Monat" — dann fehlen Verlaufs-Daten.'}]},{type:"download-modal",icon:"💾",title:'3. Im PDF-Viewer auf „Speichern" — nicht „Drucken"',image:Ds,points:[{kind:"good",icon:"✓",text:"<strong>Speichern-Button</strong> (Disketten-Symbol oben rechts in der PDF-Toolbar) — speichert eine echte Text-PDF."},{kind:"bad",icon:"✕",text:'<strong>NICHT</strong> „Drucken → Microsoft Print to PDF" — dabei werden Texte als Pfade gerendert und sind nicht lesbar.'}]},{type:"highlight",target:"#upload-zone",icon:"📥",title:"Lade jetzt dein PDF hoch",text:"Zieh dein Zeitnachweis-PDF auf die Box (oder klick sie an). Erst nach dem Upload geht die Tour weiter.",placement:"top",waitForTarget:!0,waitForEvent:"better-ess:pdf-uploaded"},{type:"modal",icon:"✨",title:"Geschafft!",text:"Dein PDF ist eingelesen. Jetzt zeig ich dir die Funktionen — anhand deiner echten Daten.",onNext:async()=>{window.location.hash="#/",await We(".saldo-value",1500)}},{type:"highlight",target:".saldo-value",icon:"⚖️",title:"Dein aktueller Saldo",text:"Plus oder Minus auf einen Blick. Tagesaktuell.",placement:"right",waitForTarget:!0},{type:"highlight",target:"#saldo-chart",icon:"📈",title:"Saldo-Verlauf",text:"Hover über die Punkte für Details. Zeitraum oben rechts umschaltbar.",placement:"top",waitForTarget:!0},{type:"highlight",target:".tag-row .ist-display",icon:"⏱️",title:"Stunden direkt kopieren",text:"Klick auf <strong>H</strong> oder <strong>M</strong> — kopiert den Wert in deine Zwischenablage. Praktisch fürs IHK-Berichtsheft.",placement:"left",waitForTarget:!0},{type:"highlight",target:".alert",icon:"⚠️",title:"Auffälligkeiten",text:"Fehlende Tage, falsche BS-Stunden, Pausen-Abzug — alles automatisch erkannt.",placement:"left",optional:!0,waitForTarget:!0,timeoutMs:1200},{type:"highlight",target:'a[href="#/profil"]',icon:"👤",title:"Profil",text:"Über 18? Pausen-Regel und Mail-Empfänger anpassen.",placement:"right"},{type:"highlight",target:'a[href="#/fahrtgeld"]',icon:"🚌",title:"Fahrgelderstattung",text:"Hier generierst du deine monatliche Fahrgeld-Excel mit deinen erkannten Berufsschultagen.",placement:"right",autoClick:!0,onAfterClick:async()=>{window.location.hash!=="#/fahrtgeld"&&(window.location.hash="#/fahrtgeld"),await We("#btn-template-upload, #btn-template-replace, .fahrtgeld-generate-card",1800)}},{type:"highlight",target:"#fahrtgeld-dropzone, .fahrtgeld-generate-card",icon:"📥",title:"Vorlage einmalig hochladen",text:'Eine bestehende Fahrgeld-Excel hier hochladen — Name, Personalnummer, Haltestellen und Tagessatz werden automatisch ausgelesen. Tour wartet auf den Upload (oder oben auf „Überspringen", um die Tour zu beenden).',placement:"top",waitForTarget:!0,timeoutMs:1500,optional:!0,waitForEvent:"better-ess:fahrgeld-template-uploaded"},{type:"highlight",target:".btn-generate-big",icon:"✅",title:"Excel generieren",text:"Monat unten auswählen, dann hier klicken. Du bekommst eine fertig ausgefüllte Excel zum Download — mit deinen Berufsschultagen, Datum und Unterschrift.",placement:"bottom",waitForTarget:!0,timeoutMs:1500,optional:!0},{type:"highlight",target:".btn-mail-big",icon:"✉️",title:"E-Mail an die Personalabteilung",text:"Öffnet Outlook mit fertig vorausgefülltem Empfänger, Betreff und Text. Excel-Anhang aus dem Download-Ordner musst du noch manuell dranhängen.",placement:"bottom",waitForTarget:!0,timeoutMs:1500,optional:!0},{type:"modal",icon:"🚀",title:"Bereit!",text:"Du kennst alle Funktionen. Tour erneut starten? Button am Ende der <strong>Daten</strong>-Seite."}],Ps=ve.findIndex(e=>e.icon==="✨");let A=null,de=null;function ra(){A===null&&(ft(),A={idx:0},ae())}function Es(e){return e?!1:!localStorage.getItem(ia)}function Ls(){localStorage.setItem(ia,"1")}function Fs(){return A!==null}function ft(){document.querySelectorAll(".tour-blur-frame, .tour-popover, .tour-pointer, .tour-highlight-border").forEach(e=>e.remove()),de&&(de(),de=null),A=null}function Be(e){const t=document.querySelector(".tour-blur-frame.full"),a=[document.querySelector('.tour-blur-frame[data-side="top"]'),document.querySelector('.tour-blur-frame[data-side="left"]'),document.querySelector('.tour-blur-frame[data-side="right"]'),document.querySelector('.tour-blur-frame[data-side="bottom"]')];if(!e){a.forEach(m=>{m&&(m.style.opacity="0")});let h=t;h||(h=document.createElement("div"),h.className="tour-blur-frame full",document.body.appendChild(h)),h.style.opacity="1";const f=document.querySelector(".tour-highlight-border");f&&(f.style.opacity="0");return}t&&(t.style.opacity="0");const n=e.getBoundingClientRect(),s=8,i=Math.max(0,n.left-s),l=Math.max(0,n.top-s),c=n.width+s*2,r=n.height+s*2,o=window.innerWidth,d=window.innerHeight,u={top:{top:0,left:0,width:o,height:l},left:{top:l,left:0,width:i,height:r},right:{top:l,left:i+c,width:o-(i+c),height:r},bottom:{top:l+r,left:0,width:o,height:d-(l+r)}};for(const[h,f]of Object.entries(u)){let m=a[Object.keys(u).indexOf(h)];m||(m=document.createElement("div"),m.className="tour-blur-frame",m.dataset.side=h,document.body.appendChild(m)),m.style.top=f.top+"px",m.style.left=f.left+"px",m.style.width=Math.max(0,f.width)+"px",m.style.height=Math.max(0,f.height)+"px",m.style.opacity=f.width<=0||f.height<=0?"0":"1"}let g=document.querySelector(".tour-highlight-border");g||(g=document.createElement("div"),g.className="tour-highlight-border",document.body.appendChild(g)),g.style.top=l+"px",g.style.left=i+"px",g.style.width=c+"px",g.style.height=r+"px",g.style.opacity="1",g.style.display=""}function mt(){let e=document.querySelector(".tour-pointer");return e||(e=document.createElement("div"),e.className="tour-pointer",e.innerHTML=`
      ...
      </svg>`,e.style.top=window.innerHeight/2+"px",e.style.left=window.innerWidth/2+"px",document.body.appendChild(e)),e}function Ks(e){const t=mt(),a=e.getBoundingClientRect(),n=a.left+a.width*.5,s=a.top+a.height*.5;t.style.top=s-6+"px",t.style.left=n-9+"px"}function Tt(){var e;(e=document.querySelector(".tour-pointer"))==null||e.remove()}async function Bs(e){const t=mt();t.classList.add("tour-pointer-clicking"),await new Promise(a=>setTimeout(a,280)),t.classList.remove("tour-pointer-clicking")}async function We(e,t=1500){const a=Date.now();for(;Date.now()-a<t;){const n=document.querySelector(e);if(n)return n;await new Promise(s=>setTimeout(s,100))}return null}async function ae(){var c,r,o;if(!A)return;const e=A.overrideStep||ve[A.idx];if(A.overrideStep=null,!e){nt();return}if(de&&(de(),de=null),e.type==="download-modal")return Tt(),Be(null),Cs(e);let t=null;if(e.type==="highlight"){if(t=e.waitForTarget?await We(e.target,e.timeoutMs??1500):document.querySelector(e.target),!t&&e.fallback){const d=e.fallback;if(d.onBefore)try{await d.onBefore()}catch(u){console.warn("tour fallback onBefore error:",u)}return A.overrideStep=d,ae()}if(!t&&e.optional)return A.idx++,ae();if(!t&&e.waitForTarget&&!e.fallback)return console.warn("[tour] target not found, skipping:",e.target),A.idx++,ae();if(t){try{t.scrollIntoView({behavior:"smooth",block:"center",inline:"nearest"})}catch{}await new Promise(d=>setTimeout(d,250)),Be(t),mt(),requestAnimationFrame(()=>Ks(t))}else Be(null)}else Tt(),Be(null);let a=document.querySelector(".tour-popover");a||(a=document.createElement("div"),a.className="tour-popover",a.style.visibility="hidden",document.body.appendChild(a)),a.classList.remove("tour-popover-large","tour-popover-hero"),e.hero&&a.classList.add("tour-popover-hero"),t?a.classList.remove("center"):a.classList.add("center");const n=A.idx===0,s=A.idx===ve.length-1,i=!!e.waitForEvent,l=i?"⏳ Warte auf Upload …":s?"Fertig":"Weiter →";if(a.innerHTML=`
    ...
    </div>`,t?(a.style.opacity="0",requestAnimationFrame(()=>{Ws(a,t,e.placement||"right"),a.style.visibility="visible",a.style.opacity="1"})):(a.style.top=a.style.left=a.style.right=a.style.bottom="",a.style.opacity="0",a.style.visibility="visible",requestAnimationFrame(()=>requestAnimationFrame(()=>{a.style.opacity="1"}))),(c=a.querySelector(".tour-skip"))==null||c.addEventListener("click",()=>{nt()}),n||(r=a.querySelector(".tour-prev"))==null||r.addEventListener("click",async()=>{A.idx=Math.max(0,A.idx-1),await ae()}),!i)(o=a.querySelector(".tour-next"))==null||o.addEventListener("click",async()=>{if(e.autoClick&&t){await Bs();try{const d=t.getAttribute("href");d&&d.startsWith("#/")?window.location.hash=d.slice(1):t.click()}catch(d){console.warn("tour autoClick error:",d)}if(e.onAfterClick)try{await e.onAfterClick()}catch(d){console.warn("tour onAfterClick error:",d)}else await new Promise(d=>setTimeout(d,350))}else if(e.onNext)try{await e.onNext()}catch(d){console.warn("tour onNext error:",d)}A.idx++,await ae()});else{const d=async()=>{A==null||A.idx,ft(),document.querySelectorAll(".upload-modal-overlay").forEach(u=>u.remove()),await new Promise(u=>setTimeout(u,300)),A={idx:Ps},await ae()};document.addEventListener(e.waitForEvent,d,{once:!0}),de=()=>document.removeEventListener(e.waitForEvent,d)}}function Cs(e){var n,s,i;let t=document.querySelector(".tour-popover");t||(t=document.createElement("div"),t.className="tour-popover",t.style.visibility="hidden",document.body.appendChild(t)),t.classList.add("tour-popover-large","center"),t.style.visibility="visible";const a=A.idx===0;A.idx,ve.length-1,t.innerHTML=`
    <div class="tour-popover-header">
      <span class="tour-popover-step">${A.idx+1} / ${ve.length}</span>
      <button class="tour-skip" type="button" aria-label="Tour beenden">Überspringen</button>
    </div>
    ...
    </div>`,t.style.top=t.style.left=t.style.right=t.style.bottom="",t.style.opacity="1",(n=t.querySelector(".tour-skip"))==null||n.addEventListener("click",()=>{nt()}),a||(s=t.querySelector(".tour-prev"))==null||s.addEventListener("click",async()=>{A.idx=Math.max(0,A.idx-1),await ae()}),(i=t.querySelector(".tour-next"))==null||i.addEventListener("click",async()=>{A.idx++,await ae()})}function Ws(e,t,a){const n=t.getBoundingClientRect(),s=16,i=e.offsetWidth||360,l=e.offsetHeight||220,c=window.innerWidth,r=window.innerHeight,o=[a,"right","bottom","left","top"];let d=null;for(const h of o)if((()=>{switch(h){case"right":return n.right+s+i<=c;case"left":return n.left-s-i>=0;case"bottom":return n.bottom+s+l<=r;case"top":return n.top-s-l>=0}})()){d=h;break}d=d||a;let u,g;switch(d){case"right":u=n.top+n.height/2-l/2,g=n.right+s;break;case"left":u=n.top+n.height/2-l/2,g=n.left-i-s;break;case"bottom":u=n.bottom+s,g=n.left+n.width/2-i/2;break;case"top":default:u=n.top-l-s,g=n.left+n.width/2-i/2;break}u=Math.max(s,Math.min(r-l-s,u)),g=Math.max(s,Math.min(c-i-s,g)),e.style.position="fixed",e.style.top=u+"px",e.style.left=g+"px",e.style.right="auto",e.style.bottom="auto",e.style.transform=""}function nt(){ft(),Ls()}async function _s({root:e}){var i;const t=await Ot(),a=await X();e.innerHTML=`
    ...
    <div class="card">
      ...
      <div id="uploads-list">
        ${t.length===0?'<div class="empty-state"><div class="empty-state-icon">📭</div><p>Noch keine Uploads</p></div>':oa(t)}
      </div>
    </div>
  ...
  `;const n=e.querySelector("#upload-zone"),s=e.querySelector("#file-input");n.addEventListener("click",()=>s.click()),n.addEventListener("dragover",l=>{l.preventDefault(),n.classList.add("drag")}),n.addEventListener("dragleave",()=>n.classList.remove("drag")),n.addEventListener("drop",async l=>{var r;l.preventDefault(),n.classList.remove("drag");const c=(r=l.dataTransfer.files)==null?void 0:r[0];c&&await Et(c,e,a)}),s.addEventListener("change",async l=>{var r;const c=(r=l.target.files)==null?void 0:r[0];c&&await Et(c,e,a)}),e.querySelector("#btn-export").addEventListener("click",Os),e.querySelector("#btn-import").addEventListener("click",()=>e.querySelector("#import-input").click()),e.querySelector("#import-input").addEventListener("change",Hs),e.querySelector("#btn-clear-parsed").addEventListener("click",Is),e.querySelector("#btn-reset").addEventListener("click",Ns),(i=e.querySelector("#btn-tour-restart"))==null||i.addEventListener("click",()=>ra()),Vs()}let Pt=!1;function Vs(){Pt||(Pt=!0,document.body.addEventListener("click",e=>{if(e.target.closest(".lightbox-overlay, .upload-modal-overlay"))return;const t=e.target.closest("img.zoomable");t&&la(t.src,t.alt)}))}function la(e,t){const a=document.createElement("div");a.className="lightbox-overlay",a.innerHTML=`
    <button class="lightbox-close" aria-label="Schließen" title="Schließen (Esc)">×</button>
    <img src="${e}" alt="${t||""}" />
  `,document.body.appendChild(a);const n=()=>{a.remove(),document.removeEventListener("keydown",s)},s=i=>{i.key==="Escape"&&n()};a.addEventListener("click",i=>{(i.target===a||i.target.classList.contains("lightbox-close"))&&n()}),document.addEventListener("keydown",s)}async function Is(){await ee("PDF-abgeleitete Daten (Tage, Monate, Uploads) werden gelöscht. Profil und Mail-Vorlagen bleiben erhalten.",{title:"PDF-Daten löschen?",confirmLabel:"Löschen",variant:"danger"})&&(await Ht(),C("Daten gelöscht. Profil bleibt."),setTimeout(()=>location.reload(),600))}function oa(e){return`
    <table class="table">
      <thead>
        <tr>
...
Wenn du fortfährst, werden alle alten Tagesdaten gelöscht und durch die neuen ersetzt. (Profil-Einstellungen wie Theme und Mail-Vorlagen bleiben erhalten.)`,{title:"Anderer Azubi erkannt",confirmLabel:"Daten ersetzen",variant:"danger"})){s.style.pointerEvents="",s.style.opacity="",n.innerHTML=`
          <div class="alert severity-info">
            <div class="alert-body">
              ...
              <p style="margin: 4px 0; font-size: 13px;">Es wurden keine Daten verändert. Lade das richtige PDF (für ${y(V)}) erneut hoch.</p>
            </div>
          </div>`;return}await Ht();const K=await X();await Ie({...K,berufsschulMuster:{wochentageWoechentlich:[],wochentage14Taegig:[],referenzDatum14Taegig:null,stundenProTag:null,halbtags:!1}})}const f=await Ya(d.tage,d.monate,d.meta.stichtagAuswertung);(f.skippedTage>0||f.skippedMonate>0)&&console.info(`[upload] ${f.skippedTage} Tage und ${f.skippedMonate} Monate uebersprungen — bestehende Daten haben juengeren Stichtag.`),await Qa({dateiname:e.name,personalnummer:d.meta.personalnummer??null,name:d.meta.name??null,zeitraumVon:((l=d.meta.zeitraumVon)==null?void 0:l.toISOString())??null,zeitraumBis:((c=d.meta.zeitraumBis)==null?void 0:c.toISOString())??null,stichtagAuswertung:((r=d.meta.stichtagAuswertung)==null?void 0:r.toISOString())??null,tageCount:d.tage.length,monateCount:d.monate.length});const m=await G(),v=Gt(m),p={...It(),...a};(v.wochentageWoechentlich.length>0||v.wochentage14Taegig.length>0)&&(p.berufsschulMuster=v),await Ie(p),n.innerHTML="",Fs()||Me({type:"success",title:"PDF erfolgreich eingelesen",desc:d.meta.zeitraumVon?`Zeitraum: ${W(d.meta.zeitraumVon)} – ${W(d.meta.zeitraumBis)}`:"Daten wurden erfolgreich verarbeitet.",stats:[{num:d.tage.length,label:"Tage"},{num:d.monate.length,label:"Monatsübersichten"}]}),C(`PDF verarbeitet: ${d.tage.length} Tage.`),document.dispatchEvent(new CustomEvent("better-ess:pdf-uploaded",{detail:{tageCount:d.tage.length,monateCount:d.monate.length}}));const M=await Ot();t.querySelector("#uploads-list").innerHTML=oa(M)}catch(o){console.error(o),n.innerHTML="",Me({type:"error",title:"Fehler beim Parsen",desc:y(o.message||String(o)),hint:'Prüfe, ob es sich um einen ESS-Zeitnachweis im richtigen Format handelt. Lade dein PDF über den Speichern-Button herunter, nicht über „Drucken".',screenshot:!0}),Ne("PDF konnte nicht gelesen werden.")}finally{s.style.pointerEvents="",s.style.opacity=""}}async function Os(){try{const e=await an(),t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),a=URL.createObjectURL(t),n=document.createElement("a"),s=new Date().toISOString().slice(0,10);n.href=a,n.download=`zeitnachweis-backup-${s}.json`,n.click(),URL.revokeObjectURL(a),C("Backup heruntergeladen.")}catch(e){Ne(`Export fehlgeschlagen: ${e.message}`)}}async function Hs(e){var a;const t=(a=e.target.files)==null?void 0:a[0];if(t)try{const n=await t.text(),s=JSON.parse(n);if(!await ee("Existierende Daten werden vom Backup überschrieben.",{title:"Backup importieren?",confirmLabel:"Importieren",variant:"danger"}))return;await nn(s),C("Backup erfolgreich importiert. Seite wird neu geladen…"),setTimeout(()=>location.reload(),800)}catch(n){Ne(`Import fehlgeschlagen: ${n.message}`)}}async function Ns(){await ee("Alle Daten (Tage, Monate, Profil, Vorlagen, Mail-Vorlagen, Fahrgeld-Vorlage) werden endgültig gelöscht. Das lässt sich nicht rückgängig machen.",{title:"ALLE Daten löschen?",confirmLabel:"Weiter zur Sicherheitsfrage",variant:"danger"})&&await ee("Letzte Warnung — wirklich alle Daten löschen?",{title:"Sicher?",confirmLabel:"Endgültig löschen",variant:"danger"})&&(await tn(),C("Alle Daten gelöscht."),setTimeout(()=>location.reload(),600))}function js(e){if(!e)return"—";const t=new Date(e);return t.toLocaleDateString("de-DE",{year:"numeric",month:"2-digit",day:"2-digit"})+" "+t.toLocaleTimeString("de-DE",{hour:"2-digit",minute:"2-digit"})}function Me(e){const{type:t,title:a,desc:n,hint:s,screenshot:i,stats:l,producer:c}=e,r=document.createElement("div");r.className="upload-modal-overlay";const o=`
    ...
    <form id="profil-form" class="grid cols-2" style="gap: 24px;">
      ...
      <div class="card">
        ...
        <div class="form-group">
          ...
          <input type="email" name="zeitwirtschaftEmail" value="${Ft(t.zeitwirtschaftEmail)}" />
        </div>
        <div class="form-group">
          <label>Anrede in Mails</label>
          <input type="text" name="zeitwirtschaftAnrede" value="${Ft(t.zeitwirtschaftAnrede)}" placeholder="Frau Kanarya" />
        </div>
      </div>
      ...
      <div class="card" style="grid-column: 1 / -1;">
        ...
        ${n?`
          <div class="tag-detail">
            ...
            <div class="tag-detail-value"><strong>${((l=a.wochentageWoechentlich)==null?void 0:l.map(o=>Lt[o]).join(", "))||"—"}</strong></div>
          </div>
          <div class="tag-detail">
            <div class="tag-detail-label">Alle 2 Wochen</div>
            <div class="tag-detail-value"><strong>${((c=a.wochentage14Taegig)==null?void 0:c.map(o=>Lt[o]).join(", "))||"—"}</strong>${a.referenzDatum14Taegig?` <span class="hint">(Anker: ${W(new Date(a.referenzDatum14Taegig))})</span>`:""}</div>
          </div>
          <div class="tag-detail">
  ...
  `,e.querySelector("#profil-form").addEventListener("submit",async o=>{var g,h;o.preventDefault();const d=new FormData(o.target),u={...t,ueber18:d.get("ueber18")==="on",zeitwirtschaftEmail:((g=d.get("zeitwirtschaftEmail"))==null?void 0:g.trim())||"Zeitwirtschaft.Aichtal@putzmeister.com",zeitwirtschaftAnrede:((h=d.get("zeitwirtschaftAnrede"))==null?void 0:h.trim())||"Frau Kanarya"};await Ie(u),C("Profil gespeichert.")})}function Ft(e){return String(e??"").replace(/"/g,"&quot;")}async function qs({root:e}){var s;const t=await fe(),a=await G(),n={};for(const i of a)n[s=i.monatKey]??(n[s]=[]),n[i.monatKey].push(i);if(t.length===0){e.innerHTML=Xs("Noch keine Monatsdaten. Lade zuerst ein PDF unter Daten hoch.");return}e.innerHTML=`
  ...
  `,requestAnimationFrame(()=>{Ge(t.querySelector("#chart-monat"),o)}),gt(t.querySelector("#tage-liste-monat"))}function Gs(e){var i,l,c,r;const t=((i=e.glz)==null?void 0:i.saldoGesamt)??0,a=((l=e.glz)==null?void 0:l.saldoVorperiode)??0,n=((c=e.glz)==null?void 0:c.saldoAktuellePeriode)??0,s=o=>o>.05?"var(--success)":o<-.05?"var(--danger)":"var(--fg)";return`
  ...
  `}function Us(e){var n;const t={};for(const s of e)t[n=s.wocheKey]??(t[n]={key:s.wocheKey,tage:[],ist:0,soll:0}),t[s.wocheKey].tage.push(s),t[s.wocheKey].ist+=we(s),t[s.wocheKey].soll+=Fe(s);const a=Object.keys(t).sort();return a.length?a.map(s=>{var u;const i=t[s],l=+(i.ist-i.soll).toFixed(2),c=l>.05?"var(--success)":l<-.05?"var(--danger)":"var(--fg-muted)",r=(u=i.tage[0])==null?void 0:u.datum,o=r?Ee(B(r)):"",d=s.split("-")[1]||"?";return`
    ...
    `}).join(""):'<p style="color: var(--fg-muted);">Keine Wochen.</p>'}function Js(e){return`
    <div class="alert severity-${e.schweregrad}">
    ...
    <div>
      ${n.map(i=>{var u;const l=a[i],c=+(l.ist-l.soll).toFixed(2),r=c>.05?"var(--success)":c<-.05?"var(--danger)":"var(--fg-muted)",o=(u=l.tage[0])==null?void 0:u.datum,d=o?Ee(B(o)):"";return`
          <a href="#/woche/${i}" class="list-item">
            <div class="tabular" style="font-size: 16px; font-weight: 600; color: var(--fg-muted); min-width: 80px;">${y(ca(i))}</div>
            <div>
  ...
  `,requestAnimationFrame(()=>{Ge(t.querySelector("#chart-woche"),r)}),gt(t.querySelector("#tage-liste-woche"))}function ei(e){return`
    <div class="alert severity-${e.schweregrad}">
      <div class="alert-icon">${e.schweregrad==="error"?"!":e.schweregrad==="warn"?"⚠":"i"}</div>
      <div class="alert-body">
        <div class="alert-title">${y(e.titel)}</div>
  ...
  `}function ca(e){const[t,a]=e.split("-");return`KW ${a} · ${t}`}async function ti({params:e,root:t}){var o,d,u;const a=e.datum,n=await b.tage.get(a),s=await X();if(!n){t.innerHTML=`<h1 class="view-title">Tag nicht gefunden</h1><p>Für ${a} liegen keine Daten vor.</p><a href="#/" class="btn">← Dashboard</a>`;return}const i=B(a),l=n.tagestyp==="Stempelzeit"?Xt(n,s):null,c=Re(i,s.berufsschulMuster),r=jt(n.zeitSpannen);t.innerHTML=`
    <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 8px;">
    ...
    <div class="grid cols-2" style="gap: 24px;">
      ...
      <div class="card">
        ...
        <div class="tag-detail">
          ...
          <div class="tag-detail-value">${n.tagestyp?`<span class="pill ${ai(n.tagestyp)}">${ze(n.tagestyp)}</span>`:"—"}</div>
        </div>
        <div class="tag-detail">
  ...
  `}function ai(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function ze(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}const ni=[{key:14,label:"2 Wochen"},{key:30,label:"1 Monat"},{key:90,label:"3 Monate"},{key:"alles",label:"Alles"}];async function si({root:e}){var i;const[t,a]=await Promise.all([G(),fe()]);if(!t.length){e.innerHTML='<h1 class="view-title">Analytics</h1><p class="view-subtitle">Keine Daten.</p><a href="#/daten" class="btn primary">Zum Upload</a>';return}let n=t.length>30?30:"alles";e.innerHTML=`
    ...
    <div class="card" style="margin-bottom: 24px;">
      <div class="card-split" style="margin-bottom: 12px; align-items: center;">
        ...
        <div class="segmented" id="startend-zeitraum">
          ${ni.map(l=>{const c=typeof l.key=="number"&&l.key>t.length;return`<button type="button" data-key="${l.key}" class="${n===l.key?"active":""}" ${c?'disabled style="opacity:0.4"':""}>${l.label}</button>`}).join("")}
        </div>
      </div>
  ...
  `;const s=()=>n==="alles"?t:t.slice(-n);requestAnimationFrame(()=>{Jn(e.querySelector("#c-saldo"),a),ts(e.querySelector("#c-wochen"),t),kt(e.querySelector("#c-startend"),s()),Qn(e.querySelector("#c-wochentag"),t),Yn(e.querySelector("#c-pausen"),t),es(e.querySelector("#c-donut"),t),Xn(e.querySelector("#c-alle-tage"),t.slice(-30))}),(i=e.querySelector("#startend-zeitraum"))==null||i.addEventListener("click",l=>{const c=l.target.closest("button[data-key]");if(!c||c.disabled)return;const r=c.getAttribute("data-key"),o=r==="alles"?"alles":parseInt(r,10);o!==n&&(n=o,e.querySelectorAll("#startend-zeitraum button").forEach(d=>d.classList.toggle("active",d===c)),kt(e.querySelector("#c-startend"),s()))})}async function et({params:e,root:t}){var N,U;const[a,n,s,i]=await Promise.all([G(),fe(),X(),ye()]);if(!a.length){t.innerHTML=`
      <h1 class="view-title">Kalender</h1>
      <p class="view-subtitle">Noch keine Daten geladen.</p>
      <a href="#/daten" class="btn primary">Zum Upload</a>`;return}const l=[...new Set(a.map(w=>w.monatKey))].sort(),c=e.yyyymm,r=l.includes(c)?c:l[l.length-1],o=a.filter(w=>w.monatKey===r),d=[...new Set(o.map(w=>w.wocheKey))].sort(),u=e.yyyykw,g=d.includes(u)?u:d[0],h=n.find(w=>w.monatKey===r),f=((N=h==null?void 0:h.glz)==null?void 0:N.saldoGesamt)??null,m=((U=h==null?void 0:h.glz)==null?void 0:U.saldoVorperiode)??null,v=f!=null&&m!=null?+(f-m).toFixed(2):null,p=l.indexOf(r),M=p>0?l[p-1]:null,V=p<l.length-1?l[p+1]:null,x=ri(r),K=qe(a,n).filter(w=>w.wocheKey===g),q=K.reduce((w,T)=>w+we(T),0),z=K.reduce((w,T)=>w+Fe(T),0),H=+(q-z).toFixed(2),$=w=>w>.05?"var(--success)":w<-.05?"var(--danger)":"var(--fg)",S=i!=null&&i.stichtagAuswertung?new Date(i.stichtagAuswertung):new Date,D=Le(a,s,S),E=D.filter(w=>K.some(T=>T.datum===w.datum)),k=D.filter(w=>o.some(T=>T.datum===w.datum)).length,_=d.map(w=>{var pe;const j=(pe=o.filter(ce=>ce.wocheKey===w).sort((ce,Je)=>ce.datum.localeCompare(Je.datum))[0])==null?void 0:pe.datum,me=j?Ee(B(j)):"";return{wk:w,kw:w.split("-")[1],range:me}});t.innerHTML=`
    <h1 class="view-title">Kalender</h1>
      ...
      <div class="kalender-monat-saldo">
        ...
        ${v!=null?`
          <div class="kalender-monat-saldo-item">
            ...
            <span class="tabular kalender-monat-saldo-wert" style="color: ${$(v)};">${R(v,{signed:!0})}</span>
          </div>
        `:""}
      </div>
    </div>
    ...
    <div class="kalender-wochen-tabs" role="tablist" aria-label="Wochen des Monats">
      ${_.map(({wk:w,kw:T,range:j})=>`
        <a href="#/kalender/${r}/${w}"
           class="kalender-wochen-tab ${w===g?"active":""}"
           role="tab" aria-selected="${w===g}"
           title="${y(j)}">
          <span class="kalender-wochen-tab-kw">KW ${y(T)}</span>
    ...
    `:`
      ...
      <div class="card">
        ...
        <div id="tage-liste-kalender">${Ue(K,{warnungen:E})}</div>
      </div>
    `}
  `,K.length&&(requestAnimationFrame(()=>{const w=t.querySelector("#chart-kalender-woche");w&&Ge(w,K)}),gt(t.querySelector("#tage-liste-kalender")))}function ii(e){return`
    <div class="alert severity-${e.schweregrad}">
      <div class="alert-icon">${e.schweregrad==="error"?"!":e.schweregrad==="warn"?"⚠":"i"}</div>
      <div class="alert-body">
        <div class="alert-title">${y(e.titel)}</div>
    ...
    </div>`}function ri(e){const[t,a]=e.split("-"),n=new Date(parseInt(t,10),parseInt(a,10)-1,1);return F(n,"MMMM yyyy",{locale:Y})}const da="Fahrgelderstattung",li="C4",ua="C5",ga="F4",ha="F5",ue=10,be=19;function Kt(e,t){return e.filter(a=>a.monatKey===t).filter(a=>a.tagestyp==="Berufsschule").filter(a=>(a.ist??0)>0).sort((a,n)=>a.datum.localeCompare(n.datum))}async function oi(e){const t=(await ct(async()=>{const{default:m}=await import("./exceljs.min-BhfpbegZ.js").then(v=>v.e);return{default:m}},__vite__mapDeps([0,1]))).default,a=new t.Workbook;try{await a.xlsx.load(e)}catch{return{ok:!1,fehler:"Die Excel-Datei ist beschädigt oder kein gültiges .xlsx-Format. Bitte die Datei neu speichern und nochmal versuchen."}}const n=a.getWorksheet(da)??a.worksheets[0];if(!n)return{ok:!1,fehler:"Excel hat keine Arbeitsblätter — die Datei scheint leer zu sein."};const s=m=>{const v=n.getCell(m).value;return v==null?"":typeof v=="object"&&v.text?String(v.text):typeof v=="object"&&v.richText?v.richText.map(p=>p.text).join(""):String(v)},i=s(ua).trim(),l=s(ga).trim(),c=s(ha).trim(),r=(l.match(/\d+/)||[""])[0],o=(c.match(/\d+/)||[""])[0],d=s(`C${ue}`).trim(),u=s(`E${ue}`).trim(),g=n.getCell(`G${ue}`).value,h=typeof g=="number"?g:parseFloat(String(g).replace(",","."))||0;let f=null;try{const m=new Set(n.getImages().map(p=>parseInt(p.imageId,10))),v=(a.media||[]).map((p,M)=>({media:p,index:M})).filter(({media:p,index:M})=>(p==null?void 0:p.type)==="image"&&!m.has(M)&&p.buffer);if(v.length>0){v.sort((x,P)=>(P.media.buffer.length||0)-(x.media.buffer.length||0));const p=v[0].media,M=p.buffer,V=M instanceof ArrayBuffer?M:M.buffer?M.buffer.slice(M.byteOffset||0,(M.byteOffset||0)+M.byteLength):null;if(V){const x=(p.extension||"").toLowerCase();f={bytes:V,extension:x==="jpg"?"jpeg":x||"png",quelle:"auto-aus-vorlage"}}}}catch(m){console.warn("[fahrtgeld] Unterschrift-Auto-Extraktion fehlgeschlagen:",m)}return!i&&!r&&!o?{ok:!1,fehler:"Diese Excel scheint nicht im Format der Putzmeister-Fahrgelderstattung zu sein — Name/Personalnummer/Kostenstelle wurden nicht erkannt. Bitte eine Original-Vorlage hochladen."}:i?{ok:!0,konstanten:{name:i,persNr:r,kst:o,vonHaltestelle:d,nachHaltestelle:u,betragProTag:h},unterschriftAuto:f}:{ok:!1,fehler:'Im Feld „Name, Vorname" der Vorlage (Zelle C5) ist nichts eingetragen — bitte die Vorlage prüfen.'}}async function ci({templateBytes:e,monatKey:t,bsTage:a,konstanten:n,unterschriftBytes:s,unterschriftExtension:i}){const l=(await ct(async()=>{const{default:z}=await import("./exceljs.min-BhfpbegZ.js").then(H=>H.e);return{default:z}},__vite__mapDeps([0,1]))).default,c=new l.Workbook;try{await c.xlsx.load(e)}catch{throw new Error("Die hinterlegte Excel-Vorlage ist beschädigt — bitte unter Fahrgelderstattung neu hochladen.")}const r=c.getWorksheet(da)??c.worksheets[0];if(!r)throw new Error("Die Excel-Vorlage hat kein passendes Arbeitsblatt — bitte eine Original-Fahrgelderstattung-Vorlage hochladen.");const[o,d]=t.split("-").map(z=>parseInt(z,10)),u=new Date(o,d-1,1,12,0,0),g=F(u,"MMMM yy",{locale:Y}),h=r.getCell(li);h.value=g,h.numFmt="@",r.getCell(ua).value=n.name,r.getCell(ga).value=`Pers.-Nr.: ${n.persNr}`,r.getCell(ha).value=`KST: ${n.kst}`;for(let z=ue;z<=be;z++)r.getCell(`A${z}`).value=null,r.getCell(`C${z}`).value=null,r.getCell(`E${z}`).value=null,r.getCell(`G${z}`).value=null;const f=be-ue+1,m=a.slice(0,f);for(let z=0;z<m.length;z++){const H=m[z],$=ue+z;r.getCell(`A${$}`).value=B(H.datum),r.getCell(`C${$}`).value=n.vonHaltestelle,r.getCell(`E${$}`).value=n.nachHaltestelle,r.getCell(`G${$}`).value=n.betragProTag}const v=+(m.length*(n.betragProTag??0)).toFixed(2),p=r.getCell(`G${be+1}`);p.value={formula:`SUM(G${ue}:G${be})`,result:v};const V=F(new Date,"dd.MM.yyyy"),x=r.getCell("A21");if(x.value=V,x.alignment={vertical:"bottom",horizontal:"center",wrapText:!1},s&&i){const z=c.addImage({buffer:s,extension:i}),H=197,$=80,S=55,D=185,E=hi(s);let k=D,_=S;if(E&&E.width>0&&E.height>0){const w=Math.min(D/E.width,S/E.height);k=Math.round(E.width*w),_=Math.round(E.height*w)}const U=Math.max(0,Math.round((H-k)/2))/$;r.addImage(z,{tl:{col:U,row:20.04},ext:{width:k,height:_},editAs:"oneCell"})}for(let z=be+3;z<=be+5;z++)for(const H of["A","B","C","D","E","F","G"]){const $=r.getCell(`${H}${z}`),S=$.value;typeof S=="string"&&/^[A-Z]\d+(-\d+)?$/.test(S.trim())&&($.value=null)}const P=await c.xlsx.writeBuffer(),K=new Blob([P],{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}),q=di(n.name,u);return{blob:K,dateiname:q,anzahlTage:m.length,ueberzaehlig:a.length-m.length}}function di(e,t){const a=F(t,"MMMM",{locale:Y}),n=F(t,"yy");let s=e;const i=/^(.+?),\s*(.+)$/.exec(e);return i&&(s=`${i[2].trim()} ${i[1].trim()}`),`Fahrgelderstattung ${s} ${a} ${n}.xlsx`}function _e(e){const[t,a]=e.split("-").map(n=>parseInt(n,10));return F(new Date(t,a-1,1),"MMMM yyyy",{locale:Y})}function Bt(e,t=null){const n={monat_jahr:_e(e)},s=(t==null?void 0:t.betreff)??"Fahrgelderstattung {monat_jahr}",i=(t==null?void 0:t.text)??`Guten Tag Frau Mayer,

hiermit sende ich Ihnen das ausgefüllte Dokument für die Fahrgelderstattung vom {monat_jahr} zu.
Vielen Dank!`,l=Ct(s,n),c=Ct(i,n),r=new URLSearchParams;return r.set("cc","anika.kailer@putzmeister.com"),r.set("subject",l),r.set("body",c),`mailto:annika.mayer@putzmeister.com?${r.toString().replace(/\+/g,"%20")}`}function Ct(e,t){return e.replace(/\{(\w+)\}/g,(a,n)=>t[n]!=null?String(t[n]):`{${n}}`)}function ui(e){const t=new Set;for(const a of e)a.tagestyp==="Berufsschule"&&(a.ist??0)>0&&t.add(a.monatKey);return[...t].sort().reverse()}function gi(e,t,a,n){var g,h;const s=t==null?void 0:t.berufsschulMuster;if(!s||!((g=s.wochentageWoechentlich)!=null&&g.length)&&!((h=s.wochentage14Taegig)!=null&&h.length))return{ausstehend:[],imMonatGesamt:a.length,vorhandenAnzahl:a.length};const[i,l]=e.split("-").map(f=>parseInt(f,10)),c=new Date(i,l-1,1),r=new Date(i,l,0),o=new Set(a.map(f=>f.datum)),d=[];let u=new Date(c);for(;u<=r;){if(!ot(u)&&Re(u,s)){const f=F(u,"yyyy-MM-dd");u>n&&!o.has(f)&&d.push(f)}u=lt(u,1)}return{ausstehend:d,imMonatGesamt:a.length+d.length,vorhandenAnzahl:a.length}}function hi(e){const t=e instanceof ArrayBuffer?e:e!=null&&e.buffer?e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength):null;if(!t||t.byteLength<24)return null;const a=new DataView(t);if(a.getUint32(0)===2303741511&&a.getUint32(4)===218765834)return{width:a.getUint32(16),height:a.getUint32(20)};if(a.getUint16(0)===65496){let n=2;for(;n+9<a.byteLength;){if(a.getUint8(n)!==255)return null;const s=a.getUint8(n+1);if(s>=192&&s<=207&&s!==196&&s!==200&&s!==204)return{height:a.getUint16(n+5),width:a.getUint16(n+7)};const l=a.getUint16(n+2);if(l<2)return null;n+=2+l}}return null}function fi(e,t){const a=URL.createObjectURL(e),n=document.createElement("a");n.href=a,n.download=t,document.body.appendChild(n),n.click(),document.body.removeChild(n),setTimeout(()=>URL.revokeObjectURL(a),1e3)}async function Pe({root:e}){var p,M,V,x,P,K,q,z,H;const t=await Ae();if(!t){mi(e);return}const[a,n,s,i]=await Promise.all([G(),X(),ye(),sn("fahrgeld_abgabe")]),l=s!=null&&s.stichtagAuswertung?new Date(s.stichtagAuswertung):new Date,c=ui(a),r=new Date,o=`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,"0")}`;c.includes(o)||c.unshift(o);const d=c;e.innerHTML=`
    ...
    <div class="card fahrtgeld-signature-info" style="margin-bottom: 24px;">
      <div class="card-split">
        ...
        <div style="display: flex; gap: 8px; align-items: flex-start;">
          ...
          ${(V=t.unterschrift)!=null&&V.dataUrl?'<button class="btn sm" id="btn-signature-clear">Entfernen</button>':""}
        </div>
      </div>
    </div>
    ...
    `:(()=>{var E;const $=d.map((k,_)=>{const N=Kt(a,k),U=+(N.length*(t.konstanten.betragProTag??0)).toFixed(2),w=N.length>10,T=gi(k,n,N,l),j=T.ausstehend.length,me=+((N.length+j)*(t.konstanten.betragProTag??0)).toFixed(2),pe=j>0?T.ausstehend.map(ce=>W(B(ce))).join(", "):"";return{mk:k,bs:N,summe:U,ueberzaehlig:w,offen:j,offenListe:pe,summeMitOffen:me,idx:_}}),S=((E=$.find(k=>k.bs.length>0))==null?void 0:E.mk)??$[0].mk,D=$.find(k=>k.mk===S)??$[0];return`
          ...
          <div class="card">
            ...
            <div class="fahrtgeld-monate">
              ${$.map(k=>{const _=k.mk===S?"checked":"",N=`data-monat="${y(k.mk)}" data-offen="${k.offen}" data-offen-liste="${y(k.offenListe)}" data-anzahl="${k.bs.length}" data-summe="${k.summe.toFixed(2).replace(".",",")}" data-summe-mit-offen="${k.summeMitOffen.toFixed(2).replace(".",",")}" data-monat-label="${y(_e(k.mk))}" data-ueberzaehlig="${k.ueberzaehlig?"1":"0"}"`;return`
  ...
  `,(x=e.querySelector("#btn-template-replace"))==null||x.addEventListener("click",()=>{e.querySelector("#fahrtgeld-replace-input").click()}),(P=e.querySelector("#fahrtgeld-replace-input"))==null||P.addEventListener("change",async $=>{var D;const S=(D=$.target.files)==null?void 0:D[0];S&&await it(S,e)}),(K=e.querySelector("#btn-template-clear"))==null||K.addEventListener("click",async()=>{await ee("Beim nächsten Öffnen wirst du gebeten, eine neue Vorlage hochzuladen.",{title:"Vorlage löschen?",confirmLabel:"Löschen",variant:"danger"})&&(await en(),C("Vorlage gelöscht."),Pe({root:e}))}),(q=e.querySelector("#btn-signature-upload"))==null||q.addEventListener("click",()=>{e.querySelector("#fahrtgeld-signature-input").click()}),(z=e.querySelector("#fahrtgeld-signature-input"))==null||z.addEventListener("change",async $=>{var D;const S=(D=$.target.files)==null?void 0:D[0];S&&await pi(S,e)}),(H=e.querySelector("#btn-signature-clear"))==null||H.addEventListener("click",async()=>{if(!await ee("Die hochgeladene Unterschrift wird entfernt — generierte Excel haben dann keine Unterschrift mehr.",{title:"Unterschrift entfernen?",confirmLabel:"Entfernen",variant:"danger"}))return;const $=await Ae();$&&(await dt({...$,unterschrift:null}),C("Unterschrift entfernt."),Pe({root:e}))});const u=e.querySelector("#btn-fahrtgeld-generate"),g=e.querySelector("#btn-fahrtgeld-mail"),h=e.querySelector(".fahrtgeld-generate-monat"),f=e.querySelector("#fahrtgeld-generate-detail"),m=e.querySelectorAll(".fahrtgeld-monat-radio");function v(){const $=e.querySelector(".fahrtgeld-monat-radio:checked");if(!$)return;const S=$.closest(".fahrtgeld-monat-row");if(!S)return;const D=$.value,E=parseInt(S.getAttribute("data-anzahl")||"0",10),k=S.getAttribute("data-summe")||"0,00",_=parseInt(S.getAttribute("data-offen")||"0",10),N=S.getAttribute("data-offen-liste")||"",U=S.getAttribute("data-summe-mit-offen")||k,w=S.getAttribute("data-monat-label")||"",T=S.getAttribute("data-ueberzaehlig")==="1";if(h&&(h.textContent=w),f){const j=[`${E} BS-Tag${E===1?"":"e"} erfasst · ${k} €`];_>0&&j.push(`<br><span class="fahrtgeld-pending">⏳ Laut Schul-Rhythmus kommen noch ${_} BS-Tag${_===1?"":"e"}: ${y(N)} (mit allen: ${U} €)</span>`),T&&j.push(`<br><span style="color: var(--warn); font-weight: 600;">· ${E-10} überzählig (max 10/Monat)</span>`),f.innerHTML=j.join("")}u&&(u.disabled=E===0),g&&(g.href=Bt(D,i),E===0?g.setAttribute("aria-disabled","true"):g.removeAttribute("aria-disabled"))}m.forEach($=>$.addEventListener("change",v)),u==null||u.addEventListener("click",async()=>{var U,w;const $=e.querySelector(".fahrtgeld-monat-radio:checked");if(!$){Z("Bitte einen Monat auswählen.",{type:"warn"});return}const S=$.closest(".fahrtgeld-monat-row"),D=$.value,E=parseInt((S==null?void 0:S.getAttribute("data-offen"))||"0",10),k=(S==null?void 0:S.getAttribute("data-offen-liste"))||"";if(E>0&&!await ee(`Laut deinem Schul-Rhythmus kommen in diesem Monat noch ${E} BS-Tag${E===1?"":"e"}:

${k}

Diese Tage sind noch nicht im Zeitnachweis-PDF und werden in der Excel fehlen. Trotzdem jetzt für die bisher erfassten Tage generieren?`,{title:"Noch ausstehende BS-Tage",confirmLabel:"Trotzdem generieren"}))return;u.disabled=!0;const _=u.querySelector(".btn-generate-label"),N=_==null?void 0:_.textContent;_&&(_.textContent="Erstelle …");try{const T=await Ae(),j=await G(),me=Kt(j,D);if(!me.length){Z("Für diesen Monat sind keine BS-Anwesenheits-Tage erkannt.",{type:"warn"});return}const pe=(U=T.unterschrift)==null?void 0:U.bytes,ce=(w=T.unterschrift)==null?void 0:w.extension,{blob:Je,dateiname:pt,ueberzaehlig:Xe}=await ci({templateBytes:T.bytes,monatKey:D,bsTage:me,konstanten:T.konstanten,unterschriftBytes:pe,unterschriftExtension:ce});fi(Je,pt),C(`Excel erstellt: ${pt}${Xe>0?` (${Xe} weiterer Tag${Xe===1?"":"e"} passte/n nicht in die Vorlage)`:""}`)}catch(T){console.error("Fahrtgeld-Generierung fehlgeschlagen:",T),Z(`Fehler: ${T.message||T}`,{type:"error",duration:8e3})}finally{u.disabled=!1,_&&N&&(_.textContent=N)}})}function mi(e){e.innerHTML=`
    <h1 class="view-title">Fahrgelderstattung</h1>
  ...
  `;const t=e.querySelector("#fahrtgeld-dropzone"),a=e.querySelector("#fahrtgeld-upload-input");t==null||t.addEventListener("click",()=>a.click()),t==null||t.addEventListener("keydown",n=>{(n.key==="Enter"||n.key===" ")&&(n.preventDefault(),a.click())}),a==null||a.addEventListener("change",async n=>{var i;const s=(i=n.target.files)==null?void 0:i[0];s&&await it(s,e)}),["dragenter","dragover"].forEach(n=>{t==null||t.addEventListener(n,s=>{s.preventDefault(),s.stopPropagation(),t.classList.add("is-dragover")})}),["dragleave","drop"].forEach(n=>{t==null||t.addEventListener(n,s=>{s.preventDefault(),s.stopPropagation(),t.classList.remove("is-dragover")})}),t==null||t.addEventListener("drop",async n=>{var i,l;const s=(l=(i=n.dataTransfer)==null?void 0:i.files)==null?void 0:l[0];s&&await it(s,e)})}async function pi(e,t){try{if(!["image/png","image/jpeg"].includes(e.type)&&!/\.(png|jpe?g)$/i.test(e.name)){Z("Bitte ein PNG oder JPG hochladen.",{type:"warn"});return}if(e.size>2*1024*1024){Z(`Die Bilddatei ist zu groß (${(e.size/1024/1024).toFixed(1)} MB). Maximal 2 MB — bitte komprimiert oder kleiner hochladen.`,{type:"warn",duration:8e3});return}const n=await e.arrayBuffer(),s=/\.png$/i.test(e.name)||e.type==="image/png"?"png":"jpeg",i=await new Promise((c,r)=>{const o=new FileReader;o.onload=()=>c(o.result),o.onerror=r,o.readAsDataURL(e)}),l=await Ae();if(!l){Z("Bitte zuerst eine Excel-Vorlage hochladen.",{type:"warn"});return}await dt({...l,unterschrift:{bytes:n,extension:s,dataUrl:i,hochgeladenAm:new Date().toISOString()}}),C("Unterschrift gespeichert."),Pe({root:t})}catch(a){console.error("Unterschrift-Upload fehlgeschlagen:",a),Z(`Fehler beim Verarbeiten: ${a.message||a}`,{type:"error",duration:8e3})}}async function it(e,t){try{const a=await e.arrayBuffer(),n=await oi(a);if(!n.ok){Z(`Vorlage nicht erkannt: ${n.fehler}`,{type:"error",duration:8e3});return}const s=await Ae();let i=s==null?void 0:s.unterschrift;if(!i&&n.unterschriftAuto){const l=bi(n.unterschriftAuto.bytes,n.unterschriftAuto.extension);i={bytes:n.unterschriftAuto.bytes,extension:n.unterschriftAuto.extension,dataUrl:l,quelle:"auto-aus-vorlage",hochgeladenAm:new Date().toISOString()}}await dt({bytes:a,konstanten:n.konstanten,unterschrift:i,hochgeladenAm:new Date().toISOString(),dateiname:e.name}),n.unterschriftAuto&&!(s!=null&&s.unterschrift)?C(`Vorlage gespeichert: ${n.konstanten.name||e.name} (Unterschrift aus Vorlage übernommen)`):C(`Vorlage gespeichert: ${n.konstanten.name||e.name}`),document.dispatchEvent(new CustomEvent("better-ess:fahrgeld-template-uploaded")),Pe({root:t})}catch(a){console.error("Vorlage-Upload fehlgeschlagen:",a),Z(`Fehler beim Verarbeiten: ${a.message||a}`,{type:"error",duration:8e3})}}function bi(e,t){const a=new Uint8Array(e);let n="";for(let l=0;l<a.length;l++)n+=String.fromCharCode(a[l]);const s=btoa(n);return`data:${t==="png"?"image/png":"image/jpeg"};base64,${s}`}async function vi({root:e}){const t=await G();if(!t.length){e.innerHTML='<h1 class="view-title">Berichtsheft</h1><p class="view-subtitle">Keine Daten.</p><a href="#/daten" class="btn primary">Zum Upload</a>';return}const a=[...new Set(t.map(i=>i.monatKey))].sort().reverse();e.innerHTML=`
      ...
      <div class="card-split" style="margin-bottom: 16px; align-items: center;">
        ...
        <div style="display: flex; gap: 8px; align-items: center;">
          ...
          <select id="filter-monat">
            ...
            ${a.map(i=>`<option value="${i}">${xi(i)}</option>`).join("")}
          </select>
...
`);navigator.clipboard.writeText(l).then(()=>C(`${i.length} Zeilen kopiert.`))});function s(){const i=n.value,c=(i?t.filter(r=>r.monatKey===i):t).filter(r=>r.ist!=null&&r.ist>0&&r.tagestyp!=="Wochenende");e.querySelector("#liste").innerHTML=yi(c),e.querySelectorAll(".copy-val").forEach(r=>{r.addEventListener("click",async()=>{const o=r.getAttribute("data-val");await navigator.clipboard.writeText(o),r.classList.add("ok");const d=r.textContent;r.textContent="✓ kopiert",setTimeout(()=>{r.classList.remove("ok"),r.textContent=d},1200)})})}s()}function yi(e){return e.length?`
    <table class="table">
      <thead>
        <tr>
          <th>Datum</th>
      ...
      <tbody>
        ${e.map(t=>{const a=He(t.ist),n=`${W(B(t.datum))}	${a}`;return`
            <tr data-copy="${Wt(n)}">
              ...
              <td>${t.tagestyp?`<span class="pill ${ki(t.tagestyp)}">${fa(t.tagestyp)}</span>`:"—"}</td>
  ...
  `:'<p style="color: var(--fg-muted);">Keine Tage in dieser Auswahl.</p>'}function wi(e){return{MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"}[e]??e}function xi(e){const[t,a]=e.split("-");return F(new Date(parseInt(t),parseInt(a)-1,1),"LLLL yyyy",{locale:Y})}function ki(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function fa(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Wt(e){return fa(e)}async function $i({root:e}){const[t,a,n,s]=await Promise.all([G(),X(),fe(),ut()]),i=Object.fromEntries(s.map(r=>[r.key,r])),l=Le(t,a,new Date).filter(r=>r.mailVorlageKey),c=Yt(n);e.innerHTML=`
    ...
    <div class="card" style="margin-bottom: 24px;">
      ...
      ${l.length===0?'<div class="empty-state"><div class="empty-state-icon">✓</div><p>Keine akuten Warnungen — top.</p></div>':l.map(r=>Si(r,a,i)).join("")}
    ...
    <div class="card">
      ...
      <div id="vorlagen-editor">
        ${Object.keys(Te).map(r=>{const o=Ze(r,i[r]);return Mi(o)}).join("")}
      </div>
    </div>
  `,zi(e),Di(e)}function Si(e,t,a){const n=Ze(e.mailVorlageKey,a[e.mailVorlageKey]);if(!n)return"";const s=aa(t,e),i=ta(n,s),l=na(t,n,s);return`
...
${J(i.text)}
      ...
      <div class="alert-actions mail-actions-big" style="margin-top: 16px;">
        ...
        <button class="btn sm btn-copy-mail" data-subject="${rt(i.betreff)}" data-body="${rt(i.text)}">📋 Betreff + Text kopieren</button>
      </div>
    </div>
  `}function Mi(e){return`
    <div class="vorlagen-item" data-key="${e.key}" style="border: 1px solid var(--border); border-radius: var(--radius-md); padding: 16px; margin-bottom: 16px;">
      ...
      <div class="form-group">
        <label>Betreff</label>
        <input type="text" class="v-betreff" value="${rt(e.betreff)}" />
      </div>
      <div class="form-group">
  ...
  `}function zi(e){e.querySelectorAll(".btn-save-vorlage").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-key"),n=t.closest(".vorlagen-item"),s=n.querySelector(".v-betreff").value,i=n.querySelector(".v-text").value;await Oe(a,{betreff:s,text:i}),C("Vorlage gespeichert.")})}),e.querySelectorAll(".btn-reset-vorlage").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-key"),n=Te[a];n&&await ee(`Deine Anpassungen an "${n.titel}" gehen verloren.`,{title:"Vorlage zurücksetzen?",confirmLabel:"Zurücksetzen",variant:"danger"})&&(await Oe(a,{betreff:n.betreff,text:n.text}),C("Zurückgesetzt."),setTimeout(()=>location.reload(),400))})})}function Di(e){e.querySelectorAll(".btn-copy-mail").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-subject"),n=t.getAttribute("data-body"),s=`Betreff: ${a}

${n}`;await navigator.clipboard.writeText(s),C("Mail-Text kopiert.")})})}function J(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function rt(e){return J(e)}async function Ai({root:e}){const[t,a]=await Promise.all([X(),ut()]),n=Object.fromEntries(a.map(s=>[s.key,s]));e.innerHTML=`
    ...
    <div class="grid cols-2">
      ...
      <div class="card" style="grid-column: 1 / -1;">
        ...
        <div id="vorlagen-editor">
          ${Object.keys(Te).map(s=>{const i=Ze(s,n[s]);return Ti(i)}).join("")}
        </div>
      </div>
  ...
  `,e.querySelector("#pause-sel").addEventListener("change",async s=>{const i={...t,pausenRegel:s.target.value};await Ie(i),C("Pausen-Regel gespeichert.")}),e.querySelectorAll(".btn-save-vorlage").forEach(s=>{s.addEventListener("click",async()=>{const i=s.getAttribute("data-key"),l=s.closest(".vorlagen-item"),c=l.querySelector(".v-betreff").value,r=l.querySelector(".v-text").value;await Oe(i,{betreff:c,text:r}),C("Vorlage gespeichert.")})}),e.querySelectorAll(".btn-reset-vorlage").forEach(s=>{s.addEventListener("click",async()=>{const i=s.getAttribute("data-key"),l=Te[i];l&&await ee(`Deine Anpassungen an "${l.titel}" gehen verloren.`,{title:"Vorlage zurücksetzen?",confirmLabel:"Zurücksetzen",variant:"danger"})&&(await Oe(i,{betreff:l.betreff,text:l.text}),C("Zurückgesetzt."),setTimeout(()=>location.reload(),400))})})}function Ti(e){return`
    <div class="vorlagen-item" data-key="${e.key}" style="border: 1px solid var(--border); border-radius: var(--radius-md); padding: 16px; margin-bottom: 16px;">
      ...
      <div class="form-group">
        <label>Betreff</label>
        <input type="text" class="v-betreff" value="${Pi(e.betreff)}" />
      </div>
      <div class="form-group">
        <label>Nachrichtentext</label>
  ...
  `}function Ve(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Pi(e){return Ve(e)}async function _t(){document.documentElement.setAttribute("data-css-ready",""),Ia();const e=document.getElementById("content");await Ua()&&setTimeout(()=>{Z('Parser wurde aktualisiert. Bitte lade deinen Zeitnachweis unter "Daten" neu hoch.',{type:"info",duration:12e3})},500),await Ga(),await Za(),I("/",St),I("/dashboard",St),I("/analytics",si),I("/kalender",et),I("/kalender/:yyyymm",et),I("/kalender/:yyyymm/:yyyykw",et),I("/monat",qs),I("/monat/:yyyymm",Zs),I("/woche",Ys),I("/woche/:yyyykw",Qs),I("/tag/:datum",ti),I("/berichtsheft",vi),I("/mails",$i),I("/fahrtgeld",Pe),I("/profil",Rs),I("/daten",_s),I("/einstellungen",Ai),Ha(e),location.hash||Oa("/");try{const t=await b.tage.count();Es(t>0)&&setTimeout(()=>ra(),700)}catch(t){console.warn("[boot] Tour-Auto-Start-Check fehlgeschlagen:",t)}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",_t):_t();
