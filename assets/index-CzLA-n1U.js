import{D as lt}from"./dexie-BODkcwel.js";import{b as le,a as N,c as q,d as ot,f as S,e as X,i as Be,p as ct,g as dt,h as ut,j as z,k as Re,l as gt,s as ht,m as mt}from"./datefns-Dq49jaKA.js";import{C as L,L as ft,B as pt,D as vt,S as bt,a as yt,b as wt,P as Mt,A as $t,c as zt,d as St,T as xt,p as kt,e as Dt,i as At}from"./chartjs-CRgZvhTJ.js";import{_ as Pt,a as Tt}from"./pdfjs-BDGsuRSB.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=a(s);fetch(s.href,i)}})();const ie="theme";function Lt(){const e=localStorage.getItem(ie)??"auto";ge(e)}function ge(e){e==="auto"?document.documentElement.removeAttribute("data-theme"):document.documentElement.setAttribute("data-theme",e),localStorage.setItem(ie,e),Ft(e)}function Et(){const e=localStorage.getItem(ie)??"auto",t=e==="auto"?"light":e==="light"?"dark":"auto";return ge(t),Ve(t),t}const oe=new Set;function Wt(e){return oe.add(e),()=>oe.delete(e)}function Ve(e){for(const t of oe)try{t(e)}catch(a){console.error(a)}}var Ie;if(typeof window<"u"&&window.matchMedia){const e=window.matchMedia("(prefers-color-scheme: dark)");(Ie=e.addEventListener)==null||Ie.call(e,"change",()=>{je()==="auto"&&Ve("auto")})}function Ft(e){const t=document.getElementById("theme-toggle");if(!t)return;const a=t.querySelector(".theme-label"),n=t.querySelector(".theme-icon-dark"),s=t.querySelector(".theme-icon-light");a&&(e==="auto"?(a.textContent="Auto",n&&(n.style.display="inline"),s&&(s.style.display="inline")):e==="light"?(a.textContent="Hell",n&&(n.style.display="none"),s&&(s.style.display="inline")):(a.textContent="Dunkel",n&&(n.style.display="inline"),s&&(s.style.display="none")))}function je(){return localStorage.getItem(ie)??"auto"}const _e=[];let He=null;function D(e,t){const a=e.split("/").filter(Boolean),n=[],s=new RegExp("^/?"+a.map(i=>i.startsWith(":")?(n.push(i.slice(1)),"([^/]+)"):Bt(i)).join("/")+"/?$");_e.push({pattern:e,regex:s,paramNames:n,render:t})}function Kt(e){e.startsWith("#")||(e="#"+e),window.location.hash===e?E():window.location.hash=e}function Ct(e,{onNavigate:t}={}){window.addEventListener("hashchange",E),E.rootEl=e,E.onNavigate=t,E()}async function E(){var n;const e=E.rootEl,t=window.location.hash.slice(1)||"/",a=t.startsWith("/")?t:`/${t}`;for(const s of _e){const i=s.regex.exec(a);if(i){const r={};s.paramNames.forEach((l,o)=>r[l]=decodeURIComponent(i[o+1])),He=a,(n=E.onNavigate)==null||n.call(E,a),Ot(a);try{e.classList.remove("view-enter"),await s.render({params:r,path:a,root:e}),e.classList.add("view-enter")}catch(l){console.error("Route render error:",l),e.innerHTML=`<div class="empty-state">
  ...
  </div>`}function Ot(e){document.querySelectorAll("[data-route]").forEach(t=>{const a=t.getAttribute("data-route"),n=a==="/"?e==="/":e===a||e.startsWith(a+"/");t.classList.toggle("active",n)})}function It(){He!=null&&E()}function Bt(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function Se(e){return String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}const p=new lt("zeitnachweis");p.version(1).stores({profil:"id",tage:"datum, wochentag, tagestyp, monatKey, wocheKey",monate:"monatKey",uploads:"++id, hochladeDatum, stichtagAuswertung",einstellungen:"key",mailVorlagen:"key",warnungDismissals:"key"});p.version(2).stores({profil:"id",tage:"datum, wochentag, tagestyp, monatKey, wocheKey",monate:"monatKey",uploads:"++id, hochladeDatum, stichtagAuswertung",einstellungen:"key",mailVorlagen:"key",warnungDismissals:"key"}).upgrade(async e=>{await e.table("tage").clear(),await e.table("monate").clear(),await e.table("uploads").clear(),await e.table("warnungDismissals").clear(),await e.table("einstellungen").put({key:"__migration_reset",value:!0})});p.version(3).stores({profil:"id",tage:"datum, wochentag, tagestyp, monatKey, wocheKey",monate:"monatKey",uploads:"++id, hochladeDatum, stichtagAuswertung",einstellungen:"key",mailVorlagen:"key",warnungDismissals:"key"}).upgrade(async e=>{await e.table("tage").clear(),await e.table("monate").clear(),await e.table("uploads").clear(),await e.table("warnungDismissals").clear(),await e.table("einstellungen").put({key:"__migration_reset",value:!0})});async function Rt(){const e=await p.einstellungen.get("__migration_reset");return(e==null?void 0:e.value)===!0?(await p.einstellungen.delete("__migration_reset"),!0):!1}async function R(){return await p.profil.get("self")??Ze()}async function he(e){const t={...e,id:"self",updatedAt:new Date().toISOString()};return await p.profil.put(t),t}function Ze(){return{id:"self",name:"",personalnummer:"",kostenstelle:"",einstellungsdatum:null,arbeitszeitplanregel:"",geburtsdatum:null,sollStundenProWoche:35,sollStundenProTag:7,berufsschulMuster:{wochentageWoechentlich:[],wochentage14Taegig:[],referenzDatum14Taegig:null},zeitwirtschaftEmail:"zeitwirtschaft@putzmeister.com",zeitwirtschaftAnrede:"Frau Kanarya",pausenRegel:"auto",erstelltAm:new Date().toISOString()}}async function Vt(e,t=null){const a=await p.einstellungen.get(e);return a?a.value:t}async function jt(e,t){await p.einstellungen.put({key:e,value:t})}async function F(){return await p.tage.orderBy("datum").toArray()}async function _t(e){return e.length?(await p.tage.bulkPut(e),e.length):0}async function Ht(e){return e.length?(await p.monate.bulkPut(e),e.length):0}async function ee(){return await p.monate.orderBy("monatKey").toArray()}async function Zt(e){return await p.uploads.add({...e,hochladeDatum:new Date().toISOString()})}async function Ge(){return await p.uploads.orderBy("hochladeDatum").reverse().toArray()}async function Gt(){await Promise.all([p.profil.clear(),p.tage.clear(),p.monate.clear(),p.uploads.clear(),p.einstellungen.clear(),p.mailVorlagen.clear(),p.warnungDismissals.clear()])}async function Nt(){await Promise.all([p.tage.clear(),p.monate.clear(),p.uploads.clear(),p.warnungDismissals.clear()])}async function qt(){const[e,t,a,n,s,i,r]=await Promise.all([p.profil.toArray(),p.tage.toArray(),p.monate.toArray(),p.uploads.toArray(),p.einstellungen.toArray(),p.mailVorlagen.toArray(),p.warnungDismissals.toArray()]);return{version:1,exportedAt:new Date().toISOString(),data:{profil:e,tage:t,monate:a,uploads:n,einstellungen:s,mailVorlagen:i,warnungDismissals:r}}}async function Jt(e){if(!e||e.version!==1||!e.data)throw new Error("Ungültiges oder inkompatibles Backup-Format.");const t=e.data;await p.transaction("rw",p.profil,p.tage,p.monate,p.uploads,p.einstellungen,p.mailVorlagen,p.warnungDismissals,async()=>{var a,n,s,i,r,l,o;(a=t.profil)!=null&&a.length&&await p.profil.bulkPut(t.profil),(n=t.tage)!=null&&n.length&&await p.tage.bulkPut(t.tage),(s=t.monate)!=null&&s.length&&await p.monate.bulkPut(t.monate),(i=t.uploads)!=null&&i.length&&await p.uploads.bulkPut(t.uploads),(r=t.einstellungen)!=null&&r.length&&await p.einstellungen.bulkPut(t.einstellungen),(l=t.mailVorlagen)!=null&&l.length&&await p.mailVorlagen.bulkPut(t.mailVorlagen),(o=t.warnungDismissals)!=null&&o.length&&await p.warnungDismissals.bulkPut(t.warnungDismissals)})}async function xe(e,t){await p.mailVorlagen.put({key:e,...t})}async function Ut(){return await p.mailVorlagen.toArray()}async function Qt(e,t){await p.warnungDismissals.put({key:`${e}-${t}`,datum:e,typ:t,dismissedAt:new Date().toISOString()})}async function Yt(){return await p.warnungDismissals.toArray()}function Ne(e){if(e==null)return null;if(typeof e=="number")return e;let t=String(e).trim();if(!t)return null;let a=!1;t.endsWith("-")&&(a=!0,t=t.slice(0,-1).trim()),t=t.replace(",",".");const n=parseFloat(t);return isNaN(n)?null:a?-n:n}function j(e){if(e==null||isNaN(e))return"—";const t=e<0,a=Math.abs(e),n=Math.floor(a),s=Math.round((a-n)*60);let i=n,r=s;return r===60&&(i+=1,r=0),`${t?"-":""}${i}:${String(r).padStart(2,"0")}`}function A(e,t={}){if(e==null||isNaN(e))return"—";const{signed:a=!1,suffix:n="h"}=t,s=a&&e>0?"+":"",i=e.toFixed(2).replace(".",",");return`${s}${i}${n}`}function _(e){if(!e)return null;const t=/^(\d{1,2}):(\d{2})$/.exec(String(e).trim());return t?parseInt(t[1],10)*60+parseInt(t[2],10):null}const ke={lessThanXSeconds:{standalone:{one:"weniger als 1 Sekunde",other:"weniger als {{count}} Sekunden"},withPreposition:{one:"weniger als 1 Sekunde",other:"weniger als {{count}} Sekunden"}},xSeconds:{standalone:{one:"1 Sekunde",other:"{{count}} Sekunden"},withPreposition:{one:"1 Sekunde",other:"{{count}} Sekunden"}},halfAMinute:{standalone:"eine halbe Minute",withPreposition:"einer halben Minute"},lessThanXMinutes:{standalone:{one:"weniger als 1 Minute",other:"weniger als {{count}} Minuten"},withPreposition:{one:"weniger als 1 Minute",other:"weniger als {{count}} Minuten"}},xMinutes:{standalone:{one:"1 Minute",other:"{{count}} Minuten"},withPreposition:{one:"1 Minute",other:"{{count}} Minuten"}},aboutXHours:{standalone:{one:"etwa 1 Stunde",other:"etwa {{count}} Stunden"},withPreposition:{one:"etwa 1 Stunde",other:"etwa {{count}} Stunden"}},xHours:{standalone:{one:"1 Stunde",other:"{{count}} Stunden"},withPreposition:{one:"1 Stunde",other:"{{count}} Stunden"}},xDays:{standalone:{one:"1 Tag",other:"{{count}} Tage"},withPreposition:{one:"1 Tag",other:"{{count}} Tagen"}},aboutXWeeks:{standalone:{one:"etwa 1 Woche",other:"etwa {{count}} Wochen"},withPreposition:{one:"etwa 1 Woche",other:"etwa {{count}} Wochen"}},xWeeks:{standalone:{one:"1 Woche",other:"{{count}} Wochen"},withPreposition:{one:"1 Woche",other:"{{count}} Wochen"}},aboutXMonths:{standalone:{one:"etwa 1 Monat",other:"etwa {{count}} Monate"},withPreposition:{one:"etwa 1 Monat",other:"etwa {{count}} Monaten"}},xMonths:{standalone:{one:"1 Monat",other:"{{count}} Monate"},withPreposition:{one:"1 Monat",other:"{{count}} Monaten"}},aboutXYears:{standalone:{one:"etwa 1 Jahr",other:"etwa {{count}} Jahre"},withPreposition:{one:"etwa 1 Jahr",other:"etwa {{count}} Jahren"}},xYears:{standalone:{one:"1 Jahr",other:"{{count}} Jahre"},withPreposition:{one:"1 Jahr",other:"{{count}} Jahren"}},overXYears:{standalone:{one:"mehr als 1 Jahr",other:"mehr als {{count}} Jahre"},withPreposition:{one:"mehr als 1 Jahr",other:"mehr als {{count}} Jahren"}},almostXYears:{standalone:{one:"fast 1 Jahr",other:"fast {{count}} Jahre"},withPreposition:{one:"fast 1 Jahr",other:"fast {{count}} Jahren"}}},Xt=(e,t,a)=>{let n;const s=a!=null&&a.addSuffix?ke[e].withPreposition:ke[e].standalone;return typeof s=="string"?n=s:t===1?n=s.one:n=s.other.replace("{{count}}",String(t)),a!=null&&a.addSuffix?a.comparison&&a.comparison>0?"in "+n:"vor "+n:n},ea={full:"EEEE, do MMMM y",long:"do MMMM y",medium:"do MMM y",short:"dd.MM.y"},ta={full:"HH:mm:ss zzzz",long:"HH:mm:ss z",medium:"HH:mm:ss",short:"HH:mm"},aa={full:"{{date}} 'um' {{time}}",long:"{{date}} 'um' {{time}}",medium:"{{date}} {{time}}",short:"{{date}} {{time}}"},na={date:le({formats:ea,defaultWidth:"full"}),time:le({formats:ta,defaultWidth:"full"}),dateTime:le({formats:aa,defaultWidth:"full"})},sa={lastWeek:"'letzten' eeee 'um' p",yesterday:"'gestern um' p",today:"'heute um' p",tomorrow:"'morgen um' p",nextWeek:"eeee 'um' p",other:"P"},ia=(e,t,a,n)=>sa[e],ra={narrow:["v.Chr.","n.Chr."],abbreviated:["v.Chr.","n.Chr."],wide:["vor Christus","nach Christus"]},la={narrow:["1","2","3","4"],abbreviated:["Q1","Q2","Q3","Q4"],wide:["1. Quartal","2. Quartal","3. Quartal","4. Quartal"]},ce={narrow:["J","F","M","A","M","J","J","A","S","O","N","D"],abbreviated:["Jan","Feb","Mär","Apr","Mai","Jun","Jul","Aug","Sep","Okt","Nov","Dez"],wide:["Januar","Februar","März","April","Mai","Juni","Juli","August","September","Oktober","November","Dezember"]},oa={narrow:ce.narrow,abbreviated:["Jan.","Feb.","März","Apr.","Mai","Juni","Juli","Aug.","Sep.","Okt.","Nov.","Dez."],wide:ce.wide},ca={narrow:["S","M","D","M","D","F","S"],short:["So","Mo","Di","Mi","Do","Fr","Sa"],abbreviated:["So.","Mo.","Di.","Mi.","Do.","Fr.","Sa."],wide:["Sonntag","Montag","Dienstag","Mittwoch","Donnerstag","Freitag","Samstag"]},da={narrow:{am:"vm.",pm:"nm.",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachm.",evening:"Abend",night:"Nacht"},abbreviated:{am:"vorm.",pm:"nachm.",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachmittag",evening:"Abend",night:"Nacht"},wide:{am:"vormittags",pm:"nachmittags",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachmittag",evening:"Abend",night:"Nacht"}},ua={narrow:{am:"vm.",pm:"nm.",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachm.",evening:"abends",night:"nachts"},abbreviated:{am:"vorm.",pm:"nachm.",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachmittags",evening:"abends",night:"nachts"},wide:{am:"vormittags",pm:"nachmittags",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachmittags",evening:"abends",night:"nachts"}},ga=e=>Number(e)+".",ha={ordinalNumber:ga,era:N({values:ra,defaultWidth:"wide"}),quarter:N({values:la,defaultWidth:"wide",argumentCallback:e=>e-1}),month:N({values:ce,formattingValues:oa,defaultWidth:"wide"}),day:N({values:ca,defaultWidth:"wide"}),dayPeriod:N({values:da,defaultWidth:"wide",formattingValues:ua,defaultFormattingWidth:"wide"})},ma=/^(\d+)(\.)?/i,fa=/\d+/i,pa={narrow:/^(v\.? ?Chr\.?|n\.? ?Chr\.?)/i,abbreviated:/^(v\.? ?Chr\.?|n\.? ?Chr\.?)/i,wide:/^(vor Christus|vor unserer Zeitrechnung|nach Christus|unserer Zeitrechnung)/i},va={any:[/^v/i,/^n/i]},ba={narrow:/^[1234]/i,abbreviated:/^q[1234]/i,wide:/^[1234](\.)? Quartal/i},ya={any:[/1/i,/2/i,/3/i,/4/i]},wa={narrow:/^[jfmasond]/i,abbreviated:/^(j[aä]n|feb|mär[z]?|apr|mai|jun[i]?|jul[i]?|aug|sep|okt|nov|dez)\.?/i,wide:/^(januar|februar|märz|april|mai|juni|juli|august|september|oktober|november|dezember)/i},Ma={narrow:[/^j/i,/^f/i,/^m/i,/^a/i,/^m/i,/^j/i,/^j/i,/^a/i,/^s/i,/^o/i,/^n/i,/^d/i],any:[/^j[aä]/i,/^f/i,/^mär/i,/^ap/i,/^mai/i,/^jun/i,/^jul/i,/^au/i,/^s/i,/^o/i,/^n/i,/^d/i]},$a={narrow:/^[smdmf]/i,short:/^(so|mo|di|mi|do|fr|sa)/i,abbreviated:/^(son?|mon?|die?|mit?|don?|fre?|sam?)\.?/i,wide:/^(sonntag|montag|dienstag|mittwoch|donnerstag|freitag|samstag)/i},za={any:[/^so/i,/^mo/i,/^di/i,/^mi/i,/^do/i,/^f/i,/^sa/i]},Sa={narrow:/^(vm\.?|nm\.?|Mitternacht|Mittag|morgens|nachm\.?|abends|nachts)/i,abbreviated:/^(vorm\.?|nachm\.?|Mitternacht|Mittag|morgens|nachm\.?|abends|nachts)/i,wide:/^(vormittags|nachmittags|Mitternacht|Mittag|morgens|nachmittags|abends|nachts)/i},xa={any:{am:/^v/i,pm:/^n/i,midnight:/^Mitte/i,noon:/^Mitta/i,morning:/morgens/i,afternoon:/nachmittags/i,evening:/abends/i,night:/nachts/i}},ka={ordinalNumber:ot({matchPattern:ma,parsePattern:fa,valueCallback:e=>parseInt(e)}),era:q({matchPatterns:pa,defaultMatchWidth:"wide",parsePatterns:va,defaultParseWidth:"any"}),quarter:q({matchPatterns:ba,defaultMatchWidth:"wide",parsePatterns:ya,defaultParseWidth:"any",valueCallback:e=>e+1}),month:q({matchPatterns:wa,defaultMatchWidth:"wide",parsePatterns:Ma,defaultParseWidth:"any"}),day:q({matchPatterns:$a,defaultMatchWidth:"wide",parsePatterns:za,defaultParseWidth:"any"}),dayPeriod:q({matchPatterns:Sa,defaultMatchWidth:"wide",parsePatterns:xa,defaultParseWidth:"any"})},H={code:"de",formatDistance:Xt,formatLong:na,formatRelative:ia,localize:ha,match:ka,options:{weekStartsOn:1,firstWeekContainsDate:4}};function Y(e){if(!e)return null;const t=e.trim();return ct(t,"dd.MM.yyyy",new Date)}function w(e){return S(e,"dd.MM.yyyy")}function qe(e){return S(e,"EE, dd.MM.yyyy",{locale:H})}function Da(e){return`${dt(e)}-${String(ut(e)).padStart(2,"0")}`}function Je(e){return S(e,"yyyy-MM")}function Aa(e){return S(e,"yyyy-MM-dd")}function Pa(e,t){if(!e||!t)return 0;e>t&&([e,t]=[t,e]);let a=0,n=new Date(e);for(;n<t;)n=X(n,1),Be(n)||a++;return a}function B(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Ta(e){var r;const t=e.filter(l=>l.tagestyp==="Berufsschule");if(t.length<2)return{wochentageWoechentlich:[],wochentage14Taegig:[],referenzDatum14Taegig:null};const a={};for(const l of t)a[r=l.wochentag]??(a[r]=[]),a[l.wochentag].push(l);const n=[],s=[];let i=null;for(const[l,o]of Object.entries(a)){o.sort((g,u)=>g.datum.localeCompare(u.datum));const c=z(o[0].datum),d=z(o[o.length-1].datum),f=Re(d,c,{weekStartsOn:1})+1,h=o.length/Math.max(1,f);h>=.75?n.push(l):h>=.35&&h<=.65&&(s.push(l),(!i||z(o[0].datum)<z(i))&&(i=o[0].datum))}return{wochentageWoechentlich:n,wochentage14Taegig:s,referenzDatum14Taegig:i}}function Ue(e,t){var s,i;if(!t)return!1;const n=["SO","MO","DI","MI","DO","FR","SA"][e.getDay()];if((s=t.wochentageWoechentlich)!=null&&s.includes(n))return!0;if((i=t.wochentage14Taegig)!=null&&i.includes(n)&&t.referenzDatum14Taegig){const r=z(t.referenzDatum14Taegig),l=Re(e,r,{weekStartsOn:1});if(l>=0&&l%2===0)return!0}return!1}function La(e,t){if(!e)return"arbzg";const a=z(e);return gt(t,a)<18?"jarbschg":"arbzg"}function Ea(e,t){return e==null?0:t==="jarbschg"?e>6?1:e>4.5?.5:0:e>9?.75:e>6?.5:0}function Qe(e){if(!e||e.length<2)return 0;const t=e.filter(n=>n.von&&n.bis).map(n=>({von:_(n.von),bis:_(n.bis)})).filter(n=>n.von!=null&&n.bis!=null).sort((n,s)=>n.von-s.von);let a=0;for(let n=1;n<t.length;n++){const s=t[n].von-t[n-1].bis;(s>0&&s>=15||s>0)&&(a+=s)}return a/60}function Ye(e,t){const a=e.zeitSpannen??[];if(!a.length||a.every(u=>!u.von))return{keinAnspruch:!0};const n=Qe(a),s=e.pause??0,i=Wa(a),r=i-s,l=t.pausenRegel&&t.pausenRegel!=="auto"?t.pausenRegel==="jarbschg"?"jarbschg":"arbzg":La(t.geburtsdatum,z(e.datum)),o=Ea(r,l),c=Math.max(n,o),d=s-c,f=Math.max(0,o-n);let h="ok",g=null;if(d>.05)h="fehler_zeitwirtschaft",g=`${Math.round(d*60)} min Pause wurden zusätzlich zur gesetzlichen Pflicht und zur gestempelten Pause abgezogen. Das sieht nach einem Zeitwirtschafts-Fehler aus.`;else if(f>.05&&s>n+.02){h="aufstockung_legal";const u=Math.round(f*60);g=`Du hast ${Math.round(n*60)} min Pause gestempelt, aber bei ${r.toFixed(2).replace(".",",")}h Arbeitszeit schreibt das Gesetz (${l.toUpperCase()}) ${Math.round(o*60)} min vor. Die fehlenden ${u} min wurden automatisch als Pause gewertet. Das ist gesetzeskonform — nächstes Mal einfach länger Pause machen.`}return{arbeitszeitMitPause:i,arbeitszeitOhnePause:r,gestempeltePause:n,abgezogenePause:s,gesetzlichePflicht:o,gesetz:l,legalerAbzug:c,unrechtmaessigerVerlustMin:Math.round(Math.max(0,d)*60),aufstockungMin:Math.round(Math.max(0,f)*60),typ:h,warnung:g}}function Wa(e){let t=0;for(const a of e){if(!a.von||!a.bis)continue;const n=_(a.von),s=_(a.bis);n!=null&&s!=null&&s>n&&(t+=s-n)}return t/60}const J={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"};function me(e,t,a,n=new Set){var d,f;const s=[],i=a??new Date,r=new Map(e.map(h=>[h.datum,h]));if(!e.length)return s;const l=z(e[0].datum),o=i;for(let h=new Date(l);h<=o;h=X(h,1)){if(Be(h))continue;const g=S(h,"yyyy-MM-dd"),u=r.get(g),v=Pa(h,o);if(!u||!u.tagestyp&&!u.ist&&(((d=u.zeitSpannen)==null?void 0:d.length)??0)===0){if(Ue(h,t.berufsschulMuster)){const m=v>=4?"error":v>=2?"warn":"info";U(s,n,{datum:g,wochentag:(u==null?void 0:u.wochentag)??te(h),typ:"bs_tag_fehlt",schweregrad:m,titel:`Berufsschultag nicht eingetragen: ${w(h)}`,beschreibung:`Laut deinem Profil hast du am ${J[te(h)]}, ${w(h)} Berufsschule. Im Zeitnachweis fehlt der Tag bisher${v>=4?" — bitte bei der Zeitwirtschaft nachhaken":""}.`,alter:v,mailVorlageKey:m==="error"?"bs_tag_fehlt":null})}else{const m=v>=4?"error":v>=2?"warn":"info";U(s,n,{datum:g,wochentag:te(h),typ:"stempelzeit_fehlt",schweregrad:m,titel:`Keine Stempelzeit am ${w(h)}`,beschreibung:`Am ${J[te(h)]}, ${w(h)} wurde keine Stempelzeit erfasst. Falls du an diesem Tag im Haus warst, sollte die Zeitwirtschaft das nachtragen${v>=4?" — es ist inzwischen ≥4 Werktage her":""}.`,alter:v,mailVorlageKey:m==="error"?"stempelzeit_fehlt":null})}continue}if(u.tagestyp==="Berufsschule"&&u.ist!=null&&u.soll!=null&&u.ist<u.soll-.01&&U(s,n,{datum:g,wochentag:u.wochentag,typ:"bs_stunden_falsch",schweregrad:"error",titel:`Berufsschultag mit zu wenig Stunden: ${w(h)}`,beschreibung:`Am ${J[u.wochentag]}, ${w(h)} sind nur ${u.ist.toFixed(2).replace(".",",")}h gebucht statt regulär ${u.soll.toFixed(2).replace(".",",")}h. Die Zeitwirtschaft hat den Berufsschultag möglicherweise nur halb erfasst.`,ist:u.ist,soll:u.soll,mailVorlageKey:"bs_stunden_falsch"}),u.tagestyp==="Stempelzeit"&&((f=u.zeitSpannen)==null?void 0:f.length)>1&&g>="2026-04-01"){const m=Ye(u,t);(m==null?void 0:m.typ)==="fehler_zeitwirtschaft"&&m.unrechtmaessigerVerlustMin>=5?U(s,n,{datum:g,wochentag:u.wochentag,typ:"pausen_abzug",schweregrad:m.unrechtmaessigerVerlustMin>=15?"error":"warn",titel:`Pausen-Abzug fehlerhaft (${w(h)})`,beschreibung:`Am ${J[u.wochentag]}, ${w(h)} wurden ${Math.round(m.abgezogenePause*60)} min Pause abgezogen. Gestempelt: ${Math.round(m.gestempeltePause*60)} min, gesetzlich nötig (${m.gesetz.toUpperCase()}): ${Math.round(m.gesetzlichePflicht*60)} min. Differenz von ${m.unrechtmaessigerVerlustMin} min ist unerklärlich.`,verlustMinuten:m.unrechtmaessigerVerlustMin,abgezogen:m.abgezogenePause,gestempelt:m.gestempeltePause,mailVorlageKey:"pausen_abzug"}):(m==null?void 0:m.typ)==="aufstockung_legal"&&m.aufstockungMin>=10&&U(s,n,{datum:g,wochentag:u.wochentag,typ:"pausen_aufstockung",schweregrad:"info",titel:`Zu wenig Pause gestempelt (${w(h)}) — ${m.aufstockungMin} min automatisch aufgestockt`,beschreibung:`Am ${J[u.wochentag]}, ${w(h)} hast du nur ${Math.round(m.gestempeltePause*60)} min Pause gemacht. Gesetz (${m.gesetz.toUpperCase()}) schreibt ${Math.round(m.gesetzlichePflicht*60)} min vor. Fehlende ${m.aufstockungMin} min wurden als Pause gewertet — das ist legal, aber du verlierst dadurch Arbeitszeit. Tipp: mach beim nächsten Mal etwas länger Mittag.`})}}const c={error:0,warn:1,info:2};return s.sort((h,g)=>{const u=c[h.schweregrad]-c[g.schweregrad];return u!==0?u:g.datum.localeCompare(h.datum)}),s}function Xe(e,t=new Set){var n,s,i,r;const a=[];for(const l of e){const o=((n=l.glz)==null?void 0:n.saldoVorperiode)??0,c=((s=l.glz)==null?void 0:s.saldoAktuellePeriode)??0,d=((i=l.glz)==null?void 0:i.umgebuchteStunden)??0,f=(r=l.glz)==null?void 0:r.saldoGesamt;if(f==null)continue;const h=o+c+d,g=Math.abs(f-h);if(g>.03){const u=`${l.monatKey}-saldo_plausi`;t.has(u)||a.push({datum:`${l.monatKey}-01`,wochentag:"",typ:"saldo_plausi",schweregrad:"warn",titel:`Saldo-Differenz im Monat ${l.monatKey}`,beschreibung:`Rechnung: Vorperiode ${o.toFixed(2)} + aktuelle Periode ${c.toFixed(2)} + umgebucht ${d.toFixed(2)} = ${h.toFixed(2)}, aber dein Saldo wird mit ${f.toFixed(2)} angezeigt. Abweichung: ${g.toFixed(2)}h.`,soll:h,ist:f})}}return a}function U(e,t,a){const n=`${a.datum}-${a.typ}`;t.has(n)||(a.id=n,e.push(a))}function te(e){return["SO","MO","DI","MI","DO","FR","SA"][e.getDay()]}function Fa(e,t){var o,c,d;const a=[...e].sort((f,h)=>f.datum.localeCompare(h.datum));if(!a.length)return[];const n=new Map(t.map(f=>[f.monatKey,f])),s={};for(const f of a)s[o=f.monatKey]??(s[o]=[]),s[f.monatKey].push(f);const i=Object.keys(s).sort(),r=[];let l=null;for(const f of i){const h=n.get(f);let g;((c=h==null?void 0:h.glz)==null?void 0:c.saldoVorperiode)!=null?g=h.glz.saldoVorperiode:l!=null?g=l:g=0;const u=s[f];for(const v of u)v.diff!=null&&(g+=v.diff),r.push({datum:v.datum,wochentag:v.wochentag,saldo:Math.round(g*100)/100,diff:v.diff,ist:v.ist,soll:v.soll,tagestyp:v.tagestyp,monatKey:v.monatKey,zeitSpannen:v.zeitSpannen});if(((d=h==null?void 0:h.glz)==null?void 0:d.saldoGesamt)!=null){const v=h.glz.saldoGesamt-g;if(Math.abs(v)>.02&&r.length>0){const M=r.length-1;r[M].umbuchung=v,r[M].saldo=Math.round((r[M].saldo+v)*100)/100,g=r[M].saldo}l=h.glz.saldoGesamt}else l=g}return r}function Ka(e,t){if(!e.length)return[];if(t==="alles")return e;const a=Math.min(t,e.length);return e.slice(-a)}function Ca(e){return e.length?e[e.length-1].saldo:0}function Oa(e){if(!e.length)return 0;const t=e[0].saldo-(e[0].diff??0),a=e[e.length-1].saldo;return Math.round((a-t)*100)/100}L.register(ft,pt,vt,bt,yt,wt,Mt,$t,zt,St,xt,kt,Dt,At);function $(e){return getComputedStyle(document.documentElement).getPropertyValue(e).trim()}function K(){return{fg:$("--fg"),fgMuted:$("--fg-muted"),fgSubtle:$("--fg-subtle"),border:$("--border"),surface:$("--surface"),accent:$("--accent"),success:$("--success"),warn:$("--warn"),danger:$("--danger"),info:$("--info"),palette:[$("--chart-1"),$("--chart-2"),$("--chart-3"),$("--chart-4"),$("--chart-5"),$("--chart-6"),$("--chart-7")]}}function b(e){return{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{labels:{color:e.fgMuted,font:{size:12}}},tooltip:{backgroundColor:e.surface,titleColor:e.fg,bodyColor:e.fg,borderColor:e.border,borderWidth:1,padding:10,displayColors:!0}},scales:{x:{ticks:{color:e.fgMuted,font:{size:11}},grid:{color:e.border,drawBorder:!1}},y:{ticks:{color:e.fgMuted,font:{size:11}},grid:{color:e.border,drawBorder:!1}}}}}function Ia(e,t){const a=K();if(C(e),!(t!=null&&t.length))return;const n=t.map(i=>S(z(i.datum),"dd.MM.")),s=t.map(i=>i.saldo);return s.map(i=>i>=0?a.success:a.danger),new L(e,{type:"line",data:{labels:n,datasets:[{label:"Tages-Saldo",data:s,borderColor:a.accent,backgroundColor:i=>{const r=i.chart,{ctx:l,chartArea:o,scales:c}=r;return o?Ga(l,o,c.y,a):O(a.accent,.14)},segment:{borderColor:i=>{const r=i.p0.parsed.y,l=i.p1.parsed.y,o=(r+l)/2;return o>=.02?a.success:o<=-.02?a.danger:a.fgMuted}},tension:.25,pointRadius:2,pointHoverRadius:5,pointBackgroundColor:s.map(i=>i>=.02?a.success:i<=-.02?a.danger:a.fgMuted),pointBorderColor:a.surface,pointBorderWidth:1,fill:!0,borderWidth:2}]},options:{...b(a),plugins:{...b(a).plugins,legend:{display:!1},tooltip:{...b(a).plugins.tooltip,callbacks:{title:i=>{const r=t[i[0].dataIndex];return S(z(r.datum),"EE, dd.MM.yyyy",{locale:H})},label:i=>{const r=t[i.dataIndex],l=[`Saldo: ${r.saldo.toFixed(2).replace(".",",")}h`];return r.diff!=null&&l.push(`Tages-Diff: ${r.diff>=0?"+":""}${r.diff.toFixed(2).replace(".",",")}h`),r.tagestyp&&l.push(`Typ: ${r.tagestyp}`),r.umbuchung&&l.push(`Umbuchung: ${r.umbuchung>=0?"+":""}${r.umbuchung.toFixed(2).replace(".",",")}h`),l}}}},scales:{...b(a).scales,y:{...b(a).scales.y,ticks:{...b(a).scales.y.ticks,callback:i=>`${i>=0?"+":""}${i.toFixed(1).replace(".",",")}h`}}}}})}function Ba(e,t){const a=K();if(C(e),!(t!=null&&t.length))return;const n=t.map(i=>i.monatKey),s=t.map(i=>{var r;return((r=i.glz)==null?void 0:r.saldoGesamt)??0});return new L(e,{type:"line",data:{labels:n,datasets:[{label:"GLZ-Saldo (Monatsende)",data:s,borderColor:a.accent,backgroundColor:O(a.accent,.18),tension:.35,fill:!0,pointRadius:4}]},options:b(a)})}function fe(e,t){const a=K();if(C(e),!(t!=null&&t.length))return;const n=t.map(r=>S(z(r.datum),"dd.MM.")),s=t.map(r=>r.ist??0),i=t.map(r=>Na(r.tagestyp,a));return new L(e,{type:"bar",data:{labels:n,datasets:[{label:"Ist-Stunden",data:s,backgroundColor:i,borderRadius:4,borderSkipped:!1}]},options:{...b(a),plugins:{...b(a).plugins,legend:{display:!1},tooltip:{...b(a).plugins.tooltip,callbacks:{label:r=>{const l=t[r.dataIndex];return`${l.tagestyp??"—"}: ${(l.ist??0).toFixed(2).replace(".",",")}h`}}}},scales:{...b(a).scales,y:{...b(a).scales.y,suggestedMin:0,suggestedMax:10}}}})}function Ra(e,t){const a=K();if(C(e),!(t!=null&&t.length))return;const n=t.filter(c=>{var d;return((d=c.zeitSpannen)==null?void 0:d.length)&&c.zeitSpannen[0].von&&c.zeitSpannen[c.zeitSpannen.length-1].bis}).map(c=>({datum:c.datum,von:_(c.zeitSpannen[0].von),bis:_(c.zeitSpannen[c.zeitSpannen.length-1].bis)})),s=n.map(c=>S(z(c.datum),"dd.MM.")),i=n.map(c=>c.von),r=n.map(c=>c.bis),l=Math.max(0,Math.floor(Math.min(...i)/60)*60-60),o=Math.min(24*60,Math.ceil(Math.max(...r)/60)*60+60);return new L(e,{type:"bar",data:{labels:s,datasets:[{label:"Arbeitszeit (Start → Ende)",data:n.map(c=>[c.von,c.bis]),backgroundColor:a.palette[0],borderColor:a.palette[0],borderWidth:0,borderRadius:3,barPercentage:.85,categoryPercentage:.95}]},options:{...b(a),plugins:{...b(a).plugins,legend:{display:!1},tooltip:{...b(a).plugins.tooltip,callbacks:{label:c=>{const[d,f]=c.raw,h=u=>`${String(Math.floor(u/60)).padStart(2,"0")}:${String(u%60).padStart(2,"0")}`,g=f-d;return`${h(d)} – ${h(f)} (${Math.floor(g/60)}h ${g%60}m inkl. Pause)`}}}},scales:{x:{ticks:{color:a.fgMuted,font:{size:10},maxRotation:60,minRotation:60,autoSkip:!0,maxTicksLimit:40},grid:{display:!1}},y:{min:l,max:o,ticks:{color:a.fgMuted,stepSize:60,callback:c=>`${String(Math.floor(c/60)).padStart(2,"0")}:00`},grid:{color:a.border}}}}})}function Va(e,t){const a=K();C(e);const n={};for(const r of t){if(r.tagestyp!=="Stempelzeit"||!r.zeitSpannen||r.zeitSpannen.length<2)continue;const l=Qe(r.zeitSpannen);if(l<=0)continue;const o=Math.round(l*60),c=Math.floor(o/15)*15;n[c]=(n[c]??0)+1}const s=Object.keys(n).map(Number).sort((r,l)=>r-l),i=s.map(r=>n[r]);return new L(e,{type:"bar",data:{labels:s.map(r=>`${r}–${r+14} min`),datasets:[{label:"Häufigkeit",data:i,backgroundColor:a.palette[1],borderRadius:4}]},options:{...b(a),plugins:{...b(a).plugins,legend:{display:!1},tooltip:{...b(a).plugins.tooltip,callbacks:{title:r=>`Pause-Länge (gestempelt): ${r[0].label}`,label:r=>`${r.parsed.y} Tag(e)`}}}}})}function ja(e,t){const a=K();C(e);const n=["MO","DI","MI","DO","FR"],s={},i={};for(const l of n)s[l]=0,i[l]=0;for(const l of t)n.includes(l.wochentag)&&(l.ist==null||l.ist===0||(s[l.wochentag]+=l.ist,i[l.wochentag]+=1));const r=n.map(l=>i[l]>0?s[l]/i[l]:0);return new L(e,{type:"bar",data:{labels:["Montag","Dienstag","Mittwoch","Donnerstag","Freitag"],datasets:[{label:"Ø Ist-Stunden",data:r,backgroundColor:a.palette[2],borderRadius:4}]},options:{...b(a),plugins:{...b(a).plugins,legend:{display:!1}}}})}function _a(e,t){const a=K();C(e);const n={};for(const r of t)!r.tagestyp||r.tagestyp==="Wochenende"||(n[r.tagestyp]=(n[r.tagestyp]??0)+1);const s=Object.keys(n),i=Object.values(n);return new L(e,{type:"doughnut",data:{labels:s,datasets:[{data:i,backgroundColor:s.map((r,l)=>a.palette[l%a.palette.length]),borderColor:a.surface,borderWidth:2}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{position:"right",labels:{color:a.fgMuted,font:{size:12}}},tooltip:b(a).plugins.tooltip}}})}function Ha(e,t){const a=K();C(e);const n={};for(const l of t){const o=l.wocheKey;n[o]??(n[o]={ist:0,soll:0}),n[o].ist+=l.ist??0,n[o].soll+=l.soll??0}const s=Object.keys(n).sort(),i=s.map(l=>n[l].ist),r=s.map(l=>n[l].soll);return new L(e,{type:"bar",data:{labels:s.map(l=>"KW "+l.split("-")[1]),datasets:[{label:"Ist",data:i,backgroundColor:a.palette[0],borderRadius:4},{label:"Soll",data:r,backgroundColor:a.palette[3],borderRadius:4}]},options:b(a)})}function Za(e,t){const a=K();C(e);const n=t.slice().sort((r,l)=>r.datum.localeCompare(l.datum));let s=0;const i=n.map(r=>(s+=r.diff??0,{x:r.datum,y:s}));return new L(e,{type:"line",data:{labels:i.map(r=>r.x),datasets:[{label:"Kumulative Differenz (+/- Soll)",data:i.map(r=>r.y),borderColor:a.palette[5],backgroundColor:O(a.palette[5],.15),fill:!0,tension:.2,pointRadius:0}]},options:{...b(a),scales:{x:{display:!1,grid:{display:!1}},y:{...b(a).scales.y}}}})}function et(e,t,{monate:a=8}={}){if(!e)return;if(e.innerHTML="",!t.length){e.innerHTML='<p style="color: var(--fg-muted); font-size: 13px;">Keine Daten.</p>';return}const n=new Map(t.map(u=>[u.datum,u])),i=z(t[t.length-1].datum),r=a*30,l=X(i,-r),o=ht(l,{weekStartsOn:1}),c=mt(i,o)+1,d=Math.ceil(c/7),f=document.createElement("div");f.className="heatmap-month-labels",f.style.gridTemplateColumns=`repeat(${d}, 14px)`,e.appendChild(f);let h=-1;for(let u=0;u<d;u++){const v=X(o,u*7),M=v.getMonth(),m=document.createElement("span");m.textContent=M!==h?S(v,"MMM",{locale:H}):"",f.appendChild(m),h=M}const g=document.createElement("div");g.className="heatmap",g.style.gridAutoFlow="column",g.style.gridTemplateRows="repeat(7, 14px)",g.style.gridTemplateColumns=`repeat(${d}, 14px)`;for(let u=0;u<d*7;u++){const v=X(o,u);if(v>i||v<l){const V=document.createElement("div");V.className="heatmap-cell",V.style.background="transparent",g.appendChild(V);continue}const M=S(v,"yyyy-MM-dd"),m=n.get(M),k=document.createElement("div");k.className="heatmap-cell",k.title=`${S(v,"EE, dd.MM.yyyy",{locale:H})}${(m==null?void 0:m.ist)!=null?" · Ist "+m.ist.toFixed(2)+"h":""}${(m==null?void 0:m.diff)!=null?" · "+(m.diff>=0?"+":"")+m.diff.toFixed(2):""}`,(m==null?void 0:m.diff)!=null&&(m.diff<=-1?k.classList.add("neg-2"):m.diff<-.05?k.classList.add("neg-1"):m.diff>=1?k.classList.add("pos-2"):m.diff>.05&&k.classList.add("pos-1")),g.appendChild(k)}e.appendChild(g)}function C(e){const t=L.getChart(e);t&&t.destroy()}function O(e,t){const a=e.replace("#","").trim();if(a.length!==6&&a.length!==3)return e;const n=a.length===3?a.split("").map(l=>l+l).join(""):a,s=parseInt(n.slice(0,2),16),i=parseInt(n.slice(2,4),16),r=parseInt(n.slice(4,6),16);return`rgba(${s}, ${i}, ${r}, ${t})`}function Ga(e,t,a,n){const{top:s,bottom:i}=t,r=e.createLinearGradient(0,s,0,i),l=a.min,o=a.max,c=o-l;if(c<=0)return O(n.success,.14);let d=(o-0)/c;return d=Math.max(0,Math.min(1,d)),r.addColorStop(0,O(n.success,.28)),r.addColorStop(Math.max(0,d-.001),O(n.success,.06)),r.addColorStop(Math.min(1,d+.001),O(n.danger,.06)),r.addColorStop(1,O(n.danger,.28)),r}function Na(e,t){const a=String(e??"").toLowerCase();return a.includes("stempel")?t.palette[0]:a.includes("berufs")?t.palette[1]:a.includes("urlaub")?t.palette[2]:a.includes("feiertag")?t.fgSubtle:a.includes("dienst")?t.palette[3]:a.includes("krank")?t.palette[4]:t.palette[5]}let qa=0;function pe(e,{type:t="info",duration:a=3500}={}){const n=document.getElementById("toast-root");if(!n)return;const s=document.createElement("div");s.className=`toast ${t}`,s.textContent=e,s.dataset.id=++qa,n.appendChild(s),setTimeout(()=>{s.style.opacity="0",s.style.transform="translateY(-8px)",s.style.transition="opacity 220ms, transform 220ms",setTimeout(()=>s.remove(),250)},a)}function ve(e){return pe(e,{type:"error",duration:6e3})}function x(e){return pe(e,{type:"success"})}const Ja=[{key:7,label:"1 Woche"},{key:14,label:"2 Wochen"},{key:30,label:"1 Monat"},{key:90,label:"3 Monate"},{key:"alles",label:"Alles"}];async function De({root:e}){var k,V,ye,we;const[t,a,n,s,i]=await Promise.all([R(),ee(),F(),Yt(),Vt("dashboardZeitraum",14)]);if(n.length===0){e.innerHTML=Xa();return}const r=!t.geburtsdatum||!((V=(k=t.berufsschulMuster)==null?void 0:k.wochentageWoechentlich)!=null&&V.length||(we=(ye=t.berufsschulMuster)==null?void 0:ye.wochentage14Taegig)!=null&&we.length),l=Fa(n,a),o=l.length;let c=i;typeof c=="number"&&c>o&&(c="alles");const d=new Set(s.map(y=>y.key)),f=me(n,t,new Date,d),h=Xe(a,d),g=[...f,...h],u=Ca(l),v=u>.05?"positive":u<-.05?"negative":"",M=g.filter(y=>y.schweregrad==="error"),m=g.filter(y=>y.schweregrad==="warn");e.innerHTML=`
    <h1 class="view-title">Dashboard</h1>
    <p class="view-subtitle">
      ${t.name?W(t.name):"Willkommen"}${t.personalnummer?` · Personalnr. ${W(t.personalnummer)}`:""}
      · Stand: ${W(w(new Date(n[n.length-1].datum)))}
    </p>
    ...
    <div class="saldo-hero" style="margin-bottom: 32px; align-items: stretch;">
      <div class="saldo-hero-text" style="min-width: 260px;">
        ...
        <div class="saldo-value ${v}">${A(u,{signed:!0,suffix:""})}</div>
      ...
      <div style="flex: 1; min-width: 400px; display: flex; flex-direction: column;">
        <div class="card-split" style="margin-bottom: 12px; align-items: center;">
          ...
          <div class="segmented" id="zeitraum-picker">
            ${Ja.map(y=>{const P=typeof y.key=="number"&&y.key>o;return`<button type="button" data-key="${y.key}" class="${c===y.key?"active":""}" ${P?'disabled style="opacity:0.4"':""}>${y.label}</button>`}).join("")}
          </div>
        </div>
    ...
    <div class="grid cols-4" style="margin-bottom: 32px;">
      ...
      <div class="card">
        ...
        <div class="tabular" style="font-size: 32px; font-weight: 650; letter-spacing: -0.02em; color: ${M.length>0?"var(--danger)":"var(--success)"};">${M.length}</div>
        <div style="color: var(--fg-muted); font-size: 12px; margin-top: 4px;">
          ${M.length>0?"sofort an Zeitwirtschaft":"keine akuten Fehler"}
        </div>
      </div>
      <div class="card">
  ...
  `,Ae(c,e,l),e.querySelectorAll("#zeitraum-picker button").forEach(y=>{y.addEventListener("click",async()=>{if(y.disabled)return;const P=y.getAttribute("data-key"),I=P==="alles"?"alles":parseInt(P,10);e.querySelectorAll("#zeitraum-picker button").forEach(Z=>Z.classList.toggle("active",Z===y)),await jt("dashboardZeitraum",I),Ae(I,e,l)})}),requestAnimationFrame(()=>{et(e.querySelector("#mini-heatmap"),n,{monate:4})}),e.addEventListener("click",async y=>{const P=y.target.closest(".ist-copy");if(P){y.preventDefault(),y.stopPropagation();const ze=P.getAttribute("data-val");try{await navigator.clipboard.writeText(ze),P.classList.add("ok");const G=P.querySelector(".ist-wert"),re=P.querySelector(".copy-icon");if(G&&re){const rt=G.textContent;G.textContent="✓ kopiert",re.style.display="none",setTimeout(()=>{P.classList.remove("ok"),G.textContent=rt,re.style.display=""},1e3)}}catch{x(`Bitte kopieren: ${ze}`)}return}const I=y.target.closest(".btn-dismiss");if(!I)return;const Z=I.getAttribute("data-datum"),Me=I.getAttribute("data-typ");if(!Z||!Me)return;await Qt(Z,Me),x("Warnung ausgeblendet.");const $e=I.closest(".alert");$e&&($e.style.display="none")})}function Ae(e,t,a){const n=Ka(a,e),s=Oa(n);requestAnimationFrame(()=>{const o=t.querySelector("#saldo-chart");Ia(o,n)});const i=t.querySelector("#hero-bewegung");if(i){const o=s>.05?"up":s<-.05?"down":"flat",c=s>.05?"↑":s<-.05?"↓":"→";i.className=`saldo-trend ${o}`,i.innerHTML=`${c} ${Math.abs(s)<.01?"Unverändert":A(s,{signed:!0})} im Zeitraum`}const r=t.querySelector("#tage-info");if(r){const o=n.length;r.textContent=`${o} ${o===1?"Tag":"Tage"}`}const l=t.querySelector("#tage-liste");l&&(l.innerHTML=Ua(n.slice().reverse()))}function Ua(e){if(!e.length)return'<p class="hint">Keine Tage im Zeitraum.</p>';const t=Math.max(1,...e.map(s=>Math.abs(s.diff??0))),a=[];let n=null;for(const s of e){if(s.wocheKey&&s.wocheKey!==n){if(n!==null){const i=s.wocheKey.split("-")[1];a.push(`<div class="woche-divider"><span>KW ${i}</span></div>`)}n=s.wocheKey}a.push(Qa(s,t))}return`<div class="tages-liste">${a.join("")}</div>`}function Qa(e,t){const a=e.diff??0,n=a>0,s=Math.min(100,Math.abs(a)/t*100),i=n?"var(--success)":a<0?"var(--danger)":"var(--fg-subtle)";return`
    <a href="#/tag/${e.datum}" class="tag-row">
      <div class="tag-row-datum">
        <div class="tabular">${W(w(new Date(e.datum)))}</div>
        <div class="tag-row-wd">${en(e.wochentag)}</div>
      </div>
      <div class="tag-row-typ">
        ${e.tagestyp?`<span class="pill ${tn(e.tagestyp)}">${W(e.tagestyp)}</span>`:'<span style="color: var(--fg-subtle); font-size: 12px;">—</span>'}
      </div>
      <div class="tag-row-ist tabular">
        ${e.ist!=null&&e.ist>0?`<button class="ist-copy" data-val="${j(e.ist)}" title="Kopieren für IHK-Berichtsheft"><span class="ist-wert">${j(e.ist)}</span><span class="copy-icon" aria-hidden="true">⧉</span></button>`:`<div class="ist-wert">${e.ist!=null?j(e.ist):"—"}</div>`}
        <div style="color: var(--fg-subtle); font-size: 11px;">Soll ${e.soll!=null?j(e.soll):"—"}</div>
      </div>
  ...
  `;const n=e.querySelector("#upload-zone"),s=e.querySelector("#file-input");n.addEventListener("click",()=>s.click()),n.addEventListener("dragover",i=>{i.preventDefault(),n.classList.add("drag")}),n.addEventListener("dragleave",()=>n.classList.remove("drag")),n.addEventListener("drop",async i=>{var l;i.preventDefault(),n.classList.remove("drag");const r=(l=i.dataTransfer.files)==null?void 0:l[0];r&&await We(r,e,a)}),s.addEventListener("change",async i=>{var l;const r=(l=i.target.files)==null?void 0:l[0];r&&await We(r,e,a)}),e.querySelector("#btn-export").addEventListener("click",pn),e.querySelector("#btn-import").addEventListener("click",()=>e.querySelector("#import-input").click()),e.querySelector("#import-input").addEventListener("change",vn),e.querySelector("#btn-clear-parsed").addEventListener("click",fn),e.querySelector("#btn-reset").addEventListener("click",bn)}async function fn(){confirm("PDF-abgeleitete Daten (Tage, Monate, Uploads) werden gelöscht. Profil und Mail-Vorlagen bleiben erhalten. Fortfahren?")&&(await Nt(),x("Daten gelöscht. Profil bleibt."),setTimeout(()=>location.reload(),600))}function tt(e){return`
    <table class="table">
      <thead>
        <tr>
      ...
      <tbody>
        ${e.map(t=>`
          <tr>
            <td>${B(yn(t.hochladeDatum))}</td>
            <td>${B(t.dateiname||"—")}</td>
            <td>${t.zeitraumVon?B(w(new Date(t.zeitraumVon))):"—"} – ${t.zeitraumBis?B(w(new Date(t.zeitraumBis))):"—"}</td>
            <td>${t.stichtagAuswertung?B(w(new Date(t.stichtagAuswertung))):"—"}</td>
  ...
  `}async function We(e,t,a){var i,r,l,o;const n=t.querySelector("#upload-status"),s=t.querySelector("#upload-zone");s.style.pointerEvents="none",s.style.opacity="0.6",n.innerHTML=`
    <div class="alert severity-info">
      ...
      <div class="alert-body">
        ...
        <p style="margin: 4px 0; font-size: 13px;"><strong>${B(e.name)}</strong> — das kann bei großen PDFs einige Sekunden dauern.</p>
      </div>
    </div>`;try{const c=await e.arrayBuffer(),d=await sn(c);await _t(d.tage),await Ht(d.monate),await Zt({dateiname:e.name,zeitraumVon:((i=d.meta.zeitraumVon)==null?void 0:i.toISOString())??null,zeitraumBis:((r=d.meta.zeitraumBis)==null?void 0:r.toISOString())??null,stichtagAuswertung:((l=d.meta.stichtagAuswertung)==null?void 0:l.toISOString())??null,tageCount:d.tage.length,monateCount:d.monate.length});const f=await F(),h=Ta(f),g={...Ze(),...a};d.meta.personalnummer&&!a.personalnummer&&(g.name=d.meta.name??a.name,g.personalnummer=d.meta.personalnummer,g.einstellungsdatum=((o=d.meta.einstellungsdatum)==null?void 0:o.toISOString())??a.einstellungsdatum,g.arbeitszeitplanregel=d.meta.arbeitszeitplanregel??a.arbeitszeitplanregel),(h.wochentageWoechentlich.length>0||h.wochentage14Taegig.length>0)&&(g.berufsschulMuster=h),await he(g),n.innerHTML=`
    ...
    `,x(`PDF verarbeitet: ${d.tage.length} Tage.`);const u=await Ge();t.querySelector("#uploads-list").innerHTML=tt(u)}catch(c){console.error(c),n.innerHTML=`
      <div class="alert severity-error">
        <div class="alert-icon">!</div>
        <div class="alert-body">
          <div class="alert-title">Fehler beim Parsen</div>
          <p style="margin: 4px 0; font-size: 13px;">${B(c.message||String(c))}</p>
    ...
    `,ve("PDF konnte nicht gelesen werden.")}finally{s.style.pointerEvents="",s.style.opacity=""}}async function pn(){try{const e=await qt(),t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),a=URL.createObjectURL(t),n=document.createElement("a"),s=new Date().toISOString().slice(0,10);n.href=a,n.download=`zeitnachweis-backup-${s}.json`,n.click(),URL.revokeObjectURL(a),x("Backup heruntergeladen.")}catch(e){ve(`Export fehlgeschlagen: ${e.message}`)}}async function vn(e){var a;const t=(a=e.target.files)==null?void 0:a[0];if(t)try{const n=await t.text(),s=JSON.parse(n);if(!confirm("Existierende Daten werden überschrieben. Fortfahren?"))return;await Jt(s),x("Backup erfolgreich importiert. Seite wird neu geladen…"),setTimeout(()=>location.reload(),800)}catch(n){ve(`Import fehlgeschlagen: ${n.message}`)}}async function bn(){confirm("ALLE Daten endgültig löschen? Das lässt sich nicht rückgängig machen.")&&confirm("Wirklich alle Daten löschen? Letzte Warnung.")&&(await Gt(),x("Alle Daten gelöscht."),setTimeout(()=>location.reload(),600))}function yn(e){if(!e)return"—";const t=new Date(e);return t.toLocaleDateString("de-DE",{year:"numeric",month:"2-digit",day:"2-digit"})+" "+t.toLocaleTimeString("de-DE",{hour:"2-digit",minute:"2-digit"})}const Fe={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag"};async function wn({root:e}){var s,i,r,l;const t=await R(),a=t.berufsschulMuster??{},n=(((s=a.wochentageWoechentlich)==null?void 0:s.length)??0)>0||(((i=a.wochentage14Taegig)==null?void 0:i.length)??0)>0;e.innerHTML=`
      ...
      <div class="card" style="grid-column: 1 / -1;">
        ...
        ${n?`
          <div class="tag-detail">
            ...
            <div class="tag-detail-value"><strong>${((r=a.wochentageWoechentlich)==null?void 0:r.map(o=>Fe[o]).join(", "))||"—"}</strong></div>
          </div>
          <div class="tag-detail">
            <div class="tag-detail-label">Alle 2 Wochen</div>
            <div class="tag-detail-value"><strong>${((l=a.wochentage14Taegig)==null?void 0:l.map(o=>Fe[o]).join(", "))||"—"}</strong>${a.referenzDatum14Taegig?` <span class="hint">(Anker: ${w(new Date(a.referenzDatum14Taegig))})</span>`:""}</div>
          </div>
  ...
  `,e.querySelector("#profil-form").addEventListener("submit",async o=>{var f,h,g,u;o.preventDefault();const c=new FormData(o.target),d={...t,name:((f=c.get("name"))==null?void 0:f.trim())||"",personalnummer:((h=c.get("personalnummer"))==null?void 0:h.trim())||"",geburtsdatum:c.get("geburtsdatum")?new Date(c.get("geburtsdatum")).toISOString():null,pausenRegel:c.get("pausenRegel")||"auto",zeitwirtschaftEmail:((g=c.get("zeitwirtschaftEmail"))==null?void 0:g.trim())||"zeitwirtschaft@putzmeister.com",zeitwirtschaftAnrede:((u=c.get("zeitwirtschaftAnrede"))==null?void 0:u.trim())||"Frau Kanarya"};await he(d),x("Profil gespeichert.")})}function ae(e){return String(e??"").replace(/"/g,"&quot;")}async function Mn({root:e}){var s;const t=await ee(),a=await F(),n={};for(const i of a)n[s=i.monatKey]??(n[s]=[]),n[i.monatKey].push(i);if(t.length===0){e.innerHTML=Dn("Noch keine Monatsdaten. Lade zuerst ein PDF unter Daten hoch.");return}e.innerHTML=`
    <h1 class="view-title">Monate</h1>
    <p class="view-subtitle">${t.length} Monate erfasst. Klicke für Details.</p>

    <div class="grid cols-2">
      ${t.slice().reverse().map(i=>{var h;const l=(n[i.monatKey]??[]).filter(g=>g.ist!=null&&g.ist>0),o=l.reduce((g,u)=>g+(u.ist??0),0),c=l.reduce((g,u)=>g+(u.soll??0),0),d=o-c,f=(h=i.glz)==null?void 0:h.saldoGesamt;return`
  ...
  `}async function Pn({params:e,root:t}){const a=await F(),n=e.yyyykw,s=a.filter(o=>o.wocheKey===n).sort((o,c)=>o.datum.localeCompare(c.datum));if(!s.length){t.innerHTML=`<h1 class="view-title">KW ${se(n)}</h1><p>Keine Daten.</p><a href="#/woche" class="btn">← Alle Wochen</a>`;return}const i=s.reduce((o,c)=>o+(c.ist??0),0),r=s.reduce((o,c)=>o+(c.soll??0),0),l=i-r;t.innerHTML=`
    <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 8px;">
  ...
  `,fe(t.querySelector("#chart-woche"),s)}function Tn(e){return`
    <table class="table">
      ...
      <tbody>
        ${e.map(t=>{var s;const a=t.diff>.05?"positive":t.diff<-.05?"negative":"",n=(s=t.zeitSpannen)==null?void 0:s[0];return`
            <tr>
              <td><a href="#/tag/${t.datum}" style="color: inherit;"><span class="tabular">${S(z(t.datum),"dd.MM.yyyy")}</span> ${t.wochentag}</a></td>
  ...
  `}function at(e){const[t,a]=e.split("-");return`KW ${a} · ${t}`}function Ln(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function se(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}async function En({params:e,root:t}){var o,c,d;const a=e.datum,n=await p.tage.get(a),s=await R();if(!n){t.innerHTML=`<h1 class="view-title">Tag nicht gefunden</h1><p>Für ${a} liegen keine Daten vor.</p><a href="#/" class="btn">← Dashboard</a>`;return}const i=z(a),r=n.tagestyp==="Stempelzeit"?Ye(n,s):null,l=Ue(i,s.berufsschulMuster);t.innerHTML=`
    ...
    <div class="grid cols-3" style="margin-bottom: 24px;">
      <div class="card">
        ...
        <div class="hint">= ${n.ist!=null?j(n.ist):"—"}</div>
      </div>
      <div class="card">
        <h3>Soll-Stunden</h3>
    ...
    <div class="grid cols-2" style="gap: 24px;">
      ...
      <div class="card">
        ...
        <div class="tag-detail">
          ...
          <div class="tag-detail-value">${n.tagestyp?`<span class="pill ${Wn(n.tagestyp)}">${Q(n.tagestyp)}</span>`:"—"}</div>
        </div>
        <div class="tag-detail">
  ...
  `}function Wn(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function Q(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}async function Fn({root:e}){const[t,a]=await Promise.all([F(),ee()]);if(!t.length){e.innerHTML='<h1 class="view-title">Analytics</h1><p class="view-subtitle">Keine Daten.</p><a href="#/daten" class="btn primary">Zum Upload</a>';return}e.innerHTML=`
  ...
  `,requestAnimationFrame(()=>{Ba(e.querySelector("#c-saldo"),a),et(e.querySelector("#heatmap"),t,{monate:8}),Ha(e.querySelector("#c-istsoll"),t),Za(e.querySelector("#c-kumulativ"),t),Ra(e.querySelector("#c-startend"),t),ja(e.querySelector("#c-wochentag"),t),Va(e.querySelector("#c-pausen"),t),_a(e.querySelector("#c-donut"),t);const n=t.slice(-30);fe(e.querySelector("#c-alle-tage"),n)})}async function Kn({root:e}){const t=await F();if(!t.length){e.innerHTML='<h1 class="view-title">Berichtsheft</h1><p class="view-subtitle">Keine Daten.</p><a href="#/daten" class="btn primary">Zum Upload</a>';return}const a=[...new Set(t.map(i=>i.monatKey))].sort().reverse();e.innerHTML=`
...
`);navigator.clipboard.writeText(r).then(()=>x(`${i.length} Zeilen kopiert.`))});function s(){const i=n.value,l=(i?t.filter(o=>o.monatKey===i):t).filter(o=>o.ist!=null&&o.ist>0&&o.tagestyp!=="Wochenende");e.querySelector("#liste").innerHTML=Cn(l),e.querySelectorAll(".copy-val").forEach(o=>{o.addEventListener("click",async()=>{const c=o.getAttribute("data-val");await navigator.clipboard.writeText(c),o.classList.add("ok");const d=o.textContent;o.textContent="✓ kopiert",setTimeout(()=>{o.classList.remove("ok"),o.textContent=d},1200)})})}s()}function Cn(e){return e.length?`
    <table class="table">
      ...
      <tbody>
        ${e.map(t=>{const a=j(t.ist),n=`${w(z(t.datum))}	${a}`;return`
            <tr data-copy="${Ke(n)}">
...
Personalnummer {personalnr}`}};function st(e,t){const a=be[e];return a?{...a,...t??{}}:null}function it(e,t){const a=Ce(e.text,t);return{betreff:Ce(e.betreff,t),text:a}}function Ce(e,t){return e.replace(/\{(\w+)\}/g,(a,n)=>t[n]!=null?String(t[n]):`{${n}}`)}function Vn(e,t){const a=t.datum?new Date(t.datum):null,n=a?qe(a).split(", ")[1]:"";return{name:e.name||"Ihr Mitarbeiter",personalnr:e.personalnummer||"—",kostenstelle:e.kostenstelle||"—",datum:n,wochentag:Rn[t.wochentag]??t.wochentag??"",zeitwirtschaft_anrede:e.zeitwirtschaftAnrede||"Frau Kanarya",zeitwirtschaft_email:e.zeitwirtschaftEmail||"zeitwirtschaft@putzmeister.com",ist:t.ist!=null?t.ist.toFixed(2).replace(".",","):"",soll:t.soll!=null?t.soll.toFixed(2).replace(".",","):"",abgezogen:t.abgezogen!=null?Math.round(t.abgezogen*60):"",gestempelt:t.gestempelt!=null?Math.round(t.gestempelt*60):"",verlust:t.verlustMinuten??""}}function jn(e,t,a){const n=it(t,a),s=e.zeitwirtschaftEmail||"zeitwirtschaft@putzmeister.com",i=new URLSearchParams;return i.set("subject",n.betreff),i.set("body",n.text),`mailto:${encodeURIComponent(s)}?${i.toString().replace(/\+/g,"%20")}`}async function _n({root:e}){const[t,a,n,s]=await Promise.all([F(),R(),ee(),Ut()]),i=Object.fromEntries(s.map(o=>[o.key,o])),r=me(t,a,new Date).filter(o=>o.mailVorlageKey),l=Xe(n);e.innerHTML=`
    ...
    <div class="card" style="margin-bottom: 24px;">
      ...
      ${r.length===0?'<div class="empty-state"><div class="empty-state-icon">✓</div><p>Keine akuten Warnungen — top.</p></div>':r.map(o=>Hn(o,a,i)).join("")}
    ...
    <div class="card">
      ...
      <div id="vorlagen-editor">
        ${Object.keys(be).map(o=>{const c=st(o,i[o]);return Zn(c)}).join("")}
      </div>
    </div>
  `,Gn(e),Nn(e)}function Hn(e,t,a){const n=st(e.mailVorlageKey,a[e.mailVorlageKey]);if(!n)return"";const s=Vn(t,e),i=it(n,s),r=jn(t,n,s);return`
...
${T(i.text)}
  ...
  `}function Gn(e){e.querySelectorAll(".btn-save-vorlage").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-key"),n=t.closest(".vorlagen-item"),s=n.querySelector(".v-betreff").value,i=n.querySelector(".v-text").value;await xe(a,{betreff:s,text:i}),x("Vorlage gespeichert.")})}),e.querySelectorAll(".btn-reset-vorlage").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-key"),n=be[a];n&&confirm(`Vorlage "${n.titel}" auf Default zurücksetzen?`)&&(await xe(a,{betreff:n.betreff,text:n.text}),x("Zurückgesetzt."),setTimeout(()=>location.reload(),400))})})}function Nn(e){e.querySelectorAll(".btn-copy-mail").forEach(t=>{t.addEventListener("click",async()=>{const a=t.getAttribute("data-subject"),n=t.getAttribute("data-body"),s=`Betreff: ${a}

${n}`;await navigator.clipboard.writeText(s),x("Mail-Text kopiert.")})})}function T(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function ue(e){return T(e)}async function qn({root:e}){const t=je(),a=await R();e.innerHTML=`
  ...
  `,e.querySelectorAll("[data-theme]").forEach(n=>{n.addEventListener("click",()=>{const s=n.getAttribute("data-theme");ge(s),e.querySelectorAll("[data-theme]").forEach(i=>i.classList.toggle("active",i===n)),x(`Theme: ${n.textContent.trim()}`)})}),e.querySelector("#pause-sel").addEventListener("change",async n=>{const s={...a,pausenRegel:n.target.value};await he(s),x("Pausen-Regel gespeichert.")})}async function Oe(){var t;Lt();const e=document.getElementById("content");(t=document.getElementById("theme-toggle"))==null||t.addEventListener("click",()=>Et()),Wt(()=>{It()}),await Rt()&&setTimeout(()=>{pe('Parser wurde aktualisiert. Bitte lade deinen Zeitnachweis unter "Daten" neu hoch.',{type:"info",duration:12e3})},500),D("/",De),D("/dashboard",De),D("/analytics",Fn),D("/monat",Mn),D("/monat/:yyyymm",$n),D("/woche",An),D("/woche/:yyyykw",Pn),D("/tag/:datum",En),D("/berichtsheft",Kn),D("/mails",_n),D("/profil",wn),D("/daten",mn),D("/einstellungen",qn),Ct(e),location.hash||Kt("/")}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Oe):Oe();
