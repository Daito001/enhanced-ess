...
import{C as Q,L as va,B as ya,D as wa,S as ka,a as xa,b as $a,P as Sa,A as Ma,c as za,d as Aa,T as Da,p as Pa,e as Ea,i as Ta}from"./chartjs-CRgZvhTJ.js";import{b as kt,a as Oe,c as Ne,d as Fa,f as L,s as Sn,e as Mn,g as zn,p as La,h as _a,i as Ue,j as Je,k as W,l as An,q as Ca,m as Ba,n as Oa,o as Na}from"./datefns-C8_rfWt_.js";import{D as Wa}from"./dexie-UpTFNL8S.js";import{GlobalWorkerOptions as Dn,getDocument as Pn}from"./pdfjs-BnPRJEQ6.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&a(l)}).observe(document,{childList:!0,subtree:!0});function n(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(s){if(s.ep)return;s.ep=!0;const i=n(s);fetch(s.href,i)}})();function Ka(){document.documentElement.setAttribute("data-theme","dark")}const en={lessThanXSeconds:{standalone:{one:"weniger als 1 Sekunde",other:"weniger als {{count}} Sekunden"},withPreposition:{one:"weniger als 1 Sekunde",other:"weniger als {{count}} Sekunden"}},xSeconds:{standalone:{one:"1 Sekunde",other:"{{count}} Sekunden"},withPreposition:{one:"1 Sekunde",other:"{{count}} Sekunden"}},halfAMinute:{standalone:"eine halbe Minute",withPreposition:"einer halben Minute"},lessThanXMinutes:{standalone:{one:"weniger als 1 Minute",other:"weniger als {{count}} Minuten"},withPreposition:{one:"weniger als 1 Minute",other:"weniger als {{count}} Minuten"}},xMinutes:{standalone:{one:"1 Minute",other:"{{count}} Minuten"},withPreposition:{one:"1 Minute",other:"{{count}} Minuten"}},aboutXHours:{standalone:{one:"etwa 1 Stunde",other:"etwa {{count}} Stunden"},withPreposition:{one:"etwa 1 Stunde",other:"etwa {{count}} Stunden"}},xHours:{standalone:{one:"1 Stunde",other:"{{count}} Stunden"},withPreposition:{one:"1 Stunde",other:"{{count}} Stunden"}},xDays:{standalone:{one:"1 Tag",other:"{{count}} Tage"},withPreposition:{one:"1 Tag",other:"{{count}} Tagen"}},aboutXWeeks:{standalone:{one:"etwa 1 Woche",other:"etwa {{count}} Wochen"},withPreposition:{one:"etwa 1 Woche",other:"etwa {{count}} Wochen"}},xWeeks:{standalone:{one:"1 Woche",other:"{{count}} Wochen"},withPreposition:{one:"1 Woche",other:"{{count}} Wochen"}},aboutXMonths:{standalone:{one:"etwa 1 Monat",other:"etwa {{count}} Monate"},withPreposition:{one:"etwa 1 Monat",other:"etwa {{count}} Monaten"}},xMonths:{standalone:{one:"1 Monat",other:"{{count}} Monate"},withPreposition:{one:"1 Monat",other:"{{count}} Monaten"}},aboutXYears:{standalone:{one:"etwa 1 Jahr",other:"etwa {{count}} Jahre"},withPreposition:{one:"etwa 1 Jahr",other:"etwa {{count}} Jahren"}},xYears:{standalone:{one:"1 Jahr",other:"{{count}} Jahre"},withPreposition:{one:"1 Jahr",other:"{{count}} Jahren"}},overXYears:{standalone:{one:"mehr als 1 Jahr",other:"mehr als {{count}} Jahre"},withPreposition:{one:"mehr als 1 Jahr",other:"mehr als {{count}} Jahren"}},almostXYears:{standalone:{one:"fast 1 Jahr",other:"fast {{count}} Jahre"},withPreposition:{one:"fast 1 Jahr",other:"fast {{count}} Jahren"}}},Va=(e,t,n)=>{let a;const s=n!=null&&n.addSuffix?en[e].withPreposition:en[e].standalone;return typeof s=="string"?a=s:t===1?a=s.one:a=s.other.replace("{{count}}",String(t)),n!=null&&n.addSuffix?n.comparison&&n.comparison>0?"in "+a:"vor "+a:a},Ia={full:"EEEE, do MMMM y",long:"do MMMM y",medium:"do MMM y",short:"dd.MM.y"},Ha={full:"HH:mm:ss zzzz",long:"HH:mm:ss z",medium:"HH:mm:ss",short:"HH:mm"},Ra={full:"{{date}} 'um' {{time}}",long:"{{date}} 'um' {{time}}",medium:"{{date}} {{time}}",short:"{{date}} {{time}}"},qa={date:kt({formats:Ia,defaultWidth:"full"}),time:kt({formats:Ha,defaultWidth:"full"}),dateTime:kt({formats:Ra,defaultWidth:"full"})},Za={lastWeek:"'letzten' eeee 'um' p",yesterday:"'gestern um' p",today:"'heute um' p",tomorrow:"'morgen um' p",nextWeek:"eeee 'um' p",other:"P"},ja=(e,t,n,a)=>Za[e],Ga={narrow:["v.Chr.","n.Chr."],abbreviated:["v.Chr.","n.Chr."],wide:["vor Christus","nach Christus"]},Ua={narrow:["1","2","3","4"],abbreviated:["Q1","Q2","Q3","Q4"],wide:["1. Quartal","2. Quartal","3. Quartal","4. Quartal"]},Pt={narrow:["J","F","M","A","M","J","J","A","S","O","N","D"],abbreviated:["Jan","Feb","Mär","Apr","Mai","Jun","Jul","Aug","Sep","Okt","Nov","Dez"],wide:["Januar","Februar","März","April","Mai","Juni","Juli","August","September","Oktober","November","Dezember"]},Ja={narrow:Pt.narrow,abbreviated:["Jan.","Feb.","März","Apr.","Mai","Juni","Juli","Aug.","Sep.","Okt.","Nov.","Dez."],wide:Pt.wide},Ya={narrow:["S","M","D","M","D","F","S"],short:["So","Mo","Di","Mi","Do","Fr","Sa"],abbreviated:["So.","Mo.","Di.","Mi.","Do.","Fr.","Sa."],wide:["Sonntag","Montag","Dienstag","Mittwoch","Donnerstag","Freitag","Samstag"]},Xa={narrow:{am:"vm.",pm:"nm.",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachm.",evening:"Abend",night:"Nacht"},abbreviated:{am:"vorm.",pm:"nachm.",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachmittag",evening:"Abend",night:"Nacht"},wide:{am:"vormittags",pm:"nachmittags",midnight:"Mitternacht",noon:"Mittag",morning:"Morgen",afternoon:"Nachmittag",evening:"Abend",night:"Nacht"}},Qa={narrow:{am:"vm.",pm:"nm.",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachm.",evening:"abends",night:"nachts"},abbreviated:{am:"vorm.",pm:"nachm.",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachmittags",evening:"abends",night:"nachts"},wide:{am:"vormittags",pm:"nachmittags",midnight:"Mitternacht",noon:"Mittag",morning:"morgens",afternoon:"nachmittags",evening:"abends",night:"nachts"}},es=e=>Number(e)+".",ts={ordinalNumber:es,era:Oe({values:Ga,defaultWidth:"wide"}),quarter:Oe({values:Ua,defaultWidth:"wide",argumentCallback:e=>e-1}),month:Oe({values:Pt,formattingValues:Ja,defaultWidth:"wide"}),day:Oe({values:Ya,defaultWidth:"wide"}),dayPeriod:Oe({values:Xa,defaultWidth:"wide",formattingValues:Qa,defaultFormattingWidth:"wide"})},ns=/^(\d+)(\.)?/i,as=/\d+/i,ss={narrow:/^(v\.? ?Chr\.?|n\.? ?Chr\.?)/i,abbreviated:/^(v\.? ?Chr\.?|n\.? ?Chr\.?)/i,wide:/^(vor Christus|vor unserer Zeitrechnung|nach Christus|unserer Zeitrechnung)/i},is={any:[/^v/i,/^n/i]},rs={narrow:/^[1234]/i,abbreviated:/^q[1234]/i,wide:/^[1234](\.)? Quartal/i},ls={any:[/1/i,/2/i,/3/i,/4/i]},os={narrow:/^[jfmasond]/i,abbreviated:/^(j[aä]n|feb|mär[z]?|apr|mai|jun[i]?|jul[i]?|aug|sep|okt|nov|dez)\.?/i,wide:/^(januar|februar|märz|april|mai|juni|juli|august|september|oktober|november|dezember)/i},cs={narrow:[/^j/i,/^f/i,/^m/i,/^a/i,/^m/i,/^j/i,/^j/i,/^a/i,/^s/i,/^o/i,/^n/i,/^d/i],any:[/^j[aä]/i,/^f/i,/^mär/i,/^ap/i,/^mai/i,/^jun/i,/^jul/i,/^au/i,/^s/i,/^o/i,/^n/i,/^d/i]},ds={narrow:/^[smdmf]/i,short:/^(so|mo|di|mi|do|fr|sa)/i,abbreviated:/^(son?|mon?|die?|mit?|don?|fre?|sam?)\.?/i,wide:/^(sonntag|montag|dienstag|mittwoch|donnerstag|freitag|samstag)/i},us={any:[/^so/i,/^mo/i,/^di/i,/^mi/i,/^do/i,/^f/i,/^sa/i]},gs={narrow:/^(vm\.?|nm\.?|Mitternacht|Mittag|morgens|nachm\.?|abends|nachts)/i,abbreviated:/^(vorm\.?|nachm\.?|Mitternacht|Mittag|morgens|nachm\.?|abends|nachts)/i,wide:/^(vormittags|nachmittags|Mitternacht|Mittag|morgens|nachmittags|abends|nachts)/i},hs={any:{am:/^v/i,pm:/^n/i,midnight:/^Mitte/i,noon:/^Mitta/i,morning:/morgens/i,afternoon:/nachmittags/i,evening:/abends/i,night:/nachts/i}},fs={ordinalNumber:Fa({matchPattern:ns,parsePattern:as,valueCallback:e=>parseInt(e)}),era:Ne({matchPatterns:ss,defaultMatchWidth:"wide",parsePatterns:is,defaultParseWidth:"any"}),quarter:Ne({matchPatterns:rs,defaultMatchWidth:"wide",parsePatterns:ls,defaultParseWidth:"any",valueCallback:e=>e+1}),month:Ne({matchPatterns:os,defaultMatchWidth:"wide",parsePatterns:cs,defaultParseWidth:"any"}),day:Ne({matchPatterns:ds,defaultMatchWidth:"wide",parsePatterns:us,defaultParseWidth:"any"}),dayPeriod:Ne({matchPatterns:gs,defaultMatchWidth:"wide",parsePatterns:hs,defaultParseWidth:"any"})},ne={code:"de",formatDistance:Va,formatLong:qa,formatRelative:ja,localize:ts,match:fs,options:{weekStartsOn:1,firstWeekContainsDate:4}};function En(e){if(e==null)return null;if(typeof e=="number")return e;let t=String(e).trim();if(!t)return null;let n=!1;t.endsWith("-")&&(n=!0,t=t.slice(0,-1).trim()),t=t.replace(",",".");const a=parseFloat(t);return isNaN(a)?null:n?-a:a}function qe(e){if(e==null||isNaN(e))return"—";const t=e<0,n=Math.abs(e),a=Math.floor(n),s=Math.round((n-a)*60);let i=a,l=s;return l===60&&(i+=1,l=0),`${t?"-":""}${i}:${String(l).padStart(2,"0")}`}function fe(e,t={}){if(e==null||isNaN(e))return"—";const{signed:n=!1,suffix:a="h"}=t,s=n&&e>0?"+":"",i=e.toFixed(2).replace(".",",");return`${s}${i}${a}`}function ms(e,t={}){if(e==null||isNaN(e))return"—";const{signed:n=!1}=t;return`${n&&e>0?"+":""}${qe(e)}`}function tn(e,t="hhmm",n={}){return t==="dezimal"?fe(e,{signed:!0,suffix:"",...n}):ms(e,{signed:!0,...n})}function ie(e){if(!e)return null;const t=/^(\d{1,2}):(\d{2})$/.exec(String(e).trim());return t?parseInt(t[1],10)*60+parseInt(t[2],10):null}function Tn(e){if(!(e!=null&&e.length))return null;const t=e.filter(s=>s.von&&s.bis);if(!t.length)return null;let n=t[0].von,a=t[0].bis;for(const s of t)ie(s.von)<ie(n)&&(n=s.von),ie(s.bis)>ie(a)&&(a=s.bis);return{kommen:n,gehen:a}}const Fn="2026-04-01";function ps(e){return e?"arbzg":"jarbschg"}function bs(e,t){return e==null?0:t==="jarbschg"?e>6?1:e>4.5?.5:0:e>9?.75:e>6?.5:0}function Ct(e){if(!e||e.length<2)return 0;const t=e.filter(a=>a.von&&a.bis).map(a=>({von:ie(a.von),bis:ie(a.bis)})).filter(a=>a.von!=null&&a.bis!=null).sort((a,s)=>a.von-s.von);let n=0;for(let a=1;a<t.length;a++){const s=t[a].von-t[a-1].bis;(s>0&&s>=15||s>0)&&(n+=s)}return n/60}function Ln(e,t){const n=e.zeitSpannen??[];if(!n.length||n.every(p=>!p.von))return{keinAnspruch:!0};const a=Ct(n),s=e.pause??0,i=vs(n),l=i-s,d=t.pausenRegel&&t.pausenRegel!=="auto"?t.pausenRegel==="jarbschg"?"jarbschg":"arbzg":ps(!!t.ueber18),c=bs(l,d);if(e.datum&&e.datum<Fn)return{arbeitszeitMitPause:i,arbeitszeitOhnePause:l,gestempeltePause:a,abgezogenePause:s,gesetzlichePflicht:c,gesetz:d,legalerAbzug:s,unrechtmaessigerVerlustMin:0,aufstockungMin:0,typ:"alt_reglement",warnung:null,altReglement:!0};const r=Math.max(a,c),o=s-r,u=Math.max(0,c-a);let h="ok",g=null;if(o>.05)h="fehler_zeitwirtschaft",g=`${Math.round(o*60)} min Pause wurden zusätzlich zur gesetzlichen Pflicht und zur gestempelten Pause abgezogen. Das sieht nach einem Zeitwirtschafts-Fehler aus.`;else if(u>.05&&s>a+.02){h="aufstockung_legal";const p=Math.round(u*60);g=`Du hast ${Math.round(a*60)} min Pause gestempelt, aber bei ${l.toFixed(2).replace(".",",")}h Arbeitszeit schreibt das Gesetz (${d.toUpperCase()}) ${Math.round(c*60)} min vor. Die fehlenden ${p} min wurden automatisch als Pause gewertet. Das ist gesetzeskonform — nächstes Mal einfach länger Pause machen.`}return{arbeitszeitMitPause:i,arbeitszeitOhnePause:l,gestempeltePause:a,abgezogenePause:s,gesetzlichePflicht:c,gesetz:d,legalerAbzug:r,unrechtmaessigerVerlustMin:Math.round(Math.max(0,o)*60),aufstockungMin:Math.round(Math.max(0,u)*60),typ:h,warnung:g,altReglement:!1}}function vs(e){let t=0;for(const n of e){if(!n.von||!n.bis)continue;const a=ie(n.von),s=ie(n.bis);a!=null&&s!=null&&s>a&&(t+=s-a)}return t/60}function _n(e,t){var c,r,o;const n=[...e].sort((u,h)=>u.datum.localeCompare(h.datum));if(!n.length)return[];const a=new Map(t.map(u=>[u.monatKey,u])),s={};for(const u of n)s[c=u.monatKey]??(s[c]=[]),s[u.monatKey].push(u);const i=Object.keys(s).sort(),l=[];let d=null;for(const u of i){const h=a.get(u);let g;((r=h==null?void 0:h.glz)==null?void 0:r.saldoVorperiode)!=null?g=h.glz.saldoVorperiode:d!=null?g=d:g=0;const p=s[u];for(const f of p)f.diff!=null&&(g+=f.diff),l.push({datum:f.datum,wochentag:f.wochentag,saldo:Math.round(g*100)/100,diff:f.diff,ist:f.ist,soll:f.soll,tagestyp:f.tagestyp,monatKey:f.monatKey,wocheKey:f.wocheKey,zeitSpannen:f.zeitSpannen});if(((o=h==null?void 0:h.glz)==null?void 0:o.saldoGesamt)!=null){const f=h.glz.saldoGesamt-g;if(Math.abs(f)>.02&&l.length>0){const v=l.length-1;l[v].umbuchung=f,l[v].saldo=Math.round((l[v].saldo+f)*100)/100,g=l[v].saldo}d=h.glz.saldoGesamt}else d=g}return l}function ys(e,t,n=0){if(!e.length)return[];if(t==="alles")return e;const a=Math.min(t,e.length),i=e.length+n*a,l=i-a;return i<=0?[]:l<0?e.slice(0,i):e.slice(l,i)}function lt(e,t){return t==="alles"||!e?0:-Math.max(0,Math.ceil(e/t)-1)}function ws(e){return e.length?e[e.length-1].saldo:0}const Cn=new Set(["Urlaub","Arbeitsunfähigkeit","Feiertag","Gleitzeit","Berufsschule","Dienstreise"]),Bn=7;function gt(e){if(!e||e.tagestyp==="Wochenende"||e.wochentag==="SA"||e.wochentag==="SO")return 0;const t=e.ist??0,n=e.soll??0;return t>0?t:Cn.has(e.tagestyp)?Math.max(n,Bn):n>0?n:t}function Bt(e){if(!e||e.tagestyp==="Wochenende"||e.wochentag==="SA"||e.wochentag==="SO")return 0;const t=e.soll??0;return t>0?t:Cn.has(e.tagestyp)?Bn:t}function ks(e){if(!e.length)return 0;const t=e[0].saldo-(e[0].diff??0),n=e[e.length-1].saldo;return Math.round((n-t)*100)/100}const xs=["SO","MO","DI","MI","DO","FR","SA"],$s=["Sonntag","Montag","Dienstag","Mittwoch","Donnerstag","Freitag","Samstag"];function Ee(e){if(!e)return null;const t=e.trim();return La(t,"dd.MM.yyyy",new Date)}function C(e){return L(e,"dd.MM.yyyy")}function Ot(e){return L(e,"EE, dd.MM.yyyy",{locale:ne})}function Ss(e){return L(e,"dd.MM.")}function Ms(e){return xs[e.getDay()]}function zs(e){return $s[e.getDay()]}function As(e){return zn(e)}function Ye(e){const t=Sn(e,{weekStartsOn:1}),n=Mn(e,{weekStartsOn:1});return`${L(t,"dd.MM.")} – ${L(n,"dd.MM.yyyy")}`}function On(e){return`${_a(e)}-${String(zn(e)).padStart(2,"0")}`}function Nt(e){return L(e,"yyyy-MM")}function Nn(e){return L(e,"yyyy-MM-dd")}function Ds(e,t){const n=[];let a=new Date(e);for(;a<=t;)Je(a)||n.push(new Date(a)),a=Ue(a,1);return n}function Wn(e,t){if(!e||!t)return 0;e>t&&([e,t]=[t,e]);let n=0,a=new Date(e);for(;a<t;)a=Ue(a,1),Je(a)||n++;return n}function M(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Ps(e){return M(e)}const Es=Object.freeze(Object.defineProperty({__proto__:null,addDays:Ue,dayKey:Nn,differenceInCalendarDays:An,endOfMonth:Ba,endOfWeek:Mn,escapeAttr:Ps,escapeHtml:M,formatGermanDate:C,formatGermanDateLong:Ot,formatShortDate:Ss,formatWocheRange:Ye,getWeekdayCode:Ms,getWeekdayName:zs,isSameDay:Oa,isWeekend:Je,isoWeek:As,monthKey:Nt,parseGermanDate:Ee,startOfMonth:Na,startOfWeek:Sn,weekKey:On,werktageAbstand:Wn,werktageZwischen:Ds},Symbol.toStringTag,{value:"Module"}));Q.register(va,ya,wa,ka,xa,$a,Sa,Ma,za,Aa,Da,Pa,Ea,Ta);function Z(e){return getComputedStyle(document.documentElement).getPropertyValue(e).trim()}function pe(){return{fg:Z("--fg"),fgMuted:Z("--fg-muted"),fgSubtle:Z("--fg-subtle"),border:Z("--border"),surface:Z("--surface"),accent:Z("--accent"),success:Z("--success"),warn:Z("--warn"),danger:Z("--danger"),info:Z("--info"),palette:[Z("--chart-1"),Z("--chart-2"),Z("--chart-3"),Z("--chart-4"),Z("--chart-5"),Z("--chart-6"),Z("--chart-7")]}}function B(e){return{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{labels:{color:e.fgMuted,font:{size:12}}},tooltip:{backgroundColor:e.surface,titleColor:e.fg,bodyColor:e.fg,borderColor:e.border,borderWidth:1,padding:10,displayColors:!0}},scales:{x:{ticks:{color:e.fgMuted,font:{size:11}},grid:{color:e.border,drawBorder:!1}},y:{ticks:{color:e.fgMuted,font:{size:11}},grid:{color:e.border,drawBorder:!1}}}}}function Wt(e,t){const n=pe();if(ve(e),!(t!=null&&t.length))return;const a=t.map(i=>L(W(i.datum),"dd.MM.")),s=t.map(i=>i.saldo);return s.map(i=>i>=0?n.success:n.danger),new Q(e,{type:"line",data:{labels:a,datasets:[{label:"Tages-Saldo",data:s,borderColor:n.accent,backgroundColor:i=>{const l=i.chart,{ctx:d,chartArea:c,scales:r}=l;return c?Kn(d,c,r.y,n):ge(n.accent,.14)},segment:{borderColor:i=>{const l=i.p0.parsed.y,d=i.p1.parsed.y,c=(l+d)/2;return c>=.02?n.success:c<=-.02?n.danger:n.fgMuted}},tension:0,pointRadius:2,pointHoverRadius:6,pointHitRadius:20,pointBackgroundColor:s.map(i=>i>=.02?n.success:i<=-.02?n.danger:n.fgMuted),pointBorderColor:n.surface,pointBorderWidth:1,fill:!0,borderWidth:2}]},options:{...B(n),interaction:{mode:"index",intersect:!1,axis:"x"},hover:{mode:"index",intersect:!1,axis:"x"},onHover:(i,l,d)=>{const c=d.getElementsAtEventForMode(i,"index",{intersect:!1},!1);d.canvas.style.cursor=c.length>0?"pointer":"default"},onClick:(i,l,d)=>{const c=d.getElementsAtEventForMode(i,"index",{intersect:!1},!1);if(c.length>0){const r=c[0].index,o=t[r];o!=null&&o.datum&&(window.location.hash=`#/tag/${o.datum}`)}},plugins:{...B(n).plugins,legend:{display:!1},tooltip:{enabled:!1,mode:"index",intersect:!1,axis:"x",position:"nearest",external:Ts(t)}},scales:{...B(n).scales,y:{...B(n).scales.y,ticks:{...B(n).scales.y.ticks,callback:i=>`${i>=0?"+":""}${i.toFixed(1).replace(".",",")}h`}}}}})}function be(e){return function(t){var f,v;const{chart:n,tooltip:a}=t;let s=n.$richTooltipEl;if(!s){s=document.createElement("div"),s.className="saldo-tooltip",document.body.appendChild(s),n.$richTooltipEl=s;const m=n.destroy.bind(n);n.destroy=function(){s.parentNode&&s.parentNode.removeChild(s),m()}}if(a.opacity===0||!((f=a.dataPoints)!=null&&f.length)){s.style.opacity="0";return}const i=e({tooltip:a,chart:n});if(!i){s.style.opacity="0";return}let l=`<div class="saldo-tooltip-title">${Et(i.title)}</div>`;for(const m of i.rows||[]){const k=m.klasse||"flat";l+=`<div class="saldo-tooltip-row"><span class="saldo-tooltip-label">${Et(m.label)}</span><span class="saldo-tooltip-value ${k}">${m.value}</span></div>`}(v=i.meta)!=null&&v.length&&(l+=`<div class="saldo-tooltip-meta">${i.meta.map(m=>`<span>${m}</span>`).join("")}</div>`),s.innerHTML=l;const d=n.canvas.getBoundingClientRect(),c=d.left+a.caretX,r=d.top+a.caretY;s.style.opacity="0",s.style.left="0px",s.style.top="0px";const o=s.offsetWidth,u=s.offsetHeight,h=18;let g=c+h;g+o>window.innerWidth-8&&(g=c-h-o);let p=r-u/2;p<8&&(p=8),p+u>window.innerHeight-8&&(p=window.innerHeight-u-8),s.style.left=g+"px",s.style.top=p+"px",s.style.opacity="1"}}function me(e){return e==null?"flat":e>.05?"pos":e<-.05?"neg":"flat"}function Se(e){return e==null?"—":(e>0?"+":"")+e.toFixed(2).replace(".",",")+"h"}function Me(e){return e==null?"—":e.toFixed(2).replace(".",",")+"h"}function Ts(e){return be(({tooltip:t})=>{const n=t.dataPoints[0].dataIndex,a=e[n];if(!a)return null;const s=[{label:"Saldo",value:Se(a.saldo),klasse:me(a.saldo)}];a.diff!=null&&s.push({label:"Tages-Diff",value:Se(a.diff),klasse:me(a.diff)});const i=[];return a.tagestyp&&i.push(`Typ: ${Et(a.tagestyp)}`),a.umbuchung&&i.push(`Umbuchung: ${a.umbuchung>=0?"+":""}${a.umbuchung.toFixed(2).replace(".",",")}h`),{title:L(W(a.datum),"EE, dd.MM.yyyy",{locale:ne}),rows:s,meta:i}})}function Et(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Fs(e,t){const n=pe();if(ve(e),!(t!=null&&t.length))return;const a=t.map(d=>d.monatKey),s=a.map(d=>{const[c,r]=d.split("-"),o=new Date(parseInt(c,10),parseInt(r,10)-1,1);return L(o,"MMM yyyy",{locale:ne})}),i=t.map(d=>{var c;return((c=d.glz)==null?void 0:c.saldoGesamt)??0}),l=t.map(d=>{var c;return((c=d.glz)==null?void 0:c.saldoVorperiode)??null});return new Q(e,{type:"line",data:{labels:s,datasets:[{label:"GLZ-Saldo (Monatsende)",data:i,borderColor:n.accent,backgroundColor:d=>{const c=d.chart,{ctx:r,chartArea:o,scales:u}=c;return o?Kn(r,o,u.y,n):ge(n.accent,.14)},segment:{borderColor:d=>{const c=d.p0.parsed.y,r=d.p1.parsed.y,o=(c+r)/2;return o>=.05?n.success:o<=-.05?n.danger:n.fgMuted}},pointBackgroundColor:i.map(d=>d>=.05?n.success:d<=-.05?n.danger:n.fgMuted),pointBorderColor:n.surface,pointBorderWidth:1,tension:0,fill:!0,pointRadius:4,pointHoverRadius:7,pointHitRadius:20}]},options:{...B(n),interaction:{mode:"index",intersect:!1,axis:"x"},hover:{mode:"index",intersect:!1,axis:"x"},onHover:(d,c,r)=>{const o=r.getElementsAtEventForMode(d,"index",{intersect:!1},!1);r.canvas.style.cursor=o.length>0?"pointer":"default"},onClick:(d,c,r)=>{const o=r.getElementsAtEventForMode(d,"index",{intersect:!1},!1);if(o.length>0){const u=o[0].index,h=a[u];h&&(window.location.hash=`#/kalender/${h}`)}},plugins:{...B(n).plugins,legend:{display:!1},tooltip:{enabled:!1,external:be(({tooltip:d})=>{const c=d.dataPoints[0].dataIndex,r=i[c],o=l[c],u=[{label:"Saldo Monatsende",value:Se(r),klasse:me(r)}];if(o!=null){const h=+(r-o).toFixed(2);u.push({label:"Vorperiode",value:Se(o),klasse:me(o)}),u.push({label:"Bewegung",value:Se(h),klasse:me(h)})}return{title:s[c],rows:u}})}}}})}function Ls(e,t){const n=pe();if(ve(e),!(t!=null&&t.length))return;const a=t.map(l=>L(W(l.datum),"dd.MM.")),s=t.map(l=>l.ist??0),i=t.map(l=>Ks(l.tagestyp,n));return new Q(e,{type:"bar",data:{labels:a,datasets:[{label:"Ist-Stunden",data:s,backgroundColor:i,borderRadius:4,borderSkipped:!1,maxBarThickness:32,categoryPercentage:.85,barPercentage:.9}]},options:{...B(n),onHover:(l,d,c)=>{const r=c.getElementsAtEventForMode(l,"nearest",{intersect:!0},!1);c.canvas.style.cursor=r.length>0?"pointer":"default"},onClick:(l,d,c)=>{const r=c.getElementsAtEventForMode(l,"nearest",{intersect:!0},!1);if(r.length>0){const o=t[r[0].index];o!=null&&o.datum&&(window.location.hash=`#/tag/${o.datum}`)}},plugins:{...B(n).plugins,legend:{display:!1},tooltip:{enabled:!1,external:be(({tooltip:l})=>{const d=l.dataPoints[0].dataIndex,c=t[d],r=[{label:"Ist",value:Me(c.ist),klasse:"flat"}];c.soll!=null&&r.push({label:"Soll",value:Me(c.soll),klasse:"flat"}),c.diff!=null&&r.push({label:"Diff",value:Se(c.diff),klasse:me(c.diff)});const o=c.tagestyp?[`Typ: ${c.tagestyp}`]:[];return{title:L(W(c.datum),"EE, dd.MM.yyyy",{locale:ne}),rows:r,meta:o}})}},scales:{...B(n).scales,y:{...B(n).scales.y,suggestedMin:0,suggestedMax:10}}}})}function nn(e,t){const n=pe();if(ve(e),!(t!=null&&t.length))return;const a=t.filter(r=>{var o;return((o=r.zeitSpannen)==null?void 0:o.length)&&r.zeitSpannen.some(u=>u.von&&u.bis)}).map(r=>{const o=r.zeitSpannen.filter(g=>g.von&&g.bis).map(g=>({von:ie(g.von),bis:ie(g.bis),vonStr:g.von,bisStr:g.bis})).filter(g=>g.von!=null&&g.bis!=null);if(o.length===0)return null;const u=Math.min(...o.map(g=>g.von)),h=Math.max(...o.map(g=>g.bis));return{...r,_spans:o,_minVon:u,_maxBis:h}}).filter(Boolean);if(!a.length)return;const s=r=>r.ist==null?n.fgMuted:r.ist>=7?n.success:n.danger,i={label:"Tages-Rahmen",data:a.map(r=>[r._minVon,r._maxBis]),backgroundColor:a.map(s),borderColor:a.map(s),borderWidth:0,borderRadius:4,borderSkipped:!1,barPercentage:.7,categoryPercentage:.9,maxBarThickness:18},l=Math.max(0,Math.floor(Math.min(...a.map(r=>r._minVon))/60)*60-60),d=Math.min(24*60,Math.ceil(Math.max(...a.map(r=>r._maxBis))/60)*60+60),c=r=>`${String(Math.floor(r/60)).padStart(2,"0")}:${String(r%60).padStart(2,"0")}`;return new Q(e,{type:"bar",data:{labels:a.map(r=>L(W(r.datum),"dd.MM.")),datasets:[i]},options:{...B(n),interaction:{mode:"index",intersect:!1,axis:"x"},onHover:(r,o,u)=>{const h=u.getElementsAtEventForMode(r,"index",{intersect:!1},!1);u.canvas.style.cursor=h.length>0?"pointer":"default"},onClick:(r,o,u)=>{const h=u.getElementsAtEventForMode(r,"index",{intersect:!1},!1);if(h.length>0){const g=a[h[0].index];g!=null&&g.datum&&(window.location.hash=`#/tag/${g.datum}`)}},plugins:{legend:{display:!1},tooltip:{enabled:!1,external:be(({tooltip:r})=>{const o=a[r.dataPoints[0].dataIndex],u=[];o.ist!=null&&u.push({label:"Ist",value:Me(o.ist),klasse:me(o.ist-7)}),o.soll!=null&&u.push({label:"Soll",value:Me(o.soll)});const h=[`Rahmen: ${c(o._minVon)} – ${c(o._maxBis)}`];return o._spans.length>1&&o._spans.forEach((g,p)=>h.push(`Block ${p+1}: ${g.vonStr} – ${g.bisStr}`)),o.pause!=null&&h.push(`Pause: ${Math.round(o.pause*60)} min`),{title:L(W(o.datum),"EE, dd.MM.yyyy",{locale:ne}),rows:u,meta:h}})}},scales:{x:{ticks:{color:n.fgMuted,font:{size:10},maxRotation:60,minRotation:60,autoSkip:!0,maxTicksLimit:40},grid:{display:!1}},y:{min:l,max:d,ticks:{color:n.fgMuted,stepSize:60,callback:r=>c(r)},grid:{color:n.border}}}}})}function _s(e,t){const n=pe();ve(e);const a={};for(const l of t){if(l.tagestyp!=="Stempelzeit"||!l.zeitSpannen||l.zeitSpannen.length<2)continue;const d=Ct(l.zeitSpannen);if(d<=0)continue;const c=Math.round(d*60),r=Math.floor(c/15)*15;a[r]=(a[r]??0)+1}const s=Object.keys(a).map(Number).sort((l,d)=>l-d),i=s.map(l=>a[l]);return new Q(e,{type:"bar",data:{labels:s.map(l=>`${l}–${l+14} min`),datasets:[{label:"Häufigkeit",data:i,backgroundColor:n.palette[1],borderRadius:4}]},options:{...B(n),onHover:(l,d,c)=>{const r=c.getElementsAtEventForMode(l,"nearest",{intersect:!0},!1);c.canvas.style.cursor=r.length>0?"pointer":"default"},onClick:(l,d,c)=>{const r=c.getElementsAtEventForMode(l,"nearest",{intersect:!0},!1);if(r.length>0){const o=s[r[0].index];o!=null&&(window.location.hash=`#/kalender/pause/${o}`)}},plugins:{...B(n).plugins,legend:{display:!1},tooltip:{enabled:!1,external:be(({tooltip:l})=>{const d=l.dataPoints[0].dataIndex;return{title:"Pause-Länge "+(s[d]!=null?`${s[d]}–${s[d]+14} min`:""),rows:[{label:"Häufigkeit",value:`${i[d]} Tag${i[d]===1?"":"e"}`}]}})}}}})}function Cs(e,t){const n=pe();ve(e);const a=["MO","DI","MI","DO","FR"],s={},i={};for(const c of a)s[c]=0,i[c]=0;for(const c of t)a.includes(c.wochentag)&&(c.ist==null||c.ist===0||(s[c.wochentag]+=c.ist,i[c.wochentag]+=1));const l=a.map(c=>i[c]>0?s[c]/i[c]:0),d={id:"wochentag-datalabels",afterDatasetsDraw(c){const{ctx:r,data:o,scales:u}=c;r.save(),r.fillStyle=n.fg,r.font="600 12px system-ui",r.textAlign="center",r.textBaseline="bottom",c.getDatasetMeta(0).data.forEach((g,p)=>{const f=o.datasets[0].data[p];if(!f||f===0)return;const v=f.toFixed(2).replace(".",",")+"h";r.fillText(v,g.x,g.y-6)}),r.restore()}};return new Q(e,{type:"bar",data:{labels:["Montag","Dienstag","Mittwoch","Donnerstag","Freitag"],datasets:[{label:"Ø Ist-Stunden",data:l,backgroundColor:n.palette[2],borderRadius:4,maxBarThickness:56,categoryPercentage:.7,barPercentage:.8}]},options:{...B(n),layout:{padding:{top:24}},onHover:(c,r,o)=>{const u=o.getElementsAtEventForMode(c,"nearest",{intersect:!0},!1);o.canvas.style.cursor=u.length>0?"pointer":"default"},onClick:(c,r,o)=>{const u=o.getElementsAtEventForMode(c,"nearest",{intersect:!0},!1);if(u.length>0){const h=a[u[0].index];h&&(window.location.hash=`#/kalender/wochentag/${h}`)}},plugins:{...B(n).plugins,legend:{display:!1},tooltip:{enabled:!1,external:be(({tooltip:c})=>{const r=c.dataPoints[0].dataIndex,o=a[r];return{title:["Montag","Dienstag","Mittwoch","Donnerstag","Freitag"][r],rows:[{label:"Ø Stunden",value:Me(l[r])},{label:"Anzahl Tage",value:String(i[o]||0)}]}})}},scales:{...B(n).scales,y:{...B(n).scales.y,suggestedMax:Math.max(...l)*1.15}}},plugins:[d]})}function Bs(e,t){const n=pe();ve(e);const a={};for(const l of t)!l.tagestyp||l.tagestyp==="Wochenende"||(a[l.tagestyp]=(a[l.tagestyp]??0)+1);const s=Object.keys(a),i=Object.values(a);return new Q(e,{type:"doughnut",data:{labels:s,datasets:[{data:i,backgroundColor:s.map((l,d)=>n.palette[d%n.palette.length]),borderColor:n.surface,borderWidth:2}]},options:{responsive:!0,maintainAspectRatio:!1,onHover:(l,d,c)=>{const r=c.getElementsAtEventForMode(l,"nearest",{intersect:!0},!1);c.canvas.style.cursor=r.length>0?"pointer":"default"},onClick:(l,d,c)=>{const r=c.getElementsAtEventForMode(l,"nearest",{intersect:!0},!1);if(r.length>0){const o=s[r[0].index];o&&(window.location.hash=`#/kalender/typ/${encodeURIComponent(o)}`)}},plugins:{legend:{position:"right",labels:{color:n.fgMuted,font:{size:12}}},tooltip:{enabled:!1,external:be(({tooltip:l})=>{const d=l.dataPoints[0].dataIndex,c=i.reduce((o,u)=>o+u,0),r=c?i[d]/c*100:0;return{title:s[d],rows:[{label:"Anzahl",value:`${i[d]} Tag${i[d]===1?"":"e"}`},{label:"Anteil",value:r.toFixed(1).replace(".",",")+"%"}]}})}}}})}function Os(e,t){const n=pe();ve(e);const a={};for(const o of t){const u=o.wocheKey;a[u]??(a[u]={ist:0,soll:0,days:0,ersterTag:null,monatKey:null}),a[u].ist+=gt(o),a[u].soll+=Bt(o),a[u].days++,(!a[u].ersterTag||o.datum&&o.datum<a[u].ersterTag)&&(a[u].ersterTag=o.datum,a[u].monatKey=o.monatKey)}const s=Object.keys(a).sort();if(!s.length)return;const i=s.map(o=>+a[o].ist.toFixed(2)),l=s.map(o=>+a[o].soll.toFixed(2)),d=s.map(o=>{const u=a[o].ersterTag;return u?Ye(W(u)):""}),c=i.map((o,u)=>o>=l[u]+.1?n.success:o<=l[u]-.1?n.danger:n.fgMuted),r={id:"wochenstunden-soll-linie",afterDatasetsDraw(o){const{ctx:u,scales:h}=o;h.x;const g=h.y;u.save(),u.strokeStyle=n.fgSubtle||n.fgMuted,u.lineWidth=1,u.setLineDash([4,4]),u.beginPath(),o.getDatasetMeta(0).data.forEach((f,v)=>{const m=f.x,k=f.width/2+2,x=g.getPixelForValue(l[v]??35);u.moveTo(m-k,x),u.lineTo(m+k,x)}),u.stroke(),u.restore()}};return new Q(e,{type:"bar",data:{labels:s.map(o=>"KW "+o.split("-")[1]),datasets:[{label:"Wochenstunden",data:i,backgroundColor:c.map(o=>ge(o,.55)),borderColor:c,borderWidth:1.5,borderRadius:4,maxBarThickness:32,categoryPercentage:.85,barPercentage:.9}]},options:{...B(n),onHover:(o,u,h)=>{const g=h.getElementsAtEventForMode(o,"nearest",{intersect:!0},!1);h.canvas.style.cursor=g.length>0?"pointer":"default"},onClick:(o,u,h)=>{var p;const g=h.getElementsAtEventForMode(o,"nearest",{intersect:!0},!1);if(g.length>0){const f=g[0].index,v=s[f],m=v?(p=a[v])==null?void 0:p.monatKey:null;v&&m?window.location.hash=`#/kalender/${m}/${v}`:v&&(window.location.hash="#/kalender")}},plugins:{...B(n).plugins,legend:{display:!1},tooltip:{enabled:!1,external:be(({tooltip:o})=>{const u=o.dataPoints[0].dataIndex,h=s[u],g=i[u],p=l[u],f=+(g-p).toFixed(2),v=d[u];return{title:v?"KW "+h.split("-")[1]+" · "+v:"KW "+h.split("-")[1]+" · "+h.split("-")[0],rows:[{label:"Ist",value:Me(g),klasse:"flat"},{label:"Soll",value:Me(p),klasse:"flat"},{label:"Diff",value:Se(f),klasse:me(f)}]}})}},scales:{...B(n).scales,y:{...B(n).scales.y,beginAtZero:!0,ticks:{...B(n).scales.y.ticks,callback:o=>`${o.toFixed(0)}h`}}}},plugins:[r]})}function ve(e){const t=Q.getChart(e);t&&t.destroy()}function Ns(){if(Q.instances){for(const e of Object.values(Q.instances))if(e!=null&&e.canvas&&!document.body.contains(e.canvas))try{e.destroy()}catch{}}document.querySelectorAll(".saldo-tooltip").forEach(e=>e.remove())}function ge(e,t){const n=e.replace("#","").trim();if(n.length!==6&&n.length!==3)return e;const a=n.length===3?n.split("").map(d=>d+d).join(""):n,s=parseInt(a.slice(0,2),16),i=parseInt(a.slice(2,4),16),l=parseInt(a.slice(4,6),16);return`rgba(${s}, ${i}, ${l}, ${t})`}function Kn(e,t,n,a){return Ws(e,t,n,0,a)}function Ws(e,t,n,a,s){const{top:i,bottom:l}=t,d=e.createLinearGradient(0,i,0,l),c=n.min,r=n.max,o=r-c;if(o<=0)return ge(s.success,.14);let u=(r-a)/o;return u=Math.max(0,Math.min(1,u)),d.addColorStop(0,ge(s.success,.28)),d.addColorStop(Math.max(0,u-.001),ge(s.success,.06)),d.addColorStop(Math.min(1,u+.001),ge(s.danger,.06)),d.addColorStop(1,ge(s.danger,.28)),d}function Ks(e,t){const n=String(e??"").toLowerCase();return n.includes("stempel")?t.palette[0]:n.includes("berufs")?t.palette[1]:n.includes("urlaub")?t.palette[2]:n.includes("feiertag")?t.fgSubtle:n.includes("dienst")?t.palette[3]:n.includes("krank")?t.palette[4]:t.palette[5]}const Vn=[];let In=null;function j(e,t){const n=e.split("/").filter(Boolean),a=[],s=new RegExp("^/?"+n.map(i=>i.startsWith(":")?(a.push(i.slice(1)),"([^/]+)"):qs(i)).join("/")+"/?$");Vn.push({pattern:e,regex:s,paramNames:a,render:t})}function Vs(e){e.startsWith("#")||(e="#"+e),window.location.hash===e?re():window.location.hash=e}function Is(e,{onNavigate:t}={}){window.addEventListener("hashchange",re),re.rootEl=e,re.onNavigate=t,re()}async function re(){var a;Ns();const e=re.rootEl,t=window.location.hash.slice(1)||"/",n=t.startsWith("/")?t:`/${t}`;for(const s of Vn){const i=s.regex.exec(n);if(i){const l={};s.paramNames.forEach((d,c)=>l[d]=decodeURIComponent(i[c+1])),In=n,(a=re.onNavigate)==null||a.call(re,n),Hs(n);try{e.classList.remove("view-enter"),await s.render({params:l,path:n,root:e}),e.classList.add("view-enter")}catch(d){console.error("Route render error:",d),e.innerHTML=`<div class="empty-state">
  ...
  `:'<span class="kg-empty">—</span>'}function jn(e){var o;const t=e.filter(u=>u.tagestyp==="Berufsschule");if(t.length<2)return{wochentageWoechentlich:[],wochentage14Taegig:[],referenzDatum14Taegig:null,stundenProTag:null,halbtags:!1};const n={};for(const u of t)n[o=u.wochentag]??(n[o]=[]),n[u.wochentag].push(u);const a=[],s=[];let i=null;for(const[u,h]of Object.entries(n)){if(h.sort((f,v)=>f.datum.localeCompare(v.datum)),h.length<2)continue;const g=[];for(let f=1;f<h.length;f++)g.push(An(W(h[f].datum),W(h[f-1].datum)));const p=rn(g);p<=10?a.push(u):p<=18&&(s.push(u),(!i||W(h[0].datum)<W(i))&&(i=h[0].datum))}const l=t.map(u=>u.ist).filter(u=>u!=null&&u>0),d=rn(l),c=d!=null?Math.round(d*4)/4:null,r=c!=null&&c<5;return{wochentageWoechentlich:a,wochentage14Taegig:s,referenzDatum14Taegig:i,stundenProTag:c,halbtags:r}}function rn(e){if(!e.length)return null;const t=e.slice().sort((a,s)=>a-s),n=Math.floor(t.length/2);return t.length%2?t[n]:(t[n-1]+t[n])/2}function mt(e,t){var s,i;if(!t)return!1;const a=["SO","MO","DI","MI","DO","FR","SA"][e.getDay()];if((s=t.wochentageWoechentlich)!=null&&s.includes(a))return!0;if((i=t.wochentage14Taegig)!=null&&i.includes(a)&&t.referenzDatum14Taegig){const l=W(t.referenzDatum14Taegig),d=Ca(e,l,{weekStartsOn:1});if(d>=0&&d%2===0)return!0}return!1}function Gn(e,t=null){return(e==null?void 0:e.halbtags)===!0&&(e==null?void 0:e.stundenProTag)!=null&&e.stundenProTag>0?e.stundenProTag:t}const ui=Object.freeze(Object.defineProperty({__proto__:null,erkenneBerufsschulMuster:jn,erwarteteBerufsschulStunden:Gn,istBerufsschulTagLautMuster:mt},Symbol.toStringTag,{value:"Module"})),We={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"};function pt(e,t,n,a=new Set,s={}){var g,p;const i=s.isAzubi!==!1,l=[],d=n??new Date,c=new Map(e.map(f=>[f.datum,f]));if(!e.length)return l;const r=W(e[0].datum),o=d,u=L(o,"yyyy-MM-dd");for(let f=new Date(r);f<=o;f=Ue(f,1)){if(Je(f))continue;const v=L(f,"yyyy-MM-dd"),m=c.get(v),k=Wn(f,o),x=v===u,P=!m||!m.tagestyp&&!m.ist&&(((g=m.zeitSpannen)==null?void 0:g.length)??0)===0;if(!(x&&P)){if(P){if(i&&mt(f,t.berufsschulMuster)){const $=k>=4?"error":k>=2?"warn":"info";Ke(l,a,{datum:v,wochentag:(m==null?void 0:m.wochentag)??nt(f),typ:"bs_tag_fehlt",schweregrad:$,titel:`Berufsschultag nicht eingetragen: ${C(f)}`,beschreibung:`Laut deinem Profil hast du am ${We[nt(f)]}, ${C(f)} Berufsschule. Im Zeitnachweis fehlt der Tag bisher${k>=4?" — bitte bei der Zeitwirtschaft nachhaken":""}.`,alter:k,mailVorlageKey:$==="error"?"bs_tag_fehlt":null})}else{const $=k>=4?"error":k>=2?"warn":"info";Ke(l,a,{datum:v,wochentag:nt(f),typ:"stempelzeit_fehlt",schweregrad:$,titel:`Keine Stempelzeit am ${C(f)}`,beschreibung:`Am ${We[nt(f)]}, ${C(f)} wurde keine Stempelzeit erfasst. Falls du an diesem Tag im Haus warst, sollte die Zeitwirtschaft das nachtragen${k>=4?" — es ist inzwischen ≥4 Werktage her":""}.`,alter:k,mailVorlageKey:$==="error"?"stempelzeit_fehlt":null})}continue}if(i&&m.tagestyp==="Berufsschule"&&m.ist!=null){const $=Gn(t.berufsschulMuster,m.soll);$!=null&&m.ist<$-.5&&Ke(l,a,{datum:v,wochentag:m.wochentag,typ:"bs_stunden_falsch",schweregrad:"error",titel:`Berufsschultag mit zu wenig Stunden: ${C(f)}`,beschreibung:`Am ${We[m.wochentag]}, ${C(f)} sind nur ${m.ist.toFixed(2).replace(".",",")}h gebucht statt der für dich üblichen ${$.toFixed(2).replace(".",",")}h. Die Zeitwirtschaft hat den Berufsschultag möglicherweise nur halb erfasst.`,ist:m.ist,soll:$,mailVorlageKey:"bs_stunden_falsch"})}if(m.tagestyp==="Stempelzeit"&&((p=m.zeitSpannen)==null?void 0:p.length)>1&&v>=Fn){const $=Ln(m,t);($==null?void 0:$.typ)==="fehler_zeitwirtschaft"&&$.unrechtmaessigerVerlustMin>=5?Ke(l,a,{datum:v,wochentag:m.wochentag,typ:"pausen_abzug",schweregrad:$.unrechtmaessigerVerlustMin>=15?"error":"warn",titel:`Pausen-Abzug fehlerhaft (${C(f)})`,beschreibung:`Am ${We[m.wochentag]}, ${C(f)} wurden ${Math.round($.abgezogenePause*60)} min Pause abgezogen. Gestempelt: ${Math.round($.gestempeltePause*60)} min, gesetzlich nötig (${$.gesetz.toUpperCase()}): ${Math.round($.gesetzlichePflicht*60)} min. Differenz von ${$.unrechtmaessigerVerlustMin} min ist unerklärlich.`,verlustMinuten:$.unrechtmaessigerVerlustMin,abgezogen:$.abgezogenePause,gestempelt:$.gestempeltePause,mailVorlageKey:"pausen_abzug"}):($==null?void 0:$.typ)==="aufstockung_legal"&&$.aufstockungMin>=10&&Ke(l,a,{datum:v,wochentag:m.wochentag,typ:"pausen_aufstockung",schweregrad:"info",titel:`Zu wenig Pause gestempelt (${C(f)}) — ${$.aufstockungMin} min automatisch aufgestockt`,beschreibung:`Am ${We[m.wochentag]}, ${C(f)} hast du nur ${Math.round($.gestempeltePause*60)} min Pause gemacht. Gesetz (${$.gesetz.toUpperCase()}) schreibt ${Math.round($.gesetzlichePflicht*60)} min vor. Fehlende ${$.aufstockungMin} min wurden als Pause gewertet — das ist legal, aber du verlierst dadurch Arbeitszeit. Tipp: mach beim nächsten Mal etwas länger Mittag.`})}}}const h={error:0,warn:1,info:2};return l.sort((f,v)=>{const m=h[f.schweregrad]-h[v.schweregrad];return m!==0?m:v.datum.localeCompare(f.datum)}),l}function Un(e,t=new Set){var a,s,i,l;const n=[];for(const d of e){const c=((a=d.glz)==null?void 0:a.saldoVorperiode)??0,r=((s=d.glz)==null?void 0:s.saldoAktuellePeriode)??0,o=((i=d.glz)==null?void 0:i.umgebuchteStunden)??0,u=(l=d.glz)==null?void 0:l.saldoGesamt;if(u==null)continue;const h=c+r+o,g=Math.abs(u-h);if(g>.03){const p=`${d.monatKey}-saldo_plausi`;t.has(p)||n.push({datum:`${d.monatKey}-01`,wochentag:"",typ:"saldo_plausi",schweregrad:"warn",titel:`Saldo-Differenz im Monat ${d.monatKey}`,beschreibung:`Rechnung: Vorperiode ${c.toFixed(2)} + aktuelle Periode ${r.toFixed(2)} + umgebucht ${o.toFixed(2)} = ${h.toFixed(2)}, aber dein Saldo wird mit ${u.toFixed(2)} angezeigt. Abweichung: ${g.toFixed(2)}h.`,soll:h,ist:u})}}return n}function Ke(e,t,n){const a=`${n.datum}-${n.typ}`;t.has(a)||(n.id=a,e.push(n))}function nt(e){return["SO","MO","DI","MI","DO","FR","SA"][e.getDay()]}const gi={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"},je={bs_tag_fehlt:{key:"bs_tag_fehlt",titel:"Berufsschultag fehlt",beschreibung:"Wenn ein Berufsschultag komplett nicht im Zeitnachweis eingetragen wurde.",betreff:"Bitte um Zeitkorrektur im ESS  - Fehlender Berufsschultag {datum}",text:`Guten Tag {zeitwirtschaft_anrede},
...
Vielen Dank!`}};function Qe(e,t){const n=je[e];return n?{...n,...t??{}}:null}function Jn(e,t){const n=ln(e.text,t);return{betreff:ln(e.betreff,t),text:n}}function ln(e,t){return e.replace(/\{(\w+)\}/g,(n,a)=>t[a]!=null?String(t[a]):`{${a}}`)}function Vt(e,t){const n=t.datum?new Date(t.datum):null;return{name:"",personalnr:"",kostenstelle:"",datum:n?Ot(n).split(", ")[1]:"",wochentag:gi[t.wochentag]??t.wochentag??"",zeitwirtschaft_anrede:e.zeitwirtschaftAnrede||"Frau Kanarya",zeitwirtschaft_email:e.zeitwirtschaftEmail||"Zeitwirtschaft.Aichtal@putzmeister.com",personal_anrede:e.personalAnrede||e.fahrtgeldAnrede||"Frau Mayer",ist:t.ist!=null?t.ist.toFixed(2).replace(".",","):"",soll:t.soll!=null?t.soll.toFixed(2).replace(".",","):"",abgezogen:t.abgezogen!=null?Math.round(t.abgezogen*60):"",gestempelt:t.gestempelt!=null?Math.round(t.gestempelt*60):"",verlust:t.verlustMinuten??""}}function It(e,t,n){const a=Jn(t,n),s=e.zeitwirtschaftEmail||"Zeitwirtschaft.Aichtal@putzmeister.com",i=new URLSearchParams;return i.set("subject",a.betreff),i.set("body",a.text),`mailto:${s}?${i.toString().replace(/\+/g,"%20")}`}let hi=0;function X(e,{type:t="info",duration:n=3500}={}){const a=document.getElementById("toast-root");if(!a)return;const s=document.createElement("div");s.className=`toast ${t}`,s.textContent=e,s.dataset.id=++hi,a.appendChild(s),setTimeout(()=>{s.style.opacity="0",s.style.transform="translateY(-8px)",s.style.transition="opacity 220ms, transform 220ms",setTimeout(()=>s.remove(),250)},n)}function ut(e){return X(e,{type:"error",duration:6e3})}function O(e){return X(e,{type:"success"})}const fi=3,mi=2.5,pi={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"};function bt(e,t={}){if(!(e!=null&&e.length))return'<p style="color: var(--fg-muted);">Keine Tage im Zeitraum.</p>';const n=new Map;for(const i of t.warnungen??[])n.has(i.datum)||n.set(i.datum,[]),n.get(i.datum).push(i);const a=[];let s=null;for(const i of e)(!s||s.key!==i.wocheKey)&&(s={key:i.wocheKey,tage:[]},a.push(s)),s.tage.push(i);return`<div class="tages-liste">${a.map(i=>bi(i,n)).join("")}</div>`}function bi(e,t){var o;const n=e.tage.reduce((u,h)=>u+gt(h),0),a=e.tage.reduce((u,h)=>u+(h.diff??0),0),s=(o=e.tage[0])==null?void 0:o.datum,i=s?Ye(W(s)):"",l=e.key?e.key.split("-")[1]:"?",d=a>.05?"pos":a<-.05?"neg":"flat",c=(a>0?"+":"")+a.toFixed(2).replace(".",",")+"h",r=n.toFixed(2).replace(".",",")+"h";return`
...
`):"",h=r?t[0].schweregrad:null;return`
    <a href="#/tag/${e.datum}" class="tag-row${r?" has-warn severity-"+h:""}">
      ...
      <div class="tag-row-ist tabular">
        ${(()=>{if(e.ist==null)return'<div class="ist-wert">—</div>';const g=qe(e.ist),[p,f]=g.split(":");return e.ist<=0?`<div class="ist-wert">${g}</div>`:`<div class="ist-display" title="Klick auf H oder M zum Kopieren">
        ...
        <div style="color: var(--fg-subtle); font-size: 11px;">Soll ${e.soll!=null?qe(e.soll):"—"}</div>
      </div>
  ...
  `}function yi(e){return pi[e]??e}function wi(e){const t={error:3,warn:2,info:1};let n=e[0];for(const a of e)(t[a.schweregrad]||0)>(t[n.schweregrad]||0)&&(n=a);return n.schweregrad==="error"?"!":n.schweregrad==="warn"?"⚠":"i"}function ki(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function Ht(e){e._istCopyAttached||(e._istCopyAttached=!0,e.addEventListener("click",async t=>{const n=t.target.closest(".ist-part");if(!n)return;t.preventDefault(),t.stopPropagation();const a=n.getAttribute("data-val");try{await navigator.clipboard.writeText(a),n._copyResetTimer&&clearTimeout(n._copyResetTimer),n.classList.add("ok"),n.textContent="✓",n._copyResetTimer=setTimeout(()=>{n.classList.remove("ok"),n.textContent=a,n._copyResetTimer=null},800)}catch{O(`Bitte kopieren: ${a}`)}}))}const xi=[{key:7,label:"1 Woche"},{key:14,label:"2 Wochen"},{key:30,label:"1 Monat"},{key:90,label:"3 Monate"},{key:180,label:"6 Monate"},{key:365,label:"1 Jahr"},{key:730,label:"2 Jahre"},{key:"alles",label:"Alles"}];function $i(e){return xi.filter(t=>t.key==="alles"||t.key<e)}async function on({root:e}){const[t,n,a,s,i,l,d,c,r]=await Promise.all([oe(),ht(),ue(),oi(),Ze("dashboardZeitraum",14),ft(),Xe(),Ze("saldoFormat","hhmm"),Le()]),o=Object.fromEntries(l.map(y=>[y.key,y]));if(a.length===0){e.innerHTML=zi();return}const u=_n(a,n),h=u.length,g=$i(h);let p=i;g.some(y=>y.key===p)||(p="alles");const f=new Set(s.map(y=>y.key)),v=d!=null&&d.stichtagAuswertung?new Date(d.stichtagAuswertung):new Date,m=pt(a,t,v,f,{isAzubi:r}),k=Un(n,f),x=[...m,...k],P=ws(u),$=P>.05?"positive":P<-.05?"negative":"";e.innerHTML=`
    ...
    <div class="saldo-hero" style="margin-bottom: 32px; align-items: stretch;">
      <div class="saldo-hero-text" style="min-width: 260px;">
        ...
        <div class="saldo-value-row">
          <div class="saldo-value ${$}" id="saldo-hero-value">${Te(tn(P,c))}</div>
    ...
    ${x.length>0?`
      <div class="card" style="margin-bottom: 32px;">
        ...
        ${x.slice(0,8).map(y=>Mi(y,t,o)).join("")}
  ...
  `;let T=0;xt(p,e,u,x,T);const N=e.querySelector("#saldo-format-toggle");N==null||N.addEventListener("click",async()=>{const b=(N.getAttribute("data-format")||"hhmm")==="hhmm"?"dezimal":"hhmm";await ct("saldoFormat",b);const S=e.querySelector("#saldo-hero-value");S&&(S.textContent=tn(P,b)),N.setAttribute("data-format",b),N.textContent=b==="hhmm"?"als Dezimal":"als Std:Min",N.title=b==="hhmm"?"Auf Dezimal umstellen":"Auf Stunden:Minuten umstellen"});const I=()=>e.querySelectorAll("#zeitraum-picker button, #zeitraum-picker-2 button");I().forEach(y=>{y.addEventListener("click",async()=>{if(y.disabled)return;const b=y.getAttribute("data-key"),S=b==="alles"?"alles":parseInt(b,10);I().forEach(F=>F.classList.toggle("active",F.getAttribute("data-key")===b)),await ct("dashboardZeitraum",S),p=S,T=0,xt(S,e,u,x,T)})});const U=y=>{if(p==="alles")return;const b=lt(u.length,p);let S=T+y;S<b&&(S=b),S>0&&(S=0),S!==T&&(T=S,xt(p,e,u,x,T))};e.querySelectorAll(".zeitraum-nav").forEach(y=>{y.addEventListener("click",b=>{const S=b.target.closest(".zeitraum-nav-btn");if(!S||S.disabled)return;const F=S.getAttribute("data-dir")==="prev"?-1:1;U(F)})}),e.addEventListener("click",async y=>{const b=y.target.closest(".ist-part");if(b){y.preventDefault(),y.stopPropagation();const H=b.getAttribute("data-val");try{await navigator.clipboard.writeText(H),b._copyResetTimer&&clearTimeout(b._copyResetTimer),b.classList.add("ok"),b.textContent="✓",b._copyResetTimer=setTimeout(()=>{b.classList.remove("ok"),b.textContent=H,b._copyResetTimer=null},800)}catch{O(`Bitte kopieren: ${H}`)}return}const S=y.target.closest(".btn-dismiss");if(!S)return;const F=S.getAttribute("data-datum"),V=S.getAttribute("data-typ");if(!F||!V)return;await li(F,V),O("Warnung ausgeblendet.");const K=S.closest(".alert");K&&(K.style.display="none")})}function xt(e,t,n,a=[],s=0){const i=ys(n,e,s),l=ks(i);requestAnimationFrame(()=>{const o=t.querySelector("#saldo-chart");Wt(o,i)});const d=t.querySelector("#hero-bewegung");if(d){const o=l>.05?"up":l<-.05?"down":"flat",u=l>.05?"↑":l<-.05?"↓":"→";d.className=`saldo-trend ${o}`,d.innerHTML=`${u} ${Math.abs(l)<.01?"Unverändert":fe(l,{signed:!0})} im Zeitraum`}const c=t.querySelector("#tage-info");if(c){const o=i.length;c.textContent=`${o} ${o===1?"Tag":"Tage"}`}const r=t.querySelector("#tage-liste");r&&(r.innerHTML=bt(i.slice().reverse(),{warnungen:a.filter(o=>i.some(u=>u.datum===o.datum))})),Si(t,i,n.length,e,s)}function cn(e){return`
  ...
  `}function Si(e,t,n,a,s){const i=e.querySelectorAll(".zeitraum-nav");if(!i.length)return;const l=a==="alles",d=l?0:lt(n,a),c=Yn(t,a);i.forEach(r=>{if(r.hidden=l,l)return;const o=r.querySelector('.zeitraum-nav-btn[data-dir="prev"]'),u=r.querySelector('.zeitraum-nav-btn[data-dir="next"]'),h=r.querySelector(".zeitraum-nav-label");o&&(o.disabled=s<=d),u&&(u.disabled=s>=0),h&&(h.textContent=c)})}function Yn(e,t=null){var c,r;if(!(e!=null&&e.length))return"—";const n=e[0].datum,a=e[e.length-1].datum,s=new Date(n),i=new Date(a),l=`${C(s)} – ${C(i)}`,d=["Januar","Februar","März","April","Mai","Juni","Juli","August","September","Oktober","November","Dezember"];if(t===7){const o=e[e.length-1].wocheKey,u=o?o.split("-")[1]:null;return u?`KW ${u} · ${l}`:l}if(t===14){const o=(c=e[0].wocheKey)==null?void 0:c.split("-")[1],u=(r=e[e.length-1].wocheKey)==null?void 0:r.split("-")[1];return o&&u&&o!==u?`KW ${o}–${u} · ${l}`:u?`KW ${u} · ${l}`:l}if(t===30)return s.getMonth()===i.getMonth()&&s.getFullYear()===i.getFullYear()?`${d[i.getMonth()]} ${i.getFullYear()} · ${l}`:`${d[s.getMonth()].slice(0,3)}–${d[i.getMonth()].slice(0,3)} ${i.getFullYear()} · ${l}`;if(t===90||t===180){const o=d[s.getMonth()].slice(0,3),u=d[i.getMonth()].slice(0,3);return`${s.getFullYear()===i.getFullYear()?`${o}–${u} ${i.getFullYear()}`:`${o} ${s.getFullYear()}–${u} ${i.getFullYear()}`} · ${l}`}return t===365?s.getFullYear()===i.getFullYear()?`Jahr ${i.getFullYear()} · ${l}`:`${i.getFullYear()-1}/${String(i.getFullYear()).slice(2)} · ${l}`:t===730?`${s.getFullYear()}–${i.getFullYear()} · ${l}`:l}function Mi(e,t,n){const a=e.schweregrad==="error"?"!":e.schweregrad==="warn"?"⚠":"i";let s=null;if(e.mailVorlageKey&&t){const i=Qe(e.mailVorlageKey,n==null?void 0:n[e.mailVorlageKey]);if(i){const l=Vt(t,e);s=It(t,i,l)}}return`
    <div class="alert severity-${e.schweregrad}">
      ...
      <div class="alert-body">
        ...
        <div class="alert-actions">
          ${s?`<a href="${$t(s)}" class="btn-mail-medium"><img src="outlook-logo.png" alt="" class="outlook-logo-medium" />E-Mail</a>`:""}
          ${e.datum&&e.datum.length===10?`<a href="#/tag/${e.datum}" class="btn sm">Tag ansehen</a>`:""}
          <button class="btn ghost sm btn-dismiss" data-datum="${$t(e.datum)}" data-typ="${$t(e.typ)}">Ausblenden</button>
        </div>
      </div>
    </div>
  `}function zi(){return`
  ...
  `}function Te(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function $t(e){return Te(e)}const Xn=""+new URL("pdf.worker.min-yatZIOMy.mjs",import.meta.url).href;Dn.workerSrc=Xn;const dn={Januar:1,Februar:2,März:3,Maerz:3,April:4,Mai:5,Juni:6,Juli:7,August:8,September:9,Oktober:10,November:11,Dezember:12},Ai=["Stempelzeit","Berufsschule Std. bez","Berufsschule","Dienstreise Arbeitszeit","Reise öff.VM/PKW Beifahr.","Reise öff.VM/PKW","Urlaub","Gleitzeit","Arbeitsunfähigkeit","TgDtEinh","Neujahr","Karfreitag","Ostermontg","Ostmontg","Osterso.","Hl.3 Kön.","Allerhlg","Pfingstmo","Fronleichn","TdDtEinh"];async function Di(e){var c,r;const n=await Pn({data:e}).promise,a=[];let s=0;for(let o=1;o<=n.numPages;o++){const h=await(await n.getPage(o)).getTextContent();s+=h.items.length;const g=Pi(h.items);for(const p of g)a.push({page:o,text:p})}const i=Ei(a),{tage:l,monate:d}=Ti(a);try{const o=await n.getMetadata();i.producer=((c=o==null?void 0:o.info)==null?void 0:c.Producer)??null,i.creator=((r=o==null?void 0:o.info)==null?void 0:r.Creator)??null}catch{}return i.totalTextItems=s,{meta:i,tage:l,monate:d}}function Pi(e){if(!e.length)return[];const t=e.slice().sort((l,d)=>{const c=d.transform[5]-l.transform[5];return Math.abs(c)>2?c:l.transform[4]-d.transform[4]}),n=[];let a=null,s=[];const i=3;for(const l of t){const d=l.transform[5];a==null||Math.abs(d-a)<=i?(s.push(l),a==null&&(a=d)):(n.push(un(s)),s=[l],a=d)}return s.length&&n.push(un(s)),n.filter(l=>l.trim().length>0)}function un(e){e.sort((a,s)=>a.transform[4]-s.transform[4]);let t="",n=-1;for(const a of e){const s=a.transform[4];n>=0&&s-n>4?t+="  ":n>=0&&s-n>.5&&(t+=" "),t+=a.str,n=s+a.width}return t}function Ei(e){var n,a;const t={personalnummer:null,name:null,kostenstelle:null,personalbereich:null,einstellungsdatum:null,mitarbeiterkreis:null,arbeitszeitplanregel:null,zeitraumVon:null,zeitraumBis:null,stichtagAuswertung:null};for(let s=0;s<e.length;s++){const i=e[s].text,l=/vom\s+(\d{2}\.\d{2}\.\d{4})\s+bis\s+(\d{2}\.\d{2}\.\d{4})/i.exec(i);l&&(t.zeitraumVon=Ee(l[1]),t.zeitraumBis=Ee(l[2]));const d=/bis einschließlich dem\s+(\d{2}\.\d{2}\.\d{4})/i.exec(i);if(d&&(t.stichtagAuswertung=Ee(d[1])),/Personalnummer/i.test(i)&&/Kostenstelle/i.test(i)){const c=(((n=e[s+1])==null?void 0:n.text)??"").trim();let r=c.split(/\s{2,}/);r.length<3&&(r=c.split(/\s+/)),r.length>=3&&/^\d/.test(r[0])&&(t.personalnummer=r[0],t.kostenstelle=r[1],t.personalbereich=r[2])}if(/Einstellungsdatum/i.test(i)&&/Mitarbeiterkreis/i.test(i)){const c=(((a=e[s+1])==null?void 0:a.text)??"").trim();let r=c.split(/\s{2,}/);r.length<3&&(r=c.split(/\s+/)),r.length>=3&&/^\d{2}\.\d{2}\.\d{4}$/.test(r[0])&&(t.einstellungsdatum=Ee(r[0]),t.mitarbeiterkreis=r[1],t.arbeitszeitplanregel=r[2])}if(/Bei Rückfragen wenden Sie sich an/i.test(i))for(let c=s+1;c<Math.min(s+8,e.length);c++){const r=e[c].text.trim();if(/^[A-ZÄÖÜ][a-zäöüß]+(?:\s[A-ZÄÖÜ][a-zäöüß]+)+$/.test(r)&&!/kanarya/i.test(r)&&!/tel/i.test(r)){t.name=r;break}}}return t}function Ti(e,t){var c;const n=[],a=[];let s=null,i=null,l=!1,d=0;for(;d<e.length;){const r=e[d].text,o=/Monat:\s*([A-Za-zäöüÄÖÜß]+)\s*-\s*(\d{4})/.exec(r);if(o){const p=o[1].trim(),f=parseInt(o[2],10),v=dn[p]??dn[p.replace("ä","ae")]??null;v&&(s={jahr:f,monat:v,monatKey:`${f}-${String(v).padStart(2,"0")}`},l=!0,i=null),d++;continue}if(/Monats.bersicht zum Stichtag\s+(\d{2}\.\d{2}\.\d{4})/i.test(r)){const p=/Monats.bersicht zum Stichtag\s+(\d{2}\.\d{2}\.\d{4})/i.exec(r),f=Ee(p[1]);i={monatKey:(s==null?void 0:s.monatKey)??Nt(f),stichtag:f,glz:{},flexi:{},zeitkonten:{},raw:{}},d=Fi(e,d+1,i),a.push(i);continue}let u=s;const h=/^(\d{2})\s+(MO|DI|MI|DO|FR|SA|SO)\b/.exec(r.trim());if(h&&s){const p=parseInt(h[1],10);l&&p>=20?u=Ci(s):p<=15&&(l=!1)}const g=gn(r,u);if(g){const p=[];let f=d+1;for(;f<e.length;){const m=e[f].text;if(/^\s*\d{4}\s+Umbuchung/.test(m)||gn(m,s)||/Wochensumme/i.test(m)||/Monats.bersicht/i.test(m)||/Monat:\s*[A-Za-z]/i.test(m))break;const k=Li(m);if(k){p.push(k),f++;continue}break}if(p.length&&g.zeitSpannen.push(...p),g.tagestyp==="Wochenende"||g.wochentag==="SA"||g.wochentag==="SO"){d=f;continue}(g.ist!=null||g.soll!=null||(((c=g.zeitSpannen)==null?void 0:c.length)??0)>0||g.tagestyp!=null)&&n.push(g),d=f;continue}d++}return{tage:n,monate:a}}function Fi(e,t,n){let a=t;const s=/(\d{4,5}|KTAU|AZAU)\s*-\s*(.+?)\s+(-?[\d,.]+-?)(?=\s+(?:\d{4,5}|KTAU|AZAU)\s*-|\s*$)/g;for(;a<e.length;){const i=e[a].text.trim();if(/^Monat:\s/.test(i)||/^Einzelergebnisse\s/.test(i)||/^Tag\b/.test(i)||/^Wochensumme/.test(i)||/^\d{2}\s+(MO|DI|MI|DO|FR|SA|SO)\b/.test(i)||/^Übersicht für den Zeitraum/i.test(i)||/^Abwesenheitsansprüche/i.test(i))break;s.lastIndex=0;let l;for(;(l=s.exec(i))!=null;){const d=l[1],c=l[2].trim(),r=En(l[3]);n.raw[d]={beschreibung:c,wert:r},d==="0008"&&(n.glz.saldoVorperiode=r),d==="8016"&&(n.glz.saldoAktuellePeriode=r),d==="9802"&&(n.glz.umgebuchteStunden=r),d==="0005"&&(n.glz.saldoGesamt=r),d==="9803"&&(n.glz.ueberzaehligeStd=r),d==="0050"&&(n.zeitkonten.produktivstunden=r),d==="9011"&&(n.flexi.jahreskontoVorperiode=r),d==="9010"&&(n.flexi.jahreskontoSaldo=r),d==="9020"&&(n.flexi.langzeitkontoSaldo=r),d==="9203"&&(n.zeitkonten.azMonatsendeUeber216=r),d==="9207"&&(n.zeitkonten.auszahlungBav=r),d==="9205"&&(n.zeitkonten.summeAuszahlung=r)}if(a++,a-t>80)break}return a}function gn(e,t){if(!t)return null;const n=e.trim(),a=/^(\d{2})\s+(MO|DI|MI|DO|FR|SA|SO)(?:\s+(.+))?$/.exec(n);if(!a)return null;const s=parseInt(a[1],10),i=a[2],l=(a[3]??"").trim();let d=t.jahr,c=t.monat;const r=new Date(d,c-1,s),o={datum:Nn(r),datumDate:r.toISOString(),wochentag:i,tagNr:s,monatKey:Nt(r),wocheKey:On(r),zeitSpannen:[],aktivitaeten:[],ist:null,soll:null,diff:null,pause:null,tazp:null,tagestyp:null,raw:n};return l?(_i(l,o),o):(o.tagestyp=["SA","SO"].includes(i)?"Wochenende":null,o)}function Li(e){const t=e.trim(),n=/^(Stempelzeit|Reise öff\.VM\/PKW Beifahr\.|Reise öff\.VM\/PKW|Dienstreise Arbeitszeit)\s+(\d{2}:\d{2})\s+(\d{2}:\d{2})\s*$/.exec(t);return n?{aktivitaet:n[1],von:n[2],bis:n[3]}:null}function _i(e,t){let n=null,a=e;for(const o of Ai)if(e.startsWith(o)){n=o,a=e.slice(o.length).trim();break}n||(n=e.split(/\s+/)[0],a=e.slice(n.length).trim()),t.tagestyp=Bi(n),t.aktivitaeten.push(n);const s=a.split(/\s+/).filter(Boolean),i=/^\d{2}:\d{2}$/,l=/^-?[\d,.]+-?$/;let d=0;for(;s[d]&&i.test(s[d])&&s[d+1]&&i.test(s[d+1]);)t.zeitSpannen.push({aktivitaet:n,von:s[d],bis:s[d+1]}),d+=2;const c=[];for(;d<s.length&&l.test(s[d]);){const o=En(s[d]);o!=null&&c.push(o),d++}let r=s[d];c.length>=5?([t.ist,t.soll,t.diff,t.pause]=c,r||(r=String(c[4]))):c.length===4?[t.ist,t.soll,t.diff,t.pause]=c:c.length===3?[t.ist,t.soll,t.diff]=c:c.length===2?[t.ist,t.soll]=c:c.length===1&&(t.ist=c[0]),r&&(t.tazp=String(r))}function Ci(e){if(!e)return null;let t=e.monat-1,n=e.jahr;return t<1&&(t=12,n-=1),{jahr:n,monat:t,monatKey:`${n}-${String(t).padStart(2,"0")}`}}function Bi(e){return e?/^Stempelzeit$/i.test(e)?"Stempelzeit":/^Berufsschule Std\. bez$/i.test(e)||/^Berufsschule$/i.test(e)?"Berufsschule":/Dienstreise/i.test(e)||/Reise/i.test(e)?"Dienstreise":/^Urlaub$/i.test(e)?"Urlaub":/^Gleitzeit$/i.test(e)?"Gleitzeit":/Arbeitsunf.higkeit/i.test(e)?"Arbeitsunfähigkeit":/^(Neujahr|Karfreitag|Ostermontg|Ostmontg|Osterso\.|Hl\.3 Kön\.|Allerhlg|Pfingstmo|Fronleichn|TdDtEinh|TgDtEinh)$/i.test(e)?"Feiertag":e:null}function le(e,t={}){const{title:n="Bestätigen",confirmLabel:a="Bestätigen",cancelLabel:s="Abbrechen",variant:i="default"}=t;return Ni({message:e,title:n,confirmLabel:a,cancelLabel:s,variant:i,kind:"confirm"})}function Oi(e,t,n={}){const{title:a="Bestätigen",confirmLabel:s="Weiter",cancelLabel:i="Abbrechen",variant:l="default",icon:d=null}=n;return new Promise(c=>{const r=document.activeElement,o=document.createElement("div");o.className="app-dialog-overlay";const u=d==="info"?`
    ...
    `,document.body.appendChild(c),requestAnimationFrame(()=>c.classList.add("is-open"));const r=c.querySelector(".app-dialog-confirm"),o=c.querySelector(".app-dialog-cancel"),u=g=>{c.classList.remove("is-open"),setTimeout(()=>{if(c.remove(),document.removeEventListener("keydown",h),d&&d.focus)try{d.focus()}catch{}l(g)},180)},h=g=>{g.key==="Escape"?(g.preventDefault(),u(!1)):g.key==="Enter"&&(g.preventDefault(),u(!0))};r==null||r.addEventListener("click",()=>u(!0)),o==null||o.addEventListener("click",()=>u(!1)),c.addEventListener("click",g=>{g.target===c&&u(!1)}),document.addEventListener("keydown",h),setTimeout(()=>r==null?void 0:r.focus(),50)})}function he(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Qn(e){return he(e).replace(/\n/g,"<br>")}const ea="better-ess-tour-completed",Rt=typeof import.meta<"u"?"./":"/",Wi=Rt+"tutorial/speichern.png",Ki=Rt+"tutorial/download.png",Vi=Rt+"tutorial/zeitraum.png",Fe=[{type:"modal",hero:!0,icon:"👋",title:"Willkommen bei Better ESS",text:"Diese App liest deinen <strong>Zeitnachweis</strong> und macht ihn auf einen Blick verständlich.<br><br>Sie <strong>warnt dich automatisch</strong> bei fehlenden Tagen, falschen Berufsschul-Stunden oder unrechtmäßigem Pausen-Abzug. Du kannst deine <strong>monatliche Fahrgelderstattungs-Excel</strong> auf Knopfdruck generieren und <strong>Korrektur-Mails an die Zeitwirtschaft</strong> mit einem Klick verschicken — Empfänger, Betreff und Text sind schon vorbefüllt."},{type:"modal",hero:!0,icon:"🔒",title:"Deine Daten bleiben bei dir",text:"Dein PDF geht <strong>nicht ins Internet</strong>.<br><br>Alles läuft lokal in deinem Browser — wie eine Notizen-App. Kein Upload, kein Server, kein Konto."},{type:"highlight",target:'a[href="#/daten"]',icon:"📂",title:"Hier startet alles",text:"Hier lädst du deinen Zeitnachweis hoch.",placement:"right",autoClick:!0,onAfterClick:async()=>{window.location.hash!=="#/daten"&&(window.location.hash="#/daten"),await st("#upload-zone",1500)}},{type:"download-modal",icon:"📥",title:'1. Im ESS auf „Zeitnachweis herunterladen" klicken',image:Ki,points:[{kind:"good",icon:"✓",text:"Den Button findest du unten rechts in der ESS-Zeitbuchungs-Ansicht."}]},{type:"download-modal",icon:"📅",title:'2. „Anderer Zeitraum" wählen — möglichst groß',image:Vi,points:[{kind:"good",icon:"✓",text:'Wähle <strong>„Anderer Zeitraum"</strong> und nimm einen möglichst großen Bereich (am besten Ausbildungsstart bis heute) — die App nutzt alle Daten für Saldo-Verlauf und Trends.'},{kind:"bad",icon:"✕",text:'Nicht „Aktuelle Woche" oder „Aktueller Monat" — dann fehlen Verlaufs-Daten.'}]},{type:"download-modal",icon:"💾",title:'3. Im PDF-Viewer auf „Speichern" — nicht „Drucken"',image:Wi,points:[{kind:"good",icon:"✓",text:"<strong>Speichern-Button</strong> (Disketten-Symbol oben rechts in der PDF-Toolbar) — speichert eine echte Text-PDF."},{kind:"bad",icon:"✕",text:'<strong>NICHT</strong> „Drucken → Microsoft Print to PDF" — dabei werden Texte als Pfade gerendert und sind nicht lesbar.'}]},{type:"highlight",target:"#upload-zone",icon:"📥",title:"Lade jetzt dein PDF hoch",text:"Zieh dein Zeitnachweis-PDF auf die Box (oder klick sie an). Erst nach dem Upload geht die Tour weiter.",placement:"top",waitForTarget:!0,waitForEvent:"better-ess:pdf-uploaded"},{type:"modal",icon:"✨",title:"Geschafft!",text:"Dein PDF ist eingelesen. Jetzt zeig ich dir die Funktionen — anhand deiner echten Daten.",onNext:async()=>{window.location.hash="#/",await st(".saldo-value",1500)}},{type:"highlight",target:".saldo-value",icon:"⚖️",title:"Dein aktueller Saldo",text:"Plus oder Minus auf einen Blick. Tagesaktuell.",placement:"right",waitForTarget:!0},{type:"highlight",target:"#saldo-chart",icon:"📈",title:"Saldo-Verlauf",text:"Hover über die Punkte für Details. Zeitraum oben rechts umschaltbar.",placement:"top",waitForTarget:!0},{type:"highlight",target:".tag-row .ist-display",icon:"⏱️",title:"Stunden direkt kopieren",text:"Klick auf <strong>H</strong> oder <strong>M</strong> — kopiert den Wert in deine Zwischenablage. Praktisch fürs IHK-Berichtsheft.",placement:"left",waitForTarget:!0},{type:"highlight",target:".alert",icon:"⚠️",title:"Auffälligkeiten",text:"Fehlende Tage, falsche BS-Stunden, Pausen-Abzug — alles automatisch erkannt.",placement:"left",optional:!0,waitForTarget:!0,timeoutMs:1200},{type:"highlight",target:'a[href="#/profil"]',icon:"👤",title:"Profil",text:"Über 18? Pausen-Regel und Mail-Empfänger anpassen.",placement:"right"},{type:"highlight",target:'a[href="#/fahrtgeld"]',icon:"🚌",title:"Fahrgelderstattung",text:"Hier generierst du deine monatliche Fahrgeld-Excel mit deinen erkannten Berufsschultagen.",placement:"right",autoClick:!0,onAfterClick:async()=>{window.location.hash!=="#/fahrtgeld"&&(window.location.hash="#/fahrtgeld"),await st("#fahrtgeld-dropzone, #btn-template-replace, .fahrtgeld-generate-card",2e3)}},{type:"highlight",target:"#fahrtgeld-dropzone, .fahrtgeld-generate-card",icon:"📥",title:"Vorlage einmalig hochladen",text:'Eine bestehende Fahrgeld-Excel hier hochladen — Name, Personalnummer, Haltestellen und Tagessatz werden automatisch ausgelesen. Tour wartet auf den Upload (oder oben auf „Überspringen", um die Tour zu beenden).',placement:"top",waitForTarget:!0,timeoutMs:2500,waitForEvent:"better-ess:fahrgeld-template-uploaded"},{type:"highlight",target:".btn-generate-big",icon:"✅",title:"Excel generieren",text:"Monat unten auswählen, dann hier klicken. Du bekommst eine fertig ausgefüllte Excel zum Download — mit deinen Berufsschultagen, Datum und Unterschrift.",placement:"bottom",waitForTarget:!0,timeoutMs:1500,optional:!0},{type:"highlight",target:".btn-mail-big",icon:"✉️",title:"E-Mail an die Personalabteilung",text:"Öffnet Outlook mit fertig vorausgefülltem Empfänger, Betreff und Text. Excel-Anhang aus dem Download-Ordner musst du noch manuell dranhängen.",placement:"bottom",waitForTarget:!0,timeoutMs:1500,optional:!0},{type:"modal",icon:"🚀",title:"Bereit!",text:"Du kennst alle Funktionen. Tour erneut starten? Button am Ende der <strong>Daten</strong>-Seite."}],hn=Fe.findIndex(e=>e.icon==="✨");let _=null,xe=null;function ta(){_===null&&(qt(),_={idx:0},ce())}function Ii(e){return e?!1:!localStorage.getItem(ea)}function Hi(){localStorage.setItem(ea,"1")}function na(){return _!==null}function qt(){document.querySelectorAll(".tour-blur-frame, .tour-popover, .tour-pointer, .tour-highlight-border").forEach(e=>e.remove()),xe&&(xe(),xe=null),_=null}function at(e){const t=document.querySelector(".tour-blur-frame.full"),n=[document.querySelector('.tour-blur-frame[data-side="top"]'),document.querySelector('.tour-blur-frame[data-side="left"]'),document.querySelector('.tour-blur-frame[data-side="right"]'),document.querySelector('.tour-blur-frame[data-side="bottom"]')];if(!e){n.forEach(v=>{v&&(v.style.opacity="0")});let g=t;!g?(g=document.createElement("div"),g.className="tour-blur-frame full",document.body.appendChild(g)):g.style.opacity="1";const f=document.querySelector(".tour-highlight-border");f&&(f.style.opacity="0");return}t&&(t.style.opacity="0");const a=e.getBoundingClientRect(),s=8,i=Math.max(0,a.left-s),l=Math.max(0,a.top-s),d=a.width+s*2,c=a.height+s*2,r=window.innerWidth,o=window.innerHeight,u={top:{top:0,left:0,width:r,height:l},left:{top:l,left:0,width:i,height:c},right:{top:l,left:i+d,width:r-(i+d),height:c},bottom:{top:l+c,left:0,width:r,height:o-(l+c)}};for(const[g,p]of Object.entries(u)){let f=n[Object.keys(u).indexOf(g)];f||(f=document.createElement("div"),f.className="tour-blur-frame",f.dataset.side=g,document.body.appendChild(f)),f.style.top=p.top+"px",f.style.left=p.left+"px",f.style.width=Math.max(0,p.width)+"px",f.style.height=Math.max(0,p.height)+"px",f.style.opacity=p.width<=0||p.height<=0?"0":"1"}let h=document.querySelector(".tour-highlight-border");h||(h=document.createElement("div"),h.className="tour-highlight-border",document.body.appendChild(h)),h.style.top=l+"px",h.style.left=i+"px",h.style.width=d+"px",h.style.height=c+"px",h.style.opacity="1",h.style.display=""}function Zt(){let e=document.querySelector(".tour-pointer");return e||(e=document.createElement("div"),e.className="tour-pointer",e.innerHTML=`
      ...
      </svg>`,e.style.top=window.innerHeight/2+"px",e.style.left=window.innerWidth/2+"px",document.body.appendChild(e)),e}function Ri(e){const t=Zt(),n=e.getBoundingClientRect(),a=n.left+n.width*.5,s=n.top+n.height*.5;t.style.top=s-6+"px",t.style.left=a-9+"px"}function fn(){var e;(e=document.querySelector(".tour-pointer"))==null||e.remove()}async function qi(e){const t=Zt();t.classList.add("tour-pointer-clicking"),await new Promise(n=>setTimeout(n,280)),t.classList.remove("tour-pointer-clicking")}async function st(e,t=1500){const n=Date.now();for(;Date.now()-n<t;){const a=document.querySelector(e);if(a)return a;await new Promise(s=>setTimeout(s,100))}return null}async function ce(){var d,c,r;if(!_)return;const e=_.overrideStep||Fe[_.idx];if(_.overrideStep=null,!e){Tt();return}if(xe&&(xe(),xe=null),e.type==="download-modal")return fn(),at(null),Zi(e);let t=null;if(e.type==="highlight"){if(t=e.waitForTarget?await st(e.target,e.timeoutMs??1500):document.querySelector(e.target),!t&&e.fallback){const o=e.fallback;if(o.onBefore)try{await o.onBefore()}catch(u){console.warn("tour fallback onBefore error:",u)}return _.overrideStep=o,ce()}if(!t&&e.optional)return _.idx++,ce();if(!t&&e.waitForTarget&&!e.fallback)return console.warn("[tour] target not found, skipping:",e.target),_.idx++,ce();if(t){try{t.scrollIntoView({behavior:"smooth",block:"center",inline:"nearest"})}catch{}await new Promise(o=>setTimeout(o,250)),at(t),Zt(),requestAnimationFrame(()=>Ri(t))}else at(null)}else fn(),at(null);let n=document.querySelector(".tour-popover");n||(n=document.createElement("div"),n.className="tour-popover",n.style.visibility="hidden",document.body.appendChild(n)),n.classList.remove("tour-popover-large","tour-popover-hero"),e.hero&&n.classList.add("tour-popover-hero"),t?n.classList.remove("center"):n.classList.add("center");const a=_.idx===0,s=_.idx===Fe.length-1,i=!!e.waitForEvent,l=i?"⏳ Warte auf Upload …":s?"Fertig":"Weiter →";if(n.innerHTML=`
    ...
    </div>`,t.style.top=t.style.left=t.style.right=t.style.bottom="",t.style.opacity="1",(a=t.querySelector(".tour-skip"))==null||a.addEventListener("click",()=>{Tt()}),n||(s=t.querySelector(".tour-prev"))==null||s.addEventListener("click",async()=>{_.idx=Math.max(0,_.idx-1),await ce()}),(i=t.querySelector(".tour-next"))==null||i.addEventListener("click",async()=>{_.idx++,await ce()})}function ji(e,t,n){const a=t.getBoundingClientRect(),s=16,i=e.offsetWidth||360,l=e.offsetHeight||220,d=window.innerWidth,c=window.innerHeight,r=[n,"right","bottom","left","top"];let o=null;for(const g of r)if((()=>{switch(g){case"right":return a.right+s+i<=d;case"left":return a.left-s-i>=0;case"bottom":return a.bottom+s+l<=c;case"top":return a.top-s-l>=0}})()){o=g;break}o=o||n;let u,h;switch(o){case"right":u=a.top+a.height/2-l/2,h=a.right+s;break;case"left":u=a.top+a.height/2-l/2,h=a.left-i-s;break;case"bottom":u=a.bottom+s,h=a.left+a.width/2-i/2;break;case"top":default:u=a.top-l-s,h=a.left+a.width/2-i/2;break}u=Math.max(s,Math.min(c-l-s,u)),h=Math.max(s,Math.min(d-i-s,h)),e.style.position="fixed",e.style.top=u+"px",e.style.left=h+"px",e.style.right="auto",e.style.bottom="auto",e.style.transform=""}function Tt(){qt(),Hi()}async function Gi({root:e}){var l;const t=await Rn(),n=await oe();e.innerHTML=`
  ...
  `}async function pn(e,t,n){var i,l,d,c;const a=t.querySelector("#upload-status"),s=t.querySelector("#upload-zone");if(e.type!=="application/pdf"&&!/\.pdf$/i.test(e.name)){Ve({type:"error",title:"Falscher Dateityp",desc:`<strong>${M(e.name)}</strong> ist keine PDF-Datei.`,hint:"Lade eine PDF-Datei hoch — den Zeitnachweis aus dem ESS über den <strong>Speichern-Button</strong> (Disketten-Symbol oben rechts im PDF-Viewer)."});return}if(e.size>50*1024*1024){Ve({type:"error",title:"Datei zu groß",desc:`<strong>${M(e.name)}</strong> ist ${(e.size/1024/1024).toFixed(1)} MB groß.`,hint:"ESS-Zeitnachweise sind normalerweise unter 1 MB. Bitte überprüfe die Datei."});return}s.style.pointerEvents="none",s.style.opacity="0.6",a.innerHTML=`
    ...
    </div>`;try{const r=await e.arrayBuffer(),o=await Di(r);if(o.tage.length===0&&!o.meta.zeitraumVon){s.style.pointerEvents="",s.style.opacity="",a.innerHTML="",Ve({type:"error",title:"Diese PDF ist nicht kompatibel",desc:'Im PDF wurden keine Texte gefunden. Das passiert, wenn das PDF über „Drucken → Als PDF speichern" (z.B. „Microsoft Print to PDF") erzeugt wurde — dabei werden Texte als Vektorpfade gerendert und können nicht ausgelesen werden.',hint:'Lade dein PDF direkt aus dem ESS über den <strong>Speichern-Button</strong> herunter (Disketten-Symbol oben rechts im PDF-Viewer) — nicht über „Drucken".',screenshot:!0,producer:(i=o.meta)==null?void 0:i.producer}),ut("PDF enthält keinen extrahierbaren Text.");return}const u=await Xe(),h=u==null?void 0:u.personalnummer,g=o.meta.personalnummer;if(h&&g&&h!==g){const x=(u==null?void 0:u.name)||`Personalnr. ${h}`,P=o.meta.name||`Personalnr. ${g}`;if(!await le(`Das hochgeladene PDF gehört zu einem anderen Azubi als die bisher gespeicherten Daten:
...
Wenn du fortfährst, werden alle alten Tagesdaten gelöscht und durch die neuen ersetzt. (Profil-Einstellungen wie Theme und Mail-Vorlagen bleiben erhalten.)`,{title:"Anderer Azubi erkannt",confirmLabel:"Daten ersetzen",variant:"danger"})){s.style.pointerEvents="",s.style.opacity="",a.innerHTML=`
    ...
    <form id="profil-form" class="grid cols-2" style="gap: 24px;">
      ...
      <div class="card">
        ...
        <div class="form-group">
          ...
          <input type="email" name="zeitwirtschaftEmail" value="${Ie(t.zeitwirtschaftEmail)}" placeholder="zeitwirtschaft@firma.de" />
        </div>
        <div class="form-group">
          <label>Anrede in Mails</label>
          <input type="text" name="zeitwirtschaftAnrede" value="${Ie(t.zeitwirtschaftAnrede)}" placeholder="z. B. Frau Müller" />
        </div>
      </div>
      ...
      <div class="card${n?"":" hidden"}" style="${n?"":"display:none;"}">
        ...
        <div class="form-group">
          ...
          <input type="email" name="fahrtgeldEmpfaenger" value="${Ie(t.fahrtgeldEmpfaenger)}" placeholder="empfaenger@firma.de" />
        </div>
        <div class="form-group">
          <label>Cc (optional)</label>
          <input type="email" name="fahrtgeldCc" value="${Ie(t.fahrtgeldCc)}" placeholder="cc@firma.de" />
        </div>
        <div class="form-group">
          <label>Anrede in Mails</label>
          <input type="text" name="fahrtgeldAnrede" value="${Ie(t.fahrtgeldAnrede)}" placeholder="z. B. Frau Müller" />
        </div>
      </div>
      ...
      <div class="card${n?"":" hidden"}" style="grid-column: 1 / -1;${n?"":" display:none;"}">
        ...
        ${i?`
          <div class="tag-detail">
            ...
            <div class="tag-detail-value"><strong>${((r=s.wochentageWoechentlich)==null?void 0:r.map(h=>bn[h]).join(", "))||"—"}</strong></div>
          </div>
          <div class="tag-detail">
            <div class="tag-detail-label">Alle 2 Wochen</div>
            <div class="tag-detail-value"><strong>${((o=s.wochentage14Taegig)==null?void 0:o.map(h=>bn[h]).join(", "))||"—"}</strong>${s.referenzDatum14Taegig?` <span class="hint">(Anker: ${C(new Date(s.referenzDatum14Taegig))})</span>`:""}</div>
          </div>
          <div class="tag-detail">
  ...
  `,e.querySelector("#profil-form").addEventListener("submit",async h=>{var f,v,m,k,x;h.preventDefault();const g=new FormData(h.target),p={...t,ueber18:g.get("ueber18")==="on",zeitwirtschaftEmail:((f=g.get("zeitwirtschaftEmail"))==null?void 0:f.trim())||"",zeitwirtschaftAnrede:((v=g.get("zeitwirtschaftAnrede"))==null?void 0:v.trim())||"",fahrtgeldEmpfaenger:((m=g.get("fahrtgeldEmpfaenger"))==null?void 0:m.trim())||"",fahrtgeldCc:((k=g.get("fahrtgeldCc"))==null?void 0:k.trim())||"",fahrtgeldAnrede:((x=g.get("fahrtgeldAnrede"))==null?void 0:x.trim())||""};await ot(p),O("Profil gespeichert.")});const l=e.querySelector("#azubi-switch");l==null||l.addEventListener("change",async h=>{await Xs(h.target.checked),typeof window.__applyAzubiVisibility=="function"&&await window.__applyAzubiVisibility(),O(h.target.checked?"Azubi-Features an.":"Azubi-Features aus."),Rs()})}function Ie(e){return String(e??"").replace(/"/g,"&quot;")}function nr(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}async function ar({params:e,root:t}){var r,o,u,h;const n=e.datum,a=await w.tage.get(n),s=await oe();if(!a){t.innerHTML=`<h1 class="view-title">Tag nicht gefunden</h1><p>Für ${n} liegen keine Daten vor.</p><a href="#/" class="btn">← Dashboard</a>`;return}const i=W(n),l=a.tagestyp==="Stempelzeit"?Ln(a,s):null,d=mt(i,s.berufsschulMuster),c=Tn(a.zeitSpannen);t.innerHTML=`
    ...
    <div class="grid cols-3" style="margin-bottom: 24px;">
      <div class="card">
        ...
        <div class="hint">= ${a.ist!=null?qe(a.ist):"—"}</div>
      </div>
      <div class="card">
        <h3>Soll-Stunden</h3>
    ...
    <div class="grid cols-2" style="gap: 24px;">
      ...
      <div class="card">
        ...
        <div class="tag-detail">
          ...
          <div class="tag-detail-value">${a.tagestyp?`<span class="pill ${sr(a.tagestyp)}">${He(a.tagestyp)}</span>`:"—"}</div>
        </div>
        <div class="tag-detail">
        ...
        <div class="card" style="grid-column: 1 / -1;">
          ...
          ${l.warnung?`
            <div class="alert severity-warn" style="margin-top: 12px;">
              ...
              <div class="alert-body">${He(l.warnung)}</div>
            </div>
          `:""}
        </div>
      `:""}
    </div>
  `}function sr(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function He(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}const ir=[{key:14,label:"2 Wochen"},{key:30,label:"1 Monat"},{key:90,label:"3 Monate"},{key:180,label:"6 Monate"},{key:365,label:"1 Jahr"},{key:730,label:"2 Jahre"},{key:"alles",label:"Alles"}];function rr(e){return ir.filter(t=>t.key==="alles"||t.key<e)}async function lr({root:e}){var o,u;const[t,n]=await Promise.all([ue(),ht()]);if(!t.length){e.innerHTML='<h1 class="view-title">Analytics</h1><p class="view-subtitle">Keine Daten.</p><a href="#/daten" class="btn primary">Zum Upload</a>';return}const a=rr(t.length);let s=a.some(h=>h.key===30)?30:"alles";const i=n.length>=6;e.innerHTML=`
  ...
  `;let l=0;const d=()=>{if(s==="alles")return t;const h=t.length,g=Math.min(s,h),p=h+l*g,f=p-g;return p<=0?[]:t.slice(Math.max(0,f),p)},c=()=>{const h=e.querySelector("#startend-nav");if(!h)return;const g=s==="alles";if(h.hidden=g,g)return;const p=lt(t.length,s),f=d();h.querySelector('.zeitraum-nav-btn[data-dir="prev"]').disabled=l<=p,h.querySelector('.zeitraum-nav-btn[data-dir="next"]').disabled=l>=0;const v=h.querySelector(".zeitraum-nav-label");v&&(v.textContent=Yn(f,s))},r=()=>{nn(e.querySelector("#c-startend"),d()),c()};requestAnimationFrame(()=>{i&&Fs(e.querySelector("#c-saldo"),n),Os(e.querySelector("#c-wochen"),t),nn(e.querySelector("#c-startend"),d()),Cs(e.querySelector("#c-wochentag"),t),_s(e.querySelector("#c-pausen"),t),Bs(e.querySelector("#c-donut"),t),Ls(e.querySelector("#c-alle-tage"),t.slice(-30)),c()}),(o=e.querySelector("#startend-zeitraum"))==null||o.addEventListener("click",h=>{const g=h.target.closest("button[data-key]");if(!g||g.disabled)return;const p=g.getAttribute("data-key"),f=p==="alles"?"alles":parseInt(p,10);f!==s&&(s=f,l=0,e.querySelectorAll("#startend-zeitraum button").forEach(v=>v.classList.toggle("active",v===g)),r())}),(u=e.querySelector("#startend-nav"))==null||u.addEventListener("click",h=>{const g=h.target.closest(".zeitraum-nav-btn");if(!g||g.disabled||s==="alles")return;const p=g.getAttribute("data-dir")==="prev"?-1:1,f=lt(t.length,s);let v=l+p;v<f&&(v=f),v>0&&(v=0),v!==l&&(l=v,r())})}function or(e){return String(e??"").replace(/"/g,"&quot;")}async function St({params:e,root:t}){const[n,a,s,i,l,d]=await Promise.all([ue(),ht(),oe(),Xe(),ft(),Le()]),c=Object.fromEntries(l.map(b=>[b.key,b]));if(!n.length){t.innerHTML=`
      <h1 class="view-title">Kalender</h1>
      <p class="view-subtitle">Noch keine Daten geladen.</p>
      <a href="#/daten" class="btn primary">Zum Upload</a>`;return}const r=[...new Set(n.map(b=>b.monatKey))].sort(),o=e.yyyymm,u=r.includes(o)?o:r[r.length-1],h=n.filter(b=>b.monatKey===u),g=[...new Set(h.map(b=>b.wocheKey))].sort(),p=e.yyyykw,f=g.includes(p)?p:null,v=r.indexOf(u),m=v>0?r[v-1]:null,k=v<r.length-1?r[v+1]:null,x=Ft(u),P=a.find(b=>b.monatKey===u),$=_n(n,a),T=$.filter(b=>b.monatKey===u),N=i!=null&&i.stichtagAuswertung?new Date(i.stichtagAuswertung):new Date,I=pt(n,s,N,void 0,{isAzubi:d}),U=I.filter(b=>b.datum.startsWith(u)),y=ur({aktiverMonatKey:u,monatLabel:x,prevMonatKey:m,nextMonatKey:k,tageAnzahl:h.length,warnungenAnzahl:U.length});f?await dr({root:t,switcherHtml:y,aktiverMonatKey:u,aktiveWocheKey:f,vollKurve:$,alleWarnungen:I,profil:s,vorlagenOverrides:c}):await cr({root:t,switcherHtml:y,monatLabel:x,tageMonat:h,monatsKurve:T,monatUebersicht:P,monatsWarnungen:U,aktiverMonatKey:u,profil:s,vorlagenOverrides:c})}async function cr({root:e,switcherHtml:t,monatLabel:n,tageMonat:a,monatsKurve:s,monatUebersicht:i,monatsWarnungen:l,aktiverMonatKey:d,profil:c,vorlagenOverrides:r}){e.innerHTML=`
    ${t}
    ...
    <div class="card">
      ...
      <div id="tage-liste-kalender">${bt(s.slice().reverse(),{warnungen:l})}</div>
    </div>
  `,s.length&&(requestAnimationFrame(()=>{const o=e.querySelector("#chart-kalender-monat");o&&Wt(o,s)}),Ht(e.querySelector("#tage-liste-kalender")))}async function dr({root:e,switcherHtml:t,aktiverMonatKey:n,aktiveWocheKey:a,vollKurve:s,alleWarnungen:i,profil:l,vorlagenOverrides:d}){var m;const c=s.filter(k=>k.wocheKey===a),r=c.reduce((k,x)=>k+gt(x),0),o=c.reduce((k,x)=>k+Bt(x),0),u=+(r-o).toFixed(2),h=k=>k>.05?"var(--success)":k<-.05?"var(--danger)":"var(--fg)",g=i.filter(k=>c.some(x=>x.datum===k.datum)),p=(m=c[0])==null?void 0:m.datum,f=p?Ye(W(p)):"",v=a.split("-")[1]||"?";e.innerHTML=`
    ${t}
    ...
    `:`
      ...
      <div class="card">
        ...
        <div id="tage-liste-kalender">${bt(c,{warnungen:g})}</div>
      </div>
    `}
  `,c.length&&(requestAnimationFrame(()=>{const k=e.querySelector("#chart-kalender-woche");k&&Wt(k,c)}),Ht(e.querySelector("#tage-liste-kalender")))}function ur({aktiverMonatKey:e,monatLabel:t,prevMonatKey:n,nextMonatKey:a,tageAnzahl:s,warnungenAnzahl:i}){const l=n?Ft(n):"",d=a?Ft(a):"";return`
    ...
    <div class="grid cols-3" style="margin-bottom: 24px;">
    ...
    </div>`}function hr(e,t){var s;const n={};for(const i of e)n[s=i.wocheKey]??(n[s]={key:i.wocheKey,tage:[],ist:0,soll:0}),n[i.wocheKey].tage.push(i),n[i.wocheKey].ist+=gt(i),n[i.wocheKey].soll+=Bt(i);const a=Object.keys(n).sort();return a.length?a.map(i=>{var h;const l=n[i],d=+(l.ist-l.soll).toFixed(2),c=d>.05?"var(--success)":d<-.05?"var(--danger)":"var(--fg-muted)",r=(h=l.tage.slice().sort((g,p)=>g.datum.localeCompare(p.datum))[0])==null?void 0:h.datum,o=r?Ye(W(r)):"",u=i.split("-")[1]||"?";return`
      ...
      </a>`}).join(""):'<p style="color: var(--fg-muted);">Keine Wochen.</p>'}function ia(e,t,n){const a=e.schweregrad==="error"?"!":e.schweregrad==="warn"?"⚠":"i";let s=null;if(e.mailVorlageKey&&t){const i=Qe(e.mailVorlageKey,n==null?void 0:n[e.mailVorlageKey]);if(i){const l=Vt(t,e);s=It(t,i,l)}}return`
    <div class="alert severity-${e.schweregrad}">
      <div class="alert-icon">${a}</div>
      <div class="alert-body">
    ...
    </div>`}function Ft(e){const[t,n]=e.split("-"),a=new Date(parseInt(t,10),parseInt(n,10)-1,1);return L(a,"MMMM yyyy",{locale:ne})}const fr={MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"};async function Mt({params:e,root:t}){const[n,a,s,i]=await Promise.all([ue(),oe(),Xe(),Le()]),l=mr(e);if(!n.length){t.innerHTML=`
      <h1 class="view-title">Kalender · ${M(l.label)}</h1>
      <p class="view-subtitle">Noch keine Daten geladen.</p>
      <a href="#/daten" class="btn primary">Zum Upload</a>`;return}const d=n.filter(l.predicate).sort((g,p)=>g.datum.localeCompare(p.datum)),c=s!=null&&s.stichtagAuswertung?new Date(s.stichtagAuswertung):new Date,o=pt(n,a,c,void 0,{isAzubi:i}).filter(g=>d.some(p=>p.datum===g.datum)),u=d.reduce((g,p)=>g+(p.ist??0),0),h=u>0?` · ${u.toFixed(2).replace(".",",")}h kumuliert`:"";t.innerHTML=`
    <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 8px;">
    ...
    `:`
      <div class="card">
        ...
        <div id="tagestyp-tage-liste">${bt(d,{warnungen:o})}</div>
      </div>
    `}
  `,Ht(t.querySelector("#tagestyp-tage-liste"))}function mr(e){if(e.typ!=null){const t=decodeURIComponent(e.typ);return{label:t,titel:`${t}-Tage`,predicate:n=>n.tagestyp===t}}if(e.wd!=null){const t=decodeURIComponent(e.wd).toUpperCase(),n=fr[t]||t;return{label:n,titel:`Tage am ${n}`,predicate:a=>a.wochentag===t}}if(e.bucket!=null){const t=parseInt(decodeURIComponent(e.bucket),10),n=t+14;return{label:`${t}–${n} min Pause`,titel:`Tage mit Pause ${t}–${n} min`,predicate:a=>{if(a.tagestyp!=="Stempelzeit"||!a.zeitSpannen||a.zeitSpannen.length<2)return!1;const s=Math.round(Ct(a.zeitSpannen)*60);return s>=t&&s<=n}}}return{label:"Filter",titel:"Tage (kein Filter)",predicate:()=>!0}}Dn.workerSrc=Xn;function pr(e){if(!e||e.byteLength<5)return!1;const t=new Uint8Array(e,0,5);return t[0]===37&&t[1]===80&&t[2]===68&&t[3]===70&&t[4]===45}async function ra(e){var $,T,N,I,U,y;let t;try{t=await Pn({data:new Uint8Array(e.slice(0))}).promise}catch{return{ok:!1,fehler:"PDF konnte nicht gelesen werden — die Datei ist beschädigt oder verschlüsselt."}}if(t.numPages<1)return{ok:!1,fehler:"PDF hat keine Seiten."};const n=await t.getPage(1),s=(await n.getAnnotations()).filter(b=>b.subtype==="Widget");if(s.length<20)return{ok:!1,fehler:"Diese PDF ist kein ausfüllbares Formular — bitte die Original-Vorlage hochladen."};const d=(await n.getTextContent()).items.filter(b=>b.str&&b.transform).map(b=>({text:b.str,x:b.transform[4],y:b.transform[5],width:b.width,height:b.height})).filter(b=>Math.abs(b.y-636)<4);let c="";for(const b of d){const S=b.text.match(/(\d{6,8})/);if(S&&!b.text.toLowerCase().includes("kst")){c=S[1];break}}const r=br(s),o=Pe(r.monatJahr),h=(Pe(r.persNr).match(/\d+/)||[""])[0],g=Pe(r.name).trim(),p=zt(r.vonSlots),f=zt(r.nachSlots),v=zt(r.betragSlots),m=vr(v),k=Pe(r.auszubildender).trim(),x=k.replace(/^\s*\d{1,2}\.\d{1,2}\.\d{2,4}\s*/,"").trim(),P=[];return g||P.push("name"),h||P.push("persNr"),c||P.push("kst"),p||P.push("vonHaltestelle"),f||P.push("nachHaltestelle"),(!m||m<=0)&&P.push("betragProTag"),!g&&!h&&!p&&!f&&!m?{ok:!1,fehler:"Diese PDF ist eine komplett leere Vorlage — bitte zuerst eine eigene Vorlage einmal von Hand mit Name, Pers.-Nr., Strecke und Tagessatz ausfüllen und dann hochladen."}:{ok:!0,konstanten:{name:g,persNr:h,kst:c,vonHaltestelle:p,nachHaltestelle:f,betragProTag:m,unterschriftText:x},layout:{monatJahrField:(($=r.monatJahr)==null?void 0:$.fieldName)||null,persNrField:((T=r.persNr)==null?void 0:T.fieldName)||null,nameField:((N=r.name)==null?void 0:N.fieldName)||null,auszubildenderField:((I=r.auszubildender)==null?void 0:I.fieldName)||null,summeField:((U=r.summe)==null?void 0:U.fieldName)||null,datumFields:r.datumSlots.map(b=>b.fieldName),vonFields:r.vonSlots.map(b=>b.fieldName),nachFields:r.nachSlots.map(b=>b.fieldName),betragFields:r.betragSlots.map(b=>b.fieldName),auszubildenderRect:((y=r.auszubildender)==null?void 0:y.rect)||null},vorhandeneEintraege:{monatJahr:o,auszubildenderText:k,anzahlBefuellteDatumZeilen:r.datumSlots.filter(b=>Pe(b)).length},missing:P,quelle:"pdf"}}function br(e){const t=e.map(g=>{const[p,f,v,m]=g.rect;return{fieldName:g.fieldName,fieldValue:g.fieldValue??"",rect:[p,f,v,m],x:(p+v)/2,y:(f+m)/2,width:v-p,height:m-f}}),n=t.find(g=>g.y>660&&g.x<250)||null,a=t.find(g=>g.y>660&&g.x>400)||null,s=t.find(g=>g.y>630&&g.y<660&&g.x<250)||null,i=t.filter(g=>g.y>370&&g.y<580),l=(g,p)=>p.y-g.y,d=i.filter(g=>g.x>0&&g.x<140).sort(l),c=i.filter(g=>g.x>140&&g.x<290).sort(l),r=i.filter(g=>g.x>290&&g.x<460).sort(l),o=i.filter(g=>g.x>460).sort(l),u=t.find(g=>g.y<370&&g.y>320&&g.x>460)||null,h=t.find(g=>g.y<340&&g.y>310&&g.x<200)||null;return{monatJahr:n,persNr:a,name:s,datumSlots:d,vonSlots:c,nachSlots:r,betragSlots:o,summe:u,auszubildender:h}}function Pe(e){return e?String(e.fieldValue??"").trim():""}function zt(e){for(const t of e){const n=Pe(t);if(n)return n}return""}function vr(e){if(!e)return 0;const t=String(e).replace(/[^\d,.\-]/g,"").replace(/\./g,"").replace(",","."),n=parseFloat(t);return Number.isFinite(n)?n:0}const la="Fahrgelderstattung",yr="C4",oa="C5",ca="F4",da="F5",$e=10,De=19;function vn(e,t){return e.filter(n=>n.monatKey===t).filter(n=>n.tagestyp==="Berufsschule").filter(n=>(n.ist??0)>0).sort((n,a)=>n.datum.localeCompare(a.datum))}async function wr(e){if(pr(e)){const t=await ra(e);return t.ok?{ok:!0,format:"pdf",konstanten:t.konstanten,layout:t.layout,missing:t.missing,vorhandeneEintraege:t.vorhandeneEintraege,unterschriftAuto:null}:t}return await kr(e)}async function kr(e){const t=(await de(async()=>{const{default:v}=await import("./exceljs.min-BhfpbegZ.js").then(m=>m.e);return{default:v}},__vite__mapDeps([0,1]),import.meta.url)).default,n=new t.Workbook;try{await n.xlsx.load(e)}catch{return{ok:!1,fehler:"Die Excel-Datei ist beschädigt oder kein gültiges .xlsx-Format. Bitte die Datei neu speichern und nochmal versuchen."}}const a=n.getWorksheet(la)??n.worksheets[0];if(!a)return{ok:!1,fehler:"Excel hat keine Arbeitsblätter — die Datei scheint leer zu sein."};const s=v=>{const m=a.getCell(v).value;return m==null?"":typeof m=="object"&&m.text?String(m.text):typeof m=="object"&&m.richText?m.richText.map(k=>k.text).join(""):String(m)},i=s(oa).trim(),l=s(ca).trim(),d=s(da).trim(),c=(l.match(/\d+/)||[""])[0],r=(d.match(/\d+/)||[""])[0],o=s(`C${$e}`).trim(),u=s(`E${$e}`).trim(),h=a.getCell(`G${$e}`).value,g=typeof h=="number"?h:parseFloat(String(h).replace(",","."))||0;let p=null;try{const v=new Set(a.getImages().map(k=>parseInt(k.imageId,10))),m=(n.media||[]).map((k,x)=>({media:k,index:x})).filter(({media:k,index:x})=>(k==null?void 0:k.type)==="image"&&!v.has(x)&&k.buffer);if(m.length>0){m.sort(($,T)=>(T.media.buffer.length||0)-($.media.buffer.length||0));const k=m[0].media,x=k.buffer,P=x instanceof ArrayBuffer?x:x.buffer?x.buffer.slice(x.byteOffset||0,(x.byteOffset||0)+x.byteLength):null;if(P){const $=(k.extension||"").toLowerCase();p={bytes:P,extension:$==="jpg"?"jpeg":$||"png",quelle:"auto-aus-vorlage"}}}}catch(v){console.warn("[fahrtgeld] Unterschrift-Auto-Extraktion fehlgeschlagen:",v)}if(!i&&!c&&!r&&!o&&!u&&!g)return{ok:!1,fehler:"Diese Excel scheint nicht im Format der der Standard-Fahrgelderstattung zu sein — keine der erwarteten Felder wurde gefunden. Bitte eine Original-Vorlage hochladen."};const f=[];return i||f.push("name"),c||f.push("persNr"),r||f.push("kst"),o||f.push("vonHaltestelle"),u||f.push("nachHaltestelle"),(!g||g<=0)&&f.push("betragProTag"),{ok:!0,format:"excel",konstanten:{name:i,persNr:c,kst:r,vonHaltestelle:o,nachHaltestelle:u,betragProTag:g},missing:f,unterschriftAuto:p}}async function xr({templateBytes:e,monatKey:t,bsTage:n,konstanten:a,unterschriftBytes:s,unterschriftExtension:i}){const l=!e;e||(e=await $r());const d=(await de(async()=>{const{default:y}=await import("./exceljs.min-BhfpbegZ.js").then(b=>b.e);return{default:y}},__vite__mapDeps([0,1]),import.meta.url)).default,c=new d.Workbook;try{await c.xlsx.load(e)}catch{throw new Error("Die hinterlegte Excel-Vorlage ist beschädigt — bitte unter Fahrgelderstattung neu hochladen.")}const r=c.getWorksheet(la)??c.worksheets[0];if(!r)throw new Error("Die Excel-Vorlage hat kein passendes Arbeitsblatt — bitte eine Original-Fahrgelderstattung-Vorlage hochladen.");if(l||s&&i)try{Array.isArray(r._media)&&(r._media=r._media.filter(y=>{var S,F,V,K;return(((F=(S=y==null?void 0:y.range)==null?void 0:S.tl)==null?void 0:F.nativeRow)??((K=(V=y==null?void 0:y.range)==null?void 0:V.tl)==null?void 0:K.row)??0)<18}))}catch(y){console.warn("[fahrtgeld] Bild-Cleanup fehlgeschlagen:",y)}const[u,h]=t.split("-").map(y=>parseInt(y,10)),g=new Date(u,h-1,1,12,0,0),p=L(g,"MMMM yy",{locale:ne}),f=r.getCell(yr);f.value=p,f.numFmt="@",r.getCell(oa).value=a.name,r.getCell(ca).value=`Pers.-Nr.: ${a.persNr}`,r.getCell(da).value=`KST: ${a.kst}`;for(let y=$e;y<=De;y++)r.getCell(`A${y}`).value=null,r.getCell(`C${y}`).value=null,r.getCell(`E${y}`).value=null,r.getCell(`G${y}`).value=null;const v=De-$e+1,m=n.slice(0,v);for(let y=0;y<m.length;y++){const b=m[y],S=$e+y;r.getCell(`A${S}`).value=W(b.datum),r.getCell(`C${S}`).value=a.vonHaltestelle,r.getCell(`E${S}`).value=a.nachHaltestelle,r.getCell(`G${S}`).value=a.betragProTag}const k=+(m.length*(a.betragProTag??0)).toFixed(2),x=r.getCell(`G${De+1}`);x.value={formula:`SUM(G${$e}:G${De})`,result:k};const $=L(new Date,"dd.MM.yyyy"),T=r.getCell("A21");if(T.value=a.unterschriftText?`${$} ${a.unterschriftText}`:$,T.alignment={vertical:"bottom",horizontal:"center",wrapText:!1},s&&i){const y=c.addImage({buffer:s,extension:i}),b=197,S=80,F=55,V=185,K=Er(s);let H=V,ae=F;if(K&&K.width>0&&K.height>0){const we=Math.min(V/K.width,F/K.height);H=Math.round(K.width*we),ae=Math.round(K.height*we)}const ye=Math.max(0,Math.round((b-H)/2))/S;r.addImage(y,{tl:{col:ye,row:20.04},ext:{width:H,height:ae},editAs:"oneCell"})}for(let y=De+3;y<=De+5;y++)for(const b of["A","B","C","D","E","F","G"]){const S=r.getCell(`${b}${y}`),F=S.value;typeof F=="string"&&/^[A-Z]\d+(-\d+)?$/.test(F.trim())&&(S.value=null)}const N=await c.xlsx.writeBuffer(),I=new Blob([N],{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}),U=ua(a.name,g);return{blob:I,dateiname:U,anzahlTage:m.length,ueberzaehlig:n.length-m.length}}function ua(e,t,n="xlsx"){const a=L(t,"MMMM",{locale:ne}),s=L(t,"yy");let i=(e||"Azubi").trim();const l=/^(.+?),\s*(.+)$/.exec(i);return l&&(i=`${l[2].trim()} ${l[1].trim()}`),`Fahrgelderstattung ${i} ${a} ${s}.${n}`}let At=null;async function $r(){return At||(At=(async()=>{const t=await fetch("./templates/fahrgeld-vorlage.xlsx");if(!t.ok)throw new Error(`Standard-Excel-Vorlage nicht ladbar (HTTP ${t.status})`);return await t.arrayBuffer()})()),At}let Dt=null;async function Sr(){return Dt||(Dt=(async()=>{const t=await fetch("./templates/fahrgeld-vorlage.pdf");if(!t.ok)throw new Error(`Standard-PDF-Vorlage nicht ladbar (HTTP ${t.status})`);const n=await t.arrayBuffer(),s=(await ra(n)).layout||await Mr(n);return{bytes:n,layout:s}})()),Dt}async function Mr(e){const i=(await(await(await(await de(()=>import("./pdfjs-BnPRJEQ6.js"),[],import.meta.url)).getDocument({data:new Uint8Array(e.slice(0))}).promise).getPage(1)).getAnnotations()).filter(m=>m.subtype==="Widget").map(m=>{const[k,x,P,$]=m.rect;return{fieldName:m.fieldName,rect:m.rect,x:(k+P)/2,y:(x+$)/2}}),l=(m,k)=>k.y-m.y,d=i.filter(m=>m.y>370&&m.y<580),c=i.find(m=>m.y>660&&m.x<250),r=i.find(m=>m.y>660&&m.x>400),o=i.find(m=>m.y>630&&m.y<660&&m.x<250),u=d.filter(m=>m.x<140).sort(l),h=d.filter(m=>m.x>140&&m.x<290).sort(l),g=d.filter(m=>m.x>290&&m.x<460).sort(l),p=d.filter(m=>m.x>460).sort(l),f=i.find(m=>m.y<370&&m.y>320&&m.x>460),v=i.find(m=>m.y<340&&m.y>310&&m.x<200);return{monatJahrField:(c==null?void 0:c.fieldName)||null,persNrField:(r==null?void 0:r.fieldName)||null,nameField:(o==null?void 0:o.fieldName)||null,auszubildenderField:(v==null?void 0:v.fieldName)||null,summeField:(f==null?void 0:f.fieldName)||null,datumFields:u.map(m=>m.fieldName),vonFields:h.map(m=>m.fieldName),nachFields:g.map(m=>m.fieldName),betragFields:p.map(m=>m.fieldName),auszubildenderRect:(v==null?void 0:v.rect)||null}}async function zr({templateBytes:e,monatKey:t,bsTage:n,konstanten:a,layout:s,unterschriftBytes:i,unterschriftExtension:l}){if(!e||!s){const b=await Sr();e=e||b.bytes,s=s||b.layout}const{PDFDocument:d}=await de(async()=>{const{PDFDocument:b}=await import("./index-Bf057_RE.js");return{PDFDocument:b}},__vite__mapDeps([2,1]),import.meta.url);let c;try{c=await d.load(e,{ignoreEncryption:!0})}catch{throw new Error("Die hinterlegte PDF-Vorlage ist beschädigt — bitte unter Fahrgelderstattung neu hochladen.")}const r=c.getForm(),[o,u]=t.split("-").map(b=>parseInt(b,10)),h=new Date(o,u-1,1,12,0,0),g=L(h,"MMMM yy",{locale:ne});J(r,s.monatJahrField,g),a.name&&J(r,s.nameField,a.name),a.persNr&&J(r,s.persNrField,a.persNr);const p=s.datumFields||[],f=s.vonFields||[],v=s.nachFields||[],m=s.betragFields||[],k=Math.min(p.length,f.length,v.length,m.length);for(let b=0;b<k;b++)J(r,p[b],""),J(r,f[b],""),J(r,v[b],""),J(r,m[b],"");const x=n.slice(0,k),P=a.betragProTag!=null&&a.betragProTag>0?a.betragProTag.toFixed(2).replace(".",","):"";for(let b=0;b<x.length;b++){const S=x[b];J(r,p[b],Ar(S.datum)),a.vonHaltestelle&&J(r,f[b],a.vonHaltestelle),a.nachHaltestelle&&J(r,v[b],a.nachHaltestelle),P&&J(r,m[b],P)}const $=+(x.length*(a.betragProTag??0)).toFixed(2);J(r,s.summeField,$.toFixed(2).replace(".",","));const T=L(new Date,"dd.MM.yyyy"),N=a.unterschriftText?`${T} ${a.unterschriftText}`:T;J(r,s.auszubildenderField,N);try{const{PDFName:b}=await de(async()=>{const{PDFName:V}=await import("./index-Bf057_RE.js");return{PDFName:V}},__vite__mapDeps([2,1]),import.meta.url),F=c.getPage(0).node.Annots();if(F)for(let V=F.size()-1;V>=0;V--){const K=F.get(V),H=c.context.lookup(K);if(H&&typeof H.lookup=="function"){const ae=H.lookup(b.of("Subtype"));ae&&String(ae)==="/StrikeOut"&&F.remove(V)}}}catch(b){console.warn("[fahrtgeld] StrikeOut-Cleanup fehlgeschlagen:",b)}try{const{rgb:b}=await de(async()=>{const{rgb:F}=await import("./index-Bf057_RE.js");return{rgb:F}},__vite__mapDeps([2,1]),import.meta.url);c.getPage(0).drawRectangle({x:16,y:286,width:60,height:16,color:b(1,1,1),borderWidth:0})}catch(b){console.warn("[fahrtgeld] Form-Code-Overlay fehlgeschlagen:",b)}if(i&&s.auszubildenderRect)try{const S=(l||"png").toLowerCase()==="png"?await c.embedPng(i):await c.embedJpg(i),[F,V,K,H]=s.auszubildenderRect,ae=K-F,et=H-V,ye=F,we=K,_e=H+1,tt=Math.min(H+30,366),Ce=we-ye,ze=Math.max(0,tt-_e);if(ze>4&&S.width>0&&S.height>0){const z=Math.min(Ce*.92/S.width,ze*.92/S.height),D=S.width*z,E=S.height*z,G=ye+(Ce-D)/2,A=_e+(ze-E)/2;c.getPage(0).drawImage(S,{x:G,y:A,width:D,height:E})}}catch(b){console.warn("[fahrtgeld] Unterschrift-Embed fehlgeschlagen:",b)}try{r.updateFieldAppearances()}catch(b){console.warn("[fahrtgeld] updateFieldAppearances fehlgeschlagen:",b)}const I=await c.save(),U=new Blob([I],{type:"application/pdf"}),y=ua(a.name,h,"pdf");return{blob:U,dateiname:y,anzahlTage:x.length,ueberzaehlig:n.length-x.length}}function J(e,t,n){if(t)try{e.getTextField(t).setText(n??"")}catch{}}function Ar(e){return L(W(e),"dd.MM.yyyy")}function it(e){const[t,n]=e.split("-").map(a=>parseInt(a,10));return L(new Date(t,n-1,1),"MMMM yyyy",{locale:ne})}function yn(e,t=null,n={},a=""){const i={monat_jahr:it(e)},l=(t==null?void 0:t.betreff)??"Fahrgelderstattung {monat_jahr} {name}",d=(t==null?void 0:t.text)??`Guten Tag {personal_anrede},

hiermit sende ich Ihnen das ausgefüllte Dokument für die Fahrgelderstattung vom {monat_jahr} zu.
Vielen Dank!`;i.personal_anrede=n.fahrtgeldAnrede||n.personalAnrede||"Frau Mayer";const c=(()=>{if(!a)return"";const p=String(a).trim(),f=/^(.+?),\s*(.+)$/.exec(p);return f?`${f[2].trim()} ${f[1].trim()}`:p})();i.name=c;const r=wn(l,i).replace(/\s+/g," ").trim(),o=wn(d,i),u=new URLSearchParams,h=n.fahrtgeldCc||"anika.kailer@putzmeister.com";return u.set("cc",h),u.set("subject",r),u.set("body",o),`mailto:${n.fahrtgeldEmpfaenger||"annika.mayer@putzmeister.com"}?${u.toString().replace(/\+/g,"%20")}`}function wn(e,t){return e.replace(/\{(\w+)\}/g,(n,a)=>t[a]!=null?String(t[a]):`{${a}}`)}function Dr(e){const t=new Set;for(const n of e)n.tagestyp==="Berufsschule"&&(n.ist??0)>0&&t.add(n.monatKey);return[...t].sort().reverse()}function Pr(e,t,n,a){var h,g;const s=t==null?void 0:t.berufsschulMuster;if(!s||!((h=s.wochentageWoechentlich)!=null&&h.length)&&!((g=s.wochentage14Taegig)!=null&&g.length))return{ausstehend:[],imMonatGesamt:n.length,vorhandenAnzahl:n.length};const[i,l]=e.split("-").map(p=>parseInt(p,10)),d=new Date(i,l-1,1),c=new Date(i,l,0),r=new Set(n.map(p=>p.datum)),o=[];let u=new Date(d);for(;u<=c;){if(!Je(u)&&mt(u,s)){const p=L(u,"yyyy-MM-dd");u>a&&!r.has(p)&&o.push(p)}u=Ue(u,1)}return{ausstehend:o,imMonatGesamt:n.length+o.length,vorhandenAnzahl:n.length}}function Er(e){const t=e instanceof ArrayBuffer?e:e!=null&&e.buffer?e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength):null;if(!t||t.byteLength<24)return null;const n=new DataView(t);if(n.getUint32(0)===2303741511&&n.getUint32(4)===218765834)return{width:n.getUint32(16),height:n.getUint32(20)};if(n.getUint16(0)===65496){let a=2;for(;a+9<n.byteLength;){if(n.getUint8(a)!==255)return null;const s=n.getUint8(a+1);if(s>=192&&s<=207&&s!==196&&s!==200&&s!==204)return{height:n.getUint16(a+5),width:n.getUint16(a+7)};const l=n.getUint16(a+2);if(l<2)return null;a+=2+l}}return null}function Tr(e,t){if(!e||!t)return null;const n=a=>String(a).toLowerCase().replace(/[,.]/g," ").split(/\s+/).filter(Boolean).sort().join(" ");return n(e)===n(t)}function kn(e,t){const n={...e||{}},a={},s=(p,f)=>{f?a[p]="vorlage":n[p]?a[p]="zeitnachweis":a[p]="fehlt"},i=(t==null?void 0:t.name)||"",l=(t==null?void 0:t.personalnummer)||"",d=(t==null?void 0:t.kostenstelle)||"",c=n.name||"",o=Tr(c,i)===!1,u=!!n.name;!n.name&&i&&(n.name=i),s("name",u);const h=!!n.persNr;!n.persNr&&l&&!o&&(n.persNr=l),s("persNr",h);const g=!!n.kst;return!n.kst&&d&&!o&&(n.kst=d),s("kst",g),a.vonHaltestelle=n.vonHaltestelle?"vorlage":"fehlt",a.nachHaltestelle=n.nachHaltestelle?"vorlage":"fehlt",a.betragProTag=n.betragProTag&&n.betragProTag>0?"vorlage":"fehlt",{konstanten:n,herkunft:a,nameKonflikt:o,vorlagenName:c,zeitnachweisName:i}}function Fr(e,t){const n=URL.createObjectURL(e),a=document.createElement("a");a.href=n,a.download=t,document.body.appendChild(a),a.click(),document.body.removeChild(a),setTimeout(()=>URL.revokeObjectURL(n),1e3)}async function Ge({root:e}){var H,ae,et,ye,we,_e,tt,Ce,ze;const t=await Re();if(!t){Lr(e);return}const[n,a,s,i]=await Promise.all([ue(),oe(),Xe(),ri("fahrgeld_abgabe")]),l=s!=null&&s.stichtagAuswertung?new Date(s.stichtagAuswertung):new Date,d=Dr(n),c=new Date,r=`${c.getFullYear()}-${String(c.getMonth()+1).padStart(2,"0")}`;d.includes(r)||d.unshift(r);const o=d,u=t.format||"excel",h=u==="pdf"?"PDF":"Excel",g={name:"Name",persNr:"Personalnummer",kst:"Kostenstelle",vonHaltestelle:'Strecke „von"',nachHaltestelle:'Strecke „nach"',betragProTag:"Tagessatz"},p=kn(t.konstanten,s),f=p.konstanten,v=p.herkunft,m=p.nameKonflikt,x=Object.entries(v).filter(([z,D])=>D==="fehlt").map(([z])=>z).map(z=>g[z]||z),P=Object.entries(v).filter(([z,D])=>D==="zeitnachweis").map(([z])=>g[z]||z),$=(z,D)=>z?v[D]==="zeitnachweis"?`<span class="fahrtgeld-aus-zeitnachweis" title="Aus deinem Zeitnachweis-PDF übernommen — die Vorlage hatte hier nichts stehen.">${M(z)} <small>(aus Zeitnachweis)</small></span>`:M(z):`<span class="fahrtgeld-fehlend" title="In der hochgeladenen Vorlage nicht gefunden — bitte vor Abgabe ergänzen.">${M(g[D]||D)} fehlt</span>`,T=(z,D)=>$(z,D);e.innerHTML=`
    ...
    `:(()=>{var G;const z=o.map((A,se)=>{const R=vn(n,A),ee=+(R.length*(t.konstanten.betragProTag??0)).toFixed(2),Ae=R.length>10,ke=Pr(A,a,R,l),Y=ke.ausstehend.length,q=+((R.length+Y)*(t.konstanten.betragProTag??0)).toFixed(2),vt=Y>0?ke.ausstehend.map(Be=>C(W(Be))).join(", "):"";return{mk:A,bs:R,summe:ee,ueberzaehlig:Ae,offen:Y,offenListe:vt,summeMitOffen:q,idx:se}}),D=((G=z.find(A=>A.bs.length>0))==null?void 0:G.mk)??z[0].mk,E=z.find(A=>A.mk===D)??z[0];return`
          <div class="card fahrtgeld-generate-card">
            <div class="fahrtgeld-generate-buttons">
              ...
              <div class="fahrtgeld-step-buttons fahrtgeld-step-buttons-mail">
                <a class="btn-mail-big" id="btn-fahrtgeld-mail" href="${M(yn(E.mk,i,a,f.name))}" target="_blank" rel="noopener" ${E.bs.length===0?'aria-disabled="true"':""}>
            ...
            <div class="fahrtgeld-generate-info" id="fahrtgeld-generate-info">
              <div class="fahrtgeld-generate-monat">${M(it(E.mk))}</div>
          ...
          <div class="card">
            ...
            <div class="fahrtgeld-monate">
              ${z.map(A=>{const se=A.mk===D?"checked":"",R=`data-monat="${M(A.mk)}" data-offen="${A.offen}" data-offen-liste="${M(A.offenListe)}" data-anzahl="${A.bs.length}" data-summe="${A.summe.toFixed(2).replace(".",",")}" data-summe-mit-offen="${A.summeMitOffen.toFixed(2).replace(".",",")}" data-monat-label="${M(it(A.mk))}" data-ueberzaehlig="${A.ueberzaehlig?"1":"0"}"`;return`
                  <label class="fahrtgeld-monat-row${A.offen>0?" has-pending":""}${A.bs.length===0?" empty":""}" ${R}>
                    <input type="radio" name="fg-monat-sel" value="${M(A.mk)}" ${se} ${A.bs.length===0?"disabled":""} class="fahrtgeld-monat-radio" />
                    <div class="fahrtgeld-monat-titel">
                      <div class="fahrtgeld-monat-name">${M(it(A.mk))}</div>
                      <div class="hint">
  ...
  `,(ye=e.querySelector("#btn-template-replace"))==null||ye.addEventListener("click",()=>{e.querySelector("#fahrtgeld-replace-input").click()}),(we=e.querySelector("#fahrtgeld-replace-input"))==null||we.addEventListener("change",async z=>{var E;const D=(E=z.target.files)==null?void 0:E[0];D&&await Lt(D,e)}),(_e=e.querySelector("#btn-template-clear"))==null||_e.addEventListener("click",async()=>{await le("Beim nächsten Öffnen wirst du gebeten, eine neue Vorlage hochzuladen.",{title:"Vorlage löschen?",confirmLabel:"Löschen",variant:"danger"})&&(await ni(),O("Vorlage gelöscht."),Ge({root:e}))}),(tt=e.querySelector("#btn-signature-upload"))==null||tt.addEventListener("click",()=>{e.querySelector("#fahrtgeld-signature-input").click()}),(Ce=e.querySelector("#fahrtgeld-signature-input"))==null||Ce.addEventListener("change",async z=>{var E;const D=(E=z.target.files)==null?void 0:E[0];D&&await _r(D,e)}),(ze=e.querySelector("#btn-signature-clear"))==null||ze.addEventListener("click",async()=>{if(!await le("Die hochgeladene Unterschrift wird entfernt — generierte Excel haben dann keine Unterschrift mehr.",{title:"Unterschrift entfernen?",confirmLabel:"Entfernen",variant:"danger"}))return;const z=await Re();z&&(await Kt({...z,unterschrift:null}),O("Unterschrift entfernt."),Ge({root:e}))});const N=e.querySelector("#btn-fahrtgeld-generate-excel"),I=e.querySelector("#btn-fahrtgeld-generate-pdf"),U=[N,I].filter(Boolean),y=e.querySelector("#btn-fahrtgeld-mail"),b=e.querySelector(".fahrtgeld-generate-monat"),S=e.querySelector("#fahrtgeld-generate-detail"),F=e.querySelectorAll(".fahrtgeld-monat-radio");function V(){const z=e.querySelector(".fahrtgeld-monat-radio:checked");if(!z)return;const D=z.closest(".fahrtgeld-monat-row");if(!D)return;const E=z.value,G=parseInt(D.getAttribute("data-anzahl")||"0",10),A=D.getAttribute("data-summe")||"0,00",se=parseInt(D.getAttribute("data-offen")||"0",10),R=D.getAttribute("data-offen-liste")||"",ee=D.getAttribute("data-summe-mit-offen")||A,Ae=D.getAttribute("data-monat-label")||"",ke=D.getAttribute("data-ueberzaehlig")==="1";if(b&&(b.textContent=Ae),S){const Y=[`${G} BS-Tag${G===1?"":"e"} erfasst · ${A} €`];se>0&&Y.push(`<br><span class="fahrtgeld-pending">⏳ Laut Schul-Rhythmus kommen noch ${se} BS-Tag${se===1?"":"e"}: ${M(R)} (mit allen: ${ee} €)</span>`),ke&&Y.push(`<br><span style="color: var(--warn); font-weight: 600;">· ${G-10} überzählig (max 10/Monat)</span>`),S.innerHTML=Y.join("")}U.forEach(Y=>{Y.disabled=G===0}),y&&(y.href=yn(E,i,a,f.name),a!=null&&a.fahrtgeldEmpfaenger||(y.title="Hinweis: Empfänger fällt auf den Putzmeister-Default zurück."),G===0?y.setAttribute("aria-disabled","true"):y.removeAttribute("aria-disabled"))}F.forEach(z=>z.addEventListener("change",V));async function K(z){var ke,Y;const D=e.querySelector(".fahrtgeld-monat-radio:checked");if(!D){X("Bitte einen Monat auswählen.",{type:"warn"});return}const E=D.closest(".fahrtgeld-monat-row"),G=D.value,A=parseInt((E==null?void 0:E.getAttribute("data-offen"))||"0",10),se=(E==null?void 0:E.getAttribute("data-offen-liste"))||"";if(A>0&&!await le(`Laut deinem Schul-Rhythmus kommen in diesem Monat noch ${A} BS-Tag${A===1?"":"e"}:

${se}

Diese Tage sind noch nicht im Zeitnachweis-PDF und werden in der ${z==="pdf"?"PDF":"Excel"} fehlen. Trotzdem jetzt für die bisher erfassten Tage generieren?`,{title:"Noch ausstehende BS-Tage",confirmLabel:"Trotzdem generieren"}))return;const R=z==="pdf"?I:N;R&&(R.disabled=!0);const ee=R==null?void 0:R.querySelector(".btn-generate-label"),Ae=ee==null?void 0:ee.textContent;ee&&(ee.textContent="Erstelle …");try{const q=await Re(),vt=await ue(),Be=vn(vt,G);if(!Be.length){X("Für diesen Monat sind keine BS-Anwesenheits-Tage erkannt.",{type:"warn"});return}const jt=(ke=q.unterschrift)==null?void 0:ke.bytes,Gt=(Y=q.unterschrift)==null?void 0:Y.extension,Ut=q.format||"excel",yt=Ut===z,Jt=yt?q.bytes:null,fa=yt&&z==="pdf"?q.layout:null,Yt=kn(q.konstanten,s).konstanten,{blob:ma,dateiname:Xt,ueberzaehlig:wt}=z==="pdf"?await zr({templateBytes:Jt,layout:fa,monatKey:G,bsTage:Be,konstanten:Yt,unterschriftBytes:jt,unterschriftExtension:Gt}):await xr({templateBytes:Jt,monatKey:G,bsTage:Be,konstanten:Yt,unterschriftBytes:jt,unterschriftExtension:Gt});Fr(ma,Xt);const Qt=z==="pdf"?"PDF":"Excel",pa=Array.isArray(q.missing)&&q.missing.length>0?` — bitte ${q.missing.length} fehlendes Feld${q.missing.length===1?"":"er"} vor Abgabe ergänzen`:"",ba=yt?"":` (aus deiner ${Ut==="pdf"?"PDF-":"Excel-"}Vorlage in ${Qt} überführt)`;O(`${Qt} erstellt: ${Xt}${wt>0?` (${wt} weiterer Tag${wt===1?"":"e"} passte/n nicht in die Vorlage)`:""}${ba}${pa}`)}catch(q){console.error("Fahrtgeld-Generierung fehlgeschlagen:",q),X(`Fehler: ${q.message||q}`,{type:"error",duration:8e3})}finally{R&&(R.disabled=!1),ee&&Ae&&(ee.textContent=Ae)}}N==null||N.addEventListener("click",()=>K("excel")),I==null||I.addEventListener("click",()=>K("pdf"))}function Lr(e){e.innerHTML=`
    <h1 class="view-title">Fahrgelderstattung</h1>
      ...
      <div class="card-split" style="margin-bottom: 16px; align-items: center;">
        ...
        <div style="display: flex; gap: 8px; align-items: center;">
          ...
          <select id="filter-monat">
            ...
            ${n.map(i=>`<option value="${i}">${Wr(i)}</option>`).join("")}
          </select>
...
`);navigator.clipboard.writeText(l).then(()=>O(`${i.length} Zeilen kopiert.`))});function s(){const i=a.value,d=(i?t.filter(c=>c.monatKey===i):t).filter(c=>c.ist!=null&&c.ist>0&&c.tagestyp!=="Wochenende");e.querySelector("#liste").innerHTML=Or(d),e.querySelectorAll(".copy-val").forEach(c=>{c.addEventListener("click",async()=>{const r=c.getAttribute("data-val");await navigator.clipboard.writeText(r),c.classList.add("ok");const o=c.textContent;c.textContent="✓ kopiert",setTimeout(()=>{c.classList.remove("ok"),c.textContent=o},1200)})})}s()}function Or(e){return e.length?`
    <table class="table">
      ...
      <tbody>
        ${e.map(t=>{const n=qe(t.ist),a=`${C(W(t.datum))}	${n}`;return`
            <tr data-copy="${xn(a)}">
              <td class="tabular">${C(W(t.datum))}</td>
              <td>${Nr(t.wochentag)}</td>
  ...
  `:'<p style="color: var(--fg-muted);">Keine Tage in dieser Auswahl.</p>'}function Nr(e){return{MO:"Montag",DI:"Dienstag",MI:"Mittwoch",DO:"Donnerstag",FR:"Freitag",SA:"Samstag",SO:"Sonntag"}[e]??e}function Wr(e){const[t,n]=e.split("-");return L(new Date(parseInt(t),parseInt(n)-1,1),"LLLL yyyy",{locale:ne})}function Kr(e){const t=String(e).toLowerCase();return t.includes("stempel")?"stempelzeit":t.includes("berufs")?"berufsschule":t.includes("urlaub")?"urlaub":t.includes("feiertag")?"feiertag":t.includes("dienst")?"dienstreise":t.includes("gleit")?"gleitzeit":t.includes("arbeitsunf")?"arbeitsunfaehigkeit":"feiertag"}function ga(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function xn(e){return ga(e)}async function Vr({root:e}){const[t,n,a,s,i]=await Promise.all([ue(),oe(),ht(),ft(),Le()]),l=Object.fromEntries(s.map(r=>[r.key,r])),d=pt(t,n,new Date,void 0,{isAzubi:i}).filter(r=>r.mailVorlageKey),c=Un(a);e.innerHTML=`
    ...
    <div class="card">
      ...
      <div id="vorlagen-editor">
        ${Object.keys(je).map(r=>{const o=Qe(r,l[r]);return Hr(o)}).join("")}
      </div>
    </div>
  `,Rr(e),qr(e)}function Ir(e,t,n){const a=Qe(e.mailVorlageKey,n[e.mailVorlageKey]);if(!a)return"";const s=Vt(t,e),i=Jn(a,s),l=It(t,a,s);return`
...
${te(i.text)}
      ...
      <div class="alert-actions mail-actions-big" style="margin-top: 16px;">
        ...
        <button class="btn sm btn-copy-mail" data-subject="${_t(i.betreff)}" data-body="${_t(i.text)}">📋 Betreff + Text kopieren</button>
      </div>
    </div>
  `}function Hr(e){return`
    <div class="vorlagen-item" data-key="${e.key}" style="border: 1px solid var(--border); border-radius: var(--radius-md); padding: 16px; margin-bottom: 16px;">
      ...
      <div class="form-group">
        <label>Betreff</label>
        <input type="text" class="v-betreff" value="${_t(e.betreff)}" />
      </div>
      <div class="form-group">
  ...
  `}function Rr(e){e.querySelectorAll(".btn-save-vorlage").forEach(t=>{t.addEventListener("click",async()=>{const n=t.getAttribute("data-key"),a=t.closest(".vorlagen-item"),s=a.querySelector(".v-betreff").value,i=a.querySelector(".v-text").value;await dt(n,{betreff:s,text:i}),O("Vorlage gespeichert.")})}),e.querySelectorAll(".btn-reset-vorlage").forEach(t=>{t.addEventListener("click",async()=>{const n=t.getAttribute("data-key"),a=je[n];a&&await le(`Deine Anpassungen an "${a.titel}" gehen verloren.`,{title:"Vorlage zurücksetzen?",confirmLabel:"Zurücksetzen",variant:"danger"})&&(await dt(n,{betreff:a.betreff,text:a.text}),O("Zurückgesetzt."),setTimeout(()=>location.reload(),400))})})}function qr(e){e.querySelectorAll(".btn-copy-mail").forEach(t=>{t.addEventListener("click",async()=>{const n=t.getAttribute("data-subject"),a=t.getAttribute("data-body"),s=`Betreff: ${n}

${a}`;await navigator.clipboard.writeText(s),O("Mail-Text kopiert.")})})}function te(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function _t(e){return te(e)}async function Zr({root:e}){const[t,n]=await Promise.all([oe(),ft()]),a=Object.fromEntries(n.map(s=>[s.key,s]));e.innerHTML=`
    ...
    <div class="grid cols-2">
      ...
      <div class="card" style="grid-column: 1 / -1;">
        ...
        <div id="vorlagen-editor">
          ${Object.keys(je).map(s=>{const i=Qe(s,a[s]);return jr(i)}).join("")}
        </div>
      </div>
  ...
  `,e.querySelector("#pause-sel").addEventListener("change",async s=>{const i={...t,pausenRegel:s.target.value};await ot(i),O("Pausen-Regel gespeichert.")}),e.querySelectorAll(".btn-save-vorlage").forEach(s=>{s.addEventListener("click",async()=>{const i=s.getAttribute("data-key"),l=s.closest(".vorlagen-item"),d=l.querySelector(".v-betreff").value,c=l.querySelector(".v-text").value;await dt(i,{betreff:d,text:c}),O("Vorlage gespeichert.")})}),e.querySelectorAll(".btn-reset-vorlage").forEach(s=>{s.addEventListener("click",async()=>{const i=s.getAttribute("data-key"),l=je[i];l&&await le(`Deine Anpassungen an "${l.titel}" gehen verloren.`,{title:"Vorlage zurücksetzen?",confirmLabel:"Zurücksetzen",variant:"danger"})&&(await dt(i,{betreff:l.betreff,text:l.text}),O("Zurückgesetzt."),setTimeout(()=>location.reload(),400))})})}function jr(e){return`
    <div class="vorlagen-item" data-key="${e.key}" style="border: 1px solid var(--border); border-radius: var(--radius-md); padding: 16px; margin-bottom: 16px;">
      <div class="card-split" style="margin-bottom: 12px;">
        <div>
          <h3 style="text-transform: none; letter-spacing: 0; color: var(--fg); font-size: 16px;">${rt(e.titel)}</h3>
          <p class="hint" style="margin: 4px 0;">${rt(e.beschreibung)}</p>
        </div>
        <button class="btn sm btn-reset-vorlage" data-key="${e.key}">Auf Default zurücksetzen</button>
      </div>
      <div class="form-group">
